...
ms.author: edupont
---
# <a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a><a name="get-ready-for-doing-business"></a>Vorbereitungen zum Tätigen von Geschäften
...
## <a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a><a name="teaching-tips-and-tours"></a>Unterrichtstipps und Touren
...
## <a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a><a name="role-specific-home-pages"></a>Rollenspezifische Homepages
...
## <a name="company-information"></a><a name="company-information"></a><a name="company-information"></a>Unternehmensdaten
...
## <a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a><a name="adding-users-and-permissions"></a>Hinzufügen von Benutzern und von Berechtigungen
...
## <a name="product-help"></a><a name="product-help"></a><a name="product-help"></a>Produkthilfe
...
### <a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a><a name="set-up-your-company-in-"></a>Ihr Unternehmen in [!INCLUDE[prod_short](includes/prod_short.md)] einrichten
