...
ms.author: edupont
---
# <a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a>Genehmigungsworkflow aktivieren
...
## <a name="enable-a-workflow"></a><a name="enable-a-workflow"></a>Workflow aktivieren
