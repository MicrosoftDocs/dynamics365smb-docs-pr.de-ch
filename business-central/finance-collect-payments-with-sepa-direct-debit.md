...
ms.author: edupont
---
# <a name="collect-payments-with-sepa-direct-debit" />Erfassen von Zahlungen per Basislastschriftverfahren SEPA
...
## <a name="setting-up-sepa-direct-debit" />Einrichten von SEPA-Lastschriften
...
### <a name="to-set-up-your-bank-account-for-sepa-direct-debit" />Einrichten Ihres Bankkontos für die SEPA-Basislastschriftübertragung
...
### <a name="to-set-up-the-customers-payment-method-for-sepa-direct-debit" />So richten Sie die Zahlungsmethode des Debitors für die SEPA-Lastschrift ein
...
#### <a name="to-set-up-the-direct-debit-mandate-that-represents-the-customer-agreement" />Einrichten der Einzugsermächtigung, entsprechend der Vereinbarung mit dem Debitor
...
## <a name="creating-sepa-direct-debit-collection-entries-and-export-to-a-bank-file" />SEPA-Lastschrifteinzugsposten erstellen und in eine Bankdatei exportieren
...
### <a name="to-create-a-direct-debit-collection" />Erstellen eines Lastschrifteinzugs
...
### <a name="to-export-a-direct-debit-collection-entry-to-a-bank-file" />Export eines Lastschrifteinzugpostens in eine Bankdatei
...
### <a name="to-reject-a-direct-debit-collection-entry" />Ablehnen eines Lastschrifteinzugpostens
...
### <a name="to-close-a-direct-debit-collection" />Schliessen eines Lastschrifteinzugs
...
## <a name="posting-sepa-direct-debit-payment-receipts" />SEPA-Lastschrifteinzug-Zahlungseingänge buchen
...
### <a name="to-post-a-direct-debit-payment-receipt-from-the-direct-debit-collections-page" />Buchen eines Lastschrifteingangs aus der Lastschrift-Einzugsseite
