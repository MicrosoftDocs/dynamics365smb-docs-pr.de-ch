...
## So richten Sie das SEPA-Lastschriftverfahren ein
...
### So richten Sie Ihr Bankkonto für das SEPA-Lastschriftverfahren ein
...
### So richten Sie die Zahlungsmethode des Debitors für das SEPA-Lastschriftverfahren ein
...
3. Richten Sie eine Zahlungsform ein. Füllen Sie die auf den Lastschrifteinzug bezüglichen Felder gemäss der Beschreibung in der folgenden Tabelle aus.  
    ...
    |Feld|Description|  
    |---------------------------------|---------------------------------------|  
    |**Basislastschrift**|Geben Sie an, ob die Zahlungsmethode für den SEPA-Lastschrifteinzug vorgesehen ist.|  
    |**Zahlungsbedingungscode Basislastschrift**|Geben Sie die Zahlungsbedingungen (z. B. „NICHT ZAHLEN“) an, die auf Verkaufsrechnungen angezeigt werden, die mit SEPA-Lastschrift bezahlt werden, um dem Kunden mitzuteilen, dass die Zahlung automatisch eingezogen wird. Als Alternative können Sie das Feld leer lassen.|  
...
5. Füllen Sie auf der Seite **SEPA-Felder** die Felder gemäss der Beschreibung in der folgenden Tabelle aus.  
    ...
    |**Zahlungsart**|Geben Sie an, ob die Übereinkunft mehrere (**Wiederkehrende**) oder einen einzelnen (**Einmalig**) Basislastschrifteinzug abdeckt.|  
...
### Erstellen eines Lastschrifteinzugs  
 ...
 3. Füllen Sie auf der Seite **Lastschrift erstellen** die Felder gemäss der Beschreibung in der folgenden Tabelle aus.  
    ...
    |**Nur Debitoren mit gültiger Einzugsermächtigung**|Geben Sie an, ob ein Lastschrifteinzug für Debitoren erstellt wird, die über eine gültige Einzugsermächtigung verfügen. **Hinweis:**  Ein Lastschrifteinzug wird erstellt, auch wenn das Feld  **Lastschriftmandats-ID**  auf der Verkaufsrechnung nicht ausgefüllt ist.|  
...
### Schliessen eines Lastschrifteinzugs
...
4. Füllen Sie auf der Seite **Lastschrift buchen** die Felder gemäss der Beschreibung in der folgenden Tabelle aus.  
    ...
    |**Nur Erf.-Journal erstellen**|Auswählen Aktivieren Sie dieses Kontrollkästchen, wenn Sie den Zahlungsbeleg nicht buchen möchten, wenn Sie die Schaltfläche  **OK**  auswählen. Der Zahlungsbeleg wird im angegebenen Journal vorbereitet und erst gebucht, wenn jemand die betreffenden Journalzeilen bucht.|  
