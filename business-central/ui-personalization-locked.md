...
ms.author: edupont
---
# <a name="why-a-page-is-locked-from-personalization"></a><a name="why-a-page-is-locked-from-personalization"></a><a name="why-a-page-is-locked-from-personalization"></a>Warum eine Seite für Personalisierungen gesperrt ist
...
## <a name="locked-from-personalizing"></a><a name="locked-from-personalizing"></a><a name="locked-from-personalizing"></a>Für Personalisierung gesperrt
...
### <a name="unlocking-the-page"></a><a name="unlocking-the-page"></a><a name="unlocking-the-page"></a>Entsperren der Seite
...
## <a name="blocked-from-personalizing"></a><a name="blocked-from-personalizing"></a><a name="blocked-from-personalizing"></a>Für Personalisierung blockiert
