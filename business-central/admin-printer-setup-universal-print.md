...
- Universal Print:
  ...
  - Sie verfügen in  [ID mindestens über die Rolle](/entra/identity/role-based-access-control/permissions-reference#printer-administrator) Druckeradministrator Microsoft Entra .

    Um Universal Print verwalten zu können, muss Ihr Konto in  [ID mindestens über die Rolle](/entra/identity/role-based-access-control/permissions-reference#printer-administrator) Druckeradministrator Microsoft Entra  verfügen. Diese Rollen werden nur für die Verwaltung von Universal Print benötigt. Es ist nicht erforderlich, dass Personen sie Einrichten und die Drucker von [!INCLUDE[prod_short](includes/prod_short.md)].
