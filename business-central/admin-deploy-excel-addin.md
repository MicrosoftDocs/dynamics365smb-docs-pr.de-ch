...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-excel"></a><a name="get-the-business-central-add-in-for-excel"></a><a name="get-the-business-central-add-in-for-excel"></a>Holen Sie sich das Business Central-Add-in für Excel
...
### <a name="about-the-add-in"></a><a name="about-the-add-in"></a><a name="about-the-add-in"></a>Über das Add-in
...
### <a name="about-deployment-as-an-admin"></a><a name="about-deployment-as-an-admin"></a><a name="about-deployment-as-an-admin"></a>Über das Bereitstellen als Admin
...
## <a name="preparation-on-premises-only"></a><a name="preparation-on-premises-only"></a><a name="preparation-on-premises-only"></a>Vorbereitung (nur on-premises)
...
## <a name="deploy-the-add-in-by-using-centralized-deployment"></a><a name="deploy-the-add-in-by-using-centralized-deployment"></a><a name="deploy-the-add-in-by-using-centralized-deployment"></a>Bereitstellen des Add-Ins mit Hilfe der zentralen Bereitstellung
...
### <a name="before-you-begin"></a><a name="before-you-begin"></a><a name="before-you-begin"></a>Bevor Sie beginnen
...
### <a name="set-up-centralized-deployment-of-the-add-in"></a><a name="set-up-centralized-deployment-of-the-add-in"></a><a name="set-up-centralized-deployment-of-the-add-in"></a>Zentrale Bereitstellung des Add-Ins festlegen
...
## <a name="individual-acquisition-install-the-add-in-manually-for-your-own-use"></a><a name="individual-acquisition-install-the-add-in-manually-for-your-own-use"></a><a name="individual-acquisition-install-the-add-in-manually-for-your-own-use"></a><a name="install"></a>Individuelle Übernahme: Installieren Sie das Add-In manuell für Ihren eigenen Gebrauch
...
### <a name="configure-the-business-central-connection"></a><a name="configure-the-business-central-connection"></a><a name="configure-the-business-central-connection"></a>Konfigurieren Sie die Business Central Verbindung
...
## <a name="prepare-devices-and-network-for-the-excel-add-in"></a><a name="prepare-devices-and-network-for-the-excel-add-in"></a><a name="prepare-devices-and-network-for-the-excel-add-in"></a>Geräte und Netzwerk für das Excel Add-In vorbereiten
