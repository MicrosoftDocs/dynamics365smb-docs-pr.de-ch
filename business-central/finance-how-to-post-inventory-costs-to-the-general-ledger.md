...
1. Wählen Sie das Symbol ![Glühbirne, die Wie möchten Sie weiter verfahren öffnet](media/ui-search/search_small.png "Tell Me-Funktion"), geben Sie **Bestandskosten in G/L** ein und wählen Sie dann den entsprechenden Link.
...
## <a name="reporting-costs-and-reconciling-with-the-general-ledger"></a>Melden von Kosten und Abstimmen mit dem Fibuposten
