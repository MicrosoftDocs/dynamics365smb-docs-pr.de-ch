...
ms.author: edupont
---
# <a name="quote-an-assemble-to-order-sale" />Offerte eines Auftragsmontageverkaufs
...
## <a name="to-create-a-sales-quote-for-an-assemble-to-order-item" />So erstellen Sie eine Verkaufsofferte für einen Auftragsmontageartikel:
