...
Sobald Sie die Daten einmal eingeben haben, können Sie die Offerte buchen. Sie können es dann per E-Mail senden. [!INCLUDE[prod_short](includes/prod_short.md)] erstellt eine .PDF-Datei mit dem Verkaufsangebot und fügt sie der E-Mail-Nachricht hinzu, deren Entwurf Sie im Add-In erstellt haben.  
