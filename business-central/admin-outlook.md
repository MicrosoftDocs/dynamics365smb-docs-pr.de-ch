...
ms.reviewer: jswymer
---
# <a name="get-the-business-central-add-in-for-outlook"></a>Das Business Central-Add-in für Outlook abrufen
...
- Ihr Microsoft 365 Konto hat mindestens die Rolle [Exchange-Administrator](/entra/identity/role-based-access-control/permissions-reference#exchange-Administrator]
...
1. Wählen Sie **Outlook Add-in Zentrale Bereitstellung**, um die Anleitung zur unterstützten Einrichtung zu starten.
1. Überprüfen Sie die erste Seite und wählen Sie **Weiter**, um die Seite zum Herunterladen der Add-Ins zu öffnen.
1. Aktivieren Sie in der Spalte **Bereitstellen** das Kontrollkästchen für die Add-Ins, die Sie bereitstellen möchten, und wählen Sie dann **Herunterladen und weiter**.

    Eine Datei mit dem Namen *OutlookAddins.zip* wird auf Ihr Gerät heruntergeladen.

1. An diesem Punkt sind Sie mit der Arbeit in Business Central fertig, sodass Sie **Erledigt** wählen können.
...
1. Wechseln Sie in den Ordner, in dem die OutlookAddins.zip heruntergeladen wurde, und extrahieren Sie die Dateien **Contact Insights.xml** und **Document View.xml** aus der .zip-Datei in einen Ordner Ihrer Wahl.
...
1. Melden Sie sich beim Microsoft 365 Admin Center an, und wechseln Sie dann zu [Integrierte Apps](https://go.microsoft.com/fwlink/?linkid=2163967).

1. Wählen Sie **Angepasste Apps hochladen**.
1. Legen Sie auf der Seite **Apps zum Bereitstellen hochladen** den **App-Typ** auf **Office-Add-In** fest.
1. Wählen Sie **Manifestdatei (.xml) vom Gerät hochladen** > **Datei auswählen** aus.
1. Wählen Sie eine der zuvor extrahierten Add-In-Dateien, **Context Insights.xml** bzw. **Documents.xml**, aus.
1. Folgen Sie den Anweisungen, um Benutzer zuzuweisen und das Add-In bereitzustellen.
1. Wiederholen Sie die Schritte 9 bis 11 für die andere Add-In-Datei, wenn Sie möchten.
