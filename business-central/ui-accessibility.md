...
ms.author: jswymer
---
# <a name="accessibility-and-keyboard-shortcuts"></a><a name="accessibility-and-keyboard-shortcuts"></a><a name="accessibility-and-keyboard-shortcuts"></a>Eingabehilfe und Tastenkombinationen
...
## <a name="headings-in-content"></a><a name="headings-in-content"></a><a name="headings-in-content"></a><a name="Headings"></a> Überschriften in Content
...
## <a name="image-and-links"></a><a name="image-and-links"></a><a name="image-and-links"></a><a name="Images"></a> Bild und Links
...
## <a name="assistive-technologies"></a><a name="assistive-technologies"></a><a name="assistive-technologies"></a><a name="AssistiveTech"></a> Assistive Technologien
...
## <a name="tooltips"></a><a name="tooltips"></a><a name="tooltips"></a>QuickInfos
...
#### <a name="accessing-tooltips"></a><a name="accessing-tooltips"></a><a name="accessing-tooltips"></a>Zugriff auf Tooltips
...
## <a name="for-more-accessibility-information"></a><a name="for-more-accessibility-information"></a><a name="for-more-accessibility-information"></a>Weitere Zugriffsinformationen
