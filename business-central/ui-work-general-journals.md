...
Die meisten Journale basieren auf dem Hauptjournal und Sie können alle Transaktionen auf der Seite  **Hauptjournale**  verarbeiten. Mehr dazu erfahren Sie unter [Transaktionen direkt im Fibu buchen](finance-how-post-transactions-directly.md).  
...
Es werden jedoch auch Journale angeboten, die für bestimmte Transaktionsarten optimiert sind, wie beispielsweise das  [!INCLUDE [prod_short](includes/prod_short.md)] Zahlungsjournal *für die Erfassung von Zahlungen.*  Weitere Informationen finden Sie unter [Zahlungsbelege und Erstattungen im Zahlungsausgangs Erf.-Journal](payables-how-post-payments-refunds.md).  
...
Es gibt mehrere Fibu Erfassungsjournalvorlagen. Jede Journalvorlage wird durch eine eigene Seite mit bestimmten Funktionen und den zur Unterstützung dieser Funktionen erforderlichen Feldern dargestellt, wie etwa die Seite  **Zahlungsabstimmungsjournale**  zur Verarbeitung von Bankzahlungen und die Seite  **Zahlungsjournale**  zur Bezahlung Ihrer Lieferanten oder Rückerstattung an Ihre Mitarbeiter. Weitere Informationen finden Sie unter [Zahlungen vornehmen](payables-make-payments.md) und [Abstimmen von Debitoren-Zahlungen mit dem Zahlungseingangs Erf.-Journal oder von Debitorenposten](receivables-how-apply-sales-transactions-manually.md).
...
Auf der Seite  **Wiederkehrende Hauptbucheinträge**  können Sie die Aktion  **Zuordnungen**  auswählen, um anzugeben, wie Beträge in der wiederkehrenden Buch.-Blattzeile mehreren Konten und Dimensionen zugeordnet werden. Die Zuordnung dient als Ausgleichskontozeile für die Erfassungsjournalzeile.
