...
---
# <a name="work-with-general-journals"></a><a name="work-with-general-journals"></a>Mit Fibu Erfassungsjournalen arbeiten
...
## <a name="use-journal-templates-and-batches"></a><a name="use-journal-templates-and-batches"></a>Erf.-Journalvorlagen und -namen verwenden
...
### <a name="validating-general-journal-batches"></a><a name="validating-general-journal-batches"></a>Fibu Erf.-Journal-Stapelverarbeitungen überprüfen
...
## <a name="understanding-main-accounts-and-balancing-accounts"></a><a name="understanding-main-accounts-and-balancing-accounts"></a>Hauptkonten und Gegenkonten und Saldokonten verstehen
...
## <a name="work-with-recurring-journals"></a><a name="work-with-recurring-journals"></a>Mit wiederkehrenden Erfassungsjournalen arbeiten
...
### <a name="recurring-method-field"></a><a name="recurring-method-field"></a>Feld Wiederholungsmethode
...
### <a name="recurring-frequency-field"></a><a name="recurring-frequency-field"></a>Feld Wiederholungsrate
...
### <a name="expiration-date-field"></a><a name="expiration-date-field"></a>Ablaufdatumsfeld
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts"></a><a name="allocating-recurring-journal-amounts-to-several-accounts"></a>Zuordnung von Beträgen des wiederkehrenden Erf.-Journals auf mehrere Konten
...
#### <a name="example-allocating-rent-payments-to-different-departments"></a><a name="example-allocating-rent-payments-to-different-departments"></a>Beispiel: Zuordnen von Mietzahlungen auf verschiedene Abteilungen
...
### <a name="calculate-the-reversal-date"></a><a name="calculate-the-reversal-date"></a>Stornierungsdatum berechnen
...
## <a name="work-with-standard-journals"></a><a name="work-with-standard-journals"></a>Mit Standard-Erfassungsjournalen arbeiten
...
### <a name="to-save-a-standard-journal"></a><a name="to-save-a-standard-journal"></a>Ein Standard-Erfassungsjournal speichern:
...
### <a name="to-reuse-a-standard-journal"></a><a name="to-reuse-a-standard-journal"></a>Standard Erf.-Journale wieder nutzen
...
## <a name="to-renumber-document-numbers-in-journals"></a><a name="to-renumber-document-numbers-in-journals"></a>Belegnummern in Erf.-Journalen neu nummerieren
...
### <a name="to-renumber-documents-in-journals"></a><a name="to-renumber-documents-in-journals"></a>Belege in Erfassungsjournalen neu nummerieren
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/paths/use-journals-dynamics-365-business-central/)
