...
---
# <a name="work-with-general-journals" />Mit Fibu Erfassungsjournalen arbeiten
...
## <a name="use-journal-templates-and-batches" />Erf.-Journalvorlagen und -namen verwenden
...
### <a name="validating-general-journal-batches" />Fibu Erf.-Journal-Stapelverarbeitungen überprüfen
...
## <a name="understanding-main-accounts-and-balancing-accounts" />Hauptkonten und Gegenkonten und Saldokonten verstehen
...
## <a name="work-with-recurring-journals" />Mit wiederkehrenden Erfassungsjournalen arbeiten
...
### <a name="recurring-method-field" />Feld Wiederholungsmethode
...
### <a name="recurring-frequency-field" />Feld Wiederholungsrate
...
### <a name="expiration-date-field" />Ablaufdatumsfeld
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts" />Zuordnung von Beträgen des wiederkehrenden Erf.-Journals auf mehrere Konten
...
#### <a name="example-allocating-rent-payments-to-different-departments" />Beispiel: Zuordnen von Mietzahlungen auf verschiedene Abteilungen
...
### <a name="calculate-the-reversal-date" />Stornierungsdatum berechnen
...
## <a name="work-with-standard-journals" />Mit Standard-Erfassungsjournalen arbeiten
...
### <a name="to-save-a-standard-journal" />Ein Standard-Erfassungsjournal speichern:
...
### <a name="to-reuse-a-standard-journal" />Standard Erf.-Journale wieder nutzen
...
## <a name="to-renumber-document-numbers-in-journals" />Belegnummern in Erf.-Journalen neu nummerieren
...
### <a name="to-renumber-documents-in-journals" />Belege in Erfassungsjournalen neu nummerieren
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-journals-dynamics-365-business-central" />Siehe verwandte [Microsoft Schulungen](/training/paths/use-journals-dynamics-365-business-central/)
