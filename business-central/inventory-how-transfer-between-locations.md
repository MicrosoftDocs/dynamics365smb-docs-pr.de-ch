...
---
# <a name="transfer-inventory-between-locations"></a><a name="transfer-inventory-between-locations"></a>Lagerbestand zwischen Lagerplätzen umlagern
...
## <a name="transfer-orders"></a><a name="transfer-orders"></a>Umlagerungsaufträge
...
## <a name="item-reclassification-journals"></a><a name="item-reclassification-journals"></a>Erfassungsjournale für die Neuklassifizierung von Artikeln
...
## <a name="to-transfer-items-with-a-transfer-order"></a><a name="to-transfer-items-with-a-transfer-order"></a>So lagern Sie Artikel mit einem Umlagerungsauftrag um
...
### <a name="post-multiple-transfer-orders-in-a-batch"></a><a name="post-multiple-transfer-orders-in-a-batch"></a>Buchen Sie mehrere Umlagerungsaufträge in einem Stapel
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a><a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch"></a>Planen Sie einen Auftragswarteschlangeneintrag, um mehrere Belege in einem Stapel zu veröffentlichen
...
## <a name="to-transfer-items-with-the-item-reclassification-journal"></a><a name="to-transfer-items-with-the-item-reclassification-journal"></a>So lagern Sie Artikel mit dem Artikel Umlag. Erfassungsjournal um
...
## <a name="undo-a-transfer-shipment"></a><a name="undo-a-transfer-shipment"></a>Ein Umlagerungsversand rückgängig machen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/transfer-items/)
