...
Sie können die Seite **Erfassungsjournale zur Artikelumlage** für Folgendes verwenden:
...
* Der Wert im Feld **Zu liefernde Menge** wird um die Menge erhöht, die Sie rückgängig gemacht haben.
