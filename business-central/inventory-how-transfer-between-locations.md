...
---
# <a name="transfer-inventory-between-locations" />Lagerbestand zwischen Lagerplätzen umlagern
...
## <a name="transfer-orders" />Umlagerungsaufträge
...
## <a name="item-reclassification-journals" />Erfassungsjournale für die Neuklassifizierung von Artikeln
...
## <a name="to-transfer-items-with-a-transfer-order" />So lagern Sie Artikel mit einem Umlagerungsauftrag um
...
### <a name="post-multiple-transfer-orders-in-a-batch" />Buchen Sie mehrere Umlagerungsaufträge in einem Stapel
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch" />Planen Sie einen Auftragswarteschlangeneintrag, um mehrere Belege in einem Stapel zu veröffentlichen
...
## <a name="to-transfer-items-with-the-item-reclassification-journal" />So lagern Sie Artikel mit dem Artikel Umlag. Erfassungsjournal um
...
## <a name="undo-a-transfer-shipment" />Ein Umlagerungsversand rückgängig machen
