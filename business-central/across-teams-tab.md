...
# <a name="add-business-central-tab-in-microsoft-teams" />Business Central-Registerkarte in Microsoft Teams hinzufügen
...
## <a name="about-business-central-tabs" />Über Business Central-Registerkarten
...
## <a name="add-tab-using-recommended-content" />Registerkarte mit empfohlenem Inhalt hinzufügen
...
## <a name="add-tab-using-a-page-link" />Registerkarte über einen Seitenlink hinzufügen
...
## <a name="add-tab-by-pinning-card-details" />Registerkarte durch Anheften von Kartendetails hinzufügen
...
## <a name="change-a-tab-and-its-content" />Eine Registerkarte und ihren Inhalt ändern
