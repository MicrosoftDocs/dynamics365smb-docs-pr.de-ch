...
ms.author: bholtorf
---
# <a name="the-late-payment-prediction-extension" />Die Erweiterung "Vorhersage verspäteter Zahlungen"
...
## <a name="viewing-all-payment-predictions" />Anzeigen aller Zahlungsvorhersagen
...
## <a name="viewing-a-payment-prediction-for-a-specific-sales-document" />Anzeigen einer Zahlungsvorhersage für einen bestimmten Verkaufsbeleg
...
### <a name="data-required-to-train-and-evaluate-the-model" />Daten, die zum Trainieren und Auswerten des Modells erforderlich sind
...
### <a name="standard-model-and-my-model" />Standardmodell und Mein Modell
...
#### <a name="to-train-and-use-your-model" />So trainieren und verwenden Sie Ihr Modell
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-late-payment-prediction" /><a name="AnchorText"> </a>Erstellen und verwenden Sie Ihren eigenen Prognose-Webdienst zur Vorhersage von Zahlungsverzug
...
## <a name="see-related-microsoft-trainingtrainingmodulespredict-late-payments-sales-documents" />Siehe verwandte [Microsoft Schulungen](/training/modules/predict-late-payments-sales-documents/)
