...
ms.author: edupont
---
# <a name="service-order-status-and-repair-status"></a><a name="service-order-status-and-repair-status"></a><a name="service-order-status-and-repair-status"></a>Serviceauftragsstatus und Reparaturstatus
...
## <a name="specifying-service-order-status-for-repair-status"></a><a name="specifying-service-order-status-for-repair-status"></a><a name="specifying-service-order-status-for-repair-status"></a>Serviceauftragsstatus für Reparaturstatusoptionen festlegen
...
### <a name="pending"></a><a name="pending"></a><a name="pending"></a>"Offen"
...
### <a name="in-process"></a><a name="in-process"></a><a name="in-process"></a>In Bearbeitung
...
### <a name="on-hold"></a><a name="on-hold"></a><a name="on-hold"></a>Abwarten
...
### <a name="finished"></a><a name="finished"></a><a name="finished"></a>Beendet
...
## <a name="assigning-priority-to-service-order-status"></a><a name="assigning-priority-to-service-order-status"></a><a name="assigning-priority-to-service-order-status"></a>Einem Serviceauftragsstatus eine Priorität zuordnen
