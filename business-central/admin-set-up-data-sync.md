...
# <a name="get-ready-to-synchronize-master-data" />Vorbereitung der Synchronisierung der Masterdaten
...
## <a name="uni-directional-synchronization-only" />Nur eindirektionale Synchronisierung
...
## <a name="specify-the-source-company" />Quellunternehmen definieren
...
## <a name="enable-or-disable-tables-and-fields" />Aktivieren oder deaktivieren Sie Tabellen und Felder
...
### <a name="use-match-based-coupling" />Kopplung basierend auf Übereinstimmung verwenden
...
## <a name="synchronize-for-the-first-time" />Zum ersten Mal synchronisieren
...
## <a name="add-or-delete-tables-from-the-synchronization-tables-list" />Hinzufügen oder Löschen von Tabellen aus der Synchronisierungstabellenliste

### <a name="add-a-table" />Eine Tabelle hinzufügen
...
### <a name="delete-a-table" />Tabelle löschen
...
## <a name="use-export-and-import-to-share-a-synchronization-setup" />Verwenden Sie Export und Import, um ein Synchronisierungseinrichtung gemeinsam zu nutzen
