...
Um Zeit zu sparen, stellt [!INCLUDE [prod_short](includes/prod_short.md)] eine Liste von Tabellen bereit, die Unternehmen häufig synchronisieren. Standardmässig sind diese Tabellen für die Synchronisierung aktiviert, aber Sie können sie nach Belieben ändern, deaktivieren oder löschen. Als zusätzliche Zeitersparnis sind einige Felder in den Tabellen bereits deaktiviert, da sie für die Tochtergesellschaft wahrscheinlich nicht relevant sind.
