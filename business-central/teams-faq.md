...
### Wie melde ich mich bei der [!INCLUDE [prod_short.md](includes/prod_short.md)] App in Teams an?
...
### Wie melde ich mich bei der [!INCLUDE [prod_short.md](includes/prod_short.md)] App in Teams ab?
...
### Stellt die App für Teams eine Verbindung zu [!INCLUDE [prod_short.md](includes/prod_short.md)] lokal her? 
...
### Funktioniert die App mit mehreren Unternehmen und Umgebungen? 
...
### In welchen Ländern oder Regionen ist die [!INCLUDE [prod_short.md](includes/prod_short.md)] App verfügbar? 
...
### Funktioniert die [!INCLUDE [prod_short.md](includes/prod_short.md)] App mit jeder Lokalisierung von [!INCLUDE [prod_short.md](includes/prod_short.md)]? 
...
### <a name="language"></a>Welche Sprachen [!INCLUDE [prod_short.md](includes/prod_short.md)] unterstützt die App?
...
### Funktioniert die [!INCLUDE [prod_short.md](includes/prod_short.md)]-App mit Branchenlösungen?
...
### Funktioniert [!INCLUDE [prod_short.md](includes/prod_short.md)] mit der mobilen App von Teams?
...
### Ist die [!INCLUDE [prod_short.md](includes/prod_short.md)]-App für Teams gleich wie die [!INCLUDE [prod_short.md](includes/prod_short.md)]-App für iOS und Android?
...
### Funktioniert die [!INCLUDE [prod_short.md](includes/prod_short.md)] App in allen Teams Clients?
...
### Welches ist der beste Team-Client für [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### Was ist der beste Weg für mich, um [!INCLUDE [prod_short.md](includes/prod_short.md)] und Microsoft Teams potenziellen Kunden zu zeigen?
...
### Nimmt die [!INCLUDE [prod_short.md](includes/prod_short.md)] App für Teams meine Anpassung und Personalisierung vor?
...
### Wie wirken sich die für die App erforderlichen Berechtigungen auf meine Privatsphäre aus?
...
### Wo kann ich etwas über meine Privatsphäre erfahren? 
...
### Wie deinstalliere ich die [!INCLUDE [prod_short.md](includes/prod_short.md)] App für Teams?
...
### Wird Microsoft die [!INCLUDE [prod_short.md](includes/prod_short.md)] App für Teams weiter verbessern?
...
### Wo finde ich die Teams Integration innerhalb des Business Central-Webclient? 
...
### <a name="who-can-view"></a>Wer kann den Inhalt einer Registerkarte sehen?
...
### <a name=#recommended-content></a>Woher kommen die empfohlenen Inhalte?
...
### Wenn ich eine Registerkarte erstelle, werden den Personen im Kanal oder Chat Berechtigungen erteilt?
...
### Kann ich neben einer Registerkarte chatten?

Ja. Verwenden Sie das Chat-Symbol, um das Gespräch zu beginnen. Dieser Chat-Thread wird dann der Registerkarte zugeordnet. 

### Wenn ich eine Registerkarte aus einem Chat oder Kanal entferne, werden dann alle Business Central-Daten gelöscht?

Anz.

### Kann ich eine Registerkarte sicher umbenennen?
...
### Ich muss aufgabenübergreifend in verschiedenen Fenstern arbeiten. Kann ich das tun?

Ja. Sie können die Registerkarte in einem eigenen Browserfenster öffnen, um den Business Central-Webclient anzuzeigen. 

### Kann ich in Teambesprechungen Registerkarten hinzufügen oder anheften?

Anz. Die Business Central-App für Teams unterstützt keine Registerkarten in Besprechungen.

### Kann keine Registerkarte hinzufügen, wenn ISV-URLs wie „*.bc.dynamics.com“ verwendet werden (kann aber angeheftet werden)

Nicht unterstützt.

### Sehen andere meine Änderungen, wenn ich in der Registerkarte z. B. navigiere, sortiere, einen Filter anwende oder suche?

Anz. Nur Feldänderungen oder laufende Aktionen wirken sich darauf aus, wie andere den Inhalt der Registerkarte sehen.

### Wird der Registerkarteninhalt automatisch aktualisiert? Wenn nicht, wie aktualisiere ich ihn?
...
### Zeigt dies Listen und Datensätze von meinen Anpassungen und Add-Ons an?

Ja. 

### Wenn ich eine Registerkarte hinzufüge, sehen die Leute sie in meiner Sprache?
...
### Kann ich mehrere Registerkarten haben, die auf unterschiedliche Inhalte verweisen?

Ja.

### Kann ich auch Registerkarten hinzufügen, um mit einer einzelnen Person zu chatten?
...
### Kann ich das Unternehmen innerhalb einer Registerkarte wechseln?

Anz. 

### Unterscheidet sich dies von der Verwendung der allgemeinen Fähigkeit von Teams, eine Registerkarte zu erstellen, die eine Website hostet?
...
### In welchen Tabellen sucht die App?
...
### Welche Felder in der Kontakttabelle kann ich durchsuchen?
...
### Enthalten die Suchergebnisse Unternehmen und Personen?
...
### Werden in den Ergebnissen Kontakte einer Geschäftsbeziehung angezeigt?
...
### Kann ich während Besprechungen nach Kontaktdaten suchen?
...
### Wie sehe ich meine letzten Interaktionen mit einem Kontakt?
...
### Wie registriere ich einen Teamanruf oder ein Meeting als Interaktion?
...
### Kann ich einen Kontakt von der [!INCLUDE [prod_short.md](includes/prod_short.md)]-App für Teams anrufen?
...
### Wie kann ich aktuelle Belege für einen Debitor oder Kreditor anzeigen?
...
### Wie suche ich mit Sonderzeichen nach Kontakten?
...
### Wie kann ich nach Kontakten suchen, die in einem anderen Unternehmen gespeichert sind?
...
### Sind [!INCLUDE [prod_short.md](includes/prod_short.md)]-Kontakte anders als die auf dem Bildschirm „Teamkontakte“?
...
### Synchronisiert [!INCLUDE [prod_short.md](includes/prod_short.md)] Kontakte mit Teams?
...
### Was ist die Mindestversion von [!INCLUDE [prod_short.md](includes/prod_short.md)] für die Kontaktsuche?
...
### Kann ich von meinem mobilen Gerät aus suchen?

Die Kontaktsuche ist bei Teams für iOS und Teams für Android in diesem Moment nicht verfügbar.

### Welche Berechtigungen benötige ich für die Kontaktsuche?
...
### Kann ich die Kontaktsuche verwenden, wenn ich ein delegierter Administrator bin?
...
### Ist die Kontaktsuche von API-Grenzwerten betroffen?
...
### Warum werde ich manchmal gebeten, die App einzurichten?
...
### Ich möchte nach Elementen oder Datensätzen aus anderen Tabellen suchen. Kann ich das von Teams aus machen?
...
### Welche Arten von Links unterstützt die App?
...
### Wie lösche ich eine Karte, die ich an einen Chat gesendet habe?
...
### Zeigen Karten immer aktuelle Informationen?
...
### Wie finde ich heraus, zu welcher Firma eine Karte in Teams gehört?
...
### Wo befindet sich die Schaltfläche Speichern im Detailfenster in Teams?
...
### Wenn ich Details für eine Karte anzeigen möchte, sehen andere Benutzer mein Detailfenster?
...
### Kann ich einen Teamanruf über das Detailfenster in Teams starten?
...
### Kann ich Belege aus dem Detailfenster in Teams drucken?
...
### Kann ich über das Detailfenster in Teams auf die Kamera zugreifen?
...
### <a name="location"></a>Kann ich über das Detailfenster in Teams auf meinen Standort zugreifen?
...
### Wie öffne ich die Details in einem neuen Fenster?
...
### Kann ich Karten mit Benutzern ausserhalb meiner Organisation teilen?
...
### Ist die Erfahrung für Benutzer, die Gäste sind, anders?
...
### Wie installiert ein Gastbenutzer die [!INCLUDE [prod_short.md](includes/prod_short.md)] App? 
...
### Versendet Teilen über Teams eine kompakte Karte? 

Ja. Der Link wird automatisch zu einer Karte erweitert, wenn Sie die Business Central-App für Teams installiert haben. 

### Erhalten die Empfänger die Nachricht von mir oder von einem Business Central Servicekonto? 
...
### Ist „Share über Teams“ in Business Central On-Premises verfügbar? 
...
### Gewährt Teilen über Teams den Empfängern Berechtigungen? 
...
### Muss ich die Teams Desktop App installiert haben, um Share über Teams nutzen zu können? 

Nr. Alles, was Sie brauchen, ist ein gültiges Konto, das Zugriff auf Microsoft Teams hat. 

### Ist Teilen über Teams in allen Business Central Clients verfügbar? 
...
### Wo finde ich die Funktion Für Teams freigeben in Business Central? 
