...
Nr. Während jeder im Chat die Karte selbst anzeigen kann, wird das Detailfenster nur dann auf Ihrem Gerät angezeigt, wenn Sie **Einzelheiten** auswählen. Andere Benutzer müssen wählen **Einzelheiten** auswählen, wenn sie das Detailfenster auf ihrem Gerät anzeigen möchten.
...
Um lokale oder internationale Festnetz- und Mobiltelefone von Teams aus anrufen zu können, benötigen Sie eine Teamlizenz für Unternehmensanrufe. Ausserdem müssen Sie Teams als Anruflösung einrichten. Weitere Informationen finden Sie unter [Planen Sie die Sprachlösung Ihres Teams](/microsoftteams/cloud-voice-landing-page) in der Teamdokumentation.
