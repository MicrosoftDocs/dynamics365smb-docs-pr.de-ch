...
ms.author: edupont
---
# <a name="subcontract-manufacturing" />Fertigung durch Fremdarbeitsvertrag
...
## <a name="subcontract-work-centers" />Arbeitsplatzgruppen für Fremdarbeiten
...
### <a name="subcontract-work-center-fields" />Felder unter "Arbeitsplatzgruppen für Fremdarbeiten"
...
### <a name="routings-that-use-subcontract-work-centers" />Arbeitspläne, in denen Arbeitsplatzgruppen für Fremdarbeit verwendet werden
...
## <a name="calculate-subcontracting-worksheets-and-create-subcontract-purchase-orders" />Fremdarbeitenarbeitsblätter berechnen und Fremdarbeitsbestellung erstellen
...
### <a name="to-calculate-the-subcontracting-worksheet" />Fremdarbeitenarbeitsblatt berechnen
...
### <a name="to-create-the-subcontract-purchase-order" />Einkaufsbestellung für Fremdarbeit generieren
1.  Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell me-Funktion") Symbol. Geben Sie **Fremdarbeitenvorschlag** ein, und wählen Sie dann den zugehörigen Link.  
...
## <a name="posting-subcontract-purchase-orders" />Einkaufsbestellungen für Fremdarbeiten buchen
...
## <a name="to-post-a-subcontract-purchase-order" />So buchen Sie eine Fremdarbeitsbestellung
