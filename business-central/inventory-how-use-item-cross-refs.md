...
ms.author: edupont
---
# <a name="use-item-references" />Element-Referenzen verwenden
...
## <a name="to-start-using-item-references" />So beginnen Sie mit der Verwendung von Artikelreferenzen
...
## <a name="to-set-up-an-item-reference" />Artikelreferenzen einrichten
...
## <a name="to-enter-a-vendors-item-description-on-a-document" />So geben Sie die Artikelbeschreibung eines Kreditors auf einem Beleg ein
