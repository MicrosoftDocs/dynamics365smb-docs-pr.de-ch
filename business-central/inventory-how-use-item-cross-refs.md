...
ms.author: edupont
---
# <a name="use-item-references"></a><a name="use-item-references"></a>Element-Referenzen verwenden
...
## <a name="to-start-using-item-references"></a><a name="to-start-using-item-references"></a>So beginnen Sie mit der Verwendung von Artikelreferenzen
...
## <a name="to-set-up-an-item-reference"></a><a name="to-set-up-an-item-reference"></a>Artikelreferenzen einrichten
...
## <a name="to-enter-a-vendors-item-description-on-a-document"></a><a name="to-enter-a-vendors-item-description-on-a-document"></a>So geben Sie die Artikelbeschreibung eines Kreditors auf einem Beleg ein
