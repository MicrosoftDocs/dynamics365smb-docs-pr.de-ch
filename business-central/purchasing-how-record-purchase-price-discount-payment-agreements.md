...
## <a name="see-related-training-at-microsoft-learn"></a>Weitere Informationen erhalten Sie in der zugehörigen Schulung unter [Microsoft Learn](/learn/modules/set-up-prices-discounts-dynamics-365-business-central/index).
