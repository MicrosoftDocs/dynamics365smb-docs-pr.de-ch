...
# <a name="viewing-service-statistics"></a><a name="viewing-service-statistics"></a><a name="viewing-service-statistics"></a>So zeigen Sie die Servicestatistik an
...
## <a name="viewing-statistics-for-service-orders"></a><a name="viewing-statistics-for-service-orders"></a><a name="viewing-statistics-for-service-orders"></a>So zeigen Sie die Serviceauftragsstatistik an
...
### <a name="view-totals-for-a-service-order"></a><a name="view-totals-for-a-service-order"></a><a name="view-totals-for-a-service-order"></a>Anzeigen von Summen für einen Auftrag
...
### <a name="view-shipping-information"></a><a name="view-shipping-information"></a><a name="view-shipping-information"></a>Ansichtsversandinformationen
...
### <a name="view-order-details"></a><a name="view-order-details"></a><a name="view-order-details"></a>Auftragsdetails anzeigen
...
### <a name="analyze-service-order-lines"></a><a name="analyze-service-order-lines"></a><a name="analyze-service-order-lines"></a>Serviceauftragspositionen analysieren
...
### <a name="view-customer-information"></a><a name="view-customer-information"></a><a name="view-customer-information"></a>So zeigen Sie Debitoreninformationen an
...
## <a name="viewing-service-item-statistics"></a><a name="viewing-service-item-statistics"></a><a name="viewing-service-item-statistics"></a>So zeigen Sie die Servicestatistik an
...
## <a name="use-trendscapes"></a><a name="use-trendscapes"></a><a name="use-trendscapes"></a>Trendscapes nutzen
...
## <a name="viewing-gains-and-losses-on-contracts"></a><a name="viewing-gains-and-losses-on-contracts"></a><a name="viewing-gains-and-losses-on-contracts"></a>Gewinne und Verluste auf Verträgen anzeigen
...
## <a name="viewing-statistics-for-posted-service-documents"></a><a name="viewing-statistics-for-posted-service-documents"></a><a name="viewing-statistics-for-posted-service-documents"></a>Servicestatistik für gebuchte Service-Belege anzeigen
...
### <a name="posted-service-shipment-statistics"></a><a name="posted-service-shipment-statistics"></a><a name="posted-service-shipment-statistics"></a>Geb. Servicelieferungsstatistik
...
### <a name="posted-service-invoice-statistics"></a><a name="posted-service-invoice-statistics"></a><a name="posted-service-invoice-statistics"></a>Geb. Servicerechnungsstatistik
...
### <a name="posted-service-credit-memo-statistics"></a><a name="posted-service-credit-memo-statistics"></a><a name="posted-service-credit-memo-statistics"></a>Statistik zu gebuchten Servicegutschriften
