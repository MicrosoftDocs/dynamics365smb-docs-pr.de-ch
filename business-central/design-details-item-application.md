...
ms.author: edupont
---
# <a name="design-details-item-application" />Designdetails: Artikelausgleich
...
## <a name="inventory-increase" />Lagerzugänge
...
## <a name="inventory-decrease" />Lagerabgänge
...
## <a name="fixed-application" />fester Ausgleich
...
### <a name="example--fixed-application-in-purchase-return" />Beispiel – Fester Ausgleich in der Einkaufsreklamation
...
### <a name="example--fixed-application-with-average-cost" />Beispiel – Fester Ausgleich mit Durchschnittskosten
...
### <a name="example--fixed-application-in-sales-return" />Beispiel – Fester Ausgleich in der Verkaufsreklamation
...
## <a name="transfer-application" />Umlagerungs-Anwendung
...
### <a name="example--average-costing-method" />Beispiel - Durchschnittskostenberechnungsmethode
...
### <a name="example--standard-costing-method" />Beispiel - Lagerabgangsmethode
...
## <a name="reapplication" />Erneuter Ausgleich
