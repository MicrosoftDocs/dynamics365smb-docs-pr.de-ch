...
1. Wählen Sie das Symbol ![Glühbirne, die die Tell Me Funktion öffnet](media/ui-search/search_small.png "Tell Me-Funktion"), geben Sie **Offerten** ein und wählen Sie dann den entsprechenden Link.
2. Geben Sie im Feld **Debitor** den Namen eines vorhandenen Debitors ein.

   Andere Felder auf der Seite **Verkaufsofferte** werden nun mit den Standardinformationen vom ausgewählten Debitor ausgefüllt.  
...
8. Wiederholen Sie die Schritte 4 bis 7 für jedes Produkt, das Sie an den Kunden verkaufen möchten.
...
12. Wenn der Debitor die Offerte annimmt, wählen Sie **Rechnung erstellen** oder **Auftrag vornehmen** aus.
