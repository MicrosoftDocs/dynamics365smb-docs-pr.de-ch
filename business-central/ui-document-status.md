...
ms.author: bholtorf
---
# <a name="status-field-on-documents" />Feld "Status" in Belegen
...
## <a name="release-process" />Freigabe-Prozess
...
### <a name="approval-procedures" />Genehmigungsverfahren
...
### <a name="warehouse-activities" />Lageraktivitäten
...
## <a name="reopen-a-released-order" />Eine freigegebene Bestellung wieder öffnen
