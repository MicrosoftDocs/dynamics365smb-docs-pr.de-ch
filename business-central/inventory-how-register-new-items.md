...
ms.author: edupont
---
# <a name="register-new-items"></a><a name="register-new-items"></a>Neue Artikel registrieren
...
## <a name="to-create-a-new-item-card"></a><a name="to-create-a-new-item-card"></a>So erstellen Sie eine neue Artikelkarte
...
### <a name="to-save-the-item-card-as-a-template"></a><a name="to-save-the-item-card-as-a-template"></a>So speichern Sie die Artikelkarte als Vorlage
...
### <a name="items-used-in-production-orders"></a><a name="items-used-in-production-orders"></a>Artikel, die in Fertigungsaufträgen verwendet werden
...
## <a name="to-set-up-multiple-vendors-for-an-item"></a><a name="to-set-up-multiple-vendors-for-an-item"></a>So richten Sie mehrere Kreditoren für einen Artikel ein
...
## <a name="set-up-item-substitutions"></a><a name="set-up-item-substitutions"></a>Ersatzartikel einrichten
...
### <a name="to-make-an-item-substitution"></a><a name="to-make-an-item-substitution"></a>So legen Sie einen Ersatzartikel für einen Artikel fest
...
## <a name="deleting-item-cards"></a><a name="deleting-item-cards"></a>Löschen von Artikelkarten
...
## <a name="manage-inventory-in-warehouses"></a><a name="manage-inventory-in-warehouses"></a>Lagerbestand in Lagern verwalten
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/create-items/)
