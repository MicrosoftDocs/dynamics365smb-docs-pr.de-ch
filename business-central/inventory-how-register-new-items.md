...
ms.author: edupont
---
# <a name="register-new-items" />Neue Artikel registrieren
...
## <a name="to-create-a-new-item-card" />So erstellen Sie eine neue Artikelkarte
...
### <a name="to-save-the-item-card-as-a-template" />So speichern Sie die Artikelkarte als Vorlage
...
### <a name="items-used-in-production-orders" />Artikel, die in Fertigungsaufträgen verwendet werden
...
## <a name="to-set-up-multiple-vendors-for-an-item" />So richten Sie mehrere Kreditoren für einen Artikel ein
...
## <a name="set-up-item-substitutions" />Ersatzartikel einrichten
...
### <a name="to-make-an-item-substitution" />So legen Sie einen Ersatzartikel für einen Artikel fest
...
## <a name="deleting-item-cards" />Löschen von Artikelkarten
...
## <a name="manage-inventory-in-warehouses" />Lagerbestand in Lagern verwalten
