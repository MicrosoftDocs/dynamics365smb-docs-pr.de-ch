...
Nachdem Sie die Grundlagen eingerichtet haben, können Sie die übrigen Kernregionen einrichten. Anschliessend sind Sie bereit, Geschäftsdaten, beispielsweise Debitoren und Kreditoren, einzugeben. Weitere Informationen finden Sie unter [[!INCLUDE[prod_short](includes/prod_short.md)]](setup.md) einrichten.  
