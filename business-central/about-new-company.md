...
---
# <a name="create-new-companies-in-includeprodshortincludesprodshortmd" />Neue Unternehmen in [!INCLUDE[prod_short](includes/prod_short.md)] erstellen
...
## <a name="choose-the-right-template" />Die richtige Vorlage auswählen
...
## <a name="copy-a-company" />Unternehmen kopieren
...
## <a name="set-up-the-company" />Unternehmen einrichten
...
## <a name="companies-and-environments" />Unternehmen und Umgebungen
...
## <a name="changing-a-companys-name" />Ändern des Namens eines Unternehmens
...
## <a name="add-contoso-coffee" />Contoso Coffee hinzufügen
