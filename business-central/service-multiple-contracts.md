...
ms.author: edupont
---
# <a name="multiple-contracts" />Mehrere Verträge
...
## <a name="creating-multiple-contracts-per-service-item" />Erstellen von mehreren Verträgen pro Serviceartikel
...
## <a name="copying-documents" />Belege kopieren
...
## <a name="creating-service-orders-for-multiple-contracts" />Erstellen von Serviceaufträgen für mehrere Verträge
