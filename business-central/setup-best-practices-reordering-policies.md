...
ms.author: edupont
---
# <a name="setup-best-practices-reordering-policies" />Bewährte Einrichtungsmethoden: Wiederbeschaffungsverfahren
...
## <a name="see-related-microsoft-trainingtrainingpathsreplenish-items-dynamics-365-business-central" />Siehe verwandte [Microsoft Schulungen](/training/paths/replenish-items-dynamics-365-business-central/)
