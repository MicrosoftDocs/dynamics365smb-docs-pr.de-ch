...
ms.author: edupont
---
# <a name="register-employees" />Erfassen eines Mitarbeiters
...
## <a name="adding-new-employees" />Hinzufügen neuer Mitarbeiter
...
## <a name="to-set-up-an-employee" />Einen Mitarbeiter einrichten:
...
## <a name="to-insert-a-picture-of-an-employee" />Das Bild eines Mitarbeiters einfügen:
...
## <a name="to-register-various-information-about-an-employee" />Erfassen von verschiedenen Informationen über einen Mitarbeiter
