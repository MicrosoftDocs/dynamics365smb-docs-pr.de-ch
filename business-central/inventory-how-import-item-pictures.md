...
ms.author: edupont
---
# <a name="import-multiple-item-pictures" />Mehrere Artikelbilder importieren
...
## <a name="to-name-picture-files-by-the-item-names-and-prepare-the-zip-file" />So benennen Sie Bilddateien anhand des Artikelnamens und bereiten die ZIP-Datei vor:
...
## <a name="to-import-item-pictures" />So importieren Sie Artikelbilder
