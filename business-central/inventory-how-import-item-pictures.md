...
ms.author: edupont
---
# <a name="import-multiple-item-pictures"></a><a name="import-multiple-item-pictures"></a>Mehrere Artikelbilder importieren
...
## <a name="to-name-picture-files-by-the-item-names-and-prepare-the-zip-file"></a><a name="to-name-picture-files-by-the-item-names-and-prepare-the-zip-file"></a>So benennen Sie Bilddateien anhand des Artikelnamens und bereiten die ZIP-Datei vor:
...
## <a name="to-import-item-pictures"></a><a name="to-import-item-pictures"></a>So importieren Sie Artikelbilder
