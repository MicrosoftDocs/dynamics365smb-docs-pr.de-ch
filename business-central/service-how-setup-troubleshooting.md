...
# <a name="setting-up-troubleshooting-for-service-items" />Problembehandlung für Serviceartikel einrichten
...
## <a name="to-set-up-troubleshooting-guidelines" />So richten Sie Lösungsanleitungen ein
...
## <a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups" />In diesem Fenster können Sie Lösungsanleitungen Serviceartikelgruppen, Artikeln oder Serviceartikeln zuordnen.
