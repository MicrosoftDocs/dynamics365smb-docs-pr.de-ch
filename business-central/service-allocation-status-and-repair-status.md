...
ms.author: bholtorf
---
# <a name="allocation-status-and-repair-status-of-service-items" />Zuordnungsstatus und Reparaturstatus von Serviceartikeln
...
## <a name="changing-repair-status" />Ändern des Reparaturstatus
...
## <a name="converting-service-quotes-to-service-orders" />Vertragsangebote in Serviceaufträge umwandeln
...
## <a name="canceling-allocations" />Zuordnungen stornieren
...
## <a name="reallocating-an-active-allocation-entry" />Eine aktive Zuordnung neu zuordnen
...
## <a name="reallocating-a-service-item" />Serviceaufgabenneu zuordnen
