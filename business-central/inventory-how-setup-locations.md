...
ms.author: bholtorf
---
# <a name="set-up-locations"></a><a name="set-up-locations"></a>Einrichten von Lagerorten
...
## <a name="location-cards"></a><a name="location-cards"></a>Lagerortkarten
...
### <a name="to-set-up-a-location"></a><a name="to-set-up-a-location"></a>So legen Sie einen Ort fest
...
### <a name="to-create-a-transfer-route"></a><a name="to-create-a-transfer-route"></a>So erstellen Sie eine Umlagerungsroute
...
## <a name="bins"></a><a name="bins"></a>Lagerplätze
...
## <a name="zones"></a><a name="zones"></a>Zonen
...
## <a name="default-dimensions-for-locations"></a><a name="default-dimensions-for-locations"></a>Standarddimensionen für Standorte
...
### <a name="example-of-default-dimensions-on-locations"></a><a name="example-of-default-dimensions-on-locations"></a>Beispiel einer Standarddimensionen für Standorte
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Siehe zugehörige Schulung unter [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
