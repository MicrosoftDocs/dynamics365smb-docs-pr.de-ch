...
ms.author: bholtorf
---
# <a name="set-up-locations" />Einrichten von Lagerorten
...
## <a name="location-cards" />Lagerortkarten
...
### <a name="to-set-up-a-location" />So legen Sie einen Ort fest
...
### <a name="to-create-a-transfer-route" />So erstellen Sie eine Umlagerungsroute
...
## <a name="default-dimensions-for-locations" />Standarddimensionen für Standorte
...
### <a name="example-of-default-dimensions-on-locations" />Beispiel einer Standarddimensionen für Standorte
...
## <a name="see-related-training-at-microsoft-learnlearnmodulestrade-set-up-dynamics-365-business-central" />Siehe zugehörige Schulung unter [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)
