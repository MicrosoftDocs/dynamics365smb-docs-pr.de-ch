...
ms.author: edupont
---
# <a name="reconcile-customer-payments-with-the-cash-receipt-journal-or-from-customer-ledger-entries" />Abstimmen von Debitoren-Zahlungen mit dem Zahlungseingangs Erf.-Journal oder von Debitorenposten
...
## <a name="to-fill-and-post-a-cash-receipt-journal" />So füllen Sie ein Zahlungseingangs Erf.-Journal aus und buchen dieses
