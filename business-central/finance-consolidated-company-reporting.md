...
# <a name="consolidating-financial-data-from-multiple-companies" />Konsolidieren von Finanzdaten aus mehreren Unternehmen
...
## <a name="use-the-consolidated-trial-balance-report" />Verwendet den Bericht „Konsolidierte Bilanz“
...
## <a name="consolidate-data" />Daten konsolidieren
...
### <a name="to-test-the-data-before-you-consolidate" />Prüfen von Datenbanken vor der Konsolidierung
...
### <a name="run-the-consolidation" />Die Konsolidierung ausführen
...
## <a name="eliminate-repeated-transactions" />Wiederholte Transaktionen verhindern
...
## <a name="export-and-import-consolidated-data-between-databases" />Konsolidierte Daten zwischen Datenbanken exportieren und importieren
