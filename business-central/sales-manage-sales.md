...
description: Lesen Sie alles darüber, wie Sie die Dienste von Business Central für die Verwaltung von Verkaufsaktivitäten mit Ihren Debitoren mit Verkaufsrechnungen, Aufträgen, Offertenn und mehr nutzen können.
author: SorenGP
ms.topic: overview
ms.devlang: na
ms.tgt_pltfrm: na
...
Für alle Verkaufsprozesse können Sie einen Genehmigungsworkflows einfügen, beispielsweise um grosse Verkäufe an bestimmten Debitoren vom Buchhaltungs-Manager zu genehmigen. Weitere Informationen finden Sie unter [Workflows verwenden](across-use-workflows.md).
