...
ms.author: edupont
---
# <a name="about-cost-accounting" />Informationen zur Kostenrechnung
...
## <a name="workflow-in-cost-accounting" />Workflow in der Kostenrechnung
...
## <a name="cost-types-cost-centers-and-cost-objects" />Kostenarten, Kostenstellen und Kostenträger
...
## <a name="cost-entries-and-cost-journals" />Kostenposten und Kosten-Erfassungsjournale
...
## <a name="cost-allocations" />Kostenumlagen
...
## <a name="cost-budgets" />Kostenbudgets
...
## <a name="cost-reporting" />Kostenberichte
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-cost-accounting-dynamics--business-central" />Siehe verwandte [Microsoft Schulungen](/training/paths/use-cost-accounting-dynamics-365-business-central/)
