...
ms.author: edupont
---
# <a name="invoice-jobs" />Fakturieren von Projekten
...
## <a name="to-create-multiple-job-sales-invoices" />So erstellen Sie mehrere Projektverkaufsrechnungen
...
## <a name="to-create-and-post-job-sales-invoice-from-job-planning-lines" />So erstellen und buchen Sie eine Projektverkaufsrechnung aus Projektplanzeilen
