...
ms.author: edupont
---
# <a name="close-an-lsv-collection-in-the-swiss-version" />Eine LSV-Sammlung schliessen in der Schweizer Version
...
## <a name="to-close-an-lsv-collection" />So schliessen Sie einen LSV-Einzug
...
## <a name="to-reopen-an-lsv-collection" />So öffnen Sie einen LSV-Einzug erneut
