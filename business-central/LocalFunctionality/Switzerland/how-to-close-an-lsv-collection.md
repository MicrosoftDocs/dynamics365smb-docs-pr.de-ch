...
ms.author: edupont
---
# <a name="close-an-lsv-collection-in-the-swiss-version"></a><a name="close-an-lsv-collection-in-the-swiss-version"></a><a name="close-an-lsv-collection-in-the-swiss-version"></a>Eine LSV-Sammlung schliessen in der Schweizer Version
...
## <a name="to-close-an-lsv-collection"></a><a name="to-close-an-lsv-collection"></a><a name="to-close-an-lsv-collection"></a>So schliessen Sie einen LSV-Einzug
...
## <a name="to-reopen-an-lsv-collection"></a><a name="to-reopen-an-lsv-collection"></a><a name="to-reopen-an-lsv-collection"></a>So öffnen Sie einen LSV-Einzug erneut
