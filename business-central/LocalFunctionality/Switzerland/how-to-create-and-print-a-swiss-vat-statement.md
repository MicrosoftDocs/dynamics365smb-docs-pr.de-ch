...
ms.author: edupont
---
# <a name="create-and-print-a-swiss-vat-statement-in-the-swiss-version"></a><a name="create-and-print-a-swiss-vat-statement-in-the-swiss-version"></a><a name="create-and-print-a-swiss-vat-statement-in-the-swiss-version"></a>Erstellen und Drucken einer Schweizer MWST-Abrechnung in der Schweizer Version
...
## <a name="to-set-up-a-swiss-vat-statement-template"></a><a name="to-set-up-a-swiss-vat-statement-template"></a><a name="to-set-up-a-swiss-vat-statement-template"></a>So richten Sie eine MWST-Abrechnungsvorlage für die Schweiz ein
...
## <a name="to-print-the-swiss-vat-statement"></a><a name="to-print-the-swiss-vat-statement"></a><a name="to-print-the-swiss-vat-statement"></a>So drucken Sie die MWST-Abrechnung (Schweiz)
