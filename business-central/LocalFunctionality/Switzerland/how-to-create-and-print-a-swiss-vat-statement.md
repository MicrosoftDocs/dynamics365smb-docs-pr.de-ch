...
ms.author: edupont
---
# <a name="create-and-print-a-swiss-vat-statement-in-the-swiss-version" />Erstellen und Drucken einer Schweizer MWST-Abrechnung in der Schweizer Version
...
## <a name="to-set-up-a-swiss-vat-statement-template" />So richten Sie eine MWST-Abrechnungsvorlage für die Schweiz ein
...
## <a name="to-print-the-swiss-vat-statement" />So drucken Sie die MWST-Abrechnung (Schweiz)
