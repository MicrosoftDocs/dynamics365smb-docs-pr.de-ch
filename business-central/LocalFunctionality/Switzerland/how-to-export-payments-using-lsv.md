...
ms.author: edupont
---
# <a name="export-payments-using-lsv-in-the-swiss-version"></a><a name="export-payments-using-lsv-in-the-swiss-version"></a><a name="export-payments-using-lsv-in-the-swiss-version"></a>Zahlungen mit LSV exportieren in der Schweizer Version
...
## <a name="to-export-payments-using-lsv"></a><a name="to-export-payments-using-lsv"></a><a name="to-export-payments-using-lsv"></a>So exportieren Sie Zahlungen mit LSV
