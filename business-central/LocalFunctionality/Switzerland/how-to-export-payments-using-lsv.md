...
ms.author: edupont
---
# <a name="export-payments-using-lsv-in-the-swiss-version" />Zahlungen mit LSV exportieren in der Schweizer Version
...
## <a name="to-export-payments-using-lsv" />So exportieren Sie Zahlungen mit LSV
