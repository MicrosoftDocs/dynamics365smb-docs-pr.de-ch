...
ms.author: edupont
---
# <a name="swiss-electronic-payments"></a><a name="swiss-electronic-payments"></a><a name="swiss-electronic-payments"></a>Elektronische Zahlungen (Schweiz)
...
## <a name="electronic-payment-methods"></a><a name="electronic-payment-methods"></a><a name="electronic-payment-methods"></a>Elektronische Zahlungsformen
...
## <a name="sepa-credit-transfers"></a><a name="sepa-credit-transfers"></a><a name="sepa-credit-transfers"></a>SEPA Kreditübertragungen
...
### <a name="iban-and-qr-iban"></a><a name="iban-and-qr-iban"></a><a name="iban-and-qr-iban"></a><a name="iban-qr"></a>IBAN und QR-IBAN
