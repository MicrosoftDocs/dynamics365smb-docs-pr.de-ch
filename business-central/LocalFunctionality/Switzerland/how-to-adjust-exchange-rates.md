...
ms.author: edupont
---
# <a name="adjust-exchange-rates-in-the-swiss-version" />Wechselkurse regulieren in der Schweizer Version
...
## <a name="to-adjust-an-exchange-rate" />So regulieren Sie einen Wechselkurs
