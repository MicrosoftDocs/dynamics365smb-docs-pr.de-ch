...
ms.author: edupont
---
# <a name="process-an-lsv-collection-in-the-swiss-version"></a><a name="process-an-lsv-collection-in-the-swiss-version"></a>Eine LSV-Sammlung verarbeiten in der Schweizer Version
...
## <a name="to-create-an-lsv-collection"></a><a name="to-create-an-lsv-collection"></a>So erstellen Sie einen LSV-Einzug
...
## <a name="to-manage-suggested-payments"></a><a name="to-manage-suggested-payments"></a>So verwalten Sie vorgeschlagene Zahlungen
