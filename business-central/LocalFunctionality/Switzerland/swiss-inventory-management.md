...
ms.author: edupont
---
# <a name="swiss-inventory-management"></a><a name="swiss-inventory-management"></a><a name="swiss-inventory-management"></a>Lagerverwaltung (Schweiz)
...
## <a name="managing-item-details"></a><a name="managing-item-details"></a><a name="managing-item-details"></a>Verwalten von Artikeldetails
...
## <a name="invoices-with-multiple-shipments"></a><a name="invoices-with-multiple-shipments"></a><a name="invoices-with-multiple-shipments"></a>Rechnungen mit mehreren Lieferungen
