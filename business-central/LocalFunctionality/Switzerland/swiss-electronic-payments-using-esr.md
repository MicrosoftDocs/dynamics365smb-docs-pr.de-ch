...
ms.author: edupont
---
# <a name="swiss-electronic-payments-using-esr-in-the-swiss-version"></a><a name="swiss-electronic-payments-using-esr-in-the-swiss-version"></a>Elektronische Zahlungen mit ESR in der Schweizer Version
