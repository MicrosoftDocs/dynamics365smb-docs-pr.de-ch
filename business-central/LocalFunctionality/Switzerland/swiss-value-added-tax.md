...
ms.author: edupont
---
# <a name="swiss-value-added-tax"></a><a name="swiss-value-added-tax"></a><a name="swiss-value-added-tax"></a>Mehrwertsteuer (Schweiz)
...
## <a name="vat-amounts-and-vat-exchange-rates"></a><a name="vat-amounts-and-vat-exchange-rates"></a><a name="vat-amounts-and-vat-exchange-rates"></a>MWST-Beträge und MWST-Wechselkurse
...
### <a name="currency-exchange-rates-for-vat-reporting"></a><a name="currency-exchange-rates-for-vat-reporting"></a><a name="currency-exchange-rates-for-vat-reporting"></a>Währungswechselkurse für die MWST-Abrechnung
