...
ms.author: edupont
---
# <a name="swiss-value-added-tax" />Mehrwertsteuer (Schweiz)
...
## <a name="vat-amounts-and-vat-exchange-rates" />MWST-Beträge und MWST-Wechselkurse
...
### <a name="currency-exchange-rates-for-vat-reporting" />Währungswechselkurse für die MWST-Abrechnung
