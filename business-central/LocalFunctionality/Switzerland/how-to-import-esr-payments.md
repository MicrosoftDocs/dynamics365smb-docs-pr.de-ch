...
ms.author: edupont
---
# <a name="import-esr-payments-in-the-swiss-version" />ESR-Zahlungen importieren in der Schweizer Version
...
## <a name="to-import-esr-payments" />So importieren Sie ESR-Zahlungen
