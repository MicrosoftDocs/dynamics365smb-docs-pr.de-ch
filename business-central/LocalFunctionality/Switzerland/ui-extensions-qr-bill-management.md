...
ms.author: soalex
---
# <a name="qr-bill-management-in-the-swiss-version-of-business-central"></a><a name="qr-bill-management-in-the-swiss-version-of-business-central"></a><a name="qr-bill-management-in-the-swiss-version-of-business-central"></a>QR-Bill Management in der Schweizer Version von Business Central
...
## <a name="get-started-with-the-qr-bill-management-extension"></a><a name="get-started-with-the-qr-bill-management-extension"></a><a name="get-started-with-the-qr-bill-management-extension"></a><a name="get-started"></a>Erste Schritte mit der QR-Bill Management-Erweiterung
...
## <a name="issuing-qr-bills"></a><a name="issuing-qr-bills"></a><a name="issuing-qr-bills"></a>Ausstellen von QR-Rechnungen
...
## <a name="adding-billing-information-to-qr-bills"></a><a name="adding-billing-information-to-qr-bills"></a><a name="adding-billing-information-to-qr-bills"></a>Hinzufügen von Abrechnungsinformationen zu QR-Rechnungen
...
## <a name="understanding-the-payment-reference"></a><a name="understanding-the-payment-reference"></a><a name="understanding-the-payment-reference"></a>Informationen über die Zahlungsreferenz
...
### <a name="formats-for-qr-references-and-creditor-references"></a><a name="formats-for-qr-references-and-creditor-references"></a><a name="formats-for-qr-references-and-creditor-references"></a><a name="formats"></a>Formate für QR-Referenzen und Kreditorreferenzen
...
## <a name="using-multiple-bank-accounts-as-issuers-of-qr-bills"></a><a name="using-multiple-bank-accounts-as-issuers-of-qr-bills"></a><a name="using-multiple-bank-accounts-as-issuers-of-qr-bills"></a><a name="multiplebankaccounts"></a>Verwendung mehrerer Bankkonten als Ersteller von QR-Rechnungen
...
### <a name="adding-a-qr-iban-to-a-new-or-existing-bank-account"></a><a name="adding-a-qr-iban-to-a-new-or-existing-bank-account"></a><a name="adding-a-qr-iban-to-a-new-or-existing-bank-account"></a>Hinzufügen einer QR-IBAN zu einem neuen oder bestehenden Bankkonto
...
## <a name="scanning-and-importing-qr-bills"></a><a name="scanning-and-importing-qr-bills"></a><a name="scanning-and-importing-qr-bills"></a>Scannen und Importieren von QR-Rechnungen
...
## <a name="receiving-qr-bills"></a><a name="receiving-qr-bills"></a><a name="receiving-qr-bills"></a>Empfang von QR-Rechnungen
...
### <a name="receiving-a-qr-bill-through-an-incoming-document"></a><a name="receiving-a-qr-bill-through-an-incoming-document"></a><a name="receiving-a-qr-bill-through-an-incoming-document"></a>Empfangen einer QR-Rechnung über einen eingehenden Beleg
...
#### <a name="receiving-through-the-kofax-ocr-service"></a><a name="receiving-through-the-kofax-ocr-service"></a><a name="receiving-through-the-kofax-ocr-service"></a>Eingang über den Kofax OCR-Dienst
...
### <a name="receiving-a-qr-bill-through-purchase-orders-or-purchase-invoices"></a><a name="receiving-a-qr-bill-through-purchase-orders-or-purchase-invoices"></a><a name="receiving-a-qr-bill-through-purchase-orders-or-purchase-invoices"></a>Empfang einer QR-Rechnung über Einkaufsbestellung oder Einkaufsrechnung
...
### <a name="receiving-a-qr-bill-through-a-purchase-journal"></a><a name="receiving-a-qr-bill-through-a-purchase-journal"></a><a name="receiving-a-qr-bill-through-a-purchase-journal"></a>Empfang einer QR-Rechnung über ein Einkauf Erf.-Journal
...
## <a name="reconciliation"></a><a name="reconciliation"></a><a name="reconciliation"></a>Abstimmen
