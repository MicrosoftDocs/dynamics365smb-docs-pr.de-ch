...
## <a name="to-issue-delivery-reminders"></a><a name="to-issue-delivery-reminders"></a>So registrieren Sie Lieferbenachrichtigungen
...
## <a name="to-view-delivery-reminder-ledger-entries"></a><a name="to-view-delivery-reminder-ledger-entries"></a>Um sich detaillierte Lieferbenachrichtigungen anzeigen zu lassen
