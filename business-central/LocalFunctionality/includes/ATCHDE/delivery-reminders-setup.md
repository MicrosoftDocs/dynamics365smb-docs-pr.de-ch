...
## <a name="to-set-up-delivery-reminders"></a><a name="to-set-up-delivery-reminders"></a><a name="to-set-up-delivery-reminders"></a>So richten Sie Lieferbenachrichtigungen ein
