...
## <a name="to-set-up-delivery-reminder-terms"></a><a name="to-set-up-delivery-reminder-terms"></a><a name="to-set-up-delivery-reminder-terms"></a>Einrichten von Lieferbenachrichtigungsmethoden
...
## <a name="to-add-delivery-reminder-levels-to-a-delivery-reminder-term"></a><a name="to-add-delivery-reminder-levels-to-a-delivery-reminder-term"></a><a name="to-add-delivery-reminder-levels-to-a-delivery-reminder-term"></a>So richten Sie Lieferbenachrichtigungsstufen für Lieferbenachrichtigungsmethoden ein
...
## <a name="to-set-up-delivery-reminder-text-messages"></a><a name="to-set-up-delivery-reminder-text-messages"></a><a name="to-set-up-delivery-reminder-text-messages"></a>Lieferbenachrichtigungstextnachrichten einrichten
