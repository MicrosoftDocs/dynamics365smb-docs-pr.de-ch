...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences" />Benutzereinstellungen und Präferenzen verwalten
...
## <a name="types-of-user-settings" />Typen von Benutzereinstellungen
...
## <a name="overview-of-all-user-specific-changes" />Übersicht aller benutzerspezifischen Änderungen
...
## <a name="to-review-or-delete-user-personalizations" />Zum Überprüfen oder Löschen von Benutzerpersonalisierungen
