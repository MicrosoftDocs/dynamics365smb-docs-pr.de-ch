...
---
# <a name="design-details-availability-in-the-warehouse" />Designdetails: Verfügbarkeit im Lager
...
## <a name="bin-content-and-reservations" />Lagerplatzinhalt und Reservierungen
...
## <a name="quantity-available-to-pick" />Verfügbare Menge für Kommissionierung
...
### <a name="calculating-the-quantity-available-to-pick" />Berechnen der zur Kommissionierung verfügbaren Menge
...
## <a name="quantity-available-to-reserve" />Für Reservierung verfügbare Menge
...
### <a name="calculating-the-quantity-available-to-reserve" />Berechnen der zur Reservierung verfügbaren Menge
