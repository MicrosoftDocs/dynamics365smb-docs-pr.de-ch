...
ms.author: bholtorf
---
# <a name="the-quickbooks-payroll-file-import-extension" />Die Quickbooks-Gehaltsabrechnungsdatei-Importerweiterung
...
## <a name="steps-to-import-payroll-data" />So importieren Sie Lohndaten
