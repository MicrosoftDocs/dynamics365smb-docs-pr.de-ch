...
ms.author: bholtorf
---
# <a name="set-up-vat-statement-templates-and-vat-statement-names"></a><a name="set-up-vat-statement-templates-and-vat-statement-names"></a>Vorlagen für Umsatzsteuerabrechnungen und Namen von Umsatzsteuerabrechnungen einrichten
...
## <a name="to-define-a-vat-statement"></a><a name="to-define-a-vat-statement"></a>So definieren Sie eine Umsatzsteuerabrechnung
...
## <a name="to-preview-the-vat-statement"></a><a name="to-preview-the-vat-statement"></a>So zeigen Sie eine Vorschau der Mehrwertsteuerabrechnung an
