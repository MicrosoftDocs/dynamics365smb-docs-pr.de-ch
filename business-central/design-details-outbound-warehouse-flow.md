...
## <a name="no-dedicated-warehouse-activity"></a>Keine dedizierte Lageraktivität
...
### <a name="1-release-a-source-document"></a>1: Ein Herkunftsbeleg freigeben
...
### <a name="2-create-an-inventory-pick"></a>2: Eine Lagerbestandkommissionierung erstellen
...
### <a name="3-post-an-inventory-pick"></a>3: Eine Lagerbestandskommissionierung buchen
...
### <a name="1-release-a-source-document-1"></a>1: Ein Herkunftsbeleg freigeben
...
### <a name="2-create-a-warehouse-shipment"></a>2: Erstellen Sie einen Warenausgang
...
### <a name="3-create-a-warehouse-pick"></a>3: Erstellen Sie eine Lagerkommissionierung
...
### <a name="4-register-a-warehouse-pick"></a>4: Eine Lagerkommissionierung erfassen
...
### <a name="5-post-the-warehouse-shipment"></a>5: Den Warenausgang buchen
...
## <a name="post-non-inventory-items"></a>Buchen von Nicht-Bestandsartikeln

[!INCLUDE [post-non-inventory-items](includes/post-non-inventory-items.md)]

## <a name="see-also"></a>Siehe auch

[Lagerverwaltung](design-details-warehouse-management.md)  
