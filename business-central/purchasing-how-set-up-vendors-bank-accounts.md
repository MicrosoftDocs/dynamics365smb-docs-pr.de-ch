...
---
# <a name="set-up-vendor-bank-accounts"></a><a name="set-up-vendor-bank-accounts"></a>Kreditorenbankkonten einrichten
...
## <a name="add-or-edit-a-vendor-bank-account"></a><a name="add-or-edit-a-vendor-bank-account"></a>Kreditorenbankkonto hinzufügen oder bearbeiten
...
## <a name="set-up-a-preferred-vendor-bank-account"></a><a name="set-up-a-preferred-vendor-bank-account"></a>Bevorzugtes Kreditor-Bankkonto einrichten
