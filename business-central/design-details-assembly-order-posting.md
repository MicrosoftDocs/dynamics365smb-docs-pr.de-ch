...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Designdetails: Montageauftragsbuchung
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a>Buchen der Sequenz
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a>Regulierung Kosten
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>Preiskorrektur durchführen
...
## <a name="assembly-costs-are-always-actual"></a><a name="assembly-costs-are-always-actual"></a>Montagekosten sind immer Ist-Kosten
...
## <a name="assemble-to-order"></a><a name="assemble-to-order"></a>Auftragsmontage
...
### <a name="posting-dates"></a><a name="posting-dates"></a>Buchungsdaten
