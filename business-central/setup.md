...
ms.author: edupont
---
# <a name="overview-of-tasks-to-set-up-includeprodshortincludesprodshortmd" />Überblick der Aufgaben zum Einrichten von [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="set-up-apps" />Einrichten von Apps
