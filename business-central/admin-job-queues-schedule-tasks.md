...
---
# <a name="use-job-queues-to-schedule-tasks" />Verwenden von Aufgabenwarteschlangen für die Aufgabenplanung
...
## <a name="monitor-status-or-errors-in-the-job-queue" />Überwachen von Status oder Fehlern in der Projektwarteschlange
...
### <a name="to-view-status-for-any-job" />So wird der Status für jedes beliebige Projekt angezeigt
...
## <a name="view-scheduled-tasks" />Geplante Aufgaben anzeigen
...
## <a name="the-my-job-queue-part" />Der „Meine Aufgabenwarteschlangen“-Teil
...
### <a name="to-view-an-error-from-the-my-job-queue-part" />So zeigen Sie einen Fehler aus dem Bereich Meine Projektwarteschlange an.
...
## <a name="examples-of-what-you-can-schedule-using-job-queue-entries" />Beispiele dafür, was Sie mithilfe von Projektwarteschlangenposten planen können

### <a name="schedule-reports" />Berichte planen
...
### <a name="schedule-synchronization-between-includeprodshortincludesprodshortmd-and-includeprodshortincludescdslongmdmd" />Die Synchronisierung planen zwischen [!INCLUDE[prod_short](includes/prod_short.md)] und [!INCLUDE[prod_short](includes/cds_long_md.md)]
...
### <a name="schedule-when-to-post-sales-and-purchase-orders" />Planen, wann Verkaufsaufträgen und Bestellungen gebucht werden sollen
...
## <a name="handle-job-queue-entry-issues" />Probleme mit Aufgabenwarteschlangenposten beheben
...
## <a name="monitor-the-job-queue-with-telemetry" />Überwachen der Projektwarteschlange mit Telemetrie
