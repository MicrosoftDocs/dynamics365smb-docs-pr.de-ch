...
## <a name="links-to-learn-more" />Links zu weiteren Informationen
...
## <a name="getting-around-in-business-central" />Navigation in Business Central
Hier finden Sie ein kurzes Video über die Navigation in [!INCLUDE[prod_short](includes/prod_short.md)].

> [!VIDEO https://www.youtube.com/embed/zqz03iMihx0]

## <a name="choosing-a-desktop-browser" />Auswahl eines Desktop-Browsers
...
## <a name="action-bars" />Aktionsleisten
