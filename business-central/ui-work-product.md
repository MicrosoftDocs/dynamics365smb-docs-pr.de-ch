...
ms.author: edupont
---
# <a name="work-with-"></a><a name="work-with-"></a>Arbeiten mit [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="cheatsheet"></a>Tipps und Tricks
...
## <a name="links-to-learn-more"></a><a name="links-to-learn-more"></a>Links zu weiteren Informationen
...
## <a name="getting-around-in-business-central"></a><a name="getting-around-in-business-central"></a>Navigation in Business Central
Hier finden Sie ein kurzes Video über die Navigation in [!INCLUDE[prod_short](includes/prod_short.md)].

> [!VIDEO https://www.youtube.com/embed/zqz03iMihx0]

## <a name="choosing-a-desktop-browser"></a><a name="choosing-a-desktop-browser"></a>Auswahl eines Desktop-Browsers
...
## <a name="action-bars"></a><a name="action-bars"></a>Aktionsleisten
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/paths/work-pro-data-dynamics-365-business-central/)
