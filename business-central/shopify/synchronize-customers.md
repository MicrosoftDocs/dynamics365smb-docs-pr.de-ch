...
# <a name="synchronize-customers" />Debitoren synchronisieren
...
## <a name="important-settings-when-importing-customers-from-shopify" />Wichtige Einstellungen beim Import von Debitoren aus Shopify
...
### <a name="customer-template-per-country" />Debitorenvorlage pro Land
...
## <a name="export-customers-to-shopify" />Debitoren nach Shopify exportieren
...
### <a name="populate-customer-information-in-shopify" />Debitoreninformationen in Shopify ausfüllen
...
## <a name="sync-customers" />Debitoren synchronisieren
