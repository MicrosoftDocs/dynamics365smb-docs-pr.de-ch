...
# <a name="get-started-with-the-shopify-connector" />Erste Schritte mit dem Shopify-Konnektor
...
## <a name="prerequisites-for-shopify" />Voraussetzungen für Shopify
...
## <a name="prerequisites-for-business-central" />Voraussetzungen für Business Central
...
## <a name="install-the-dynamics-365-business-central-app-to-your-shopify-online-store" />Installieren Sie die Dynamics 365 Business Central App in Ihrem Shopify Online Store
...
## <a name="connect-business-central-to-the-shopify-online-store" />Verbinden Sie Business Central mit dem Shopify-Online-Store
...
## <a name="testing-strategies" />Teststrategien
...
### <a name="shopify-sandbox-and-business-central-sandbox" />Shopify Sandbox und Business Central-Sandbox
...
### <a name="shopify-sandbox-and-business-central-production" />Shopify Sandbox und Business Central-Produktion
...
### <a name="shopify-production-and-business-central-sandbox" />Shopify Produktion und Business Central-Sandbox
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-shopify-connector-dynamics-365-business-central" />Siehe verwandte [Microsoft Schulungen](/training/paths/use-shopify-connector-dynamics-365-business-central/)
