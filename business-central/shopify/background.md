...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](../media/ui-search/search_small.png "Wie möchten Sie weiter verfahren?") , geben Sie den Namen für den **Shopify-Shop** ein, und wählen Sie den Namen des Shops aus der Liste aus.
