...
# <a name="run-tasks-in-the-background" />Aufgaben im Hintergrund ausführen
...
## <a name="run-tasks-in-the-background-for-a-specific-shop" />Aufgaben im Hintergrund für einen bestimmten Shop ausführen
...
## <a name="to-schedule-recurring-tasks" />So planen Sie wiederkehrende Aufgaben
