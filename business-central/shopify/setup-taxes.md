...
# <a name="set-up-taxes-for-the-shopify-connection"></a><a name="set-up-taxes-for-the-shopify-connection"></a>Steuern für Shopify Verbindung einrichten
...
## <a name="if-you-sell-domestically"></a><a name="if-you-sell-domestically"></a>Wenn Sie im Inland verkaufen
...
## <a name="if-you-sell-internationally"></a><a name="if-you-sell-internationally"></a>Wenn Sie international verkaufen
...
### <a name="all-prices-include-tax-is-selected"></a><a name="all-prices-include-tax-is-selected"></a>Alle Preise verstehen sich inklusive Mehrwertsteuer ist ausgewählt
...
### <a name="all-prices-include-tax-is-not-selected"></a><a name="all-prices-include-tax-is-not-selected"></a>Alle Preise verstehen sich inklusive Mehrwertsteuer ist nicht ausgewählt
...
## <a name="dynamic-tax-inclusive-pricing"></a><a name="dynamic-tax-inclusive-pricing"></a>Dynamische Preise inklusive Steuern
...
### <a name="all-prices-include-tax-is-selected-1"></a><a name="all-prices-include-tax-is-selected-1"></a>Alle Preise verstehen sich inklusive Mehrwertsteuer ist ausgewählt
...
### <a name="all-prices-include-tax-is-not-selected-1"></a><a name="all-prices-include-tax-is-not-selected-1"></a>Alle Preise verstehen sich inklusive Mehrwertsteuer ist nicht ausgewählt
...
## <a name="if-you-sell-to-eu-customers"></a><a name="if-you-sell-to-eu-customers"></a>Wenn Sie an EU-Debitoren verkaufen
...
### <a name="collect-vat-set-to-one-stop-shop-registration"></a><a name="collect-vat-set-to-one-stop-shop-registration"></a>Sammeln Sie die MWST, die auf die One-Stop-Shop-Registrierung eingestellt ist
...
### <a name="collect-vat-set-to-micro-business-exemption"></a><a name="collect-vat-set-to-micro-business-exemption"></a>MWST erheben ist auf Ausnahmeregelung für Kleinstunternehmen eingestellt
...
## <a name="importing-shopify-orders-sold-to-international-customers"></a><a name="importing-shopify-orders-sold-to-international-customers"></a>Importierender Shopify Bestellungen, die an internationale Debitoren verkauft wurden
...
## <a name="other-tax-remarks"></a><a name="other-tax-remarks"></a>Sonstige Anmerkungen zu Steuern
