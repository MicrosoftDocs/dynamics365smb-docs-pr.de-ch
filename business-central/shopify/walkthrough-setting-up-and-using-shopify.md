...
## Exemplarische Vorgehensweise: Feinabstimmung der Element-Verwaltung
...
3. Fügen Sie den folgenden Text mit HTML-Tags hinzu: `<b>Simple stylish design</b> blends with any ensemble. <i>Available in two editions.</i>`. Schliessen Sie die Seite **Erweiterter Text** und kehren Sie zur Artikelkarte zurück.
