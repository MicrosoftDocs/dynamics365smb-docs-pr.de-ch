...
# <a name="walkthrough-set-up-and-use-the-shopify-connector"></a><a name="walkthrough-set-up-and-use-the-shopify-connector"></a>Exemplarische Vorgehensweise: Festlegen und Verwenden des Shopify Konnektors
...
## <a name="connect-business-central-to-the-shopify-shop"></a><a name="connect-business-central-to-the-shopify-shop"></a>Verbinden Sie Business Central mit dem Shopify-Laden
...
## <a name="walkthrough-start-selling-products-online"></a><a name="walkthrough-start-selling-products-online"></a>Exemplarische Vorgehensweise: Mit dem Online-Verkauf von Produkten beginnen
...
## <a name="walkthrough-invite-your-customers-to-your-new-online-store"></a><a name="walkthrough-invite-your-customers-to-your-new-online-store"></a>Exemplarische Vorgehensweise: Laden Sie Ihre Kunden in Ihren neuen Online Store ein
...
## <a name="walkthrough-fine-tuning-of-item-management"></a><a name="walkthrough-fine-tuning-of-item-management"></a>Exemplarische Vorgehensweise: Feinabstimmung der Element-Verwaltung

### <a name="scenario-2"></a><a name="scenario-2"></a>Szenario
...
### <a name="steps-2"></a><a name="steps-2"></a>Schritte
...
## <a name="walkthrough-import-items-from-shopify"></a><a name="walkthrough-import-items-from-shopify"></a>Exemplarische Vorgehensweise: Elemente aus Shopify importieren

### <a name="scenario-3"></a><a name="scenario-3"></a>Szenario
...
### <a name="steps-3"></a><a name="steps-3"></a>Schritte
...
#### <a name="prepare-data"></a><a name="prepare-data"></a>Daten vorbereiten
...
#### <a name="run-the-synchronization"></a><a name="run-the-synchronization"></a>Führen Sie die Synchronisierung aus
