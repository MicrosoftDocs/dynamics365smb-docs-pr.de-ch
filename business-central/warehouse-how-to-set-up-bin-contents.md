...
ms.author: edupont
---
# <a name="create-bin-contents" />Lagerplatzinhalt erstellen
...
## <a name="to-create-bin-content-manually" />So erstellen Sie Lagerplatzinhalt manuell
...
## <a name="to-create-bin-content-with-a-worksheet" />So erstellen Sie Lagerplatzinhalt in einem Arbeitsblatt
