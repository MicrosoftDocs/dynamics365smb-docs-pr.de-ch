...
ms.author: edupont
---
# <a name="design-details-integration-with-inventory"></a><a name="design-details-integration-with-inventory"></a>Designdetails: Integration mit dem Lagerbestand
...
## <a name="physical-inventory"></a><a name="physical-inventory"></a>Physisches Lager
...
## <a name="warehouse-adjustments-to-the-item-ledger"></a><a name="warehouse-adjustments-to-the-item-ledger"></a>Lagerplatz-Anpassungen mit dem Artikelposten
