...
Sie können die Seite **Integrationstabellenzuordnungen** verwenden, um ein Synchronisationsprojekt für bestimmte Tabellenzuordnungen auszuführen. Dadurch werden Daten in allen gekoppelten Datensätzen in der [!INCLUDE[d365fin](includes/d365fin_md.md)]-Tabelle und der [!INCLUDE[d365fin](includes/cds_long_md.md)]-Einheit synchronisiert, die von der Tabellenzuordnung definiert werden. Standardmässig werden nur Datensätze synchronisiert, die seit der letzten Synchronisierung geändert wurden.  
