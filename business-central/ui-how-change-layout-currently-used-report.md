...
ms.author: jswymer
---
# <a name="legacy-set-the-layout-used-by-a-report" />(Legacy) Die von einem Bericht verwendeten Layouts festlegen
...
## <a name="to-change-which-report-layout-to-use-for-a-report-or-document" />So ändern Sie das für einen Bericht oder einen Beleg zu verwendende Berichtslayout
...
## <a name="to-change-the-custom-layout-to-use-for-a-report-layout" />So ändern Sie das benutzerdefinierte Layout, das für ein Berichtslayout verwendet werden soll
