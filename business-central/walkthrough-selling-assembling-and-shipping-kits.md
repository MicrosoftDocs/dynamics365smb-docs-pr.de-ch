...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits" />Exemplarische Vorgehensweise: Verkauf, Montage und Liefern von Kits
...
### <a name="setting-up-assembly-items" />Montageartikel einrichten
...
### <a name="selling-customized-assembly-items" />Verkauf von benutzerdefinierten Montageartikeln
...
### <a name="planning-for-assembly-items" />Planung für Montageartikel
...
### <a name="assembling-items" />Artikelmontage
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order" />Versand von Montageartikeln, aus Lagerbestand und nach Auftrag montiert
...
### <a name="creating-the-assembly-items" />Erstellen der Montageartikel
...
### <a name="selling-the-assembly-items" />Verlaufen der Montageartikel
...
### <a name="planning-for-the-unavailable-ats-items" />Planen für die nicht verfügbaren ATS-Artikel
...
### <a name="assembling-and-shipping-the-first-ato-quantity" />Montieren und Versenden der ersten ATO-Menge
...
### <a name="assembling-and-recording-the-second-ato-quantity" />Montieren und erfassen der zweiten ATO-Menge
...
### <a name="assembling-the-ats-quantity" />Montieren der ATS-Menge
...
### <a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order" />Lieferung der übrigen Artikel, teilweise aus dem Lagerbestand und teilweise nach Auftrag montiert
...
## <a name="see-related-microsoft-training" />Siehe verwandte [Microsoft Schulungen](/training/paths/assemble-items-dynamics-365-business-central/)
