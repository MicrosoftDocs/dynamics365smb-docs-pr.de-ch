...
---
# <a name="set-up-invoice-rounding"></a>Rechnungsrundung einrichten
...
Um die automatische Rundung zu nutzen, müssen Sie Fibukonten einrichten, auf die Rundungsdifferenzen gebucht werden. Bevor Sie dies tun können, müssen Sie die MWST-Produktbuchungsgruppen einrichten. Weitere Informationen finden Sie unter [MWST einrichten](finance-setup-vat.md).  

### <a name="to-set-up-general-ledger-accounts-for-invoice-rounding-differences"></a>Fibukonten für Rechnungsrundungsdifferenzen einrichten:
