...
11. Aus der Liste der verfügbaren Vorlagen wählen Sie eine der verfügbaren Vorlagen aus und wählen Sie **Erstellen**.  
    ...
    - *Genehmigung für Microsoft [!INCLUDE[prod_long](includes/prod_long.md)]-Verkaufsofferte anfordern*
    ...
    - *Genehmigung für Microsoft [!INCLUDE[prod_long](includes/prod_long.md)]-Fibu Erf.-Journalname anfordern*  
    - *Genehmigung für Microsoft [!INCLUDE[prod_long](includes/prod_long.md)]-Fibu Erfassungsjournalzeilen anfordern*
...
Die Verwendung von Power Automate zum Integrieren Ihrer [!INCLUDE[prod_short](includes/prod_short.md)]-Genehmigungen erfordert, dass bestimmte Seiten- und Codeunit-Objekte als Webdienste veröffentlicht werden. Standardmässig werden die meisten erforderlichen Objekte als Webdienste für Sie veröffentlicht. In einigen Fällen wurde Ihre Umgebung jedoch möglicherweise so angepasst, dass diese Objekte nicht mehr veröffentlicht werden.
