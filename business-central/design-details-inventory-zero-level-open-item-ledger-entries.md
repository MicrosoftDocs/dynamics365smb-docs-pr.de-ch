...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue" />Designdetails: Bekannte Artikelanwendungsprobleme
...
## <a name="symptoms-of-the-issue" />Symptome des Problems
...
## <a name="basics-of-item-application" />Vorgaben des Artikelausgleichs
...
### <a name="quantity-application" />Mengenausgleich
...
### <a name="cost-application" />Ausgleich Lagerwert reguliert
...
## <a name="illustration-of-a-basic-cost-flow" />Abbildung eines grundlegenden Kostenflusses
...
## <a name="reasons-for-the-issue" />Gründe für das Problem
...
## <a name="identifying-the-issue" />Festlegung des Ergebnisses
...
## <a name="workaround-for-the-issue" />Gründe für das Problem
