...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a><a name="prepare-financial-reporting-with-financial-data-and-account-categories"></a>Financial Reporting mit Finanzdaten und Kontokategorien vorbereiten
...
## <a name="financial-reports"></a><a name="financial-reports"></a>Finanzielle Berichte
...
## <a name="gl-account-categories"></a><a name="gl-account-categories"></a>Fibukonto-Kategorien
...
## <a name="create-a-new-financial-report"></a><a name="create-a-new-financial-report"></a>Erstellen Sie einen neuen Finanzbericht
...
### <a name="edit-a-column-definition"></a><a name="edit-a-column-definition"></a>Bearbeiten Sie eine Spaltendefinition
...
### <a name="create-a-column-that-calculates-percentages"></a><a name="create-a-column-that-calculates-percentages"></a>Erstellen Sie eine Spalte zur Berechnung von Prozentsätzen
...
## <a name="set-up-financial-reports-with-overviews"></a><a name="set-up-financial-reports-with-overviews"></a>Einrichten von Finanzberichten mit Übersichten
...
## <a name="comparing-accounting-periods-using-period-formulas"></a><a name="comparing-accounting-periods-using-period-formulas"></a>Vergleich von Buchhaltungsperioden mit Hilfe von Periodenformeln
...
## <a name="print-and-save-financial-reports"></a><a name="print-and-save-financial-reports"></a>Finanzberichte drucken und speichern
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a><a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document"></a>Planen Sie einen Finanzbericht oder speichern Sie ihn als PDF-, Word- oder Excel-Dokument
...
## <a name="importing-or-exporting-financial-reports"></a><a name="importing-or-exporting-financial-reports"></a>Importieren oder Exportieren von Finanzberichten
...
### <a name="import-and-export-financial-reports"></a><a name="import-and-export-financial-reports"></a>Finanzberichte importieren und exportieren
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe dazu [Microsoft Schulung](/training/modules/configure-financial-reports-dynamics-365-business-central/index).
