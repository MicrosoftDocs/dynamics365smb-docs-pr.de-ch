...
---
# <a name="prepare-financial-reporting-with-financial-data-and-account-categories" />Financial Reporting mit Finanzdaten und Kontokategorien vorbereiten
...
## <a name="financial-reports" />Finanzielle Berichte
...
## <a name="gl-account-categories" />Fibukonto-Kategorien
...
## <a name="create-a-new-financial-report" />Erstellen Sie einen neuen Finanzbericht
...
### <a name="edit-a-column-definition" />Bearbeiten Sie eine Spaltendefinition
...
### <a name="create-a-column-that-calculates-percentages" />Erstellen Sie eine Spalte zur Berechnung von Prozentsätzen
...
## <a name="set-up-financial-reports-with-overviews" />Einrichten von Finanzberichten mit Übersichten
...
## <a name="comparing-accounting-periods-using-period-formulas" />Vergleich von Buchhaltungsperioden mit Hilfe von Periodenformeln
...
## <a name="print-and-save-financial-reports" />Finanzberichte drucken und speichern
...
### <a name="schedule-a-financial-report-or-save-as-a-pdf-word-or-excel-document" />Planen Sie einen Finanzbericht oder speichern Sie ihn als PDF-, Word- oder Excel-Dokument
...
## <a name="importing-or-exporting-financial-reports" />Importieren oder Exportieren von Finanzberichten
...
### <a name="import-and-export-financial-reports" />Finanzberichte importieren und exportieren
...
## <a name="see-related-microsoft-trainingtrainingmodulesconfigure-financial-reports-dynamics--business-centralindex" />Siehe dazu [Microsoft Schulung](/training/modules/configure-financial-reports-dynamics-365-business-central/index).
