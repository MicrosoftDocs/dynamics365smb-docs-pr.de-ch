...
Wenn die Berechnung gemäss regulärer Zeitperioden erfolgen soll, muss eine Formel in das Feld **Vergleichsdatumsformel** eingegeben werden. Wenn das Feld zum Beispiel auf -1J festgelegt wird, wird [!INCLUDE [prodshort](includes/prodshort.md)] mit derselben Periode 1 Jahr zuvor verglichen.
