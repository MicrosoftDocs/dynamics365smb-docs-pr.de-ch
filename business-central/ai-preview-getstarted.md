...
# <a name="get-started-with-a-business-central-preview-version-for-copilot"></a><a name="get-started-with-a-business-central-preview-version-for-copilot"></a>Erste Schritte mit einer Business Central-Vorschauversion für Copilot
...
## <a name="your-organization-already-uses-business-central"></a><a name="your-organization-already-uses-business-central"></a>Ihre Organisation verwendet Business Central bereits
...
## <a name="your-organization-doesnt-use-business-central"></a><a name="your-organization-doesnt-use-business-central"></a>Ihre Organisation verwendet Business Central nicht
