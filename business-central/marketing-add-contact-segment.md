...
ms.author: jswymer
---
# <a name="add-contacts-to-segments"></a><a name="add-contacts-to-segments"></a>Kontakte zu Segementen hinzuzufügen
...
## <a name="to-add-a-contact-to-a-segment"></a><a name="to-add-a-contact-to-a-segment"></a>Um einem Segment einen Kontakt hinzuzufügen:
...
## <a name="to-refine-the-number-of-contacts"></a><a name="to-refine-the-number-of-contacts"></a>Um die Anzahl der Kontakte neu zu definieren
...
## <a name="to-reduce-the-number-of-contacts"></a><a name="to-reduce-the-number-of-contacts"></a>Um die Anzahl der Kontakte zu reduzieren
