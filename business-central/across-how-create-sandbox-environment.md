...
3. Wählen Sie **Erstellen** aus.  
  Eine andere Registerkarte in Ihrem Browser wird geöffnet für das Abschliessen der Einrichtung der Sandkastenumgebung.
> [!NOTE]  
...
4. Wenn die Sandkastenumgebung bereitsteht, werden Sie zum Begrüssung-Assistenten der Sandkastenumgebung umgeleitet.
![Sandkasten-Begrüssung-Assistent](./media/across-sandbox/sandbox-wizard.png)
