...
7. Wählen Sie das Symbol ![Glühlampe, mit der die Funktion „Wie möchten Sie weiter verfahren“ geöffnet wird](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren?") aus, geben Sie **Fibuposten einrichten** ein, und wählen dann den zugehörigen Link aus.  
8. Öffnen Sie das Fenster **Fibu Einrichtung**.  
...
2. Versehen Sie im Fenster **Fibu Einrichung** im Inforegister **Anwendung** das Feld **Zahlungstoleranzwarnung** mit einem Häkchen, um die Warnung zu aktivieren. Um die Warnung zu deaktivieren, entfernen Sie das Häkchen.  

> [!NOTE]  
>  Die Standardoption des Fensters **Zahlungstoleranzwarnung** ist **Restbetrag offen lassen**. Die Standardoption des Fensters **Kontotoleranzwarnung** ist **Überzogenes Skonto nicht akzeptieren**.
