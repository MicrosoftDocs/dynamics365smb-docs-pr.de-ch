...
7. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Hauptbuchhaltung Einrichtung** ein und wählen Sie dann den zugehörigen Link.  
...
|—|Inv.|Skonto|Max. Zahl.-Tol.|Skontodatum|Skontotoleranz Datum|Zahlungsdatum|Zahl.-|Toleranzart|Alle Posten geschlossen|Skontotoleranz GL/CL|Zahl.-Tol. G/L|  
|-------|----------|----------------|-----------------------|---------------------|--------------------------|------------------|----------|--------------------|------------------------|------------------------------|----------------------------|  
...
|4A|1.000|20|5|15.01.2003|01/20/03|16.01.2003 – 20.01.03|1005|Skontotol.|Nein, 25 in der Zahl.|20/-20|0|  
...
![Einzelzahlungstoleranzregeln 1.](media/singlePmtTolRules(Pre1503).gif "Einmahlzahlungstoleranz-Regeln 1")  
...
![Toleranzregeln für Einzelzahlungen 2.](media/singlePmtTolRules(GracePeriod).gif "Einmahlzahlungstoleranz-Regeln 2")  
...
![Einzelzahlungs-Toleranzregeln 3.](media/singlePmtTolRules(Post0120).gif "Einmalzahlungstoleranz-Regeln 3")  
