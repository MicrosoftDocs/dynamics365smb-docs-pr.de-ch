...
ms.author: edupont
---
# <a name="work-with-payment-tolerances-and-payment-discount-tolerances" />Mit Zahlungstoleranzen und Skontotoleranzen arbeiten
...
## <a name="applying-payment-tolerance-to-multiple-documents" />Anwenden der Zahlungstoleranz auf mehrere Belege
...
## <a name="to-set-up-tolerances" />Toleranzen einrichten:
...
## <a name="to-enable-or-disable-payment-tolerance-warnings" />So aktivieren oder deaktivieren Sie die Zahlungstoleranzwarnungen
...
## <a name="to-block-payment-tolerance-for-customers" />Zahlungstoleranz für Debitoren sperren:
