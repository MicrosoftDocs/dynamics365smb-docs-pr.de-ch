...
## <a name="install-a-prod_short-app-in-power-bi"></a>Eine [!INCLUDE[prod_short](includes/prod_short.md)]-App in Power BI installieren
...
## <a name="connect-the-prod_short-app-to-your-data"></a>[!INCLUDE[prod_short](includes/prod_short.md)]-App mit Ihren Daten verbinden
...
### <a name="you-need-a-power-bi-pro-license-to-install-the-prod_short-app-in-power-bi"></a>Sie brauchen eine Power BI Pro Lizenz zur Installation der [!INCLUDE[prod_short](includes/prod_short.md)] App in Power BI
