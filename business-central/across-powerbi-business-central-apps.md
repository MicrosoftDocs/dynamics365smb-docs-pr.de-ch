...
### <a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid" />Parameterprüfung fehlgeschlagen. Prüfen Sie, ob alle Parameter gültig sind.
...
### <a name="cant-sign-in" />Anmeldung nicht möglich
...
### <a name="incorrect-company-name" />Ungültiger Unternehmensname
...
### <a name="the-key-didnt-match-any-rows-in-the-table" />Der Schlüssel glich keinen Zeilen in der Tabelle
...
### <a name="historical-data-appears-to-be-missing" />Historische Daten scheinen zu fehlen
...
### <a name="i-only-see-data-for-a-single-company" />Ich sehe nur Daten für ein einzelnes Unternehmen
