...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions"></a><a name="set-up-data-exchange-definitions"></a>Richten Sie Datenaustauschdefinitionen ein.
...
## <a name="create-a-data-exchange-definition"></a><a name="create-a-data-exchange-definition"></a>Erstellen Sie eine Datenaustauschdefinition
...
### <a name="to-describe-the-formatting-of-lines-and-columns-in-the-file"></a><a name="to-describe-the-formatting-of-lines-and-columns-in-the-file"></a><a name=formatlinescolumns></a>Um die Formatierung von Zeilen und Spalten in der Datei zu beschreiben
...
### <a name="to-map-columns-in-the-data-file-to-fields-in-"></a><a name="to-map-columns-in-the-data-file-to-fields-in-"></a><a name=mapfields></a>Zur Zuordnung von Spalten in der Datendatei zu Feldern in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="transformation-rules"></a><a name="transformation-rules"></a>Transformationsregeln
...
### <a name="tip-for-developers-example-of-the-custom-option"></a><a name="tip-for-developers-example-of-the-custom-option"></a>Tipp für Entwickler: Beispiel für die angepasste Option
...
## <a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others"></a><a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others"></a>Exportieren einer Datenaustauschdefinition als XML-Datei zur Verwendung durch andere
...
## <a name="import-an-existing-data-exchange-definition"></a><a name="import-an-existing-data-exchange-definition"></a>Importieren einer bestehenden Datenaustauschdefinition
