...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions" />Richten Sie Datenaustauschdefinitionen ein.
...
## <a name="create-a-data-exchange-definition" />Erstellen Sie eine Datenaustauschdefinition
...
## <a name="transformation-rules" />Transformationsregeln
...
### <a name="tip-for-developers-example-of-the-custom-option" />Tipp für Entwickler: Beispiel für die angepasste Option
...
## <a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others" />Exportieren einer Datenaustauschdefinition als XML-Datei zur Verwendung durch andere
...
## <a name="import-an-existing-data-exchange-definition" />Importieren einer bestehenden Datenaustauschdefinition
