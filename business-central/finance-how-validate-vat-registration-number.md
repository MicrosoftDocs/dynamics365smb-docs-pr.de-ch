...
## <a name="configure-the-service-to-verify-vat-registration-numbers-automatically" />Konfigurieren Sie den Dienst so, dass die MWST Nummern automatisch überprüft werden
