...
ms.author: bholtorf
---
# <a name="pick-for-production-assembly-or-jobs-in-advanced-warehouse-configurations" />Kommissionierung für Montage, Produktion oder Projekte in erweiterter Lagerkonfiguration
...
## <a name="project-management" />Projektmanagement
...
## <a name="to-create-pick-documents-in-bulk-with-the-pick-worksheet" />So erstellen Sie Kommissionierungsbelege mit dem Kommissionierungsarbeitsblatt in Masse
...
## <a name="to-pick-items-for-a-productions-order-assembly-order-job" />Zur Entnahme von Artikeln für einen Produktionsauftrag, Montageauftrag oder Auftrag
...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration" />Buchung von Produktionskomponenten in einer erweiterten Lagerkonfiguration
