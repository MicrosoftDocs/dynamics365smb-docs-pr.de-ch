...
# <a name="set-up-fixed-asset-depreciation" />Richten Sie eine neue Anlagenabschreibung ein
...
## <a name="to-create-a-depreciation-book" />So erstellen Sie ein Anlagen-Abschreibungsbuch
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset" />So verknüpfen Sie ein Abschreibungsbuch mit einer Anlage
...
## <a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job" />So weisen Sie ein Abschreibungsbuch mehreren Anlagen mit einer Stapelverarbeitung zu
...
## <a name="to-set-up-depreciation-posting-types" />So richten Sie Abschreibungsbuchungsarten ein:
...
## <a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation" />So richten Sie Standardvorlagen und -Standardstapelverarbeitungen für Anlagen-Abschreibung ein
