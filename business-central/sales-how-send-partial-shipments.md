...
Standardmässig, setzt [!INCLUDE [prod_short](includes/prod_short.md)] das Feld auf der **Debitorenkarte** als **Teilweise**, wodurch Teillieferungen möglich sind. Wenn jedoch das Feld zur Angabe von **Vollständig** angepasst wurde, wird das Feld **Zu liefernde Menge** Verkaufsaufträgen für diesen Debitor als gesperrt angezeigt.
