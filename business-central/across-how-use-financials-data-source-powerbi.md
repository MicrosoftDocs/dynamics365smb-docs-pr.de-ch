...
3. Power BI zeigt einen Assistenten an, der Sie durch den Verbindungsprozess führt, einschliesslich der Anmeldung bei [!INCLUDE[prodshort](includes/prodshort.md)]. Wählen Sie **Anmelden**, und wählen Sie dann das entsprechende Konto. Verwenden Sie dasselbe Konto, mit dem Sie sich bei [!INCLUDE[prodshort](includes/prodshort.md)] anmelden.
