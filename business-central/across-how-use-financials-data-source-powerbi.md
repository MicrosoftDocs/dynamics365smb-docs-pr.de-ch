...
# <a name="building-power-bi-reports-to-display-include-prodlongincludesprodlongmd-data" />Power BI-Berichte erstellen zur Anzeige von [!INCLUDE [prod_long](includes/prod_long.md)]-Daten
...
## <a name="a-namegetdataaadd-includeprodshortincludesprodshortmd-as-a-data-source-in-power-bi-desktop" /><a name="getdata"></a>[!INCLUDE[prod_short](includes/prod_short.md)] als Datenquelle in Power BI Desktop hinzufügen
...
## <a name="creating-accessible-reports" />Erstellen von zugänglichen Berichten
...
## <a name="creating-reports-to-display-data-associated-with-a-list" />Berichte erstellen, um mit einer Liste verknüpfte Daten anzuzeigen
...
## <a name="a-namethemeausing-the-include-prodshortincludesprodshortmd-report-theme-optional" /><a name="theme"></a>Verwenden des [!INCLUDE [prod_short](includes/prod_short.md)]-Berichtsthemas (optional)
...
### <a name="download-the-theme" />Herunterladen des Themas
...
### <a name="import-the-theme-on-a-report" />Importieren des Themas in einen Bericht
...
## <a name="publish-reports" />Veröffentlichen von Berichten
...
## <a name="distribute-or-share-a-report" />Verteilen oder Teilen eines Berichts
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page" />„Datensatz kann nicht eingefügt werden. Die aktuelle Verbindungsabsicht ist schreibgeschützt“. Fehler beim Verbinden mit der angepassten API-Seite
