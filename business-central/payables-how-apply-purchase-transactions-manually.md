...
# Abgleichen von Kreditorenzahlungen mit dem Zahlungsjournal oder aus Kreditorenposten
...
Sie können Lieferantenzahlungen manuell auf die zugehörigen Einkaufsbelege anwenden, wenn Sie die Zahlungen auf der Seite  **Zahlungsjournale**  buchen. Informationen zum Ausfüllen des Zahlungsausgangs-Erf.-Journals finden Sie in [Vorgehensweise: Anwenden von Zahlungen](payables-make-payments.md).
