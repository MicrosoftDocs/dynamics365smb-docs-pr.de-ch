---
title: 'Artikel mit Serien-, Chargen- und Paketnummern verfolgen'
...
---
# Artikel mit Serien-, Chargen- und Paketnummern verfolgen
...
Die Mengenfelder im Kopf der Seite **Artikeltrackingzeilen** zeigen dynamisch die Mengen und die Summen der Artikeltrackingnummern an, die in den Zeilen definiert sind. Die Mengen müssen mit denen in den Belegzeilen übereinstimmen, was durch die Angabe  *0*  in den Feldern  **Undefiniert**  gekennzeichnet ist.
...
Wenn Sie lange auf der Seite  **Artikelverfolgungszeilen**  arbeiten oder wenn viele Aktivitäten mit dem Artikel stattfinden, mit dem Sie arbeiten, können Sie die Aktion  **Verfügbarkeit aktualisieren**  auswählen. Wenn Sie die Seite schliessen, wird die Verfügbarkeit des Artikels also automatisch neu überprüft, um zu bestätigen, dass es keine Verfügbarkeitsprobleme gibt.
...
3. Wählen Sie auf der Seite  **Artikel Karte**  die  **Zugehörige** Aktion, wählen Sie die  **Zugehörige** Aktion, wählen Sie die Aktion  **Einträge**  und wählen Sie dann  **Hauptbucheinträge**.
...
> [!NOTE]
> [!INCLUDE [prod_short](includes/prod_short.md)] überprüft, ob jede Zeile eine einzigartige Kombination aus Serien-, Los- und/oder Paketnummern hat. Wenn Sie eine Charge, ein Paket oder ein Los und ein Paket in mehrere Lose oder Pakete aufteilen möchten, müssen Sie mehrere Erfassungsjournalzeilen verwenden.

1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol, geben Sie  **Artikelumbuchungsjournale** ein und wählen Sie dann das zugehörige verknüpfen aus.  
...
4. Geben Sie im Feld  **Seriennummern** oder  **Chargennummern**  Auswählen die aktuelle Serien- oder Chargennummer ein.  
...
|Lagerartikelverfolgungszeilen     |* Seriennr.<br><br>* Neue Seriennr.<br><br>* Chargennr.<br><br>* Neue Chargennr.<br><br>* Paketnr.<br><br>* Neue Paketnr.|
