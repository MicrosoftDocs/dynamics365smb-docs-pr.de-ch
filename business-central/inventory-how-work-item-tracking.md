...
ms.author: edupont
---
# <a name="track-items-with-serial-lot-and-package-numbers" />Verfolgen Sie Artikel mit Serien-, Chargen‑ und Paketnummern
...
## <a name="item-tracking-availability" />Verfügbarkeit des Artikeltrackings
...
## <a name="to-assign-serial-or-lot-numbers-during-an-inbound-transaction" />Serien- oder Chargennummern während einer eingehenden Transaktion zuzuordnen:
...
### <a name="to-handle-serial-and-lot-numbers-when-getting-receipt-lines-from-a-purchase-invoice" />So verwenden Sie Serien- und Chargennummern beim Abrufen von Einkaufslieferzielen aus einer Einkaufsrechnung
...
## <a name="to-assign-a-serial-or-lot-number-during-an-outbound-transaction" />Serien- oder Chargennummern bei ausgehenden Vorgängen zuordnen
...
### <a name="to-select-from-existing-serial-or-lot-numbers" />Aus bestehenden Serien- oder Chargennummern auswählen
...
### <a name="to-assign-new-serial-or-lot-numbers" />So weisen Sie neue Chargen- oder Seriennummern zu
...
### <a name="assign-tracking-numbers-on-source-documents" />Trackingnummern in Quellbelegen zuweisen
...
## <a name="to-handle-serial-and-lot-numbers-on-transfer-orders" />Um Serien-/Chargennummern in Umlagerungsaufträgen zu verarbeiten:
...
## <a name="to-record-additional-serial-or-lot-number-information" />So zeichnen Sie zusätzliche Serien- oder Chargennummerinformationen auf
...
## <a name="to-modify-existing-serial-or-lot-number-information" />Bestehende Serien- oder Chargennummerinformationen ändern
...
## <a name="to-reclassify-serial-or-lot-numbers" />Um Chargen- oder Seriennummern zu ändern
