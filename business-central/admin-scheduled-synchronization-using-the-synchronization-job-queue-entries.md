...
# <a name="scheduling-a-synchronization-between-business-central-and-dataverse" />Planen einer Synchronisierung zwischen Business Central und Dataverse
...
## <a name="default-synchronization-job-queue-entries" />Standard-Synchronisations-Projektwarteschlangeneinträge
...
## <a name="synchronization-process" />Synchronisierungsprozess
...
## <a name="about-inactivity-timeouts" />Über Inaktivitätszeitüberschreitungen
...
## <a name="to-view-the-synchronization-job-log" />So zeigen Sie das Synchronisierungsprojektprotokoll an:
...
## <a name="to-view-the-synchronization-job-log-from-the-table-mappings" />So zeigen Sie das Protokoll der Synchronisierungsprojekte über die Tabellenzuordnungen an:
...
## <a name="to-view-the-synchronization-error-log" />So zeigen Sie das Synchronisierungsfehlerprotokoll an:
