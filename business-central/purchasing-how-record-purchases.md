...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a>Käufe mit Einkaufsrechnungen und Aufträgen erfassen
...
## <a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a>Käufe mit Einkaufsrechnungen erfassen
...
### <a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a>Eine Verkaufsrechnung erstellen und buchen
...
## <a name="posted-invoices"></a><a name="posted-invoices"></a>Gebuchte Rechnungen
...
## <a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a>Kaufen von Nicht-Bestandsartikeln
...
## <a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a>Verwendung von Bestellungen
...
## <a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a>Empfangen Sie Artikel mit einer Einkaufsbestellung
...
## <a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a>Mehr Artikel als bestellt erhalten
...
### <a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a>Richten Sie Übereingänge ein
...
### <a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a>Den Eingangsüberschusscode einem Artikel zuweisen
...
### <a name="over-receive-an-order"></a><a name="over-receive-an-order"></a>Übereingang eines Auftrags
...
## <a name="external-document-number"></a><a name="external-document-number"></a>Externe Belegnummer

[!INCLUDE [ext-doc-no-purch](includes/ext-doc-no-purch.md)]

## <a name="posting-purchases"></a><a name="posting-purchases"></a>Einkäufe buchen
...
## <a name="viewing-ledger-entries"></a><a name="viewing-ledger-entries"></a>Anzeigen von Posten
...
## <a name="editing-ledger-entries"></a><a name="editing-ledger-entries"></a>Bearbeiten von Posten
...
## <a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/processing-invoices-dynamics-365-business-central/index)
