...
Wenn Sie die Bestandsartikel erhalten oder wenn die gekaufte Dienstleistung abgeschlossen ist, buchen Sie die Rechnung oder Bestellung, um die Bestands- und Finanzdaten zu aktualisieren und die Zahlung an den Lieferanten gemäss den Zahlungsbedingungen zu aktivieren. Erfahren Sie mehr unter [Einkäufe buchen](ui-post-purchases.md), [Empfangen von Gegenständen](warehouse-how-receive-items.md) und [Zahlungen leisten](payables-make-payments.md).
