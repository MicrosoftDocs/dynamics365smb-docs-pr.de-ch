...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse" />Mit Microsoft Dataverse verbinden
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide" />So verwenden Sie die Dataverse Anleitung zur unterstützten Einrichtung
...
### <a name="to-create-or-maintain-the-connection-manually" />So erstellen oder pflegen Sie den Link manuell
...
## <a name="customize-the-match-based-coupling" />Kopplung basierend auf Übereinstimmung anpassen
...
### <a name="view-the-results-of-the-coupling-job" />Anzeigen der Ergebnisse des Kopplungsauftrags
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication" />Verbindungen von Business Central Online zur Verwendung der zertifikatsbasierten Authentifizierung upgraden
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication" />So aktualisieren Sie Ihre Business Central Online-Verbindung, um die zertifikatsbasierte Authentifizierung zu verwenden
...
## <a name="connecting-on-premises-versions" />Verbinden von lokalen Versionen
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse" />So registrieren Sie eine Anwendung in Azure AD, um eine Verbindung mit Dataverse über Business Central herzustellen
