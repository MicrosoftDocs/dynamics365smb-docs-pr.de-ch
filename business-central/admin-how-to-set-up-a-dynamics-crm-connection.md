...
ms.author: bholtorf
---
# <a name="connect-to-microsoft-dataverse"></a><a name="connect-to-microsoft-dataverse"></a>Mit Microsoft Dataverse verbinden
...
## <a name="set-up-a-connection-to-"></a><a name="set-up-a-connection-to-"></a>Verbindung zu [!INCLUDE[cds_long_md](includes/cds_long_md.md)] einrichten
...
### <a name="to-use-the-dataverse-connection-setup-assisted-setup-guide"></a><a name="to-use-the-dataverse-connection-setup-assisted-setup-guide"></a>So verwenden Sie die Dataverse Anleitung zur unterstützten Einrichtung
...
### <a name="to-create-or-maintain-the-connection-manually"></a><a name="to-create-or-maintain-the-connection-manually"></a>So erstellen oder pflegen Sie den Link manuell
...
## <a name="customize-the-match-based-coupling"></a><a name="customize-the-match-based-coupling"></a>Kopplung basierend auf Übereinstimmung anpassen
...
### <a name="view-the-results-of-the-coupling-job"></a><a name="view-the-results-of-the-coupling-job"></a>Anzeigen der Ergebnisse des Kopplungsauftrags
...
## <a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication"></a><a name="upgrade-connections-from-business-central-online-to-use-certificate-based-authentication"></a>Verbindungen von Business Central Online zur Verwendung der zertifikatsbasierten Authentifizierung upgraden
...
### <a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication"></a><a name="to-upgrade-your-business-central-online-connection-to-use-certificate-based-authentication"></a>So aktualisieren Sie Ihre Business Central Online-Verbindung, um die zertifikatsbasierte Authentifizierung zu verwenden
...
## <a name="connecting-on-premises-versions"></a><a name="connecting-on-premises-versions"></a>Verbinden von lokalen Versionen
...
### <a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse"></a><a name="to-register-an-application-in-azure-ad-for-connecting-from-business-central-to-dataverse"></a>So registrieren Sie eine Anwendung in Azure AD, um eine Verbindung mit Dataverse über Business Central herzustellen
...
### <a name="to-disconnect-from-"></a><a name="to-disconnect-from-"></a>So trennen Sie [!INCLUDE[cds_long_md](includes/cds_long_md.md)]
