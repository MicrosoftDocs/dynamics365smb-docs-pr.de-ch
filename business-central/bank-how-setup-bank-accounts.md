...
## <a name="to-set-up-bank-accounts"></a><a name="to-set-up-bank-accounts"></a>Bankkonten einrichten:
...
## <a name="to-enter-an-opening-balance"></a><a name="to-enter-an-opening-balance"></a>So geben Sie einen Eröffnungssaldo ein
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a><a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files"></a>Um Ihre Bankkonten zum Importieren und Exportieren von Bankdateien einzurichten
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a><a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files"></a>Um Ihre Bankkonten zum Importieren und Exportieren von Bankdateien einzurichten
...
## <a name="changing-your-bank-account"></a><a name="changing-your-bank-account"></a>Ändern Ihres Bankkontos
