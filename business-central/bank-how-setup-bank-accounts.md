...
Die Erstellung eines Bankkontos führt dazu, dass es an allen in der Abbildung gezeigten Stellen verfügbar ist und auch im Fibukonto und auf der Seite **Unternehmensdaten** gespiegelt wird.
...
Vom physischen Konto bei der Bank treffen immer wieder Transaktionen ein, die nicht im Zahlungsabstimmungs-Erfassungsjournal ausgewiesen sind, wie beispielsweise die folgenden Transaktionen:  
...
> [!WARNING]
> Einige Felder können sensible Daten enthalten, wie z.B. die Felder **Clearing-Nummer**, **Bankkontonr.**, **SWIFT Code** und **IBAN Code**. Erfahren Sie mehr unter [Sensible Felder überwachen](across-log-changes.md#monitor-sensitive-fields).
...
6. Die Transaktionen werden in ein Zahlungserfassungsjournal eingefügt, das für den Export von Zahlungen in eine Datei vorbereitet wurde.
