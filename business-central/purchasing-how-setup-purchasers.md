...
ms.author: edupont
---
# <a name="set-up-purchasers" />Einkäufer einrichten
...
## <a name="to-set-up-purchasers" />So richten Sie Einkäufer ein
...
## <a name="to-assign-purchasers-to-vendors" />Einkäufer Kreditoren zuweisen
