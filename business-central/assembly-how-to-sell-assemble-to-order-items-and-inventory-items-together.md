...
---
# <a name="sell-assemble-to-order-items-and-inventory-items-together" />So verkaufen Sie Auftragsmontageartikel und Lagerartikel zusammen
...
## <a name="to-sell-assemble-to-order-items-and-inventory-items-together" />So verkaufen Sie Auftragsmontageartikel und Lagerartikel zusammen
