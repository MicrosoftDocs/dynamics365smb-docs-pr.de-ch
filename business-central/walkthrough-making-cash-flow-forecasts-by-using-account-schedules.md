...
ms.author: edupont
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports"></a><a name="walkthrough-making-cash-flow-forecasts-using-financial-reports"></a>Walkthrough: Erstellen Sie Cashflow-Prognosen mithilfe von Finanzberichten
...
## <a name="setting-up-a-new-financial-report-name"></a><a name="setting-up-a-new-financial-report-name"></a>Einrichten eines neuen Finanzberichtnamens
...
### <a name="set-up-a-new-financial-report-name"></a><a name="set-up-a-new-financial-report-name"></a>Einrichten eines neuen Finanzberichtnamens
...
## <a name="setting-up-row-definition-lines"></a><a name="setting-up-row-definition-lines"></a>Einrichten von Zeilendefinitionslinien
...
### <a name="set-up-row-definition-lines"></a><a name="set-up-row-definition-lines"></a>Einrichten von Zeilendefinitionslinien
...
## <a name="setting-up-a-new-column-definition"></a><a name="setting-up-a-new-column-definition"></a>Einrichten einer neuen Spaltendefinition
...
### <a name="set-up-a-new-column-definition"></a><a name="set-up-a-new-column-definition"></a>Eine neue Spaltendefinition einrichten
...
## <a name="assigning-the-column-definition-to-the-financial-report-name"></a><a name="assigning-the-column-definition-to-the-financial-report-name"></a>Zuordnen einer Spaltendefinition zu einem Finanzberichtsnamen

Ken kann die Spaltendefinition jetzt dem Finanzberichtsnamen zuweisen.  

### <a name="assign-the-column-definition-to-the-financial-report-name"></a><a name="assign-the-column-definition-to-the-financial-report-name"></a>Zuordnen einer Spaltendefinition zu einem Finanzberichtsnamen
...
## <a name="view-and-print-the-cash-flow-forecast"></a><a name="view-and-print-the-cash-flow-forecast"></a>Cashflowplanung anzeigen und drucken
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/forecast-cash-flow-dynamics-365-business-central/)
