...
---
# <a name="walkthrough-make-cash-flow-forecasts-using-financial-reports"></a>Walkthrough: Erstellen Sie Cashflow-Prognosen mithilfe von Finanzberichten
...
### <a name="set-up-a-new-financial-report-name-1"></a>Einrichten eines neuen Finanzberichtnamens
...
### <a name="set-up-row-definition-lines-1"></a>Einrichten von Zeilendefinitionslinien
...
## <a name="set-up-a-new-column-definition"></a>Einrichten einer neuen Spaltendefinition
...
### <a name="set-up-a-new-column-definition-1"></a>Eine neue Spaltendefinition einrichten
...
## <a name="assig-the-column-definition-to-the-financial-report-name"></a>Zuordnen einer Spaltendefinition zu einem Finanzberichtsnamen
