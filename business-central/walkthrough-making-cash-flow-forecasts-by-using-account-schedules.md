...
ms.author: edupont
---
# <a name="walkthrough-making-cash-flow-forecasts-using-financial-reports" />Walkthrough: Erstellen Sie Cashflow-Prognosen mithilfe von Finanzberichten
...
## <a name="setting-up-a-new-financial-report-name" />Einrichten eines neuen Finanzberichtnamens
...
### <a name="set-up-a-new-financial-report-name" />Einrichten eines neuen Finanzberichtnamens
...
## <a name="setting-up-row-definition-lines" />Einrichten von Zeilendefinitionslinien
...
### <a name="set-up-row-definition-lines" />Einrichten von Zeilendefinitionslinien
...
## <a name="setting-up-a-new-column-definition" />Einrichten einer neuen Spaltendefinition
...
### <a name="set-up-a-new-column-definition" />Eine neue Spaltendefinition einrichten
...
## <a name="assigning-the-column-definition-to-the-financial-report-name" />Zuordnen einer Spaltendefinition zu einem Finanzberichtsnamen

Ken kann die Spaltendefinition jetzt dem Finanzberichtsnamen zuweisen.  

### <a name="assign-the-column-definition-to-the-financial-report-name" />Zuordnen einer Spaltendefinition zu einem Finanzberichtsnamen
...
## <a name="view-and-print-the-cash-flow-forecast" />Cashflowplanung anzeigen und drucken
...
## <a name="see-related-microsoft-trainingtrainingmodulesforecast-cash-flow-dynamics--business-central" />Siehe verwandte [Microsoft Schulungen](/training/modules/forecast-cash-flow-dynamics-365-business-central/)
