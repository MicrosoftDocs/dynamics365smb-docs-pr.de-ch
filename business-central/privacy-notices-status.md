...
# <a name="privacy-notices-status-in-"></a><a name="privacy-notices-status-in-"></a>Status der Datenschutzhinweise in [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="privacy-notices-status-page"></a><a name="privacy-notices-status-page"></a>Seite „Status der Datenschutzhinweise“
...
## <a name="privacy-notice-approvals"></a><a name="privacy-notice-approvals"></a>Datenschutzhinweisgenehmigungen
