...
### <a name="can-i-convert-the-trial-to-a-paid-license" />Kann ich die Testversion in eine kostenpflichtige Lizenz umwandeln?
...
### <a name="what-are-the-trial-limits-and-quotas" />Welche Beschränkungen und Kontingente gelten für die Testversion?
...
### <a name="how-do-i-start-using-the-trial" />Wie beginne ich mit der Nutzung der Testversion?
...
### <a name="what-features-are-available-in-the-trial" />Welche Funktionen stehen in der Testversion zur Verfügung?
...
### <a name="how-long-does-the-trial-last" />Wie lange ist die Testversion gültig?
...
### <a name="how-do-i-remove-sample-data-from-the-trial" />Wie kann ich Beispieldaten aus der Testversion entfernen?
...
### <a name="how-do-i-restore-sample-data" />Wie kann ich Beispieldaten wiederherstellen?
