...
ms.author: jswymer
---
# <a name="managing-onedrive-integration-with-business-central" />Verwalten der OneDrive Integration mit Business Central
...
## <a name="configure-onedrive-for-integration-with-business-central" />Konfigurieren Sie OneDrive für die Integration mit Business Central
...
### <a name="managing-privacy" />Datenschutz verwalten
...
## <a name="configure-business-central" />Business Central konfigurieren
...
### <a name="about-multiple-environments" />Über mehrere Umgebungen
...
### <a name="configure-onedrive-using-onedrive-setup" />Konfigurieren Sie OneDrive über die Einrichtung OneDrive
...
### <a name="switching-to-new-onedrive-integration-after-upgrade" />Umschalten auf die neue OneDrive Integration nach dem Upgrade
