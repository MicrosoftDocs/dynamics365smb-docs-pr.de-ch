...
# <a name="financial-information-quick-start" />Finanzinformationen Schnellstart
...
## <a name="set-up-the-chart-of-accounts" />Die Kontenpläne einrichten
...
### <a name="add-an-account-to-the-chart-of-accounts" />Dem Kontenplan ein Konto hinzufügen
...
### <a name="get-an-overview-of-the-chart-of-accounts" />Verschaffen Sie sich einen Überblick über den Kontenplan
...
## <a name="see-related-training-at-microsoft-learn" />Siehe verwandte Schulungen unter [Microsoft Learn](/learn/paths/set-up-financial-management-dynamics-365-business-central/).
