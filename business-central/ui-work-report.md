...
ms.author: jswymer
---
# <a name="run-and-print-reports"></a><a name="run-and-print-reports"></a>Berichte ausführen und drucken
...
## <a name="using-default-valuesmdashpredefined-settings"></a><a name="using-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Standardwerte verwenden&mdash;– vordefinierte Einstellungen
...
## <a name="specifying-the-data-to-include-in-a-report"></a><a name="specifying-the-data-to-include-in-a-report"></a>Angeben der Daten, die in Berichten integriert werden sollen
...
## <a name="previewing-a-report"></a><a name="previewing-a-report"></a>So zeigen Sie eine Berichtvorschau an:
...
### <a name="work-with-the-preview"></a><a name="work-with-the-preview"></a>Mit der Vorschau arbeiten
...
## <a name="saving-a-report-to-a-file"></a><a name="saving-a-report-to-a-file"></a>Speichern eines Berichts in einer Datei
...
## <a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a> Planen der späteren oder regelmässigen Ausführung eines Berichts
...
### <a name="manage-scheduled-recurring-reports"></a><a name="manage-scheduled-recurring-reports"></a>Verwalten Sie geplante wiederkehrende Berichte
...
## <a name="printing-a-report"></a><a name="printing-a-report"></a><a name="PrintReport"></a>Berichte drucken
...
### <a name="printer"></a><a name="printer"></a><a name="Printer"></a>Drucker
...
### <a name="printing-reports-in-thai"></a><a name="printing-reports-in-thai"></a>Drucken von Berichten in Thailändisch
...
## <a name="switching-the-report-layout"></a><a name="switching-the-report-layout"></a>Wechseln des Berichtslayouts
...
## <a name="change-language-and-format-of-numbers-dates-and-times"></a><a name="change-language-and-format-of-numbers-dates-and-times"></a>Ändern Sie die Sprache und das Format von Zahlen, Daten und Uhrzeiten
...
## <a name="advanced-options"></a><a name="advanced-options"></a>Erweiterte Optionen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/paths/setup-reporting-dynamics-365-business-central/)
