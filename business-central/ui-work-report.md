...
---
# <a name="run-and-print-reports-in-business-central"></a>Berichte ausführen und drucken
...
## <a name="use-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Standardwerte verwenden&mdash;– vordefinierte Einstellungen
...
## <a name="specify-the-data-to-include-in-a-report"></a>Angeben der Daten, die in Berichten integriert werden sollen
...
## <a name="preview-a-report"></a>So zeigen Sie eine Berichtvorschau an:
...
## <a name="schedule-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a>Planen der späteren oder regelmässigen Ausführung eines Berichts
...
## <a name="print-a-report"></a><a name="PrintReport"></a>Berichte drucken
...
### <a name="print-reports-in-thai"></a>Drucken von Berichten in Thailändisch
...
## <a name="switch-the-report-layout"></a>Wechseln des Berichtslayouts
