...
- Beleg verschieben
    ...
    Sie können den sichtbaren Bereich des Berichts in beliebiger Richtung verschieben, daher können Sie weitere Bereiche oder den Bericht anzeigen. Das Schwenken ist hilfreich, wenn Sie die Ansicht vergrössert haben, um Details zu sehen. Mithilfe der Maus beispielsweise drücken und halten Sie die linke Maustaste an einem beliebigen Ort in der Berichtsvorschau und bewegen Sie dann Ihre Maus, um einen Abschnitt des Berichts auszuwählen.
