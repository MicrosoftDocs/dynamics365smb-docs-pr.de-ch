...
ms.author: jswymer
---
# <a name="run-and-print-reports" />Berichte ausführen und drucken
...
## <a name="specifying-the-data-to-include-in-a-report" />Angeben der Daten, die in Berichten integriert werden sollen
...
## <a name="previewing-a-report" />So zeigen Sie eine Berichtvorschau an:
...
### <a name="work-with-the-preview" />Mit der Vorschau arbeiten
...
## <a name="saving-a-report-to-a-file" />Speichern eines Berichts in einer Datei
...
## <a name="a-nameschedulereporta-scheduling-a-report-to-run-later-or-periodically" /><a name="ScheduleReport"></a> Planen der späteren oder regelmässigen Ausführung eines Berichts
...
### <a name="manage-scheduled-recurring-reports" />Verwalten Sie geplante wiederkehrende Berichte
...
### <a name="printing-reports-in-thai" />Drucken von Berichten in Thailändisch
...
## <a name="switching-the-report-layout" />Wechseln des Berichtslayouts
...
## <a name="change-language-and-format-of-numbers-dates-and-times" />Ändern Sie die Sprache und das Format von Zahlen, Daten und Uhrzeiten
...
## <a name="advanced-options" />Erweiterte Optionen
