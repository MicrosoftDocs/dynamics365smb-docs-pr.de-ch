...
| Microsoft Power Automate |Ja|Nr.|**Automatisieren** von Aktionen auf **Artikel** Karte |[Einrichten der Power Automate-Integration](/dynamics365/business-central/dev-itpro/powerplatform/power-automate-setup)|
| Microsoft Azure OpenAI-Dienst |Ja |Nr.|**Copilot** |[KI-gestützten Marketingtext für Artikel mit Copilot konfigurieren](enable-ai.md)|
