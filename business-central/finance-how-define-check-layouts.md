...
ms.author: edupont
---
# <a name="select-a-check-layout" />Ein Schecklayout auswählen
...
## <a name="to-select-a-check-layout" />So wählen Sie ein Schecklayout aus
...
## <a name="use-micr-and-security-fonts" />Verwenden von MICR- und Sicherheitsschriftarten
...
### <a name="secure-font-specifications" />Spezifikationen für sichere Schriftarten
