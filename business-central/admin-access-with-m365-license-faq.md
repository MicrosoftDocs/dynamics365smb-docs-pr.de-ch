...
## <a name="permissions"></a>[Berechtigungen](#tab/permissions) 
...
### <a name="after-a-user-signs-in-can-i-change-which-objects-they-have-access-to"></a>Kann ich, nachdem sich ein Benutzer angemeldet hat, ändern, auf welche Objekte er Zugriff hat?
...
## <a name="setup-and-configuration"></a>[Einrichtung und Konfiguration](#tab/setup)
...
## <a name="licensing"></a>[Lizenzierung](#tab/license)
...
## <a name="usage"></a>[Benutzung](#tab/usage)
