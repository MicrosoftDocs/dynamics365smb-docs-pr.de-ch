...
ms.reviewer: jswymer
---
# <a name="create-users-according-to-licenses" />Benutzer nach Lizenzen anlegen
...
## <a name="manage-users-and-licenses-in-online-tenants" />Benutzer und Lizenzen in Online-Mandanten verwalten
...
### <a name="a-namelicensespermissionsaconfigure-permissions-based-on-licenses" /><a name="licensespermissions"></a>Berechtigungen auf Grundlage von Lizenzen konfigurieren
...
### <a name="a-nameadduserato-add-users-or-update-user-information-and-license-assignments-in-business-central" /><a name="adduser"></a>Um Benutzer hinzuzufügen oder Benutzerinformationen und Lizenzzuweisungen in Business Central zu aktualisieren
...
### <a name="to-remove-a-users-access-to-the-system" />So entfernen Sie den Zugriff eines Benutzers auf das System
...
### <a name="a-namem365asynchronization-with-microsoft-365" /><a name="m365"></a>Synchronisierung mit Microsoft 365
...
## <a name="manage-users-and-licenses-in-on-premises-deployments" />Benutzer und Lizenzen in lokalen Bereitstellungen verwalten
...
### <a name="to-edit-or-delete-a-user-in-an-on-premises-deployment" />So bearbeiten oder löschen Sie einen Benutzer in einer Vor-Ort-Bereitstellung
