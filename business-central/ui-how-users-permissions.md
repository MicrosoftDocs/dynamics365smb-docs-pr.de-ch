---
title: Benutzer gemäss Lizenzen erstellen
...
---
# <a name="create-users-according-to-licenses"></a>Benutzer gemäss Lizenzen erstellen

[!INCLUDE[azure-ad-to-microsoft-entra-id](~/../shared-content/shared/azure-ad-to-microsoft-entra-id.md)]

[!INCLUDE [2023rw1-sec-group-short](includes/2023rw1-sec-group-short.md)]

Dieser Artikel beschreibt, wie Administratoren Benutzer erstellen und festlegen, wer sich anmelden kann bei [!INCLUDE[prod_short](includes/prod_short.md)]. Dieser Artikel beschreibt auch, wie Sie Berechtigungen gemäss Ihren Produktlizenzen verschiedenen Benutzenden zuweisen.
...
- Ein Benutzerkonto wird automatisch importiert, wenn sich der Benutzende das erste Mal bei [!INCLUDE [prod_short](includes/prod_short.md)] anmeldet.
   ...
   > [!NOTE]
   > Nachdem Benutzende sich online bei [!INCLUDE [prod_short](includes/prod_short.md)] angemeldet haben, können Sie diese Benutzenden nicht löschen.
...
1. Ziehen Sie die Felder **Status** (Benutzender aktiviert/deaktiviert) und **Lizenztyp** in den Region **Zeilengruppen**.
...
1. Öffnen Sie die Liste [Benutzende](https://businesscentral.dynamics.com/?page=9800) und wählen Sie das Symbol :::image type="content" source="media/analysis-mode-icon.png" alt-text="Analysemodus eingeben"::: aus, um den Analysemodus zu aktivieren.
1. Entfernen Sie auf dem Menü **Spalten** alle Spalten (wählen Sie das Kästchen neben dem Feld **Suchen** auf der rechten Seite aus).
1. Ziehen Sie die Felder **Lizenztyp** und **Status** in den Region **Zeilengruppen**.
1. Wählen Sie die Felder **Benutzername**, **Vollständiger Name** und **Autorisierungs-E-Mail** aus.
