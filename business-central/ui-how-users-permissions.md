...
1. Ändern Sie die Lizenz im Microsoft 365 Admin Center. Weitere Informationen finden Sie unter [Benutzer einzeln oder in grossen Mengen zu Microsoft 365 hinzufügen](https://aka.ms/CreateOffice365Users).
...
|-|-|-|-|-|-|
|Umfang:|Aktueller Benutzer|Neue Benutzer in Microsoft 365|Mehrere ausgewählte Benutzer|Einzelner ausgewählter Benutzer (ausser aktuellem)|Mehrere ausgewählte Benutzer|
