...
ms.author: edupont
---
# <a name="restructure-warehouses" />Lager umstrukturieren
...
## <a name="to-restructure-a-basic-warehouse-that-uses-bins-only" />Um ein Basislager neu zu strukturieren, das nur Lagerplätze verwendet
...
## <a name="to-restructure-an-advanced-warehouse-that-uses-directed-put-away-and-pick" />Um ein erweitertes Lager, das eine gesteuerte Einlagerung und Kommissionierung verwendet, neu zu strukturieren
...
## <a name="to-delete-a-bin" />So löschen Sie einen Lagerplatz:
...
## <a name="to-rename-a-bin-and-change-the-bin-code-in-all-records" />So benennen Sie einen Lagerplatz um und ändern den Lagerplatzcode in allen Datensätzen:
