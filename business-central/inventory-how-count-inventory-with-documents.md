...
ms.author: edupont
---
# <a name="count-and-adjust-inventory-using-documents" />Erfassung und Regulierung des Lagerbestand mithilfe von Belegen
...
## <a name="to-create-a-physical-inventory-order" />So erstellen Sie einen Inventurauftrag
...
## <a name="to-create-a-physical-inventory-recording" />So erstellen Sie eine Inventurerfassung
...
## <a name="to-finish-a-physical-inventory-recording" />So schliessen Sie eine Inventurerfassung ab
...
## <a name="to-complete-a-physical-inventory-order" />So schliessen Sie einen Inventurauftrag ab
...
### <a name="to-find-duplicate-physical-inventory-order-lines" />So finden Sie doppelte Inventurauftragszeilen
...
### <a name="to-post-a-physical-inventory-order" />So buchen Sie einen Inventurauftrag
...
### <a name="to-view-posted-physical-inventory-orders" />So zeigen Sie gebuchte Inventuraufträge an
...
## <a name="handling-item-tracking-when-counting-inventory" />Verarbeitung der Artikeltracking beim Erfassen des Lagerbestands
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item" />Beispiel – Vorbereiten einer Inventurerfassung für einen Artikel mit Artikelverfolgung
...
### <a name="example---record-and-post-counted-lot-number-differences" />Beispiel – Erfassen und buchen von erfassten Chargennummer-Differenzen
...
## <a name="inventory-documents" />Inventurbelege
...
### <a name="to-set-up-numbering-for-inventory-documents" />Nummerierung von Inventurbelegen einrichten
...
### <a name="to-create-and-post-an-inventory-document" />Erstellen und Buchen eines Inventurbelegs
...
## <a name="printing-inventory-documents" />Drucken von Inventurbelegen
