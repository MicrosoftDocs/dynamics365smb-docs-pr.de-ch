...
ms.author: edupont
---
# <a name="auditing-changes-in-business-central" />Protokollieren von Änderungen in Business Central
...
## <a name="about-the-change-log" />Informationen zum Änderungsprotokoll
...
### <a name="work-with-the-change-log" />Mit dem Änderungsprotokoll arbeiten
...
## <a name="about-activity-logs" />Informationen zu Aktivitätsprotokollen
...
### <a name="work-with-activity-logs" />Mit Aktivitätsprotokollen arbeiten
...
## <a name="monitoring-sensitive-fields" />Überwachen sensibler Felder
...
### <a name="setting-up-field-monitoring" />Einrichten der Feldüberwachung
...
### <a name="work-with-field-monitoring" />Mit der Feldüberwachung arbeiten
...
### <a name="viewing-field-monitoring-telemetry" />Anzeigen der Feldüberwachungstelemetrie
...
## <a name="defining-retention-policies" />Definieren von Aufbewahrungsrichtlinien
