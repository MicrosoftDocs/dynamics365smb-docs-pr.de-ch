...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers"></a><a name="set-up-work-centers-and-machine-centers"></a>Arbeitsplätze und Arbeitsplatzgruppen einrichten
...
## <a name="to-set-up-a-work-center"></a><a name="to-set-up-a-work-center"></a>Um Arbeitsplatzgruppen einzurichten:
...
## <a name="considerations-about-capacity"></a><a name="considerations-about-capacity"></a>Überlegungen zur Kapazität
...
### <a name="run-time"></a><a name="run-time"></a>Bearbeitungszeit
...
### <a name="setup-time"></a><a name="setup-time"></a>Rüstzeit
...
### <a name="work-center-processing-multiple-orders-simultaneously"></a><a name="work-center-processing-multiple-orders-simultaneously"></a>Arbeitsplatz, der mehrere Aufträge gleichzeitig bearbeitet
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a><a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work"></a>Effiziente Ressourcen können nur einen Teil ihrer Arbeitszeit der produktiven Arbeit widmen
...
### <a name="consolidated-calendar"></a><a name="consolidated-calendar"></a>Konsolidierter Kalender
...
### <a name="example---different-machine-centers-assigned-to-a-work-center"></a><a name="example---different-machine-centers-assigned-to-a-work-center"></a>Beispiel - unterschiedliche Arbeitsplätze, die einer Arbeitsplatzgruppe zugewiesen sind
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a><a name="to-set-up-a-capacity-constrained-machine-or-work-center"></a>So wird ein in der Kapazität eingeschränkter Arbeitsplatz oder Arbeitsplatzgruppe eingerichtet
