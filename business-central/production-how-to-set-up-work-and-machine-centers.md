...
|Option|Beschreibung|
|------|-----------|
|**Manuell**|Verbrauch wird manuell im FA-Istmeldungs Erf.-Journal oder im Produktions-Erf.-Journal gebucht.|
...
1. Wählen Sie das Symbol ![Glühbirne, das die Funktion „Sie wünschen“ öffnet](media/ui-search/search_small.png "Tell Me-Funktion"), geben Sie **Begrenzte Kapazitäten** ein und wählen Sie dann den entsprechenden Link.
2. Wählen Sie die Aktion **Neu** aus.
