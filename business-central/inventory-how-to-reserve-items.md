...
ms.author: edupont
---
# <a name="reserve-items"></a><a name="reserve-items"></a>Artikel reservieren
...
## <a name="reserve-items-for-sales"></a><a name="reserve-items-for-sales"></a>Sie Artikel für Verkäufe reservieren
...
## <a name="reserve-an-item-for-a-production-order-line"></a><a name="reserve-an-item-for-a-production-order-line"></a>Artikel für FA-Zeilen reservieren
...
## <a name="reserve-items-for-production-order-components"></a><a name="reserve-items-for-production-order-components"></a>Artikel für FA-Komponenten reservieren
...
## <a name="change-a-reservation"></a><a name="change-a-reservation"></a>Reservierung ändern
...
## <a name="cancel-a-reservation"></a><a name="cancel-a-reservation"></a>Reservierung stornieren
...
## <a name="reserve-a-specific-serial-or-lot-number"></a><a name="reserve-a-specific-serial-or-lot-number"></a>Bestimmte Serien- oder Chargennummer reservieren
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/manage-outbound-serial-lot-numbers/)
