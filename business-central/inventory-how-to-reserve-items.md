...
> [!TIP]
> Basierend auf den Mengen, die Sie im Bestand reserviert haben, zeigt [!INCLUDE [prod_short](includes/prod_short.md)] einen Status der Belege an, sodass Sie schnell über den nächsten Schritt informiert sind. Beispielsweise um anzugeben, dass Sie einen Kundenauftrag versenden oder mit der Arbeit an einem Projekt, einer Montage oder einem Produktionsauftrag beginnen können. Der Status trägt auch dazu bei, das Risiko versehentlicher Teillieferungen oder Verzögerungen aufgrund fehlender Bestände für Produktions- und Montageaufträge zu verringern.
>
