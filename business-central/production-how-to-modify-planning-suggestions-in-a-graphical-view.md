...
ms.locfileid: "4759281"
---
# <a name="modify-planning-suggestions-in-a-graphical-view"></a><span data-ttu-id="0d9a6-104">Ändern von Planungsvorschlägen in einer grafischen Ansicht</span><span class="sxs-lookup"><span data-stu-id="0d9a6-104">Modify Planning Suggestions in a Graphical View</span></span>

<span data-ttu-id="0d9a6-105">Eine typische Planungsaktivität besteht darin, Planungsvorschlagszeilen zu ändern oder hinzuzufügen, um die vorgeschlagenen Beschaffungsaufträge zu ändern, bevor Sie diese kommissionieren, indem Sie die Funktion **Ereignismeldung durchführen** ausführen.</span><span class="sxs-lookup"><span data-stu-id="0d9a6-105">A typical planning activity is to change or add planning worksheet lines to modify the suggested supply orders before you commit them by running the **Carry out Action Message** function.</span></span> <span data-ttu-id="0d9a6-106">Eine Alternative zur Durchführung im Planungsvorschlag ist die Verwendung einer grafischen Ansicht.</span><span class="sxs-lookup"><span data-stu-id="0d9a6-106">An alternative to doing this in the planning worksheet is to use a graphical view.</span></span> <span data-ttu-id="0d9a6-107">Dies wird derzeit in [!INCLUDE[prod_short](includes/prod_short.md)] jedoch nicht unterstützt.</span><span class="sxs-lookup"><span data-stu-id="0d9a6-107">However, this is currently not supported in [!INCLUDE[prod_short](includes/prod_short.md)].</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="0d9a6-108">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="0d9a6-108">See Also</span></span>

[<span data-ttu-id="0d9a6-109">Planung</span><span class="sxs-lookup"><span data-stu-id="0d9a6-109">Planning</span></span>](production-planning.md)  
[<span data-ttu-id="0d9a6-110">Produktion einrichten</span><span class="sxs-lookup"><span data-stu-id="0d9a6-110">Setting Up Manufacturing</span></span>](production-configure-production-processes.md)  
[<span data-ttu-id="0d9a6-111">Produktion</span><span class="sxs-lookup"><span data-stu-id="0d9a6-111">Manufacturing</span></span>](production-manage-manufacturing.md)  
[<span data-ttu-id="0d9a6-112">Lagerbesttand</span><span class="sxs-lookup"><span data-stu-id="0d9a6-112">Inventory</span></span>](inventory-manage-inventory.md)  
[<span data-ttu-id="0d9a6-113">Einkauf</span><span class="sxs-lookup"><span data-stu-id="0d9a6-113">Purchasing</span></span>](purchasing-manage-purchasing.md)  
[<span data-ttu-id="0d9a6-114">Designdetails: Vorratsplanung</span><span class="sxs-lookup"><span data-stu-id="0d9a6-114">Design Details: Supply Planning</span></span>](design-details-supply-planning.md)  
[<span data-ttu-id="0d9a6-115">Bewährte Einrichtungsmethoden: Beschaffungsplanung</span><span class="sxs-lookup"><span data-stu-id="0d9a6-115">Setup Best Practices: Supply Planning</span></span>](setup-best-practices-supply-planning.md)  
<span data-ttu-id="0d9a6-116">[Arbeiten mit [!INCLUDE[prod_short](includes/prod_short.md)]](ui-work-product.md)</span><span class="sxs-lookup"><span data-stu-id="0d9a6-116">[Working with [!INCLUDE[prod_short](includes/prod_short.md)]](ui-work-product.md)</span></span>
