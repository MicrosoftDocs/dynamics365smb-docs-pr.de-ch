...
1.  Wählen Sie das Symbol ![Glühbirne, das die Funktion „Sie wünschen“ öffnet](media/ui-search/search_small.png "Tell Me-Funktion") aus, geben Sie **Artikelverfügbarkeit nach Zeitachse** ein, und wählen Sie dann den zugehörigen Link.  
