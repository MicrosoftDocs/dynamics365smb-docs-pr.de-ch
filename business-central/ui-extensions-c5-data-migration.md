...
# <a name="the-c5-data-migration-extension"></a><a name="the-c5-data-migration-extension"></a>Die C5-Datenmigrations-Erweiterung
...
## <a name="what-data-is-migrated"></a><a name="what-data-is-migrated"></a>Welche Daten werden migriert?

Die folgenden Daten werden für jede Einheit migriert:

### <a name="customers"></a><a name="customers"></a>Debitoren
...
### <a name="vendors"></a><a name="vendors"></a>Kreditoren
...
### <a name="items"></a><a name="items"></a>Artikel
...
### <a name="chart-of-accounts"></a><a name="chart-of-accounts"></a>Kontenplan
...
## <a name="file-size-requirements"></a><a name="file-size-requirements"></a>Dateigrössen-Anforderungen
...
## <a name="to-migrate-data"></a><a name="to-migrate-data"></a>Um Daten zu migrieren
...
## <a name="viewing-the-status-of-the-migration"></a><a name="viewing-the-status-of-the-migration"></a>Status der Migration anzeigen
...
## <a name="how-to-avoid-double-posting"></a><a name="how-to-avoid-double-posting"></a>Wie Sie Doppel-Buchung vermeiden
...
## <a name="correcting-errors"></a><a name="correcting-errors"></a>Nachbesserung
...
## <a name="verifying-data-after-migrating"></a><a name="verifying-data-after-migrating"></a>Prüfen von Daten nach dem Migrieren
...
## <a name="stopping-data-migration"></a><a name="stopping-data-migration"></a>Datenmigration anhalten
