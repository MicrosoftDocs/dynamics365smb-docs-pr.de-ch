...
## <a name="what-data-is-migrated" />Welche Daten werden migriert?

Die folgenden Daten werden für jede Einheit migriert:

### <a name="customers" />Debitoren
...
### <a name="chart-of-accounts" />Kontenplan
...
## <a name="file-size-requirements" />Dateigrössen-Anforderungen
...
## <a name="to-migrate-data" />Um Daten zu migrieren
...
## <a name="viewing-the-status-of-the-migration" />Status der Migration anzeigen
...
## <a name="how-to-avoid-double-posting" />Wie Sie Doppel-Buchung vermeiden
...
## <a name="correcting-errors" />Nachbesserung
...
## <a name="verifying-data-after-migrating" />Prüfen von Daten nach dem Migrieren
...
## <a name="stopping-data-migration" />Datenmigration anhalten
