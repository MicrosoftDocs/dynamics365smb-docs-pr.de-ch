---
title: "Designdetails\_– durchschnittliche Kosten"
...
|Feld|Description|  
|---------------------------------|---------------------------------------|  
|**Durchschnittskostenperiode**|Gibt an, in welcher Periode die Durchschnittskosten berechnet werden. Folgende Optionen sind verfügbar:<br /><br /> - **Tag**<br />- **Woche**<br />- **Monat**<br />- **Buchhaltungsperiode**<br /><br /> Bei Lagerabgängen, die während der Durchschnittskostenperiode gebucht wurden, wird der durchschnittliche Einstandspreis verwendet, der für diese Periode berechnet wurde.|  
|**Einst.-Pr.(durchschn.)Ber.-Art**|Gibt an, wie die durchschnittlichen Kosten eines Artikels berechnet werden. Folgende Optionen sind verfügbar:<br /><br /> - **Option**<br />- **Artikel, Variante und Lagerort**<br /> Wenn diese Option ausgewählt ist, berechnet die Anwendung den durchschnittlichen Einstandspreis pro Artikel für jeden Lagerort und für jede Variante des Artikels. Die durchschnittlichen Kosten des Artikels davon abhängt, wo Sie ihn gelagert und welche Variante (z. B. welche Farbe) Sie ausgewählt haben.|  
...
Die folgende Tabelle zeigt Lagerposten für den Beispiel-Durchschnittkostenartikel, ITEM1, bevor Sie den Batchauftrag **Lagerreg. fakt. Einst. Preise** ausführen.  
...
|--|--|--|--|--|
| ARTIKEL1 |  | BLAU | 01-01-23 |   Nr. |
| ARTIKEL1 |  | BLAU | 02-01-23 |   Nr. |
| ARTIKEL1 |  | BLAU | 02-02-23 |   Nr. |
| ARTIKEL1 |  | BLAU | 02-03-23 |   Nr. |

 Die folgende Tabelle zeigt dieselben Lagerposten an, nachdem Sie den Batchauftrag **Lagerreg. fakt. Einst. Preise** ausgeführt haben. Der durchschnittliche Einstandspreis pro Tag wird auf die Lagerabgänge berechnet und angewendet.  
...
| **Artikelnr.** | **Variantencode** | **Lagerortcode** | **Bewertungsdatum** | **Einstandspreis ist reguliert** |
|--|--|--|--|--|
| ARTIKEL1 |  | BLAU | 01-31-23 |   Nr. |
| ARTIKEL1 |  | BLAU | 02-28-23 |   Nr. |
...
Die folgende Tabelle zeigt dieselben Lagerposten an, nachdem Sie den Batchauftrag **Lagerreg. fakt. Einst. Preise** ausgeführt haben. Der durchschnittliche Einstandspreis pro Monat wird auf die Lagerabgänge berechnet und angewendet.  
...
[Geschäftsprozess für die Produktkalkulation und seine Beziehung zu anderen Prozessen mit Dynamics 365](/dynamics365/guidance/business-processes/design-to-retire-define-product-costing-overview)  
