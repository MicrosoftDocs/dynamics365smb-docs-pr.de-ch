...
## <a name="to-view-changed-depreciation-book-values-due-to-fixed-asset-reclassification" />So zeigen Sie geänderte Abschreibungsbuch-Werte aufgrund von Anlagenumbuchung an
