...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub" />Fehlerbehandlung in Ihrem Unternehmens-Hub
...
## <a name="check-errors" />Fehler prüfen
...
## <a name="connection-failed" />Verbindung fehlgeschlagen
...
## <a name="data-does-not-refresh" />Daten werden nicht aktualisiert
