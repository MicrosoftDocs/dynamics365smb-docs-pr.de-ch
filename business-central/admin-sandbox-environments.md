...
ms.author: solsen
---
# <a name="sandbox-environments-in-includeprodshortincludesprodshortmd" />Sandbox-Umgebungen in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="advanced-user-experience" />Erweiterte Benutzeroberfläche
...
### <a name="complete-sample-data" />Vollständige Beispieldaten
