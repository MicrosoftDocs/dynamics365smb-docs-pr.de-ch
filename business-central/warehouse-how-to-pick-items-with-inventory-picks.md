...
## <a name="to-create-the-pick-in-two-steps"></a>So erstellen Sie die Kommissionierung in zwei Schritten
...
## <a name="to-record-inventory-picks"></a>So erfassen Sie Lagerkommissionierungen
...
## <a name="handling-assemble-to-order-items-with-inventory-picks"></a>Verarbeiten von Auftragsmontageartikeln mit Lagerkommissionierungen
