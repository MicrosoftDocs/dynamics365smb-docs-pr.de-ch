...
---
# <a name="pick-items-with-inventory-picks" />Artikel mit der Lagerkommissionierung kommissionieren
...
## <a name="to-create-multiple-inventory-picks-with-a-batch-job" />Mehrere Lagerkommissionierungen mit einem Batchauftrag erstellen
...
## <a name="to-create-the-pick-in-two-steps" />So erstellen Sie die Kommissionierung in zwei Schritten

### <a name="to-request-an-inventory-pick-by-releasing-the-source-document" />So fordern Sie eine Lagerkommissionierung durch Freigabe des Herkunftsbelegs an
...
### <a name="to-create-an-inventory-pick-based-on-the-source-document" />So erstellen Sie eine Lagerkommissionierung auf Grundlage des Herkunftsbelegs
...
6. Wählen Sie die Schaltfläche **OK**, um die Kommissionierungszeilen gemäss den ausgewählten Herkunftsbelegen auszufüllen.  

## <a name="to-record-inventory-picks" />So erfassen Sie Lagerkommissionierungen
...
## <a name="handling-assemble-to-order-items-with-inventory-picks" />Verarbeiten von Auftragsmontageartikeln mit Lagerkommissionierungen
...
2. Die gebuchte Lagerkommissionierung bucht den Montageausstoss, den Komponentenverbrauch und die Verkaufslieferung.
...
Bei Verkäufen, bei denen die gesamte Menge aus der Verkaufsauftragszeile montiert wird, wird eine Lagerkommissionierzeile für diese Menge erstellt. Der Wert im Feld **Menge für Montage** gleicht dem Wert im Feld **Zu liefernde Menge**. Das Feld **Auftragsmontage** wird in der Zeile ausgewählt.
...
* Die andere Kommissionierungszeile hängt davon ab, welche Lagerplätze die Restmenge erfüllen können. Wenn der Artikel in mehreren Lagerplätzen aufbewahrt wird, werden mehrere Zeilen erstellt. Die Entnahmezeile basiert auf der Menge im Feld **Zu liefernde Menge**.
