...
ms.author: jswymer
---
# <a name="work-with--data-in-power-bi"></a><a name="work-with--data-in-power-bi"></a>Mit [!INCLUDE [prod_short](includes/prod_short.md)]-Daten in Power BI arbeiten
...
## <a name="get-the-latest-data"></a><a name="get-the-latest-data"></a>Aktuelle Daten beziehen
...
### <a name="refresh-manually"></a><a name="refresh-manually"></a>Manuell aktualisieren
...
### <a name="schedule-a-refresh"></a><a name="schedule-a-refresh"></a>Eine Aktualisierung planen
...
## <a name="upload-reports-from-files"></a><a name="upload-reports-from-files"></a><a name="upload"></a>Hochladen von Berichten aus Dateien
...
## <a name="share-reports-with-others"></a><a name="share-reports-with-others"></a><a name="share"></a>Berichte mit anderen teilen
