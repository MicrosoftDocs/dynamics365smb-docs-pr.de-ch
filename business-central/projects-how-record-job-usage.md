...
4. Geben Sie im Feld **In das Journal zu übertragende Menge** die umzulagernde Menge ein. Der Standardwert ist der Wert, den Sie im Feld **Menge** angegeben haben.
    ...
    Das Feld **Restmenge** zeigt die Menge an, die verbleibt, um das Projekt abzuschliessen und in das Erf.-Journal umzulagern. <!--Should we mention that this field is not shown by default, and that if they want to use it they must add it?--> 
