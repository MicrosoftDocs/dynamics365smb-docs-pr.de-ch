...
1. Wählen Sie das Symbol ![Glühbirne, die die Funktion Tell Me](media/ui-search/search_small.png "Tell Me-Funktion") öffnet, geben Sie **Job Journale** ein und wählen Sie dann den entsprechenden Link.  
