...
Webdienste sind eine einfache Art, Anwendungsfunktionen für verschiedene externe Systeme und Benutzer zugänglich zu machen. Standardmässig stellt [!INCLUDE[d365fin](includes/d365fin_md.md)] eine Reihe von Objekten als Webdienste bereit, um eine bessere Integration in andere Microsoft-Dienste zu ermöglichen. Sie können bei Bedarf weitere Webdienste hinzufügen.  

Richten Sie einen Webdienst in [!INCLUDE[d365fin](includes/d365fin_md.md)] ein, und veröffentlichen Sie den Webdienst anschliessend, damit er authentifizierten Benutzern zur Verfügung steht. Alle autorisierten Benutzer können auf Metadaten für Webdienste zugreifen, aber nur Benutzer mit ausreichenden -Berechtigungen können auf tatsächliche Daten zugreifen.  
