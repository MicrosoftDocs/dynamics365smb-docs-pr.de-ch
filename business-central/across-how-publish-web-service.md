...
ms.author: edupont
---
# <a name="publish-a-web-service" />Webdienst veröffentlichen
...
## <a name="creating-and-publishing-a-web-service" />Erstellen und Veröffentlichen eines Webdienstes

Die folgenden Schritte erläutern, wie ein Webdienst erstellt und veröffentlicht wird.  

### <a name="to-create-and-publish-a-web-service" />So erstellen und veröffentlichen Sie einen Webdienst
...
### <a name="to-verify-the-availability-of-a-web-service" />So prüfen Sie die Verfügbarkeit eines Webdienstes
