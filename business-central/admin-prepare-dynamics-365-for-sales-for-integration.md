...
|**Bidirektionale Synchronisierung von Verkaufsaufträgen**|Synchronisieren Sie Verkaufsaufträge in beide Richtungen. Wenn ein Kunde beispielsweise seine Meinung bezüglich des bestellten Produkts oder der Bestellmenge ändert [!INCLUDE[crm_md](includes/crm_md.md)], können Sie die Änderung in [!INCLUDE[prod_short](includes/prod_short.md)] bearbeiten, indem Sie den Verkaufsbeleg archivieren und einen neuen erstellen. Dasselbe gilt für Änderungen in [!INCLUDE[prod_short](includes/prod_short.md)]. Wenn sich beispielsweise Preise, Salestaxbeträge oder voraussichtliche Warenausgangsdaten ändern, werden die Änderungen automatisch mit [!INCLUDE[crm_md](includes/crm_md.md)] synchronisiert. Dadurch bleiben Ihre Verkäufer über die neuesten Änderungen und den Status von Offerten und Bestellungen auf dem Laufenden.|
