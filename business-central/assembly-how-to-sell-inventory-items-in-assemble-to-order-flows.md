...
---
# <a name="selling-inventory-items-in-assemble-to-order-flows" />Verkauf von Lagerartikeln in Programmfertigungen (Flows)
...
## <a name="to-sell-inventory-items-in-assemble-to-order-flows" />So verkaufen Sie Lagerartikel in Programmfertigungs-Flüssen
...
## <a name="see-related-microsoft-trainingtrainingmodulesassemble-to-order-dynamics-365-business-central" />Siehe verwandte [Microsoft Schulungen](/training/modules/assemble-to-order-dynamics-365-business-central/)
