...
Wenn Sie die Dateneingabe in einem Feld beendet haben, drücken Sie einfach ENTER, um die Änderungen zu bestätigen und zum nächsten Feld zu wechseln. Wenn Sie die Richtung umkehren und zum vorherigen Feld gehen möchten, drücken SHIFT+ENTER. Weitere Informationen zu diesen Tastenkombinationen finden Sie unter [Tastenkombinationen der Schnelleingabe für Felder](keyboard-shortcuts.md#QuickEntry).
