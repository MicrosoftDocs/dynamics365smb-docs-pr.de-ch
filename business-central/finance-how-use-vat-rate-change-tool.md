...
# <a name="managing-vat-rate-changes"></a><a name="managing-vat-rate-changes"></a>Verwalten von Änderungen des Mehrwertsteuersatzes
...
## <a name="changing-vat-rates"></a><a name="changing-vat-rates"></a>Ändern von Mehrwertsteuersätzen
...
## <a name="the-vat-rate-change-tool"></a><a name="the-vat-rate-change-tool"></a>Das Tool zum Ändern des MWST-Satzes
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations"></a><a name="understanding-the-vat-rate-conversion-process-and-limitations"></a>Verstehen des Prozesses und der Einschränkungen des Tools zum Ändern des MWST-Satzes
...
### <a name="to-prepare-vat-rate-change-conversions"></a><a name="to-prepare-vat-rate-change-conversions"></a>So bereiten Sie Mehrwertsteuersatzänderungen vor
...
### <a name="to-set-up-the-vat-rate-change-tool"></a><a name="to-set-up-the-vat-rate-change-tool"></a>So richten Sie das Mehrwertsteuersatz-Änderungstool ein
...
### <a name="to-set-up-product-posting-group-conversion"></a><a name="to-set-up-product-posting-group-conversion"></a>So richten Sie die Produktbuchungsgruppenkonvertierung ein
...
### <a name="to-perform-vat-rate-change-conversion"></a><a name="to-perform-vat-rate-change-conversion"></a>So führen Sie eine Umrechnung für die MWST.-Satzänderung aus
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/rate-change-dynamics-365-business-central/)
