...
# <a name="managing-vat-rate-changes" />Verwalten von Änderungen des Mehrwertsteuersatzes
...
## <a name="changing-vat-rates" />Ändern von Mehrwertsteuersätzen
...
## <a name="the-vat-rate-change-tool" />Das Tool zum Ändern des MWST-Satzes
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations" />Verstehen des Prozesses und der Einschränkungen des Tools zum Ändern des MWST-Satzes
...
### <a name="to-prepare-vat-rate-change-conversions" />So bereiten Sie Mehrwertsteuersatzänderungen vor
...
### <a name="to-set-up-the-vat-rate-change-tool" />So richten Sie das Mehrwertsteuersatz-Änderungstool ein
...
### <a name="to-set-up-product-posting-group-conversion" />So richten Sie die Produktbuchungsgruppenkonvertierung ein
...
### <a name="to-perform-vat-rate-change-conversion" />So führen Sie eine Umrechnung für die MWST.-Satzänderung aus
...
## <a name="see-related-microsoft-trainingtrainingmodulesrate-change-dynamics-365-business-central" />Siehe verwandte [Microsoft Schulungen](/training/modules/rate-change-dynamics-365-business-central/)
