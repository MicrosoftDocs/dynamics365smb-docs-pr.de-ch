...
---
# <a name="design-details-transfers-in-planning"></a><a name="design-details-transfers-in-planning"></a>Designdetails: Umlagerungen in Planung
...
## <a name="why-is-a-transfer-a-special-case"></a><a name="why-is-a-transfer-a-special-case"></a>Warum ist eine Umlagerung ein spezieller Fall?
...
## <a name="transfers-are-dependent-demand"></a><a name="transfers-are-dependent-demand"></a>Umlagerungen sind abhängiger Bedarf
...
## <a name="planning-sequence"></a><a name="planning-sequence"></a>Planungssequenz
...
## <a name="transfer-level-code"></a><a name="transfer-level-code"></a>Umlagerungsebenencode
...
## <a name="planning-transfers-without-sku"></a><a name="planning-transfers-without-sku"></a>Umlagerungen ohne SKU planen
...
## <a name="changing-quantity-with-reservations"></a><a name="changing-quantity-with-reservations"></a>Ändern der Menge mit Reservierungen
...
## <a name="changing-quantity-in-a-transfer-chain"></a><a name="changing-quantity-in-a-transfer-chain"></a>Ändern der Menge in einer Umlagerungskette
...
## <a name="lead-time-calculation"></a><a name="lead-time-calculation"></a>Beschaffungszeit
...
## <a name="safety-lead-time"></a><a name="safety-lead-time"></a>Sicherheitsdurchlaufzeit
...
## <a name="reschedule"></a><a name="reschedule"></a>Neu planen
...
## <a name="serial-and-lot-numbers-in-transfer-chains"></a><a name="serial-and-lot-numbers-in-transfer-chains"></a>Serien und Chargennummern in Umlagerungsketten
