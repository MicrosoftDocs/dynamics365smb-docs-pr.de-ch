...
# <a name="block-vendors"></a>Anbieter blockieren
Sie können einen Lieferanten sperren, beispielsweise wegen Insolvenz, sodass dieser nicht in Einkaufsbelegen hinzugefügt werden kann oder keine Zahlungen für ihn gebucht werden können.
...
|**Zahlung**|Für diesen Lieferanten können keine neuen Zahlungen erstellt werden.|  
