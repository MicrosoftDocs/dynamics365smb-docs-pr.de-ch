...
ms.author: bholtorf
---
# <a name="block-vendors"></a><a name="block-vendors"></a>Kreditoren sperren
...
## <a name="to-block-a-vendor"></a><a name="to-block-a-vendor"></a>So blockieren Sie einen Kreditor
