...
ms.author: edupont
---
# <a name="set-up-shipment-methods"></a><a name="set-up-shipment-methods"></a><a name="set-up-shipment-methods"></a>Lieferbedingungen einrichten
...
## <a name="to-set-up-a-shipment-method"></a><a name="to-set-up-a-shipment-method"></a><a name="to-set-up-a-shipment-method"></a>So richten Sie eine Lieferbedingung ein
