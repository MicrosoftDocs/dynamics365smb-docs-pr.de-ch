...
4. Füllen Sie auf der Seite **Verkaufsauftrag** die Felder wie benötigt aus. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
    ...
    Wenn Sie wiederkehrende Verkaufszeilen für den Debitor, wie etwa einen Monatsersatzauftrag, eingerichtet haben, können Sie diese auf der Rechnung durch Auswählen der Aktion **Wiederkehrende Verkaufszeilen abrufen** einfügen.
