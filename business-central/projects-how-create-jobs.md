...
ms.author: edupont
---
# <a name="create-jobs"></a><a name="create-jobs"></a>Projekt erstellen
...
## <a name="to-create-a-job-card"></a><a name="to-create-a-job-card"></a>So erstellen Sie eine Projektkarte
...
## <a name="to-create-tasks-for-a-job"></a><a name="to-create-tasks-for-a-job"></a>Aufgaben für ein Projekt erstellen
...
## <a name="to-create-planning-lines-for-a-job"></a><a name="to-create-planning-lines-for-a-job"></a>So erstellen Sie eine Projektplanzeile für ein Projekt
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/create-new-job/)
