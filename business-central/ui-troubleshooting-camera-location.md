...
# <a name="troubleshooting-accessing-camera-and-location" />Problembehebung: Auf Kamera und Standort zugreifen
...
## <a name="device-must-have-camera-and-location-capabilities" />Das Gerät muss über Kamera- und Standortfunktionen verfügen
...
## <a name="access-permissions-not-enabled" />Zugriffsberechtigungen sind nicht aktiviert
...
## <a name="web-client-connection-not-secure" />Webclient-Verbindung ist nicht sicher
...
## <a name="work-with-virtualization-technologies" />Mit Virtualisierungstechnologien arbeiten
...
## <a name="antivirus-software" />Antivirensoftware
