...
# <a name="posting-date-on-adjustment-value-entry-compared-to-the-source-entry" />Buchungsdatum bei der Eingabe von Anpassungswerten im Vergleich zur Quelleingabe
...
## <a name="revaluation-scenario" />Szenario Neubewertung
...
### <a name="to-test-the-scenario" />So führen Sie ein Testszenario aus
...
### <a name="to-test-the-scenario-1" />So führen Sie ein Testszenario aus
