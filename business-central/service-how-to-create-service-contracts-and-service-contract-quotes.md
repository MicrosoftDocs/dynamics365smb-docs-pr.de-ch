...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes"></a><a name="work-with-service-contracts-and-service-contract-quotes"></a>Arbeiten mit Serviceverträgen und Servicevertragsofferten
...
## <a name="to-create-a-service-contract-or-service-contract-quote"></a><a name="to-create-a-service-contract-or-service-contract-quote"></a>So erstellen Sie einen Servicevertrag oder eine Servicevertragsofferte
...
## <a name="to-convert-a-service-contract-quote-to-service-contract"></a><a name="to-convert-a-service-contract-quote-to-service-contract"></a>So wandeln Sie Servicevertragsofferten in Serviceverträge um
...
## <a name="to-create-contract-service-credit-memos"></a><a name="to-create-contract-service-credit-memos"></a>So erstellen Sie Servicevertragsgutschriften
...
## <a name="updating-and-evaluating-contracts"></a><a name="updating-and-evaluating-contracts"></a>Aktualisieren und Auswerten von Verträgen
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a><a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote"></a>So fügen Sie einem Serviceauftrag oder einer Vertragsofferte Vertragszeilen hinzu
...
## <a name="to-remove-contract-lines"></a><a name="to-remove-contract-lines"></a>So entfernen Sie Vertragszeilen
...
## <a name="service-line-cost-and-value"></a><a name="service-line-cost-and-value"></a>Servicezeile "Kosten und Wert"
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes"></a><a name="to-add-a-contract-discount-to-service-contract-quotes"></a>So fügen Sie einen Vertragsrabatt für Servicevertragsofferten hinzu
...
## <a name="to-change-the-owner-of-a-service-contract"></a><a name="to-change-the-owner-of-a-service-contract"></a>So ändern Sie den Inhaber eines Servicevertrags
...
## <a name="to-update-a-service-contract-price"></a><a name="to-update-a-service-contract-price"></a>So aktualisieren Sie Servicevertragspreise
...
## <a name="to-post-prepaid-contract-entries"></a><a name="to-post-prepaid-contract-entries"></a>So buchen Sie vorausbezahlte Vertragsposten
...
## <a name="changing-the-service-contract-status"></a><a name="changing-the-service-contract-status"></a>Ändern des Servicevertrag-Status
...
## <a name="to-cancel-a-service-contract"></a><a name="to-cancel-a-service-contract"></a>So kündigen Sie einen Servicevertrag
...
## <a name="filing-a-service-contract-or-contract-quote"></a><a name="filing-a-service-contract-or-contract-quote"></a>Archivieren eines Servicevertrags oder einer Vertragsofferte
