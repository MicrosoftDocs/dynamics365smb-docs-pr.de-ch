...
ms.author: bholtorf
---
# <a name="work-with-service-contracts-and-service-contract-quotes" />Arbeiten mit Serviceverträgen und Servicevertragsofferten
...
## <a name="to-create-a-service-contract-or-service-contract-quote" />So erstellen Sie einen Servicevertrag oder eine Servicevertragsofferte
...
## <a name="to-convert-a-service-contract-quote-to-service-contract" />So wandeln Sie Servicevertragsofferten in Serviceverträge um
...
## <a name="to-create-contract-service-credit-memos" />So erstellen Sie Servicevertragsgutschriften
...
## <a name="updating-and-evaluating-contracts" />Aktualisieren und Auswerten von Verträgen
...
## <a name="to-add-a-contract-line-to-a-service-contract-or-contract-quote" />So fügen Sie einem Serviceauftrag oder einer Vertragsofferte Vertragszeilen hinzu
...
## <a name="to-remove-contract-lines" />So entfernen Sie Vertragszeilen
...
## <a name="service-line-cost-and-value" />Servicezeile "Kosten und Wert"
...
## <a name="to-add-a-contract-discount-to-service-contract-quotes" />So fügen Sie einen Vertragsrabatt für Servicevertragsofferten hinzu
...
## <a name="to-change-the-owner-of-a-service-contract" />So ändern Sie den Inhaber eines Servicevertrags
...
## <a name="to-update-a-service-contract-price" />So aktualisieren Sie Servicevertragspreise
...
## <a name="to-post-prepaid-contract-entries" />So buchen Sie vorausbezahlte Vertragsposten
...
## <a name="changing-the-service-contract-status" />Ändern des Servicevertrag-Status
...
## <a name="to-cancel-a-service-contract" />So kündigen Sie einen Servicevertrag
...
## <a name="filing-a-service-contract-or-contract-quote" />Archivieren eines Servicevertrags oder einer Vertragsofferte
