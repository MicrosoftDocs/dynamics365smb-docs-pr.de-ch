...
ms.author: edupont
---
# <a name="work-on-service-tasks" />Mit Serviceaufgaben arbeiten
...
## <a name="to-work-on-a-service-task" />So bearbeiten Sie eine Serviceaufgabe
...
## <a name="to-register-service-operations" />So erfassen Sie Servicearbeiten
...
## <a name="to-register-spare-parts" />So erfassen Sie Ersatzteile
...
## <a name="to-register-spare-parts-from-a-service-order" />So erfassen Sie Ersatzteile aus einem Serviceauftrag
...
## <a name="to-replace-a-service-item-or-a-service-item-component" />So ersetzen Sie einen Serviceartikel oder eine Serviceartikelkomponente
...
## <a name="to-change-the-response-time-for-a-service-item-line" />So ändern Sie die Reaktionszeit für eine Serviceartikelzeile
...
## <a name="to-register-faultresolution-codes" />So erfassen Sie Problem-/Lösungscodes
