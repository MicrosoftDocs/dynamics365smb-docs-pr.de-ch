...
##### [Designdetails: Abstimmung mit der Finanzbuchhaltung](design-details-reconciliation-with-the-general-ledger.md)  
...
##### [Fibu-Erf.-Journal-Buchungsposition – Übersicht](design-details-general-journal-post-line-overview.md)  
...
##### [Eingehende Belege einrichten](across-how-setup-income-documents.md)
##### [Sich auf den elektronischen Versand und Empfang von Belegen vorbereiten](across-how-to-set-up-electronic-document-sending-and-receiving.md)
...
#### [Überblick zu Aufgaben, Buchhaltungsperioden zu schliessen](year-how-complete-period-end-processes.md)
...
#### [Erfolgsrechnungskonten abschliessen](year-close-income-statement.md)
...
#### [Umsatz und Kosten mehreren Fibukonten zuteilen](finance-allocate-revenue-costs.md)
...
#### [MWST-Nummern validieren](finance-how-validate-vat-registration-number.md)
...
### [Salestaxes für die Shopify-Verbindung einrichten](shopify/setup-taxes.md)
...
#### Salestax
##### [Salestax in der australischen Version](LocalFunctionality/Australia/tax.md)
...
##### [Steuern auf Waren und Dienstleistungen auf Vorauszahlungen berechnen](LocalFunctionality/Australia/how-to-calculate-goods-and-services-tax-on-prepayments.md)
...
##### [Nicht abzugsfähige MWST einrichten](LocalFunctionality/Belgium/how-to-set-up-non-deductible-vat.md)
...
##### [Zahlungszeilen und Fibu-Erf.-Journalzeilen zusammenfassen](LocalFunctionality/Belgium/summarizing-payment-lines-and-general-journal-lines.md)
...
#### Salestax
##### [Steuern und Mehrwertsteuern auf Waren und Dienstleistungen in Kanada melden](LocalFunctionality/Canada/sales-tax-goods-services.md)
...
##### [Salestax und Umsatzsteuer einrichten](LocalFunctionality/Canada/how-to-set-up-use-tax-and-purchase-tax.md)
#### Banking und Zahlungen
...
##### [Ausgleich von Fibuposten](LocalFunctionality/Czech/general-ledger-entries-application.md)
...
##### [Buchungsgruppen in Umlagerungsaufträgen](LocalFunctionality/Czech/how-to-use-posting-groups-in-transfer-orders.md)
#### Allgemein
...
##### [Lagerbestandsumlagerungsvorlagen](LocalFunctionality/Czech/inventory-movement-templates.md)
...
##### [MWST-Erklärungen elektronisch übermitteln](localfunctionality/denmark/how-to-evat-statement-dk.md)
#### Banking und Zahlungen
##### [FIK-Details im Zahlungsabstimmungs-Erf.-Journal](LocalFunctionality/Denmark/fik-details-in-the-payment-reconciliation-journal.md)
...
#### Kernfinanzierung
##### [Fibuposten](LocalFunctionality/France/general-ledger.md)
...
##### [MWST-Voranmeldungen](LocalFunctionality\Germany\how-to-set-up-and-export-sales-vat-advance-notifications.md)
...
##### [Einheitlicher Euro-Zahlungsverkehrsraum](LocalFunctionality/Netherlands/single-euro-payments-area-sepa-.md)
...
##### [Quellensteuer berechnen und buchen](LocalFunctionality/NewZealand/how-to-calculate-and-post-withholding-tax-settlements.md)
...
##### [Abrechnungswechselkurse für MWST-Posten anpassen](LocalFunctionality/NewZealand/how-to-adjust-settlement-exchange-rates-for-vat-entries.md)
...
#### MWST
##### [Norwegische Standardprotokolldatei – Salestaxverwaltung (SAF-T)](LocalFunctionality/Norway/ui-extensions-setup-and-generate-saf-t-files-no.md)
...
##### [Protokolle einrichten und erstellen](LocalFunctionality/Russia/how-to-set-up-and-create-letters-of-attorney.md)
...
##### [MWST-Posten vorbereiten und buchen](LocalFunctionality/Russia/How-to-Prepare-VAT-Entries-for-Posting.md)  
##### [MWST-Ausgleich](LocalFunctionality/Russia/Settlement-VAT.md)  
##### [Bücher über Käufe und Verkäufe und die MWST-Erklärung im XML-Format hochladen](LocalFunctionality/Russia/upload-books-purchases-sales-xml-vat-declaration.md)  
...
#### Salestaxkonten
##### [Salestaxkonten in der russischen Version](LocalFunctionality/Russia/Tax-Accounting.md)
##### [Salestaxkonten einrichten](LocalFunctionality/Russia/How-to-Set-Up-Tax-Accounting.md)  
...
##### [Konten und Zahlungen für persönliche Einkommenssteuerzahlungen](LocalFunctionality/Russia/Accounting-for-personal-income-tax-payments.md)  
...
##### [Lagerbestand einrichten](LocalFunctionality/Russia/Inventory-Setup.md)
...
##### [Ihren Urlaub planen](LocalFunctionality/Russia/Vacation-planning.md)
...
##### [Daten in das Standardimport-/-exportformat importieren und exportieren](LocalFunctionality/Sweden/how-to-import-and-export-data-in-standard-import-export-format.md)  
...
##### [Mehrwertsteuer (Schweiz)](LocalFunctionality/Switzerland/swiss-value-added-tax.md)
...
##### [Salestax und Umsatzsteuer einrichten](LocalFunctionality/UnitedStates/how-to-set-up-use-tax-and-purchase-tax.md)  
...
#### [Mahnungen im Inkasso automatisieren](finance-automate-reminders.md)
...
#### [Neue Artikel registrieren](inventory-how-register-new-items.md)
#### [Neue Artikel durch Kopieren vorhandener Artikel erstellen](inventory-how-copy-items.md)
...
#### [Anlagenabschreibung einrichten](fa-how-setup-depreciation.md)
...
#### [Lagerplatzinhalte erstellen](warehouse-how-to-set-up-bin-contents.md)
...
#### [Basislager mit Vorgangsregionen einrichten](warehouse-how-to-set-up-basic-warehouses-with-operations-areas.md)
...
#### [Die FEFO-Methode aktivieren, um Artikel auszuwählen](warehouse-picking-by-fefo.md)
...
#### [Buchung der Komponenten entsprechend der Arbeitsgangsausgabe aktivieren](production-how-to-flush-components-according-to-operation-output.md)
...
#### [Mit Fertigungsfamilien arbeiten](production-how-work-family.md)
#### [Standard-Arbeitsplanposten einrichten](production-how-set-up-standard-routing-lines.md)
#### [Fertigung in Fremdarbeit](production-how-to-subcontract-manufacturing.md)
...
#### [Serviceverträge einrichten](service-how-setup-service-contracts.md)
### Komplexe Anwendungsregionen mithilfe bewährter Methoden einrichten 
...
##### Berichtsersteller
###### [Erste Schritte: Berichte erstellen](across-how-use-financials-data-source-powerbi.md)
...
###### [Mit Power BI eine Verbindung aus Business Central lokal herstellen](across-working-with-business-central-in-powerbi.md)
###### [Business Central-Apps in Power BI verwenden](across-powerbi-business-central-apps.md)
##### [Häufig gestellte Fragen](power-bi-faq.md)
...
#### [Massenrechnungen für Microsoft-Buchungen](finance-bookings.md)
#### [Geschäftsdaten aus anderen Finanzsystemen importieren](across-import-data-configuration-packages.md)
### [Unternehmensdaten](admin-company-information.md)
### [Nummernserie erstellen](ui-create-number-series.md)
...
## [Analyse nach Funktionsregion](analytics-by-functional-area.md)
...
### [Anwendungs-Compliance](compliance/compliance-application-compliance.md)
### [Service-Compliance](compliance/compliance-service-compliance.md)
### [Zertifizierungen](compliance/compliance-certifications.md)
## [Service – Übersicht (nur in Englisch)](/dynamics365/business-central/dev-itpro/service-overview?toc=/dynamics365/business-central/toc.json)
...
##### [Benutzerzugriffs-Flow](admin-access-with-m365-license-flow.md)
...
##### [Benutzer gemäss Lizenzen erstellen](ui-how-users-permissions.md)
##### [Benutzern und Gruppen Berechtigungen zuweisen](ui-define-granular-permissions.md)
...
#### [AMC Banking 365 Fundamentals-Erweiterung einrichten](ui-extensions-amc-banking.md)
...
### [In Microsoft Dynamics 365 Field Service integrieren](admin-integrate-field-service.md)
...
## [Entfernte oder veraltete Features](/dynamics365/business-central/dev-itpro/upgrade/deprecated-features-w1?toc=/dynamics365/business-central/toc.json)
# Copilot- und KI-Funktionen
## [Informationen zu Copilot in Business Central](copilot-overview.md)
...
### [Häufig gestellte Fragen zum Chat mit Copilot](chat-with-copilot-faq.md?toc=/dynamics365/business-central/toc.json)
### [Häufig gestellte Fragen zur verantwortungsvollen KI für den Chat mit Copilot](faqs-chat-with-copilot.md?toc=/dynamics365/business-central/toc.json)
...
### [Häufig gestellte Fragen zu Verkaufszeilenvorschlägen mit Copilot](faq-sales-suggest-sales-lines-with-copilot.md)
...
## [Häufig gestellte Fragen zu Vorschlägen für Marketingtexte](faqs-marketing-text.md)
## [Häufig gestellte Fragen zu Verkaufszeilenvorschlägen mit Copilot (Vorschauversion)](faq-sales-suggest-sales-lines-with-copilot.md)
## [Häufig gestellte Fragen zur Zuordnung von E-Belegen zu Bestellungen mit Copilot (Vorschauversion)](faqs-map-edocuments.md)
