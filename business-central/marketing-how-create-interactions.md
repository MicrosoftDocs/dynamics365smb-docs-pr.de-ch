...
ms.author: jswymer
---
# <a name="create-interactions-on-contacts-and-segments" />Erstellen von Aktivitäten zu Kontakten und Segmenten
...
## <a name="to-create-an-interaction" />So erstellen Sie eine Aktivität
...
## <a name="to-finish-and-delete-postponed-interactions" />Beenden und Löschen von zurückgestellten Aktivitäten
1. Öffnen Sie den Kontakt, den Verkäufer oder den Aktivitätenprotokollposten.
...
## <a name="to-create-an-interaction-on-a-segment" />So erstellen Sie eine Aktivität für ein Segment
