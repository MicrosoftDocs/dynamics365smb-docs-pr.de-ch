...
In diesem Artikel erlernen Sie einige der Grundlagen zum Anzeigen von Power BI-Berichten, einschliesslich Scorecards, in [!INCLUDE [prod_short](includes/prod_short.md)].
...
Das Verbinden mit Power BI erfolgt auf ähnliche Weise wie bei [!INCLUDE [prod_short](includes/prod_short.md)] online. Auf der Seite **MICROSOFT ENTRA-SERVICEBERECHTIGUNGEN** werden Sie jedoch möglicherweise aufgefordert, Zugriff auf die Power BI-Dienste zu gewähren. Um den Zugriff zu gewähren, wählen Sie **Azure Services autorisieren** und dann **Akzeptieren** aus.
