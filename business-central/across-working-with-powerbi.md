...
4. Auf der nächsten Seite [!INCLUDE[prod_short](includes/prod_short.md)] lädt jetzt einen Demo-Bericht auf Power BI hoch. Dies dauert einige Minuten, daher erfolgt dies im Hintergrund. Um das Setup abzuschliessen, wählen Sie **Weiter** und dann **Fertig** aus.
