...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a>Mit Power BI-Berichten in [!INCLUDE [prod_short](includes/prod_short.md)] arbeiten
...
### <a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a>Power BI registrieren
...
## <a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect"></a>Mit Power BI verbinden – nur ein Mal
...
#### <a name="from--on-premises"></a><a name="from--on-premises"></a>Aus [!INCLUDE [prod_short](includes/prod_short.md)] on-premises
...
## <a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a>Mit Power BI-Berichten arbeiten

### <a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a>Berichte auf Listenseiten anzeigen
...
### <a name="switch-reports"></a><a name="switch-reports"></a>Berichte wechseln
...
### <a name="get-more-reports"></a><a name="get-more-reports"></a>Weitere Berichte erhalten
...
### <a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a>Berichte verwalten und ändern
...
### <a name="upload-reports"></a><a name="upload-reports"></a><a name="upload"></a>Berichte hochladen
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a>Auf der Seite „Bericht auswählen“ auf einer Listenseite wird kein Bericht angezeigt
