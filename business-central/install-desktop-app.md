...
ms.author: jswymer
---
# <a name="get-business-central-desktop-app" />Business Central-App auf den Desktop holen
...
## <a name="why-use-the-app" />Warum die App verwenden?
...
## <a name="install-the-app-for-business-central-online" />Installieren Sie die App für Business Central online
...
### <a name="from-microsoft-store" />Aus dem Microsoft Store
...
### <a name="from-the-browser" />Über den Browser
...
## <a name="install-the-app-for-business-central-on-premises" />Installieren Sie die App für Business Central vor Ort
