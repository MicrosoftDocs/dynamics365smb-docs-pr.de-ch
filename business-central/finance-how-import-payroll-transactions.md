...
ms.author: edupont
---
# <a name="importing-payroll-transactions"></a><a name="importing-payroll-transactions"></a><a name="importing-payroll-transactions"></a>Importieren von Transaktionen der Gehaltsabrechnung
...
## <a name="to-import-a-payroll-file"></a><a name="to-import-a-payroll-file"></a><a name="to-import-a-payroll-file"></a>Um eine Lohndatei zu importieren
