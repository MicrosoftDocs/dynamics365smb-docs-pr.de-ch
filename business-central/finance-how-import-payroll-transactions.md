...
ms.author: edupont
---
# <a name="importing-payroll-transactions" />Importieren von Transaktionen der Gehaltsabrechnung
...
## <a name="to-import-a-payroll-file" />Um eine Lohndatei zu importieren
