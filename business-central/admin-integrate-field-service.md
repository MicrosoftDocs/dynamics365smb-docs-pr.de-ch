...
Sie müssen die Field Service Integration-App von  [AppSource](https://go.microsoft.com/fwlink/?linkid=2277917) herunterladen und installieren [!INCLUDE [prod_short](includes/prod_short.md)].
...
Nachdem Sie eine Verbindung zu Dataverse und Sales hergestellt haben, können Sie Ihre Integration zu [!INCLUDE [field-service-short](includes/field-service-short.md)] einrichten.

* Laden Sie die Field Service Integration-App herunter und installieren Sie sie von [AppSource](https://go.microsoft.com/fwlink/?linkid=2277917). Suchen Sie anschließend auf der Seite  **Erweiterungsverwaltung**  nach der App „Field Service Integration“ und wählen Sie die Aktion  **Einrichten**  aus, um die unterstützte Einrichtung Anleitung auszuführen.
* Wählen Sie auf der Seite **Unterstützte Einrichtung** in [!INCLUDE [prod_short](includes/prod_short.md)] **Integration zu Dynamics 365 Field Service einrichten** aus, um die Anleitung zur unterstützten Einrichtung auszuführen.

In diesem Abschnitt werden die wichtigsten Einstellungen in der Anleitung beschrieben.
