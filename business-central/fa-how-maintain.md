...
Instandhaltungskosten sind Betriebsausgaben für Massnahmen zur Erhaltung des Zustands Ihrer Anlagen. Im Gegensatz zu Kapitalerhöhungen erhöht die Instandhaltung nicht den Wert Ihrer Anlagen.
...
## <a name="post-maintenance-costs-from-a-fixed-asset-gl-journal"></a>Wartungskosten aus einem Anlagen-Fibu-Erfassungsjournal buchen
...
3. Stellen Sie auf der Seite **Abschreibungsbuchkarte** sicher, dass das Kontrollkästchen **Wartung** nicht aktiviert ist, damit Sie keine Wartungskosten im Fibuposten buchen.
...
4. Geben Sie im Feld **Nr.** die Anlage aus, und geben Sie dann die Menge und die Kosten an.
