...
ms.author: jswymer
---
# <a name="welcome-to-" />Willkommen bei [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="see-related-microsoft-learn-training" />Das dazugehörige Training finden Sie unter [Microsoft Learn Training](/training/dynamics365/business-central?WT.mc_id=dyn365bc_landingpage-docs)
