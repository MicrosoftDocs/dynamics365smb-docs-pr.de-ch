...
ms.author: edupont
---
# <a name="reconcile-payments-that-cannot-be-applied-automatically" />Zahlungen abstimmen, die nicht automatisch ausgeglichen werden können
...
## <a name="to-reconcile-payments-that-cannot-be-applied-automatically" />Abstimmen von Zahlungen, die nicht automatisch übernommen werden können
