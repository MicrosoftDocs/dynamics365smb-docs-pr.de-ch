...
#### <a name="-greater-than"></a><a name="-greater-than"></a>(>) Grösser als

|Beispielausdruck|Angezeigte Datensätze|  
|-----------------------|-----------------------|  
|`>1200`|Datensatznummern grösser als 1200|  

#### <a name="-greater-than-or-equal-to"></a><a name="-greater-than-or-equal-to"></a>(>=) Grösser oder gleich
...
#### <a name="-case-insensitive"></a><a name="-case-insensitive"></a>(@) Gross-/Kleinschreibung beachten
