...
ms.author: bholtorf
---
# <a name="the-troubleshooting-fa-ledger-entries-extension" />Die Erweiterung zur Problembehebung bei Anlagenposten
...
## <a name="troubleshooting-fixed-asset-ledger-entries" />Problembehebung bei Anlagenposten
