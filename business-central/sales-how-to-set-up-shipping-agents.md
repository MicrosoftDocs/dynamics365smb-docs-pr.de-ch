...
ms.author: edupont
---
# <a name="set-up-shipping-agents"></a><a name="set-up-shipping-agents"></a>Zusteller einrichten
...
## <a name="to-set-up-a-shipping-agent"></a><a name="to-set-up-a-shipping-agent"></a>So richten Sie einen Spediteur ein
