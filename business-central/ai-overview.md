...
---
# <a name="overview-of-ai-powered-item-marketing-text-preview-with-copilot" />Überblick über KI-gestützte Marketingtexte für Artikel (Vorschauversion) mit Copilot
...
## <a name="what-is-ai-powered-item-marketing-text-with-copilot" />Was ist KI-gestützter Marketingtext für Artikel mit Copilot
...
## <a name="where-its-used" />Wo es verwendet wird
...
## <a name="why-and-how-to-use-it" />Warum sollte ich es verwenden und wie geht es
...
## <a name="current-limitations" />Welche Einschränkungen gelten derzeit?
