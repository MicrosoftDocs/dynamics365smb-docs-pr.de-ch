...
---
# <a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a>Überwachen des Status und der Leistung
...
## <a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a>WIP-Methode für ein Projekt erstellen
...
## <a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a>Eine WIP-Methode für ein Projekt definieren
...
### <a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a>Eine WIP-Methode für eine Projektaufgabe definieren
...
## <a name="calculate-wip"></a><a name="calculate-wip"></a>WIP berechnen
...
## <a name="post-wip"></a><a name="post-wip"></a>WIP buchen
...
## <a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a>Berechnen und Buchen von Projekt-Abschlussposten
...
## <a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a>Projektbuchungsposten anzeigen
...
## <a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/paths/calculate-post-job-wip/)
