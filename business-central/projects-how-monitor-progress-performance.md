...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell me-Funktion") Symbol. Geben Sie **WIP-Methoden für Projekt** ein und wählen Sie dann den zugehörigen Link aus.  
...
4. Um diese neue Methode zur Standardmethode zu machen, wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell me-Funktion") Symbol. Geben Sie **Projekteinrichtung** ein und wählen Sie den zugehörigen Link aus.  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell me-Funktion") Symbol. Geben Sie **Projekte** ein und wählen Sie den zugehörigen Link aus.
2. Wählen Sie die Aktion **Neu** aus. Erfahren Sie mehr unter [Projekte erstellen](projects-how-create-jobs.md).  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **WIP berechnen Projekt** ein und wählen Sie dann den zugehörigen Link aus.  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **WIP nach Sachkonten Projekt** ein und wählen Sie dann den zugehörigen Link aus.  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Projektjournale** ein und wählen Sie den zugehörigen Link aus.
...
[Exemplarische Vorgehensweise: Berechnen des Umlaufbestandes für ein Projekt](walkthrough-calculating-work-in-process-for-a-job.md)
