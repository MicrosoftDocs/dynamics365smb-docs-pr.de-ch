...
---
# <a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a>Überwachen des Status und der Leistung
...
## <a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a>WIP-Methode für ein Projekt erstellen
...
4. Um diese neue Methode zur Standardmethode zu machen, wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell me-Funktion") Symbol. Geben Sie **Projekt Einrichtung** ein, wählen Sie den zugehörigen Link.  
5. Wählen Sie im Feld **WIP-Standardmethode** die Methode aus der Liste aus.

## <a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a>Eine WIP-Methode für ein Projekt definieren
...
2. Wählen Sie die Aktion **Neu** aus. Erfahren Sie mehr unter [Arbeitsplätze schaffen](projects-how-create-jobs.md).  
...
### <a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a>Eine WIP-Methode für eine Projektaufgabe definieren

Sie können eine WIP-Methode für eine Arbeitsaufgabe definieren, einige Arbeitsaufgaben von der WIP-Berechnung ausschliessen oder Aufgaben gruppieren, die zusammen berechnet werden sollen. 
...
## <a name="calculate-wip"></a><a name="calculate-wip"></a><a name="calculate-wip"></a>WIP berechnen
...
## <a name="post-wip"></a><a name="post-wip"></a><a name="post-wip"></a>WIP buchen
...
## <a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a>Berechnen und Buchen von Projekt-Abschlussposten
...
## <a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a>Projektbuchungsposten anzeigen
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Projektjournale** ein und wählen Sie den zugehörigen Link.
...
## <a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/paths/calculate-post-job-wip/)
