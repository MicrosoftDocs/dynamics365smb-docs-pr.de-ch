...
1. Wählen Sie das Symbol ![Glühbirne, das die Funktion Tell Me](media/ui-search/search_small.png "Tell Me-Funktion") öffnet, geben Sie **Jobs** ein und wählen Sie dann den entsprechenden Link.  
...
8. Füllen Sie auf der Seite **WIP nach Sachkonten Projekt buchen** aus und füllen Sie die Felder wie erforderlich aus.  
     ...
     Die WIP-Fibuposten, die beim Ausführen der Stapelverarbeitung erstellt wurden, weisen nun ein Häkchen im Feld **Auftrag abgeschlossen** auf, um anzugeben, dass es sich hierbei um Abschlussposten handelt.
