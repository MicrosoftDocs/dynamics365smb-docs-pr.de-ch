...
ms.author: edupont
---
# <a name="service-posting" />Servicebuchung
...
## <a name="to-view-information-about-a-posted-service-document" />So zeigen Sie zusätzliche Informationen zu einem gebuchten Servicebeleg an
