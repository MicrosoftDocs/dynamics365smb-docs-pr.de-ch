...
# <a name="the-sales-and-inventory-forecast-extension"></a><a name="the-sales-and-inventory-forecast-extension"></a>Die Verkaufs- und Bestandprognosen-Erweiterung
...
## <a name="setting-up-forecasting"></a><a name="setting-up-forecasting"></a>Einrichten der Planung
...
## <a name="use-the-forecasts"></a><a name="use-the-forecasts"></a>Planungen verwenden
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/use-sales-inventory-forecast-extension/)
