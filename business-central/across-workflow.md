...
## <a name="approval-workflows"></a><a name="approval-workflows"></a><a name="approval-workflows"></a>Genehmigungsworkflows
...
| Aktivieren Sie Genehmigungsworkflows, reagieren Sie auf Workflowbenachrichtigungen, einschliesslich Anfragegenehmigungen und Anforderungen, um einen Workflowschritt auszuführen. Archivieren und löschen Sie Workflows. | [Artikelgenehmigungsworkflow verwenden](across-use-workflows.md) |
