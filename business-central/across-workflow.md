...
* Power Automate-Flows
  ...
  * Instant Flows, die manuell durch das Aktionsmenü **Automatisieren** von Listen, Karten und Dokumentenseiten ausgelöst werden.
...
Beispiele für Ereignisse in Genehmigungs-Workflows sind die Erstellung von Verkaufs- oder Kaufaufträgen/Offerten/Rechnungen, Preisänderungen, Lieferanten- oder Kundenbearbeitungen und mehr.
...
| Aktivieren Sie Genehmigungsworkflows, reagieren Sie auf Workflowbenachrichtigungen, einschliesslich Anfragegenehmigungen und Anforderungen, um einen Workflowschritt auszuführen. Archivieren und löschen Sie Workflows. | [Genehmigungsworkflows verwenden](across-use-workflows.md) |
