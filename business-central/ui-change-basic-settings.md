...
-   Im Mittelpunkt finden Sie die Kacheln **Aktivitäten**. Aktivitäten zeigen aktuelle Daten an und können geklickt werden oder getippt werden, um detailliertere Informationen anzuzeigen. Die zentralen Leistungs-Indikatoren können eingerichtet werden, um ein ausgewähltes Diagramm für eine visuelle Darstellung anzuzeigen, zum Beispiel, Cashflow oder Einnahmen und Ausgaben. Sie können eine Liste von Lieblingsdebitoren auf der Homepage auch für Konten einrichten, mit denen Sie häufig Geschäfte tätigen oder denen Sie besondere Aufmerksamkeit schenken müssen.
...
> [!TIP]  
>   Tippen Sie **a** um rasch das Arbeitsdatum in ein Datumsfeld einzugeben. Schreiben Sie **h**, um rasch das aktuelle Datum in ein Datumsfeld einzugeben.
