...
ms.author: jswymer
---
# <a name="change-basic-settings"></a><a name="change-basic-settings"></a><a name="change-basic-settings"></a>Ändern von grundlegenden Einstellungen
...
## <a name="company"></a><a name="company"></a><a name="company"></a><a name="company"></a>Unternehmen
...
## <a name="work-date"></a><a name="work-date"></a><a name="work-date"></a><a name="work-date"></a>Arbeitsdatum

Das am häufigsten verwendete Arbeitsdatum ist das heutige Datum. Um Aufgaben wie das Abschliessen von Transaktionen für ein Datum auszuführen, das nicht das aktuelle Datum ist, müssen Sie vielleicht vorübergehend das Datum ändern.
...
### <a name="work-date-indication"></a><a name="work-date-indication"></a><a name="work-date-indication"></a>Arbeitsdatumsangabe
...
## <a name="language"></a><a name="language"></a><a name="language"></a><a name="language"></a> Sprache
...
## <a name="time-zone"></a><a name="time-zone"></a><a name="time-zone"></a>Zeitzone
...
## <a name="notifications"></a><a name="notifications"></a><a name="notifications"></a>Benachrichtigungen
...
## <a name="teaching-tips"></a><a name="teaching-tips"></a><a name="teaching-tips"></a>Unterrichtstipps
