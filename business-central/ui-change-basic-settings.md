...
ms.author: jswymer
---
# <a name="change-basic-settings" />Ändern von grundlegenden Einstellungen
...
### <a name="change-the-role" />Die Rolle ändern
...
### <a name="work-date-indication" />Arbeitsdatumsangabe
...
## <a name="notifications" />Benachrichtigungen
...
## <a name="teaching-tips" />Unterrichtstipps
