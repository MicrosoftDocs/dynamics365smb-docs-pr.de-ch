...
ms.author: jswymer
---
# <a name="change-basic-settings"></a><a name="change-basic-settings"></a>Ändern von grundlegenden Einstellungen
...
## <a name="role"></a><a name="role"></a><a name="role-center"></a>Rolle
...
### <a name="change-the-role"></a><a name="change-the-role"></a>Die Rolle ändern
...
## <a name="company"></a><a name="company"></a><a name="company"></a>Unternehmen
...
### <a name="work-date-indication"></a><a name="work-date-indication"></a>Arbeitsdatumsangabe
...
## <a name="language"></a><a name="language"></a><a name="language"></a> Sprache
...
## <a name="time-zone"></a><a name="time-zone"></a>Zeitzone
...
## <a name="teaching-tips"></a><a name="teaching-tips"></a>Unterrichtstipps
