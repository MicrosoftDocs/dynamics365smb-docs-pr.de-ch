...
* Für Onlineversionen gibt es mehr als [40 lokalisierte Länder-/Regionsversionen](/dynamics365/business-central/dev-itpro/compliance/apptest-countries-and-translations?toc=/dynamics365/business-central/toc.json), die Sie als Erweiterungen von Microsoft AppSource installieren können.  
* Für lokale Versionen sind [Länder-/Regionsversionen](/azure/architecture/solution-ideas/articles/business-central) entweder als von Microsoft lokalisierte Versionen oder als von Partnern betriebene Zusatzlokalisierungen verfügbar.
