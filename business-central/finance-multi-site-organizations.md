...
# <a name="business-central-for-multi-site-and-international-organizations" />Business Central für Unternehmen mit mehreren Standorten und internationale Organisationen
...
## <a name="integrating-the-headquarter-company-and-the-sites" />Integration der Firma in der Zentrale und der Standorte
...
## <a name="meet-the-needs-of-domestic-and-international-sites" />Erfüllen Sie die Bedürfnisse von inländischen und internationalen Standorten
...
## <a name="consolidate-financial-data" />Finanzdaten konsolidieren
...
## <a name="share-business-insight-with-integrated-analytics" />Teilen Sie Business Insights mit integrierten Analysen
...
## <a name="exchange-data-using-apis-and-xmlports" />Daten mithilfe von APIs und XMLports austauschen
...
## <a name="promote-an-efficient-intercompany-supply-chain" />Fördern Sie eine effiziente Intercompany-Lieferkette
...
## <a name="respond-quickly-to-new-business-conditions" />Reagieren Sie schnell auf neue Geschäftsbedingungen
