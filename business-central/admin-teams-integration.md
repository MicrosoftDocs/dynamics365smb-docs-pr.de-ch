...
## <a name="installing-the-business-central-app-by-using-centralized-deployment" />Installieren der Business Central-App mit Hilfe der zentralen Bereitstellung
...
## <a name="managing-privacy-and-compliance" />Datenschutz und Compliance verwalten
...
### <a name="restricting-sharing-of-cards" />Beschränken des Kartenaustauschs
...
### <a name="responding-to-data-requests" />Antworten auf Datenenanforderungen
...
## <a name="show-or-hide-record-data-on-cards" />Datensatzdaten auf Karten ein- oder ausblenden
