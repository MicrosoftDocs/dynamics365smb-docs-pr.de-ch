...
Als Teams-Administrator können Sie alle Apps für Ihre Organisation verwalten, einschliesslich der [!INCLUDE [prodshort](includes/prodshort.md)]-App. Sie können die [!INCLUDE [prodshort](includes/prodshort.md)]-App für Ihr Unternehmen genehmigen oder installieren, die Installation der App durch Benutzer blockieren und vieles mehr.
...
- Codeunit **2718 Seitenzusammenfassungsanbieter** wird als Webdienst veröffentlicht:
    ...
    Diese Codeunit wird standardmässig als Webdienst veröffentlicht. Die Codeunit ist Teil der [!INCLUDE [prodshort](includes/prodshort.md)]-Systemanwendung. Sie wird verwendet, um die Felddaten für eine [!INCLUDE [prodshort](includes/prodshort.md)]-Seite abzurufen, die einer Teams-Unterhaltung hinzugefügt wurde. 

- Benutzerberechtigungen:

    Die Seiten und Daten, die Benutzer in einer Teams-Unterhaltung anzeigen und bearbeiten können, werden grösstenteils durch deren Berechtigungen in [!INCLUDE [prodshort](includes/prodshort.md)] gesteuert.
