...
# <a name="managing-microsoft-teams-integration-with-"></a><a name="managing-microsoft-teams-integration-with-"></a>Verwalten der Microsoft Teams-Integration mit [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="in-microsoft-teams"></a><a name="in-microsoft-teams"></a>In Microsoft Teams

### <a name="minimum-requirements"></a><a name="minimum-requirements"></a>Mindestanforderungen
...
### <a name="managing-the--app-optional"></a><a name="managing-the--app-optional"></a>Verwalten der [!INCLUDE [prod_short](includes/prod_short.md)] App (optional)
...
## <a name="in-"></a><a name="in-"></a>In [!INCLUDE [prod_short](includes/prod_short.md)]

### <a name="minimum-requirements-1"></a><a name="minimum-requirements-1"></a>Mindestanforderungen
...
## <a name="installing-the-business-central-app-by-using-centralized-deployment"></a><a name="installing-the-business-central-app-by-using-centralized-deployment"></a>Installieren der Business Central-App mit Hilfe der zentralen Bereitstellung
...
## <a name="managing-privacy-and-compliance"></a><a name="managing-privacy-and-compliance"></a>Datenschutz und Compliance verwalten
...
### <a name="understanding-where--cards-are-stored"></a><a name="understanding-where--cards-are-stored"></a>Verstehen wo [!INCLUDE [prod_short](includes/prod_short.md)] Karten gespeichert werden
...
### <a name="restricting-sharing-of-cards"></a><a name="restricting-sharing-of-cards"></a>Beschränken des Kartenaustauschs
...
### <a name="responding-to-data-requests"></a><a name="responding-to-data-requests"></a>Antworten auf Datenenanforderungen
...
## <a name="show-or-hide-record-data-on-cards"></a><a name="show-or-hide-record-data-on-cards"></a>Datensatzdaten auf Karten ein- oder ausblenden
