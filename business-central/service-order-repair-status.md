...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs" />Einrichten von Status für Serviceaufträge und Reparaturen
...
## <a name="to-set-up-service-status-priorities" />So richten Sie Servicestatusprioritäten ein
...
## <a name="to-set-up-a-repair-status" />So richten Sie einen Reparaturstatus ein
