...
## <a name="to-calculate-depreciation-automatically" />So berechnen Sie Abschreibung automatisch
...
## <a name="to-post-depreciation-manually-from-the-fixed-asset-gl-journal" />So buchen Sie eine Abschreibung aus dem Anlagen Fibu Erf.-Journal
...
## <a name="to-calculate-allocations-in-the-fixed-asset-gl-journal" />So berechnen Sie Verteilungen in Anlagen Fibu Erf.-Journalen
