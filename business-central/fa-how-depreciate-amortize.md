...
2. Wählen Sie **Zugehörig**, **Buchungsgruppe**, **Zuteilungen** und dann **Abschreibung** aus.
3. Füllen Sie für jede Buchungsgruppe die Fibukonten und die entsprechenden Zuteilungsprozentsätze aus, und schliessen Sie anschliessend die Seite.
4. Wählen Sie als Nächstes die ![Glühbirne, die die „Wie möchten Sie weiter verfahren-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Anlagen-Fibu-Erfassungsjournale** ein, und wählen Sie dann den zugehörigen Link.
5. Geben Sie die Anlage und die entsprechende Anlagenbuchungsgruppe ein, und das Abschreibungsbuch bestimmt die Zuteilungspositionen.
6. Wählen Sie die Aktion **Buchen**, um das Journal zu buchen.
