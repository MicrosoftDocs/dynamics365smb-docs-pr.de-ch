...
ms.author: edupont
---
# <a name="onboard-users-with-checklists" />Onboarding von Benutzern mit Checklisten
...
## <a name="to-add-an-item-to-the-checklist" />So fügen Sie der Checkliste ein Element hinzu
