...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Exemplarische Vorgehensweise: Einrichten und Nutzen eines Einkaufsanfrage-Genehmigungsworkflows
...
### <a name="set-up-approval-users"></a>Einrichten von Genehmigungsbenutzern
...
### <a name="set-up-notifications"></a>Einrichten von Benachrichtigungen
...
## <a name="create-the-approval-workflow"></a>Erstellen des Genehmigungsworkflows
