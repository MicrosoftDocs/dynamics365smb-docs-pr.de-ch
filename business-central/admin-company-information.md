...
Nachdem Sie die Informationen ausgefüllt haben, können Sie die Seite schliessen.  
...
Wenn es mehr als eine Firma oder eine Umgebung gibt, sehen Sie den Firmenumschalter oben rechts in der App-Leiste, in der Nähe des Symbols für die Suche. Standardmässig verwendet der Firmenwechsler ein standardmässiges Symbol der Firma, wie ![Firmensymbol Launcher.](media/ui-experience/company-icon.png "Zeigt das Symbol für den Wechsel der Firma an, das verwendet wird, wenn es nur eine Umgebung gibt") und ![Firmen-Symbol-mult-env](media/ui-experience/company-icon-multi-env.png "Zeigt das Symbol für den Wechsler der Firma an, wenn es mehrere Umgebungen gibt").
