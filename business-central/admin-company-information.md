...
# <a name="company-information-overview"></a><a name="company-information-overview"></a><a name="company-information-overview"></a>Übersicht über Unternehmensdaten
...
## <a name="working-with-multiple-companies"></a><a name="working-with-multiple-companies"></a><a name="working-with-multiple-companies"></a>Arbeiten mit mehreren Firmen
...
## <a name="display-a-company-badge"></a><a name="display-a-company-badge"></a><a name="display-a-company-badge"></a><a name="badge"></a>Ein Abzeichen für eine Firma anzeigen
...
## <a name="change-company-display-name"></a><a name="change-company-display-name"></a><a name="change-company-display-name"></a>Anzeigename der Firma ändern
...
## <a name="experience"></a><a name="experience"></a><a name="experience"></a>Erfahrung
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/create-new-companies-dynamics-365-business-central/)
