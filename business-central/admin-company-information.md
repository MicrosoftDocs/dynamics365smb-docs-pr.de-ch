...
Es gibt einige Funktionen, mit denen Sie während der Arbeit zwischen den Firmen wechseln können, z. B. den Firmenwechsler (Ctrl+O). Erfahren Sie mehr unter [Zu einer anderen Firma oder Umgebung wechseln](ui-organization-switch.md).
...
2. Wenn Sie fertig sind, aktualisieren Sie den Browser (drücken Sie Ctrl+F5), um das Abzeichen im Client zu aktualisieren.  
