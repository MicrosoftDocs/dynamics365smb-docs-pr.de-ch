...
## <a name="to-set-up-a-gl-account-for-deferral"></a>So richten Sie ein Fibukonto für Abgrenzungen ein
...
Für beide Arten von Abgrenzung wählen Sie im Feld **Art** **Bilanz** aus und benennen Sie die Konten entsprechend, wie "Nicht verdiente Erträge" für abgegrenzte Einnahmen und "nicht bezahlte Ausgaben" für abgegrenzte Ausgaben.
...
4. Geben Sie Feld **Berechnungsmethode** an, wie das Feld **Betrag** für jede Periode im Fenster **Abgrenzungsplan** berechnet wird. Sie haben die Wahl zwischen den folgenden Optionen:
   ...
   * **Benutzerdefiniert**: Die regelmässig Abgrenzungsbeträge werden nicht berechnet. Sie müssen das Feld **Betrag** für jede Periode im Abgrenzungsplanfenster manuell ausfüllen. Weitere Informationen finden Sie im Abschnitt „So ändern Sie einen Abgrenzungsplan aus einer Verkaufsrechnung”.
...
4. Ändern Sie im Fenster **Abgrenzungsplan** die Einstellungen im Kopf oder die Werte in den Zeilen, zum Beispiel, um den Betrag bis zu einer zusätzlichen Buchhaltungsperiode zurückzustellen.
...
## <a name="to-preview-how-deferred-revenues-or-expenses-will-be-posted-to-the-general-ledger"></a>Um anzuzeigen, wie die Abgrenzungsausgaben oder -einnahmen im Fibuposten gebucht werden
> [!NOTE]  
...
Zu einem bestimmten Aufschubkonto zu buchende Fibuposten, beispielsweise „Nicht verdiente Erträge”, werden von der Beschreibung bezeichnet, die Sie im Feld **Periodenbeschreibung** in der Abgrenzungsvorlage eingegeben haben, beispielsweise „Einnahmeaufschub für Februar 2016“.

## <a name="to-review-posted-deferrals-in-the-sales-deferral-summary-report"></a>So überprüfen Sie gebuchte Abgrenzungen im Bericht „Verkaufsabgrenzung – Zusammenfassung”
> [!NOTE]  
...
1. Wählen Sie das Symbol ![Nach Seite oder Bericht suchen] (media/ui-search/search_small.png "Nach Seite oder Bericht suchen")und geben **Verkaufsabgrenzung – Zusammenfassung** ein. Wählen Sie dann den zugehörigen Link aus.
2. Geben Sie im Fenster **Verkaufsabgrenzung – Zusammenfassung** im Feld **Saldo ab** das Datum ein, bis zu welchem Sie abgegrenzte Einnahmen anzeigen möchten.
