...
##### <a name="table-482-reclas-dimension-set-buffer"></a>Tabelle 482 Umlag.-Dimensionssatzpuffer  
 Tabelle 482 **Umlag.-Dimensionssatzpuffer** ist eine neue Tabelle. Diese Tabelle wird verwendet, um eine Dimensionssatz-ID zu ändern Es ist erforderlich, wenn Sie einen Dimensionswertcode und einen neuen Dimensionswertcode, beispielsweise in der Tabelle **Umlagerungs Erf.-Journal,** bearbeiten.  
...
#### <a name="changes-to-table-83-item-journal-line"></a>Änderungen an der Artikel Erf.-Journalzeile der Tabelle-83  
 Zwei neue Felder wurden zu Tabelle 83 **Artikel Erf.-Journalzeile** hinzugefügt.  
