...
ms.author: edupont
---
# <a name="use-ocr-to-turn-pdf-and-image-files-into-electronic-documents" />Verwenden von OCR, um PDF und Bilddateien in elektronische Belege umzuwandeln
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-from-the-incoming-documents-page" />So senden Sie eine PDF- oder Bilddatei über die Seite Eingehende Belege an den OCR-Dienst
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-by-email" />So senden Sie eine PDF- oder Bilddatei per E-Mail zum OCR-Dienst
...
## <a name="to-receive-the-resulting-electronic-document-from-the-ocr-service" />So erhalten Sie den resultierenden elektronischen Beleg vom OCR-Dienst
...
## <a name="to-create-a-purchase-invoice-from-an-electronic-document-received-from-the-ocr-service" />Eine Einkaufsrechnung aus einem vom OCR-Dienst erhaltenen elektronischen Beleg erstellen.
...
### <a name="to-map-text-on-an-incoming-document-to-a-specific-vendor-account" />So ordnen Sie Text auf einem eingehenden Beleg einem bestimmten Kreditorkonto zu
...
## <a name="to-handle-errors-when-receiving-electronic-documents" />Behandeln von Fehlern beim Erhalt von elektronischen Belegen
...
## <a name="to-train-the-ocr-service-to-avoid-errors" />So schulen Sie den OCR-Dienst, um Fehler zu vermeiden
