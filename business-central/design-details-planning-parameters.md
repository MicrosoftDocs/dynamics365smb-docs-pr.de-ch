...
---
# <a name="design-details-planning-parameters"></a><a name="design-details-planning-parameters"></a>Designdetails: Planungsparameter
...
## <a name="define-whether-the-item-is-planned"></a><a name="define-whether-the-item-is-planned"></a>Festlegen, ob der Artikel geplant ist
...
## <a name="define-when-to-reorder"></a><a name="define-when-to-reorder"></a>Definieren Sie, wann neu bestellt werden soll
...
## <a name="define-how-much-to-reorder"></a><a name="define-how-much-to-reorder"></a>Definieren Sie, wie viel neu bestellt werden soll
...
## <a name="optimize-when-and-how-much-to-reorder"></a><a name="optimize-when-and-how-much-to-reorder"></a>Optimieren des Zeitpunktes und der Menge bei einer Neubestellung
...
## <a name="modify-the-supply-orders"></a><a name="modify-the-supply-orders"></a>Ändern Sie die Beschaffungsaufträge
...
## <a name="delimit-the-item"></a><a name="delimit-the-item"></a>Abgrenzen des Artikels
...
## <a name="use-low-level-codes-to-manage-derived-demand"></a><a name="use-low-level-codes-to-manage-derived-demand"></a>Verwenden von Stücklistenebenen, um den abgeleiteten Bedarf zu verwalten
