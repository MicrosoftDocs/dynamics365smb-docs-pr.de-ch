...
ms.author: bholtorf
---
# <a name="setting-up-cash-flow-analysis" />Aufstellung Cashflow-Analyse
...
## <a name="the-cash-cycle-and-income--expense-charts" />Diagramme Geldumlauf und Einnahmen und Ausgaben
...
## <a name="set-up-the-cash-flow-chart" />Richtet den Cashflow-Kontenplan ein.
...
## <a name="set-up-cash-flow-forecasts" />Richtet Cashflowplanungen ein
...
#### <a name="receivables" />Forderungen
...
#### <a name="payables" />Verbindlichkeiten
