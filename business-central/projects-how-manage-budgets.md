...
ms.author: edupont
---
# <a name="manage-job-budgets" />Verwalten von Projektbudgets
...
## <a name="a-namejobbudgetcostsa-to-estimate-the-budgeted-costs-for-a-job" /><a name="JobBudgetCosts"></a> Die budgetierten Kosten für ein Projekt schätzen
...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-job-planning-lines" />Siehe verwandte [Microsoft Schulungen](/training/modules/set-up-job-planning-lines/)
