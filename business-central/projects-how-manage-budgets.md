...
ms.author: edupont
---
# <a name="manage-job-budgets"></a><a name="manage-job-budgets"></a>Verwalten von Projektbudgets
...
## <a name="to-estimate-the-budgeted-costs-for-a-job"></a><a name="to-estimate-the-budgeted-costs-for-a-job"></a><a name="JobBudgetCosts"></a> Die budgetierten Kosten für ein Projekt schätzen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/set-up-job-planning-lines/)
