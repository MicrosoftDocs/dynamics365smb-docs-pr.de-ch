...
# <a name="add-marketing-text-to-items" />Marketingtext zu Artikeln hinzufügen
...
## <a name="a-namecopilotacreate-ai-generated-marketing-text-preview-with-copilot" /><a name=copilot></a>KI-generierte Marketingtexte (Vorschauversion) mit Copilot erstellen
...
### <a name="create-first-draft-with-copilot" />Einen ersten Entwurf mit Copilot erstellen
...
### <a name="review-edit-and-save-text" />Text überprüfen, bearbeiten und speichern
...
### <a name="improve-and-tailor-text-suggestions" />Textvorschläge verbessern und anpassen
...
## <a name="create-marketing-text-from-scratch" />Marketingtexte von Grund auf neu erstellen
