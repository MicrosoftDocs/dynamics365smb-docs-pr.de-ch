...
| Entwickeln Sie ein Verständnis für den Fibuposten und den Kontenplan |[Verständnis der Fibu und des COA](finance-general-ledger.md) |
...
| Importieren Sie Gehaltstransaktionen von Ihrem Gehaltsabrechnungsanbieter in den Fibuposten. |[Lohntransaktionen importieren](finance-how-import-payroll-transactions.md)|
...
|Folgen Sie einer durchgängigen Vorgehensweise, wie Sie Kontenschema verwenden, um Cashflow-Planungen zu erstellen.|[Exemplarische Vorgehensweise: Erstellen von Cashflowplanungen mithilfe von Kontenschema](walkthrough-making-cash-flow-forecasts-by-using-account-schedules.md)|
