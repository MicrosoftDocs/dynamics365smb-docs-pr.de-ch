...
ms.locfileid: "3922733"
---
# <a name="create-contacts"></a>Kontakt erstellen
Wenn Sie eine Geschäftsbeziehung zu jemandem in einem anderen Unternehmen aufbauen, können Sie diese als Kontakt erstellen und einige Informationen über sie oder deren Unternehmen eingeben, die für die zukünftige Kommunikation hilfreich sein können. Auf der Seite **Kontaktkarte** können Sie die folgenden Arten von Kontakten erstellen:
...
Sie können den Wert des Felds **Typ** später ändern, oder Sie können die Felder im Inforegister **Vererbung** auf der Seite **Marketingeinrichtung** verwenden, um die Daten anzugeben, die zwischen einer Person und deren Unternehmen zugehörigen Unternehmen freigegeben werden. Weitere Informationen finden Sie unter [Einrichten von Kontakten](marketing-setup-contacts.md).
...
Wenn Sie Debitoren, Kreditoren und Bankkonten haben, für die Sie Kontaktkarten erstellen möchten, können Sie die Stapelverarbeitungen **Kontakte aus Debitoren/Kreditoren/Bankkonten erstellen** verwenden, um Kontakte auf der Basis von bestehenden Daten zu erstellen. Wenn Sie einen Kontakt auf diese Weise erstellen, werden die Kontaktinformationen anschliessend mit den verbundenen Debitoren-, Kreditoren- oder den Bankkontoinformationen synchronisiert. Weitere Informationen finden Sie unter [Synchronisieren von Kontakten mit Debitoren, Kreditoren und Bankkonten](marketing-create-contact-companies.md#synchronizing-contacts-with-customers-vendors-employees-and-bank-accounts).
...
Wenn Sie einen Debitor, Kreditor, Mitarbeiter oder ein Bankkonto für das Unternehmen haben, für das Sie einen Kontakt erstellen möchten, können Sie die Funktion **Erstellen als** verwenden. Wenn Sie einen Kontakt auf diese Weise erstellen, werden die Kontaktinformationen anschliessend mit den verbundenen Debitoren-, Kreditoren-, Mitarbeiter- oder den Bankkontoinformationen synchronisiert. Weitere Informationen finden Sie unter [Synchronisieren von Kontakten mit Debitoren, Kreditoren und Bankkonten](marketing-create-contact-companies.md#synchronizing-contacts-with-customers-vendors-employees-and-bank-accounts).
...
## <a name="to-link-a-contact-to-an-existing-customer-vendor-employee-or-bank-account"></a>So verknüpfen Sie einen Kontakt mit einem vorhanden Debitor, Kreditor, Mitarbeiter oder Bankkonto
