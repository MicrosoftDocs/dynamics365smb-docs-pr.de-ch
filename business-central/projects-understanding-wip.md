...
ms.author: edupont
---
# <a name="understanding-wip-methods-in-project-management" />Grundlegendes zu WIP-Methoden im Projektmanagement
...
## <a name="see-related-microsoft-training" />Siehe verwandte [Microsoft Schulungen](/training/paths/calculate-post-job-wip/)
