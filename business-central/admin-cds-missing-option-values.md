...
# <a name="handling-missing-option-values"></a><a name="handling-missing-option-values"></a>Behandlung fehlender Optionswerte
> [!NOTE]
...
### <a name="extending-option-sets-in-"></a><a name="extending-option-sets-in-"></a>Optionssätze in [!INCLUDE[prod_short](includes/prod_short.md)] erweitern
...
### <a name="update--option-mapping"></a><a name="update--option-mapping"></a>Update [!INCLUDE[prod_short](includes/cds_long_md.md)] Optionszuordnung
