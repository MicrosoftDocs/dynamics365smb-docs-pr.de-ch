...
> [!IMPORTANT]
> Das E-Beleg-Kernmodul ist ein Framework. Standardmässig gibt es kein Feld **Belegformat** oder **Belegintegration**. Diese Details gehören zu Lokalisierungs-Apps, da sie beide spezifisch für lokale Anforderungen sind.
...
2. Wählen Sie **Neu** und dann auf der Seite **E-Belegdienst** auf dem Inforegister **Allgemein** die Felder wie in der folgenden Tabelle beschrieben aus.
    ...
    | Belegformat | <p>Das Exportformat für die Einrichtung des elektronischen Exports.</p><p>Standardmässig gibt es in diesem Feld in Zyklus 1 keine Optionen.</p> |
...
Wenn Sie das Format **Datenaustauschdefinition** nicht verwenden, können Sie schliesslich Formate über die Zeilen **Zuordnung exportieren** und **Zuordnung importieren** konfigurieren, in denen Sie die zu verwendenden Tabellen und Felder finden und ggf. Transformationsregeln konfigurieren können.
