...
ms.author: edupont
---
# <a name="add-extended-text" />Zusatztext hinzufügen
...
## <a name="to-define-extended-text-for-an-description" />So definieren Sie Zusatztexte für eine Beschreibung
...
## <a name="to-add-an-extended-item-text-on-a-sales-order-line" />Einen erweiterten Elementtext in einer Verkaufsauftragszeile hinzufügen
