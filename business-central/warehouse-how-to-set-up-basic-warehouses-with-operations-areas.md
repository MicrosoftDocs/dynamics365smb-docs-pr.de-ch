...
## Um den Inventurprozess für Aktivitäten des internen Arbeitsgangs ausführen
...
## Um eine Standardlagerplatzstruktur in der Fertigungsregion zu definieren
...
## Um eine Standardlagerplatzstruktur in einer Montageregion zu definieren
...
### So richten Sie ein, dass eine Lagerbestandsumlagerung automatisch erstellt wird, wenn die Lagerkommissionierung für die Montageartikel erstellt wird.
...
### Um den Lagerplatz in der Montageregion einzurichten, wo Komponenten standardmässig platziert werden, bevor sie bei der Montage verbraucht werden können.
...
### Um den Lagerplatz in der Montageregion einzurichten, auf den fertige Montageartikel gebucht werden, wenn sie im Lager montiert werden.
...
### Um den Lagerplatz einzurichten, auf den fertige Montageartikel gebucht werden, wenn sie entsprechend einem verknüpftem Auftrag montiert werden.
...
## So erstellen Sie dedizierte Komponentenlagerplätze
