...
ms.author: edupont
---
# <a name="process-purchase-returns-or-cancellations" />Verarbeiten einer Einkaufsrücklieferung oder von Stornierungen
...
## <a name="inventory-costing" />Lagerkosten
...
## <a name="to-create-a-purchase-credit-memo-from-a-posted-purchase-invoice" />Eine neue Einkaufsgutschrift aus einer gebuchte Einkaufsrechnung erstellen
...
## <a name="to-create-a-purchase-credit-memo-by-copying-a-posted-purchase-invoice" />Erstellt eine neue Einkaufsgutschrift, um eine gebuchte Einkaufsrechnung zurückzusetzen.
...
## <a name="to-create-a-purchase-return-order-based-on-one-or-more-posted-purchase-documents" />Weitere Informationen finden Sie unter „Einkaufsreklamation auf einem oder mehreren gebuchten Einkaufsbelegen erstellen“.
...
## <a name="to-create-a-replacement-purchase-order-from-a-purchase-return-order" />So erstellen Sie eine Ersatzbestellung anhand von einer Reklamation
...
## <a name="to-create-a-purchase-allowance" />So erstellen Sie einen Einkaufsnachlass
...
## <a name="to-combine-return-shipments" />So fassen Sie Rücklieferungen zusammen
...
### <a name="to-remove-open-purchase-return-orders-after-combined-return-shipment-posting" />Offene Einkaufsreklamationen nach kombinierter Rücklieferungsbuchung entfernen
...
## <a name="see-related-microsoft-trainingtrainingpathsreturn-items-dynamics--business-central" />Siehe verwandte [Microsoft Schulungen](/training/paths/return-items-dynamics-365-business-central/)
