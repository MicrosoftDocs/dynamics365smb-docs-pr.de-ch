...
# <a name="the-tax-file-formats-dk-extension"></a><a name="the-tax-file-formats-dk-extension"></a><a name="the-tax-file-formats-dk-extension"></a>Die Steuerdateiformate-Erweiterung (DK)
