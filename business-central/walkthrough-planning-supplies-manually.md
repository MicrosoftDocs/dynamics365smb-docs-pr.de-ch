...
3.  Maximieren Sie das Fenster **Auftragsplanung**, und passen Sie die Grösse der Spaltenfelder so an, dass alle standardmässigen Feldnamen angezeigt werden.  
...
3.  Schliessen Sie den offenen Fertigungsauftrag, um zum Fenster **Auftragsplanung** zurückzukehren.  
...
6.  Schliessen Sie das Fenster **Auftragsplanung**.  

     Es wäre jetzt möglich, alle Planungsaufgaben in dieser Ansicht abzuschliessen. Stattdessen übernehmen Sie nun die Rolle des Produktionsplaners, indem Sie zum soeben erstellten Fertigungsauftrag navigieren und das Fenster **Auftragsplanung** öffnen.  
