...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-manually" />Exemplarische Vorgehensweise: Manuelle Beschaffungsplanung
...
## <a name="setting-up-the-sample-data" />Einrichten der Beispieldaten
...
## <a name="use-the-order-planning-page" />Die Seite „Auftragsplanung“ verwenden
...
### <a name="to-use-the-order-planning-page" />So verwenden Sie die Seite "Auftragsplanung"
...
## <a name="planning-a-purchase-order-to-fulfill-component-demand" />Planen einer Bestellung zum Erfüllen des Komponentenbedarfs
 In diesem Verfahren erstellen Sie eine Bestellung für benötigte Produktionskomponenten.  

### <a name="to-plan-a-purchase-order-to-fulfill-component-need-in-production" />So planen Sie eine Bestellung zum Erfüllen des Komponentenbedarfs in der Produktion
...
## <a name="planning-a-transfer-order-to-fulfill-sales-demand" />Planen eines Umlagerungsauftrags zum Erfüllen des Verkaufsbedarfs
...
### <a name="to-plan-a-transfer-order-to-fulfill-sales-demand" />So planen Sie einen Umlagerungsauftrag zum Erfüllen des Verkaufsbedarfs
...
## <a name="planning-a-multilevel-production-order-to-fulfill-sales-demand" />Planen eines Fertigungsauftrags mit mehreren Ebenen zum Erfüllen des Verkaufsbedarfs
...
### <a name="to-plan-multilevel-production-to-fulfill-sales-demand" />So planen Sie einen Fertigungsauftrag mit mehreren Ebenen zum Erfüllen des Verkaufsbedarfs
...
### <a name="to-plan-a-specific-production-order" />So planen Sie einen spezifischen Fertigungsauftrag
