...
## <a name="change-the-user-setup" />Ändern Sie die Benutzereinrichtung
...
### <a name="overview-of-involved-posting-date-setup" />Übersicht über die Einstellung des beteiligten Buchungsdatums
...
#### <a name="user-setup" />Benutzereinrichtung
