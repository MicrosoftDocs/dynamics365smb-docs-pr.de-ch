...
ms.author: edupont
---
# <a name="dimension-set-entries-overview" />Dimensionssatz-Eintrags-Übersicht
...
## <a name="dimension-sets" />Dimensionssätze
...
## <a name="dimension-set-entries" />Dimensionssatzposten
