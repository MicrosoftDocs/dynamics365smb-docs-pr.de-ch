...
ms.author: edupont
---
# <a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a>Dimensionssatz-Eintrags-Übersicht
...
## <a name="dimension-sets"></a><a name="dimension-sets"></a><a name="dimension-sets"></a>Dimensionssätze
...
|----------------------|--------------------|--------------------------|--------------------------|  
|108|AREA|70|Nordamerika|  
|108|UNTERNEHMENSGRUPPE|HOME|Start|  
|108|KOSTENSTELLE|VERKAUF|Verkauf|  

## <a name="dimension-set-entries"></a><a name="dimension-set-entries"></a><a name="dimension-set-entries"></a>Dimensionssatzposten
...
## <a name="performance-improvement"></a><a name="performance-improvement"></a><a name="performance-improvement"></a>Leistungsverbesserung
