...
Der Hilfeinhalt für die Standardversion von [!INCLUDE[prod_short](includes/prod_short.md)] wird auf der Microsoft Dokumentenseite veröffentlicht. Die Inhalte sind in verschiedenen Sprachen verfügbar. Wenn Sie die Belege in [!INCLUDE[prod_short](includes/prod_short.md)] öffnen, wird der Inhalt in Ihrer Sprache angezeigt. Wenn eine bestimmte Seite noch nicht in der Sprache verfügbar ist, wird sie standardmässig in Englisch angezeigt.
