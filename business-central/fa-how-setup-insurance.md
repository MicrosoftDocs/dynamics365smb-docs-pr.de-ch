...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance" />Um Anlagenversicherung einzurichten:
...
## <a name="to-set-up-general-insurance-information" />So richten Sie allgemeine Versicherungsinformationen ein
...
## <a name="to-set-up-insurance-types" />So richten Sie Versicherungsarten ein
...
## <a name="to-set-up-insurance-cards" />So richten Sie Versicherungskarten ein
...
## <a name="to-set-up-insurance-journal-templates" />So richten Sie Versicherungs Erfassungsjournalvorlagen ein
...
## <a name="to-set-up-insurance-journal-batches" />So richten Sie Versicherungs Erfassungsjournalnamen ein
