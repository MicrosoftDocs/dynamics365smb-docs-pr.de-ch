...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance"></a><a name="set-up-fixed-asset-insurance"></a>Um Anlagenversicherung einzurichten:
...
## <a name="to-set-up-general-insurance-information"></a><a name="to-set-up-general-insurance-information"></a>So richten Sie allgemeine Versicherungsinformationen ein
...
## <a name="to-set-up-insurance-types"></a><a name="to-set-up-insurance-types"></a>So richten Sie Versicherungsarten ein
...
## <a name="to-set-up-insurance-cards"></a><a name="to-set-up-insurance-cards"></a>So richten Sie Versicherungskarten ein
...
## <a name="to-set-up-insurance-journal-templates"></a><a name="to-set-up-insurance-journal-templates"></a>So richten Sie Versicherungs Erfassungsjournalvorlagen ein
...
## <a name="to-set-up-insurance-journal-batches"></a><a name="to-set-up-insurance-journal-batches"></a>So richten Sie Versicherungs Erfassungsjournalnamen ein
