...
ms.author: edupont
---
# <a name="about-calculating-standard-cost"></a><a name="about-calculating-standard-cost"></a>Informationen zur Berechnung von festen Einstandspreisen
...
## <a name="setting-up-standard-costs"></a><a name="setting-up-standard-costs"></a>Festlegen von Standardkalkulationen
...
### <a name="material-costs"></a><a name="material-costs"></a>Stoffkosten
...
### <a name="capacity-costs"></a><a name="capacity-costs"></a>Kalkulation von Kapazitäten
...
### <a name="subcontractor-costs"></a><a name="subcontractor-costs"></a>Kosten für Subunternehmer
...
## <a name="updating-standard-costs"></a><a name="updating-standard-costs"></a>Aktualisieren von Standardkalkulationen
