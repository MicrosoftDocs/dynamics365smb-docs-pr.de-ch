...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts" />(Legacy) Erstellen und Ändern benutzerdefinierter Berichtslayouts
...
## <a name="create-a-custom-layout" />Benutzerdefiniertes Layout erstellen
...
## <a name="a-namemodifycustomlayoutamodifying-a-custom-layout" /><a name="ModifyCustomLayout"></a>Ändern eines benutzerdefinierten Layouts
...
### <a name="modify-a-custom-layout" />Ändern eines benutzerdefinierten Layouts
