...
Berichte verfügen standardmässig über ein integriertes Berichtslayout. Das Layout kann ein RDLC-Berichtslayout und/oder ein Word-Berichtslayout sein. Sie können die integrierten Layouts nicht ändern, aber Sie können angepasste Layouts erstellen. Ein Bericht kann mehrere benutzerdefinierte Berichtslayouts haben.
...
Nachdem Sie benutzerdefinierte Berichtslayouts definiert haben, können Sie sie auf den Seiten „Debitorenkarte“ und „Kreditorenkarte“ auswählen. Die Layouts werden verwendet, wenn Sie Belege für den Debitor oder Kreditor erstellen. Weitere Informationen finden Sie unter [Beleglayouts für Debitoren und Kreditoren definieren](ui-define-customer-vendor-document-layouts.md).
