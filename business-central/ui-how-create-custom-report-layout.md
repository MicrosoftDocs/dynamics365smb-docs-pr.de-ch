...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts"></a><a name="legacy-create-and-modify-custom-report-layouts"></a>(Legacy) Erstellen und Ändern benutzerdefinierter Berichtslayouts
...
## <a name="create-a-custom-layout"></a><a name="create-a-custom-layout"></a>Benutzerdefiniertes Layout erstellen
...
## <a name="modifying-a-custom-layout"></a><a name="modifying-a-custom-layout"></a><a name="ModifyCustomLayout"></a>Ändern eines benutzerdefinierten Layouts
...
### <a name="modify-a-custom-layout"></a><a name="modify-a-custom-layout"></a>Ändern eines benutzerdefinierten Layouts
