...
# <a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a>Die MWST-Gruppenverwaltungserweiterung für das Vereinigte Königreich
...
## <a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a>Bildung einer Mehrwertsteuergruppe
...
### <a name="license-requirements"></a><a name="license-requirements"></a>Lizenzanforderungen
...
## <a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a>Mehrwertsteuergruppe einrichten
...
### <a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a>Azure Active Directory Einrichtung für Gruppenmitglieder
...
### <a name="group-api-setup"></a><a name="group-api-setup"></a>Einrichtung der Gruppen API
...
## <a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a>Mehrwertsteuergruppenmitglieder einrichten
...
### <a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a>Vertreter der Mehrwertsteuergruppe verwendet Business Central Online
...
### <a name="vat-group-representative-uses-business-central-on-premises"></a><a name="vat-group-representative-uses-business-central-on-premises"></a>Vertreter der Mehrwertsteuergruppe verwendet Business Central-On-Premises
...
## <a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a>Vertreter der Mehrwertsteuergruppe einrichten
...
## <a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a>Die Funktionen der Mehrwertsteuergruppenverwaltung verwenden
...
### <a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a>Mehrwertsteuermitglied-Übermittlungen prüfen
...
### <a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a>Erstellen einer Gruppenmehrwertsteuererklärung
