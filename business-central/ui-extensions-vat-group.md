...
4. Geben Sie im Feld **Gruppenabrechnungskonto** das Abrechnungskonto an, das für die Mehrwertsteuerbeträge der Gruppenmitglieder verwendet wird.
5. Geben Sie im Feld **MWST-Ausgleichskontos** das Konto an, das Sie für MWST-Abrechnungen verwenden.
