...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />Die MWST-Gruppenverwaltungserweiterung für das Vereinigte Königreich
...
## <a name="forming-a-vat-group" />Bildung einer Mehrwertsteuergruppe
...
### <a name="license-requirements" />Lizenzanforderungen
...
## <a name="set-up-a-vat-group" />Mehrwertsteuergruppe einrichten
...
### <a name="azure-active-directory-setup-for-group-members" />Azure Active Directory Einrichtung für Gruppenmitglieder
...
### <a name="group-api-setup" />Einrichtung der Gruppen API
...
## <a name="set-up-vat-group-members" />Mehrwertsteuergruppenmitglieder einrichten
...
### <a name="vat-group-representative-uses-business-central-online" />Vertreter der Mehrwertsteuergruppe verwendet Business Central Online
...
### <a name="vat-group-representative-uses-business-central-on-premises" />Vertreter der Mehrwertsteuergruppe verwendet Business Central-On-Premises
...
## <a name="set-up-the-vat-group-representative" />Vertreter der Mehrwertsteuergruppe einrichten
...
## <a name="use-the-vat-group-management-features" />Die Funktionen der Mehrwertsteuergruppenverwaltung verwenden
...
### <a name="review-vat-member-submissions" />Mehrwertsteuermitglied-Übermittlungen prüfen
...
### <a name="create-a-group-vat-return" />Erstellen einer Gruppenmehrwertsteuererklärung
