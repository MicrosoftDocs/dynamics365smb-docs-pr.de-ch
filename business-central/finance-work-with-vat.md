...
## <a name="calculating-vat-manually-using-journals"></a>Manuelle MWST-Berechnung mithilfe von Erfassungsjournalen
...
### <a name="to-set-the-system-up-for-manual-vat-entry-in-general-journals"></a>So richten Sie das System für manuelle MWST-Posten in Fibu-Erfassungsjournalen ein
...
### <a name="to-create-a-new-invoice-for-the-import-authority-vendor-after-you-complete-the-setup"></a>So erstellen Sie eine neue Rechnung für die als Kreditor fungierende Einfuhrbehörde, nachdem Sie die Einrichtung abgeschlossen haben
