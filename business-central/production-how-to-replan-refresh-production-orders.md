...
ms.author: edupont
---
# <a name="replan-or-refresh-production-orders-directly" />Neugestaltungs- oder direkt Aktualisierung von Fertigungsaufträgen
...
## <a name="to-replan-a-production-order" />Einen Fertigungsauftrag neu planen
...
## <a name="to-refresh-a-production-order" />Einen Fertigungsauftrag aktualisieren
