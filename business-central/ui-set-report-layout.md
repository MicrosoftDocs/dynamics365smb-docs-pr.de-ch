...
ms.author: jswymer
---
# <a name="setting-the-layout-used-by-a-report" />Festlegen des von einem Bericht verwendeten Layouts
...
## <a name="set-the-layout-from-the-report-layouts-page" />Das Layout aus der Berichtslayouts-Seite festlegen
...
## <a name="set-the-layout-from-report-layout-selection-page" />Das Layout aus der Auswahl des Berichtslayouts-Seite festlegen
...
## <a name="revert-to-the-original-default-layout" />Das ursprüngliche Standardlayout wiederherstellen
