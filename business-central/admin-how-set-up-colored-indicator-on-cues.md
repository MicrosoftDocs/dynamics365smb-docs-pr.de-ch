...
ms.author: jswymer
---
# <a name="set-up-a-colored-indicator-on-cues-for-the-company-or-individual-users" />Einrichten eines farbigen Indikators auf Stapeln für das ganze Unternehmen oder einzelne Benutzer
...
### <a name="to-set-up-colored-indicators-on-cues" />So richten Sie farbige Indikatoren auf Stapeln ein.
