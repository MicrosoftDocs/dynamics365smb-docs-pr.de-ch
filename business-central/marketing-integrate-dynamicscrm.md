...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central"></a><a name="use-dynamics-365-sales-from-business-central"></a>Verwenden von Dynamics 365 Sales von Business Central
...
## <a name="coupling-records"></a><a name="coupling-records"></a>Kopplungsdatensätze
...
## <a name="fully-synchronizing-records"></a><a name="fully-synchronizing-records"></a>Datensätze vollständig synchronisieren
...
## <a name="handling-sales-order-data"></a><a name="handling-sales-order-data"></a>Bearbeiten von Verkaufsauftragsdaten
...
## <a name="handling-sales-quotes-data"></a><a name="handling-sales-quotes-data"></a>Bearbeiten von Verkaufsangebotsdaten
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a>Behandlung der gebuchten Verkaufsrechnungen, Debitoren-Zahlungen und Statistiken
...
## <a name="handling-sales-prices"></a><a name="handling-sales-prices"></a>Handhabung von Verkaufspreisen
> [!NOTE]
