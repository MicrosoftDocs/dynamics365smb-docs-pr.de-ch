...
## <a name="couple-records"></a>Kopplungsdatensätze
...
## <a name="fully-synchronize-records"></a>Datensätze vollständig synchronisieren
...
## <a name="handle-sales-order-data"></a>Bearbeiten von Verkaufsauftragsdaten
...
## <a name="handle-sales-quotes-data"></a>Bearbeiten von Verkaufsangebotsdaten
...
## <a name="handle-posted-sales-invoices-customer-payments-and-statistics"></a>Behandlung der gebuchten Verkaufsrechnungen, Debitoren-Zahlungen und Statistiken
...
## <a name="handle-sales-prices"></a>Handhabung von Verkaufspreisen
> [!NOTE]
