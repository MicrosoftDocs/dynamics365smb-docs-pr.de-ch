...
Wenn Sie **Verarbeiten** in [!INCLUDE[d365fin](includes/d365fin_md.md)] für eine Offerte wählen, die den Status **Gewonnen** hat, wird ein Verkaufsauftrag in [!INCLUDE[d365fin](includes/d365fin_md.md)] nur dann erstellt, wenn ein entsprechender Verkaufsauftrag in [!INCLUDE[crm_md](includes/crm_md.md)] eingereicht wird. Andernfalls wird die Offerte nur in [!INCLUDE[d365fin](includes/d365fin_md.md)] freigegeben. Wenn ein entsprechender Verkaufsauftrag später in [!INCLUDE[crm_md](includes/crm_md.md)] eingereicht wird und ein Verkaufsauftrag auf dessen Grundlage erstellt wird, wird die **Offertennummer** im Verkaufsauftrag aktualisiert und die Offerte wird archiviert.
