...
# <a name="configure-api-templates" />API Vorlagen konfigurieren
...
## <a name="setting-up-the-entity-template" />Einrichten der Einheiten-Vorlage
...
## <a name="assign-the-template-to-an-api" />Weisen Sie die Vorlage zu einer API zu
