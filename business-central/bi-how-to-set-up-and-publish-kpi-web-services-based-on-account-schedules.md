...
---
# <a name="set-up-and-publish-kpi-web-services-based-on-financial-reports" />KPI-Webdienste auf der Grundlage von Finanzberichten festlegen und veröffentlichen
...
## <a name="set-up-and-publish-a-kpi-web-service-based-on-financial-reports" />Einen KPI-Webservice auf der Basis von Finanzberichten festlegen und veröffentlichen
