...
ms.author: edupont
---
# <a name="set-up-put-away-templates" />Einlagerungsmethoden einzurichten
...
## <a name="to-set-up-put-away-templates" />So richten Sie Einlagerungsmethoden ein:
...
## <a name="see-related-microsoft-trainingtrainingmodulesput-away-templates" />Siehe verwandte [Microsoft Schulungen](/training/modules/put-away-templates/)
