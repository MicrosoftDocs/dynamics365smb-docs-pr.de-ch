...
ms.author: edupont
---
# <a name="create-a-demand-forecast" />Bedarfsplanung erstellen
...
## <a name="sales-forecasts-and-production-forecasts" />Absatzplanungen und Fertigungsplanungen
...
## <a name="component-forecast" />Komponentenabsatzplanung
...
## <a name="forecasting-periods" />Planungsperioden
...
## <a name="forecast-by-locations" />Absatzplanung nach Lagerorten
...
### <a name="use-forecast-by-locations" />Planung pro Lagerort verwenden
...
### <a name="do-not-use-forecast-by-locations" />Planung pro Lagerort nicht verwenden
...
## <a name="to-create-a-demand-forecast" />So erstellen Sie eine Absatzplanung
