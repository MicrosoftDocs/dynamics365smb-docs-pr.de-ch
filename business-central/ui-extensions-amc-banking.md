...
# <a name="use-the-amc-banking-365-fundamentals-extension"></a><a name="use-the-amc-banking-365-fundamentals-extension"></a>Die AMC Banking 365 Fundamentals-Erweiterung verwenden
...
## <a name="use-our-demonstration-account"></a><a name="use-our-demonstration-account"></a>Unser Demonstrationskonto verwenden
...
## <a name="setting-up-the-extension"></a><a name="setting-up-the-extension"></a>Einrichten der Erweiterung
...
### <a name="to-set-up-the-required-permission-sets"></a><a name="to-set-up-the-required-permission-sets"></a>So richten Sie die erforderlichen Berechtigungsgruppen ein
...
### <a name="to-connect-the-extension-to-amc-banking"></a><a name="to-connect-the-extension-to-amc-banking"></a>So verbinden Sie die Erweiterung mit AMC Banking.
...
### <a name="to-connect-bank-accounts-to-the-extension"></a><a name="to-connect-bank-accounts-to-the-extension"></a>So verbinden Sie Bankkonten mit der Erweiterung
...
## <a name="use-the-extension"></a><a name="use-the-extension"></a>Die Erweiterung verwenden
...
### <a name="to-export-data-and-submit-it-to-your-bank"></a><a name="to-export-data-and-submit-it-to-your-bank"></a>So exportieren Sie Daten und übermitteln sie an Ihre Bank
...
### <a name="to-import-and-apply-the-converted-file"></a><a name="to-import-and-apply-the-converted-file"></a>So importieren und wenden Sie die konvertierte Datei an
