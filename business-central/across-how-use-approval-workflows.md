...
Sie richten Genehmigungsworkflows auf der Seite **Workflow** ein. Ausserdem müssen Sie auf der Seite **Genehmigungsbenutzereinrichtung** die Genehmigungsbenutzer festlegen, einschliesslich aller relevanten Betragsgrenzen. Weitere Informationen erhalten Sie unter [Workflows einrichten](across-set-up-workflows.md).  
...
In regelmässigen Abständen müssen Sie Genehmigungs-Workflowbenutzer an überfällige Genehmigungsanforderungen erinnern, auf die sie reagieren müssen. Verwenden Sie die Funktion **Fällige Genehmigungsbenachrichtigungen senden**, um Benutzer zu erinnern.
