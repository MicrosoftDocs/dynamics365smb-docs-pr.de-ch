...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows"></a><a name="how-to-use-approval-workflows"></a><a name="how-to-use-approval-workflows"></a>So verwenden Sie Genehmigungsworkflows
...
## <a name="request-a-record-approval"></a><a name="request-a-record-approval"></a><a name="request-a-record-approval"></a>Genehmigung eines Datensatzes anfordern
...
## <a name="cancel-approval-requests"></a><a name="cancel-approval-requests"></a><a name="cancel-approval-requests"></a>Genehmigungsanforderungen stornieren
...
## <a name="approve-or-reject-approval-requests"></a><a name="approve-or-reject-approval-requests"></a><a name="approve-or-reject-approval-requests"></a>Genehmigungsanforderungen genehmigen oder ablehnen
...
## <a name="delegate-approval-requests"></a><a name="delegate-approval-requests"></a><a name="delegate-approval-requests"></a>Genehmigungsanforderungen delegieren
...
## <a name="manage-overdue-approval-requests"></a><a name="manage-overdue-approval-requests"></a><a name="manage-overdue-approval-requests"></a>Überfällige Genehmigungsanforderungen verwalten
