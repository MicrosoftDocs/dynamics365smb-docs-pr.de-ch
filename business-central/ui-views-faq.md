...
### <a name="how-do-i-know-whether-im-on-list-type-page"></a>Woher weiss ich, ob ich auf der Seite mit dem Listentyp bin

Seitenüberprüfung verwenden. Drücken Sie zum Öffnen der Seitenprüfung Ctrl + ALT+F1. Dann im Feld **Seite** suchen Sie nach dem Wort **Liste** in der Klammer am Ende.
...
### <a name="others-in-my-organization-need-similar-list-views-as-standard-what-can-i-do"></a>Andere in meiner Organisation benötigen standardmässig ähnliche Listenansichten. Was kann ich tun?
