...
ms.author: edupont
---
# <a name="convert-existing-locations-to-warehouse-locations" />Konvertieren vorhandener Lagerorte in Lagerorte des Lagers
...
## <a name="to-enable-an-existing-location-to-operate-as-a-warehouse-location" />S aktivieren Sie einen vorhandenen Lagerort für den Lagerbetrieb:
