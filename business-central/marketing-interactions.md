...
ms.author: jswymer
---
# <a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a>Aktivitäten mit Kontakten aufzeichnen
...
## <a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a>Einrichten von Aktivitätenvorlagen
...
## <a name="creating-interactions"></a><a name="creating-interactions"></a>Aktivitäten erstellen
...
## <a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a>Anzeigen und Verwalten von aufgezeichneten Aktivitäten
