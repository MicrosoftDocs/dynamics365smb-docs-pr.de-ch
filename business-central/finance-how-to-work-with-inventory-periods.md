...
ms.author: edupont
---
# <a name="work-with-inventory-periods"></a><a name="work-with-inventory-periods"></a>Arbeiten mit Lagerbuchungsperioden
...
## <a name="to-create-an-inventory-period"></a><a name="to-create-an-inventory-period"></a>Eine Lagerbuchungsperiode erstellen
...
## <a name="closing-inventory-periods"></a><a name="closing-inventory-periods"></a>Lagerbuchungsperioden schliessen
...
### <a name="to-close-an-inventory-period"></a><a name="to-close-an-inventory-period"></a>Eine Lagerbuchungsperiode schliessen
...
## <a name="reopening-inventory-periods"></a><a name="reopening-inventory-periods"></a>Lagerbuchungsperioden erneut öffnen
...
### <a name="to-reopen-an-inventory-period"></a><a name="to-reopen-an-inventory-period"></a>So öffnen Sie eine Lagerbuchungsperiode erneut
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell me-Funktion") Symbol. Geben Sie **Lagerbuchungsperioden** ein und wählen Sie dann den zugehörigen Link.  
