...
ms.author: jswymer
---
# <a name="sharing-business-data-from-business-central"></a><a name="sharing-business-data-from-business-central"></a>Freigeben von Geschäftsdaten aus Business Central
...
## <a name="copying-a-link"></a><a name="copying-a-link"></a>Kopieren eines Links
...
### <a name="modify-the-page-link"></a><a name="modify-the-page-link"></a>Seitenlink ändern
...
### <a name="about-filtered-lists"></a><a name="about-filtered-lists"></a>Informationen zu gefilterten Listen
...
## <a name="sharing-to-teams"></a><a name="sharing-to-teams"></a>Freigeben für Teams
...
## <a name="sharing-through-onedrive"></a><a name="sharing-through-onedrive"></a>Freigeben durch OneDrive
...
## <a name="opening-in-excel"></a><a name="opening-in-excel"></a>Öffnen in Excel
...
## <a name="sharing-rows-or-tables"></a><a name="sharing-rows-or-tables"></a>Freigeben von Zeilen oder Tabellen
