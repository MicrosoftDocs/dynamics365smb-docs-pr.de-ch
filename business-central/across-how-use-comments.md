...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents"></a><a name="add-comments-to-cards-and-documents"></a>Hinzufügen von Bemerkungen zu Karten und Belegen
...
## <a name="to-add-a-comments-to-an-item-card"></a><a name="to-add-a-comments-to-an-item-card"></a>Um Bemerkungen einer Artikelkarte hinzuzufügen
