...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting" />Arbeiten Sie mit Intrastat Reporting
...
## <a name="fill-in-the-intrastat-report" />Füllen Sie im Intrastat-Bericht
...
## <a name="modify-the-intrastat-report" />Ändern des Intrastat-Berichts
...
## <a name="validate-intrastat-lines" />Intrastat-Zeilen validieren
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure" />Neuberechnung von Gewicht oder zusätzlicher Masseinheit
...
## <a name="intrastat-rules" />Intrastat-Regeln
...
### <a name="fixed-assets-reporting" />Berichterstattung über Anlagen
...
### <a name="intrastat-report-statuses" />Status der Intrastat-Berichte
