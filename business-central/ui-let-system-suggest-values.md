...
ms.author: edupont
---
# <a name="letting-includeprodshortincludesprodshortmd-suggest-values" />[!INCLUDE[prod_short](includes/prod_short.md)] Werte vorschlagen lassen
...
## <a name="the-suggest-balancing-amount-check-box-on-the-general-journal-batches-page" />Das Kontrollkästchen **Ausgleichsbetrag vorschlagen** auf der Seite **Fibu Erf.-Journalnamen**
