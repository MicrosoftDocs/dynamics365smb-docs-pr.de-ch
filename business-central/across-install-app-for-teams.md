...
# <a name="install-the-include-prodshortincludesprodshortmd-app-for-microsoft-teams" />Die App [!INCLUDE [prod_short](includes/prod_short.md)] für Microsoft Teams installieren
