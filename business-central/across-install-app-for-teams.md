...
# <a name="install-the--app-for-microsoft-teams"></a><a name="install-the--app-for-microsoft-teams"></a>Die App [!INCLUDE [prod_short](includes/prod_short.md)] für Microsoft Teams installieren
...
## <a name="add-the-business-central-app-to-teams"></a><a name="add-the-business-central-app-to-teams"></a>Die Business Central-App zu Teams hinzufügen
...
## <a name="next-step"></a><a name="next-step"></a>Nächster Schritt
