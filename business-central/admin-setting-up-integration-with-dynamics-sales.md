...
## <a name="setting-up-accounts-sales-people"></a>Einrichten von Konten für Verkäufer
...
![Koppeln von Verkäufern mit Benutzern in Dynamics 365 Sales](media/couple-salespeople.png "Visualisierung des Koppelns von Verkäufern mit Benutzern in Dynamics 365 Sales")

## <a name="minimum-permissions-for-user-accounts-in-includecrm_mdincludescrm_mdmd"></a>Mindestberechtigungen für Benutzerkonten in [!INCLUDE[crm_md](includes/crm_md.md)]
...
|Plugin-Assembly|Global|Lesen|Lesen|Lesen|
...
|Eigenschaftenzuordnung|Global|Lesen|Lesen|Lesen|
|Eigenschaftsoptionssatz-Element|Global|Lesen|Lesen|Lesen|
|Offerte|Global|Lesen|Lesen|Lesen|
...
### <a name="product-availability-user"></a>Produktverfügbarkeitsbenutzer
