...
---
# Buchhalterumgebungen in [!INCLUDE[prod_long](includes/prod_long.md)]
...
### Ihren Buchhalter zu Microsoft 365 im Azure-Portal hinzufügen
...
### Den neuen Benutzer in [!INCLUDE[prod_short](includes/prod_short.md)] importieren
