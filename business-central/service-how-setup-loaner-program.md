...
ms.author: bholtorf
---
# <a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a>Einrichten eines Leihgeräteprogramms
...
## <a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a>So richten Sie einen Leihgerät ein
