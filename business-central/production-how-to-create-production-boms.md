...
ms.author: bholtorf
---
# <a name="create-production-boms"></a><a name="create-production-boms"></a>Fertigungsauftrag erstellen
...
## <a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a>Erstellen Sie eine neue Fertigungsstückliste.
...
## <a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a>Neue Versionen von Fertigungsstücklisten erzeugen
...
## <a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a>Mengenberechnungsformel in Fertigungsstücklisten
