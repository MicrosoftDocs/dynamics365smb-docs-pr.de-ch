...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers" />Exemplarische Vorgehensweise: Verfolgung von Serien-/Chargennummern
...
## <a name="prepare-sample-data" />Vorbereiten der Beispieldaten
...
### <a name="to-create-the-items" />Serviceartikel anlegen
...
### <a name="to-purchase-components" />Um Komponenten zu kaufen
...
### <a name="to-produce-end-items" />Um Endartikel zu produzieren
...
### <a name="to-sell-the-end-items" />Um die Endartikel zu verkaufen
...
## <a name="tracing-from-usage-to-origin" />Verfolgung vom Verbrauch zum Ursprung
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it" />So stellen Sie fest, aus welcher Charge und von welchem Kreditor der fehlerhafte Rahmen stammt
...
## <a name="tracing-from-origin-to-usage" />Verfolgung vom Verbrauch zum Ursprung
...
### <a name="to-find-all-usage-of-the-faulty-lot" />So machen Sie alle Verbrauchsfälle der fehlerhaften Charge ausfindig
...
## <a name="finding-all-records-of-a-seriallot-number" />Alle Datensätze einer Serien-/Chargennummer finden
