...
# <a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a>Unternehmenskonsolidierung einrichten
...
* Wenn Sie erweitertere Einstellungen benötigen, können Sie den Konsolidierungsmandanten und die Konzernmandanten einrichten.
  * In jedem Konzernmandanten geben Sie an, welche Fibukonten in die Konsolidierung einzubeziehen sind und geben Sie die Konsolidierungsumrechnungsmethode für jedes Konto an.
...
## <a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a>Einfache Konsolidierungseinrichtung
...
## <a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a>Erweiterte Konsolidierungseinrichtung
...
### <a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a>Das konsolidierte Unternehmen einrichten

Zuerst müssen Sie das konsolidierte Unternehmen einrichten. Die Einrichtung des konsolidierten Mandanten erfolgt auf die gleiche Weise wie die Einrichtung anderer Mandanten. Weitere Informationen finden Sie unter [Vorbereitungen für das Ausführen von Geschäften](ui-get-ready-business.md).  
...
4. Sie können Dimensionsinformationen und Fibukonten konsolidieren.

    Weitere Informationen finden Sie im Abschnitt [Dimensionen ein- oder ausschliessen](#dim).

### <a name="add-business-units"></a><a name="add-business-units"></a><a name="add-business-units"></a><a name="busunit"></a>Konzernmandanten hinzufügen
...
### <a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="glacc"></a>Fibukonten für die Konsolidierung vorbereiten

Der Kontenplan eines Unternehmens, das konsolidiert wird, muss Konten für die Konsolidierung angeben. Für jedes Buchungsfibukonto in jedem Unternehmen müssen Sie das Fibukonto in dem konsolidierten Unternehmen angeben, auf das der Saldo bei der Konsolidierung übertragen wird. Mit dieser Zuordnung können Unternehmen mit unterschiedlichen Kontenplänen zusammen konsolidiert werden.
...
### <a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="exchrates"></a>Wechselkurse für Konsolidierungen angeben
...
### <a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="dim"></a>Dimensionen ein- oder ausschliessen
...
* Fügen Sie die relevanten Dimensionen zu den relevanten Fibukonten hinzu

### <a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude"></a>Ein Unternehmen aus der Konsolidierung ausschliessen
...
### <a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include"></a>Schliessen Sie Unternehmen in die Konsolidierung ein, das teilweise im Besitz ist
