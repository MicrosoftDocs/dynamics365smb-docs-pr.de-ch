...
# <a name="set-up-company-consolidation"></a><a name="set-up-company-consolidation"></a>Unternehmenskonsolidierung einrichten
...
## <a name="simple-consolidation-setup"></a><a name="simple-consolidation-setup"></a>Einfache Konsolidierungseinrichtung
...
## <a name="advanced-consolidation-setup"></a><a name="advanced-consolidation-setup"></a>Erweiterte Konsolidierungseinrichtung
...
### <a name="set-up-the-consolidated-company"></a><a name="set-up-the-consolidated-company"></a>Das konsolidierte Unternehmen einrichten
...
### <a name="add-business-units"></a><a name="add-business-units"></a><a name="busunit"></a>Konzernmandanten hinzufügen
...
### <a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="prepare-general-ledger-accounts-for-consolidation"></a><a name="glacc"></a>Fibukonten für die Konsolidierung vorbereiten
...
### <a name="specify-exchange-rates-for-consolidations"></a><a name="specify-exchange-rates-for-consolidations"></a><a name="exchrates"></a>Wechselkurse für Konsolidierungen angeben
...
### <a name="include-or-exclude-dimensions"></a><a name="include-or-exclude-dimensions"></a><a name="dim"></a>Dimensionen ein- oder ausschliessen
...
### <a name="exclude-a-company-from-consolidation"></a><a name="exclude-a-company-from-consolidation"></a><a name="exclude"></a>Ein Unternehmen aus der Konsolidierung ausschliessen
...
### <a name="include-a-partially-owned-company-in-consolidation"></a><a name="include-a-partially-owned-company-in-consolidation"></a><a name="include"></a>Schliessen Sie Unternehmen in die Konsolidierung ein, das teilweise im Besitz ist
