...
# <a name="set-up-company-consolidation" />Unternehmenskonsolidierung einrichten
...
## <a name="simple-consolidation-setup" />Einfache Konsolidierungseinrichtung
...
## <a name="advanced-consolidation-setup" />Erweiterte Konsolidierungseinrichtung
...
### <a name="set-up-the-consolidated-company" />Das konsolidierte Unternehmen einrichten
...
### <a name="a-namebusunitaadd-business-units" /><a name="busunit"></a>Konzernmandanten hinzufügen
...
### <a name="a-nameglaccaprepare-general-ledger-accounts-for-consolidation" /><a name="glacc"></a>Fibukonten für die Konsolidierung vorbereiten
...
### <a name="a-nameexchratesaspecify-exchange-rates-for-consolidations" /><a name="exchrates"></a>Wechselkurse für Konsolidierungen angeben
...
### <a name="a-namedimainclude-or-exclude-dimensions" /><a name="dim"></a>Dimensionen ein- oder ausschliessen
...
### <a name="a-nameexcludeaexclude-a-company-from-consolidation" /><a name="exclude"></a>Ein Unternehmen aus der Konsolidierung ausschliessen
...
### <a name="a-nameincludeainclude-a-partially-owned-company-in-consolidation" /><a name="include"></a>Schliessen Sie Unternehmen in die Konsolidierung ein, das teilweise im Besitz ist
