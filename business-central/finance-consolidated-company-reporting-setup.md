...
### <a name="add-business-units" /><a name="busunit"></a>Konzernmandanten hinzufügen
...
### <a name="prepare-general-ledger-accounts-for-consolidation" /><a name="glacc"></a>Fibukonten für die Konsolidierung vorbereiten
...
### <a name="specify-exchange-rates-for-consolidations" /><a name="exchrates"></a>Wechselkurse für Konsolidierungen angeben
...
### <a name="include-or-exclude-dimensions" /><a name="dim"></a>Dimensionen ein- oder ausschliessen
...
### <a name="exclude-a-company-from-consolidation" /><a name="exclude"></a>Ein Unternehmen aus der Konsolidierung ausschliessen
...
### <a name="include-a-partially-owned-company-in-consolidation" /><a name="include"></a>Schliessen Sie Unternehmen in die Konsolidierung ein, das teilweise im Besitz ist
