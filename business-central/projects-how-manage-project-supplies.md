...
ms.author: edupont
---
# <a name="manage-job-supplies" />Verwalten von Projektlieferungen
...
## <a name="to-purchase-items-or-services-for-a-job" />Um Artikel oder Services für ein Projekt kaufen
...
## <a name="to-view-the-value-of-purchases-for-a-job" />So zeigen Sie den Wert eines Kaufes für ein Projekt
...
## <a name="to-post-a-job-related-expense" />Projektbezogene Aufwendung buchen
