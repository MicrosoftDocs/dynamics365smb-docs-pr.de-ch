...
# <a name="responding-to-requests-about-users-personal-data" />Reagieren auf Anfragen über personenbezogene Daten von Benutzern
...
## <a name="types-of-requests" />Arten von Anträgen
...
## <a name="restrict-data-processing-for-a-data-subject" />Die Datenverarbeitung für eine betroffene Person einschränken
...
## <a name="handling-data-subject-requests-when-using-a-trial-version" />Umgang mit den Anträgen betroffener Personen in einer Testversion
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject" />Daten aus Tabellen exportieren, die nicht nach betroffenen Personen klassifiziert sind
...
## <a name="handling-data-about-minors" />Umgang mit Daten über Minderjährige
