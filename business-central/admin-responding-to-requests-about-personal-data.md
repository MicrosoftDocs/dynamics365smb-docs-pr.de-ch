...
# <a name="responding-to-requests-about-users-personal-data"></a><a name="responding-to-requests-about-users-personal-data"></a>Reagieren auf Anfragen über personenbezogene Daten von Benutzern
...
## <a name="types-of-requests"></a><a name="types-of-requests"></a>Arten von Anträgen
...
## <a name="restrict-data-processing-for-a-data-subject"></a><a name="restrict-data-processing-for-a-data-subject"></a>Die Datenverarbeitung für eine betroffene Person einschränken
...
## <a name="handling-data-subject-requests-when-using-a-trial-version"></a><a name="handling-data-subject-requests-when-using-a-trial-version"></a>Umgang mit den Anträgen betroffener Personen in einer Testversion
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject"></a><a name="exporting-data-from-tables-not-classified-by-data-subject"></a>Daten aus Tabellen exportieren, die nicht nach betroffenen Personen klassifiziert sind
...
## <a name="handling-data-about-minors"></a><a name="handling-data-about-minors"></a>Umgang mit Daten über Minderjährige
