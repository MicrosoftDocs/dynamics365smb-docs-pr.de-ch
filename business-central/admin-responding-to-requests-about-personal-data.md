---
title: Reagieren auf Anfragen über personenbezogene Daten von Benutzern
...
# <a name="responding-to-requests-about-users-personal-data"></a><a name="responding-to-requests-about-users-personal-data"></a><a name="responding-to-requests-about-users-personal-data"></a>Reagieren auf Anfragen über personenbezogene Daten von Benutzern

Datensubjekte können mehrere Arten von Aktionen für die Personendaten abfragen. Beispielsweise sie nach einigen Datenschutzgesetzen und -vorschriften das Recht, den Export, das Löschen oder die Änderung Ihrer Personendaten anzufordern. Diese Anträge heissen *Anträge betroffener Personen*. Wenn Sie die Vertraulichkeit Ihrer Daten klassifiziert haben und sicher sind, dass sie korrekt sind, kann ein Administrator mithilfe der Optionen auf der Registerkarte **Datenprivatsphäre** im **IT-Manager** Rollenzentrum antworten. Weitere Informationen zur Klassifizierung von Daten und Datenvertraulichkeit in [!INCLUDE[prod_long](includes/prod_long.md)] finden Sie in den folgenden Artikeln:
...
## <a name="types-of-requests"></a><a name="types-of-requests"></a><a name="types-of-requests"></a>Arten von Anträgen
...
## <a name="restrict-data-processing-for-a-data-subject"></a><a name="restrict-data-processing-for-a-data-subject"></a><a name="restrict-data-processing-for-a-data-subject"></a>Die Datenverarbeitung für eine betroffene Person einschränken
...
## <a name="handling-data-subject-requests-when-using-a-trial-version"></a><a name="handling-data-subject-requests-when-using-a-trial-version"></a><a name="handling-data-subject-requests-when-using-a-trial-version"></a>Umgang mit den Anträgen betroffener Personen in einer Testversion
...
In der Arbeits- und Schuldatenschutzseite können Sie Ihr Konto schliessen. Wir empfehlen jedoch, zunächst alle Daten zu exportieren und zu löschen. Wenn Sie Ihr Konto löschen, verlieren Sie den Zugriff auf [!INCLUDE[prod_short](includes/prod_short.md)].
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject"></a><a name="exporting-data-from-tables-not-classified-by-data-subject"></a><a name="exporting-data-from-tables-not-classified-by-data-subject"></a>Daten aus Tabellen exportieren, die nicht nach betroffenen Personen klassifiziert sind
...
## <a name="handling-data-about-minors"></a><a name="handling-data-about-minors"></a><a name="handling-data-about-minors"></a>Umgang mit Daten über Minderjährige
