...
Nachdem Sie Ihr Lager so eingerichtet haben, können Sie verschiedene Lagervorgänge verwalten. Weitere Informationen finden Sie unter [Verwalten von Lager-](inventory-manage-inventory.md) und [Lagerort-Verwaltung - Übersicht](design-details-warehouse-management.md).
...
| Organisieren Sie Ihr Lager an mehreren Lagerorten, einschliesslich Umlagerungsrouten. |[Lagerorte einrichten](inventory-how-register-new-items.md) |
...
|Erfahren Sie, wie Sie das Feld **Art** entsprechend dem Geschäftszweck auf der Artikelkarte ausfüllen.|[Info zu Artikeltypen](inventory-about-item-types.md)|
...
|Sie können Lagerhaltungsdaten verwenden, um Informationen über Ihre Artikel für einen bestimmten Lagerortcode und/oder einen bestimmten Variantencode zu speichern.|[Lagerhaltungseinheiten einrichten](inventory-how-to-set-up-stockkeeping-units.md)|
