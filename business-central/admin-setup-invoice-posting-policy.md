...
# <a name="define-an-invoice-posting-policy-for-users"></a><a name="define-an-invoice-posting-policy-for-users"></a>Definieren Sie eine Rechnungsbuchungsrichtlinie für Benutzer
...
## <a name="to-specify-a-posting-policy"></a><a name="to-specify-a-posting-policy"></a>Um eine Buchhaltungsperioden festlegen
...
## <a name="effect-on-documents"></a><a name="effect-on-documents"></a>Auswirkung auf die Belege
