---
title: Rechnungsbuchungsrichtlinie für Benutzer definieren
...
|Verkaufsrechnungen|Keine Optionen| Die Buchungen ist gemäss Benutzereinrichtung unzulässig.|Möchten Sie die Rechnung buchen?|
|Verkaufsgutschrift|Keine Optionen|Die Buchungen ist gemäss Benutzereinrichtung unzulässig.|Möchten Sie die Gutschrift buchen?|
...
|Einkaufsrechnung|Keine Optionen|Die Buchungen ist gemäss Benutzereinrichtung unzulässig.|Möchten Sie die Rechnung buchen?|
|Einkaufsgutschrift|Keine Optionen|Die Buchungen ist gemäss Benutzereinrichtung unzulässig.|Möchten Sie die Gutschrift buchen?|
