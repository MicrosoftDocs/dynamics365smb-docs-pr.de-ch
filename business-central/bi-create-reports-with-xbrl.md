...
ms.author: edupont
---
# <a name="create-reports-with-xbrl" />Berichte mit XBRL erstellen
...
## <a name="xbrl-comprises-the-following-components" />XBRL umfasst die folgenden Komponenten
...
## <a name="layered-taxonomies" />Mehrschichtige Taxonomien
...
## <a name="set-up-xbrl-lines" />XBRL-Zeilen festlegen
...
## <a name="import-an-xbrl-taxonomy" />Importieren einer XBRL-Taxonomie
...
## <a name="update-an-xbrl-taxonomy" />Aktualisieren einer XBRL-Taxonomie
...
## <a name="see-related-training-at-microsoft-learnlearnmodulesxbrl-reports-dynamics--business-centralindex" />Siehe dazu die Schulung unter [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index).
