...
ms.author: edupont
---
# <a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a>Berichte mit XBRL erstellen
...
## <a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a>XBRL umfasst die folgenden Komponenten
...
## <a name="layered-taxonomies"></a><a name="layered-taxonomies"></a>Mehrschichtige Taxonomien
...
## <a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a>XBRL-Zeilen festlegen
...
## <a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a>Importieren einer XBRL-Taxonomie
...
## <a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a>Aktualisieren einer XBRL-Taxonomie
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Siehe dazu die Schulung unter [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index).
