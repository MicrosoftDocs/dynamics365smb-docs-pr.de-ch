...
ms.locfileid: "8135491"
---
# <a name="create-reports-with-xbrl"></a>Berichte mit XBRL erstellen

> [!NOTE]
> Wir sind dabei, die Funktionen für XBRL-Berichte aus [!INCLUDE[prod_short](includes/prod_short.md)] zu entfernen. Weitere Informationen finden Sie unter [Änderungen in 2022 Release Welle 1](/dynamics365/business-central/dev-itpro/upgrade/deprecated-features-w1).
...
> [!NOTE]
> Sie können fibupostenbezogene Schemas importieren und XBRL Instance Documents erstellen, indem Sie Fibudaten aus dem Kontenplan Elementen in Taxonomien zuordnen, die für Finanzberichte wie Bilanzen, Erfolgsrechnungen usw. erstellt wurden.
> 
...
7.  Um dem Finanzbericht eine Notiz hinzuzufügen, wählen Sie die **Notizen** Aktion.  
   ...
   > [!TIP]
   > Um Zeilen vom Export auszuschliessen, wählen Sie **UNZUTREFFEND** als Quelltyp aus.
