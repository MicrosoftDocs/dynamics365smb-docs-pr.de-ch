...
# <a name="handling-lot-sizes-in-production"></a><a name="handling-lot-sizes-in-production"></a>Umgang mit Losgrössen in der Produktion
...
## <a name="units-of-measure-in-production-bill-of-materials"></a><a name="units-of-measure-in-production-bill-of-materials"></a>Einheiten in der Stückliste
...
## <a name="lot-size-on-routing-lines"></a><a name="lot-size-on-routing-lines"></a>Losgrösse auf Arbeitsgänge
...
## <a name="lot-sizes-for-items-and-stockkeeping-units"></a><a name="lot-sizes-for-items-and-stockkeeping-units"></a>Losgrössen für Artikel und Lagereinheiten
...
## <a name="lot-size-on-item-and-stockkeeping-units"></a><a name="lot-size-on-item-and-stockkeeping-units"></a>Losgrösse für Artikel und Lagereinheiten
