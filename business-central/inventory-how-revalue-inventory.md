...
ms.author: edupont
---
# <a name="revalue-inventory"></a><a name="revalue-inventory"></a><a name="revalue-inventory"></a>Neubewerten von Lagerbestand
...
## <a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a><a name="to-revalue-inventory"></a>Neubewerten von Lagerbestand
