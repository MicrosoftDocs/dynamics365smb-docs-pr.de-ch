...
Nachdem Sie Suchbegriffe in das Suchfeld eingegeben haben, können Sie die genauen Suchkriterien und die Felder anzeigen, auf die sie angewendet wurden, indem Sie den Seitenprüfbereich öffnen (**Ctrl + ALT+F1**) und dann die Registerkarte **Seitenfilter** wählen.
