...
ms.author: bholtorf
---
# <a name="create-bank-deposits" />Bankeinzahlungen erstellen
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits" />Nummernserien und Abschlagseinzahlungen
...
### <a name="general-journal-templates-for-bank-deposits" />Fibu Erf.-Journalvorlagen für Bankeinzahlungen
...
## <a name="dimensions-on-bank-deposit-lines" />Dimensionen in Bankeinzahlungszeilen
...
## <a name="create-a-bank-deposit" />Bankeinzahlung erstellen
...
## <a name="finding-posted-bank-deposits" />Suchen gebuchter Bankeinzahlungen
...
## <a name="reversing-a-posted-bank-deposit" />Stornieren einer gebuchten Bankeinzahlung
