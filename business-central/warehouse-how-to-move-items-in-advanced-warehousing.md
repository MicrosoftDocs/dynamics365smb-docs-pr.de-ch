...
# <a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick" />Artikel in erweiterten Lagerkonfigurationen umlagern, die gesteuerte Einlagerung und Kommissionierung verwenden
...
## <a name="warehouse-movement-worksheet" />Lagerplatzumlagerungsarbeitsblatt

### <a name="to-move-items-with-the-warehouse-movement-worksheet" />Um Artikel mit dem Lagerplatzumlagerungsarbeitsblatt umzulagern
...
### <a name="to-register-the-warehouse-movement" />So registrieren Sie die Lagerplatzumlagerung:
...
## <a name="internal-pick" />Interne Kommissionierung

### <a name="to-create-an-internal-pick" />So erstellen Sie eine interne Kommissionierung
...
### <a name="to-register-the-warehouse-pick" />So registrieren Sie die Warenkommissionierung
...
## <a name="internal-put-away" />Interne Einlagerung

### <a name="to-create-an-internal-put-away" />So erstellen Sie eine interne Einlag.-Anforderung
...
### <a name="to-register-the-warehouse-put-away" />So registrieren Sie eine Wareneinlagerung
...
## <a name="to-register-a-movement-that-has-already-happened" />So registrieren Sie eine Umlagerung, die bereits stattgefunden hat
