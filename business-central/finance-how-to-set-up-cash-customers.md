...
ms.author: edupont
---
# <a name="set-up-cash-customers"></a><a name="set-up-cash-customers"></a>Bargelddebitoren einrichten
...
## <a name="to-set-up-a-cash-customer"></a><a name="to-set-up-a-cash-customer"></a>So richten Sie Bargelddebitoren ein:
