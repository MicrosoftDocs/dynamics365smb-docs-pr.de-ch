...
---
# <a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a>Designdetails: Zentrale Konzepte des Planungssystems
...
## <a name="planning-parameters"></a><a name="planning-parameters"></a>Planungsparameter
...
## <a name="planning-starting-date"></a><a name="planning-starting-date"></a>Startdatum der Planung
...
## <a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a>Dynamisches Auftragstracking (Bedarfsverursacher)
...
### <a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a>Dynamisches Auftragstracking gegenüber dem Planungssystem
...
## <a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a>Sequenz und Priorität in der Planung
...
### <a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a>Element-Priorität / Low-Level Code
...
#### <a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a>Optimierung der Leistung für Low-Level-Berechnungen
...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Orte / Priorität auf Übertragungsebene
...
### <a name="order-priority"></a><a name="order-priority"></a>Auftragspriorität
...
## <a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a>Bedarfsplanung und Rahmenaufträge
...
## <a name="planning-assignment"></a><a name="planning-assignment"></a>Planungszuordnung
...
## <a name="item-dimensions"></a><a name="item-dimensions"></a>Dimensionen der Elemente
...
## <a name="item-attributes"></a><a name="item-attributes"></a>Artikelattribute
...
### <a name="specific-attributes"></a><a name="specific-attributes"></a>Spezifische Attribute
...
### <a name="non-specific-attributes"></a><a name="non-specific-attributes"></a>Unspezifische Attribute
...
## <a name="order-to-order-links"></a><a name="order-to-order-links"></a>Order-to-Order-Verbindungen
...
## <a name="reservations"></a><a name="reservations"></a>Reservierungen
...
## <a name="warnings"></a><a name="warnings"></a>Warnungen
...
### <a name="emergency"></a><a name="emergency"></a>Notfall
...
### <a name="exception"></a><a name="exception"></a>Ausnahme
...
### <a name="attention"></a><a name="attention"></a>Achtung
...
## <a name="error-logs"></a><a name="error-logs"></a>Fehlerprotokolle
...
## <a name="planning-flexibility"></a><a name="planning-flexibility"></a>Flexibilität bei der Planung
...
## <a name="order-planning"></a><a name="order-planning"></a>Auftragsplanung
...
## <a name="finite-loading"></a><a name="finite-loading"></a>Begrenzte Ladung
