...
---
# <a name="design-details-central-concepts-of-the-planning-system" />Designdetails: Zentrale Konzepte des Planungssystems
...
## <a name="planning-parameters" />Planungsparameter
...
## <a name="planning-starting-date" />Startdatum der Planung
...
## <a name="dynamic-order-tracking-pegging" />Dynamisches Auftragstracking (Bedarfsverursacher)
...
### <a name="dynamic-order-tracking-versus-the-planning-system" />Dynamisches Auftragstracking gegenüber dem Planungssystem
...
## <a name="sequence-and-priority-in-planning" />Sequenz und Priorität in der Planung
...
### <a name="item-priority--low-level-code" />Element-Priorität / Low-Level Code
...
#### <a name="optimizing-performance-for-low-level-calculations" />Optimierung der Leistung für Low-Level-Berechnungen
...
### <a name="locations--transfer-level-priority" />Orte / Priorität auf Übertragungsebene
...
### <a name="order-priority" />Auftragspriorität
...
## <a name="demand-forecasts-and-blanket-orders" />Bedarfsplanung und Rahmenaufträge
...
## <a name="planning-assignment" />Planungszuordnung
...
## <a name="item-dimensions" />Dimensionen der Elemente
...
## <a name="item-attributes" />Artikelattribute
...
### <a name="specific-attributes" />Spezifische Attribute
...
### <a name="non-specific-attributes" />Unspezifische Attribute
...
## <a name="reservations" />Reservierungen
...
## <a name="error-logs" />Fehlerprotokolle
...
## <a name="planning-flexibility" />Flexibilität bei der Planung
...
## <a name="order-planning" />Auftragsplanung
...
## <a name="finite-loading" />Begrenzte Ladung
