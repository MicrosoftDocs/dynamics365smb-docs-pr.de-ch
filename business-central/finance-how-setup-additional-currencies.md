...
In der Anwendung wird der Fibuposten in der Mandantenwährung (MW) eingerichtet, aber eine weitere Währung, der ein aktueller Wechselkurs zugewiesen ist, kann als zusätzliche Währung eingerichtet werden. Wird eine zweite Währung als Berichtswährung festgelegt, erfasst [!INCLUDE[prod_short](includes/prod_short.md)] Beträge automatisch für jeden Fibuposten und weitere Posten, wie zum Beispiel MWST-Posten, sowohl in der LW als auch in der Berichtswährung.
...
## <a name="displaying-reports-and-amounts-in-acy"></a>Anzeigen von Berichten und Beträgen in der Berichtswährung
...
Einige Finanzberichte basieren auf Fibuposten. Um die Finanzdaten in dem Bericht in der Berichtswährung anzuzeigen, wählen Sie das Kontrollkästchen **Beträge in Berichtswährung ausgeben** im Inforegister **Optionen** für den entsprechenden Finanzbuchhaltungsbericht.
...
## <a name="setting-up-an-acy"></a>Einrichten einer Berichtswährung
...
3. Wenn Sie die Buchung in einer Berichtswährung durchführen, können Sie im Feld **MWST-Kursregulierung** angeben, wie die auf der Seite **MWST-Buchungseinrichtung** für die Buchung der MWST eingerichteten Konten bei Wechselkursschwankungen zwischen der LW und der Berichtswährung reguliert werden.  
...
### <a name="to-activate-the-acy"></a>Berichtswährung aktivieren:
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Hauptbuchhaltung Einrichtung** ein und wählen Sie dann den zugehörigen Link.  
