...
ms.author: jswymer
---
# <a name="opening-and-sharing-business-central-files-in-microsoft-onedrive" />Öffnen und Freigeben von Business Central Dateien in Microsoft OneDrive
...
## <a name="open-in-onedrive" />In OneDrive öffnen
...
## <a name="first-time-sign-in-from-business-central" />Erstmalige Anmeldung über Business Central
...
## <a name="managing-multiple-copies-of-a-file" />Verwalten mehrerer Kopien einer Datei
...
## <a name="about-your-business-central-folder-on-onedrive" />Informationen zu Ihrem Business Central-Ordner auf OneDrive
