...
Wenn eine Datei mit demselben Namen bereits in OneDrive vorhanden ist, bietet Ihnen [!INCLUDE[prod_short](includes/prod_short.md)] ausserdem die Möglichkeit, die Datei zu ersetzen oder beide Dateien zu behalten. Wenn Sie beide Dateien behalten möchten, wird die neue Datei in OneDrive kopiert und erhält einen Dateinamen mit einer Suffixnummer, z. B. „Artikel (2).xlsx“. Die ursprügnliche Datei wird nicht verändert. 
