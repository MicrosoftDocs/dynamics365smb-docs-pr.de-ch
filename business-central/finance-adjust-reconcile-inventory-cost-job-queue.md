---
title: Anpassen der Kosten/Abstimmen der Kosten mit dem Hauptbuch mithilfe der Aufgabenwarteschlange
...
ms.locfileid: "6688477"
---
# <a name="adjust-and-reconcile-inventory-cost-with-general-ledger-with-job-queue"></a>Anpassen von Lagerkosten und Abstimmen der Kosten mit dem Hauptbuch mithilfe der Aufgabenwarteschlange

Um die Erfahrung zu optimieren, sind die automatische Kostenanpassung und die Buchung im Hauptbuch standardmässig aktiviert. Da sich jedoch im Laufe der Zeit Daten ansammeln, kann dies die Leistung beeinträchtigen. Um die Belastung der Anwendung zu reduzieren, ist es oft hilfreich, Aufgabenwarteschlangeneinträge zu verwenden, um Aufgaben in den Hintergrund zu verschieben.
...
3. Wählen Sie in der Benachrichtigung, die jetzt oben auf der Seite angezeigt wird, die Verknüpfung **Einen Projektwarteschlangenposten planen** aus.
...
> [!NOTE]
> Um Sperren zu vermeiden, planen Sie keine Aufgaben für den Batchauftrag **Lagerreg. fakt. Einst. Preise**, die Codeunit **Lagerreg. buchen** und Aufgaben zum gleichzeitigen Buchen von Verkaufs- oder Einkaufstransaktionen, und stellen Sie sicher, dass sie dieselbe Aufgabenwarteschlangen-Kategorie verwenden.
