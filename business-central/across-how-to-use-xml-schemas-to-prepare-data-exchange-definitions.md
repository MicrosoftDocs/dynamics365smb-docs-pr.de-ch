...
ms.author: edupont
---
# <a name="use-xml-schemas-to-prepare-data-exchange-definitions" />Verwenden von XML-Schemata zur Vorbereitung der Datenaustauschdefinitionen
...
## <a name="to-load-an-xml-schema-file" />So laden Sie eine XML-Schemadatei
...
### <a name="to-select-or-clear-nodes-in-an-xml-schema" />So wählen oder löschen Sie Knoten in XML-Schema
...
### <a name="to-generate-a-data-exchange-definition-that-is-based-on-an-xml-schema" />So generieren Sie eine Datenaustauschdefinition, die auf einem XML-Schema basiert
