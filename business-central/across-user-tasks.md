...
ms.author: edupont
---
# <a name="define-user-tasks" />Benutzeraufgaben definieren
...
## <a name="managing-user-tasks" />Benutzeraufgaben verwalten
...
### <a name="picking-up-user-tasks" />Benutzeraufgaben aufnehmen
...
### <a name="deleting-user-tasks" />Benutzeraufgaben löschen
