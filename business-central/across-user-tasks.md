...
ms.author: edupont
---
# <a name="define-user-tasks"></a><a name="define-user-tasks"></a>Benutzeraufgaben definieren
...
## <a name="managing-user-tasks"></a><a name="managing-user-tasks"></a>Benutzeraufgaben verwalten
...
### <a name="picking-up-user-tasks"></a><a name="picking-up-user-tasks"></a>Benutzeraufgaben aufnehmen
...
### <a name="deleting-user-tasks"></a><a name="deleting-user-tasks"></a>Benutzeraufgaben löschen
