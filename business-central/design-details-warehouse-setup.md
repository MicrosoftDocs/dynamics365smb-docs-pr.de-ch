---
title: Entwurfsdetails – Einrichtung des Lagers
description: 'Die Funktionalität des Lagers enthält verschiedene Komplexitätsstufen, die grösstenteils durch die Einrichtung der Lagerplätze auf den Lagerortkarten definiert werden.'
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
ms.author: edupont
---
# <a name="design-details-warehouse-setup"></a><a name="design-details-warehouse-setup"></a><a name="design-details-warehouse-setup"></a>Designdetails: Lagereinrichtung
...
Die nachstehende Tabelle zeigt, welche Elemente benötigt werden, um verschiedene Lagerkomplexitätsebenen zu definieren, welche UI-Belege die einzelnen Ebenen unterstützen und welche Lagerortcodes diese Ebenen in der [!INCLUDE[prod_short](includes/prod_short.md)] Demodatenbank widerspiegeln.  

[!INCLUDE [locations-cronus](includes/locations-cronus.md)]

|Komplexitätsebene|Beschreibung|UI-Beleg|Beispiel Ort|Minimale Elementanforderung|  
|----------------|-----------|-----------|---------------|---------------------------|  
...
Beispiele dazu, wie die UI-Belege pro Lagerkomplexitätsebene verwendet werden, finden Sie unter [Designdetails: Eingehender Lagerhausfluss](design-details-inbound-warehouse-flow.md).  

## <a name="bin-and-bin-content"></a><a name="bin-and-bin-content"></a><a name="bin-and-bin-content"></a>Lagerplatz,Lagerplatzinhalt
