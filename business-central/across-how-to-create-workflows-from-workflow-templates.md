...
ms.author: edupont
---
# <a name="create-workflows-from-workflow-templates" />Erstellen von Workflows aus Workflowvorlagen
...
## <a name="to-create-a-workflow-from-a-workflow-template" />So erstellen Sie einen Workflow über eine Workflowvorlage
