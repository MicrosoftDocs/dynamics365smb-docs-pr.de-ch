...
ms.author: edupont
---
# <a name="set-up-bin-types"></a><a name="set-up-bin-types"></a><a name="set-up-bin-types"></a>Lagerplatzarten einrichten
...
## <a name="to-set-up-the-bin-types-you-want-to-use"></a><a name="to-set-up-the-bin-types-you-want-to-use"></a><a name="to-set-up-the-bin-types-you-want-to-use"></a>So richten die Lagerplatzarten ein, die Sie verwenden möchten:
