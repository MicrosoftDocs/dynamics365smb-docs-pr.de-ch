...
ms.author: jswymer
---
# <a name="create-segments"></a><a name="create-segments"></a>Segmente erstellen
...
## <a name="to-create-a-segment"></a><a name="to-create-a-segment"></a>So erstellen Sie ein Segment
