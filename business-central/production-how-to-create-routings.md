...
ms.author: edupont
---
# <a name="create-routings"></a><a name="create-routings"></a>Routings erstellen
...
## <a name="to-create-a-routing"></a><a name="to-create-a-routing"></a>So erstellen Sie ein Routing
...
## <a name="to-create-routing-links"></a><a name="to-create-routing-links"></a>So erstellen Sie einen Arbeitsplanlink
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a><a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a>Personal, Werkzeug und Prüfmassnahmen den Arbeitsplanvorgängen zuweisen
...
## <a name="to-create-a-new-versions-of-a-routing"></a><a name="to-create-a-new-versions-of-a-routing"></a>Neue Arbeitsplanversionen erzeugen
