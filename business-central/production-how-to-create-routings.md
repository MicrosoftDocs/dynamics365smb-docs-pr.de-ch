...
description: 'Diese Artikel gibt einen Überblick über die verschiedenen Möglichkeiten, Arbeitspläne zu erstellen, einschliesslich der erforderlichen Voraussetzungen und wie Sie Arbeitsplan-Verknüpfungen erstellen.'
author: brentholtorf
ms.author: bholtorf
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a>Personal, Werkzeug und Prüfmassnahmen den Arbeitsplanvorgängen zuweisen
...
5. Füllen Sie die Felder je nach Bedarf aus. [!INCLUDE [tooltip-inline-tip_md](../archive/SetupAndAdministration/includes/tooltip-inline-tip_md.md)]
