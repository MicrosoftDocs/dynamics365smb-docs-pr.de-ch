...
---
# <a name="design-details-handling-reordering-policies" />Designdetails: Umgang mit Wiederbeschaffungsverfahren
...
## <a name="stay-below-the-overflow-level" />Unter der Überlaufmenge bleiben
...
### <a name="calculating-the-overflow-level" />Berechnung der Überlaufmenge
...
#### <a name="order-multiple" />Losgrössenrundungsfaktor
