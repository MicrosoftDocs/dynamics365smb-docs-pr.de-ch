...
---
# <a name="design-details-handling-reordering-policies"></a><a name="design-details-handling-reordering-policies"></a>Designdetails: Umgang mit Wiederbeschaffungsverfahren
...
## <a name="the-role-of-the-reorder-point"></a><a name="the-role-of-the-reorder-point"></a>Die Rolle des Meldebestands
...
## <a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a><a name="monitoring-the-projected-inventory-level-and-the-reorder-point"></a>Überwachen der voraussichtlichen Lagerebene und des Meldebestands
...
### <a name="projected-inventory"></a><a name="projected-inventory"></a>Voraussichtlicher Lagerbestand
...
### <a name="projected-available-inventory"></a><a name="projected-available-inventory"></a>Voraussichtlich verfügbarer Lagerbestand
...
### <a name="time-buckets"></a><a name="time-buckets"></a>Zeitrahmen
...
### <a name="determining-the-projected-inventory-level"></a><a name="determining-the-projected-inventory-level"></a>Bestimmen des voraussichtlichen Lagerbestands
...
## <a name="the-role-of-the-time-bucket"></a><a name="the-role-of-the-time-bucket"></a>Die Rolle des Zeitrahmens
...
## <a name="stay-below-the-overflow-level"></a><a name="stay-below-the-overflow-level"></a>Unter der Überlaufmenge bleiben
...
### <a name="calculating-the-overflow-level"></a><a name="calculating-the-overflow-level"></a>Berechnung der Überlaufmenge

Die Überlaufmenge wird auf verschiedene Arten abhängig vom Wiederbeschaffungsverfahren berechnet.  

#### <a name="maximum-qty"></a><a name="maximum-qty"></a>Auffüllen auf Maximalbestand
...
#### <a name="fixed-reorder-qty"></a><a name="fixed-reorder-qty"></a>Feste Bestellmenge
...
#### <a name="order-multiple"></a><a name="order-multiple"></a>Losgrössenrundungsfaktor
...
### <a name="creating-the-planning-line-with-an-overflow-warning"></a><a name="creating-the-planning-line-with-an-overflow-warning"></a>Erstellen der Planungszeile mit Überlaufwarnmeldung
...
#### <a name="calculating-the-planning-line-quantity"></a><a name="calculating-the-planning-line-quantity"></a>Berechnen der Planungszeilenmenge
...
#### <a name="defining-the-action-message-type"></a><a name="defining-the-action-message-type"></a>Definieren des Aktionsmeldungstyps
...
#### <a name="composing-the-warning-message"></a><a name="composing-the-warning-message"></a>Verfassen der Warnmeldung
...
#### <a name="item-setup"></a><a name="item-setup"></a>Artikeleinrichtung
...
#### <a name="situation-before-sales-decrease"></a><a name="situation-before-sales-decrease"></a>Situation vor Vertriebsabgang
...
#### <a name="situation-after-sales-decrease"></a><a name="situation-after-sales-decrease"></a>Situation nach Vertriebsabgang
...
#### <a name="resulting-planning-lines"></a><a name="resulting-planning-lines"></a>Planungszeilen erstellen
...
## <a name="handling-projected-negative-inventory"></a><a name="handling-projected-negative-inventory"></a>Bestandvoraussichtlich negativ behandeln
...
## <a name="reordering-policies"></a><a name="reordering-policies"></a>Wiederbeschaffungsverfahren
...
### <a name="fixed-reorder-quantity"></a><a name="fixed-reorder-quantity"></a>Feste Wiederbeschaffungsmenge
...
#### <a name="calculated-per-time-bucket"></a><a name="calculated-per-time-bucket"></a>Berechnet pro Zeitrahmen
...
#### <a name="creates-only-necessary-supply"></a><a name="creates-only-necessary-supply"></a>Erstellt nur erforderlichen Vorrat
...
#### <a name="combines-with-order-modifiers"></a><a name="combines-with-order-modifiers"></a>Wird mit anderen Auftragsmodifizierern kombiniert
...
#### <a name="combines-with-calendars"></a><a name="combines-with-calendars"></a>Zusammenfassen mit Kalendern
...
#### <a name="shouldnt-be-used-with-forecasts"></a><a name="shouldnt-be-used-with-forecasts"></a>Sollte nicht mit Planung verwendet werden
...
#### <a name="must-not-be-used-with-reservations"></a><a name="must-not-be-used-with-reservations"></a>Darf nicht mit Reservierungen verwendet werden
...
### <a name="maximum-quantity"></a><a name="maximum-quantity"></a>Höchstmenge
...
#### <a name="calculate-per-time-bucket"></a><a name="calculate-per-time-bucket"></a>Berechnet pro Zeitrahmen
...
#### <a name="combine-with-order-modifiers"></a><a name="combine-with-order-modifiers"></a>Mit anderen Auftragsmodifizierern kombinieren
...
### <a name="combine-with-calendars"></a><a name="combine-with-calendars"></a>Mit Kalendern kombinieren

Bevor ein neuer Beschaffungsauftrag vorgeschlagen wird, um einen Meldebestand zu erfüllen, prüft das Planungssystem, ob der Auftrag für einen arbeitsfreien Tag geplant ist. Es verwendet die Kalender, die Sie im Feld **Basiskalendercode** in den Seiten **Unternehmensinformationen** und **Standortkarte** angegeben haben.  

Wenn das geplante Datum ein freier Tag ist, verschiebt das Planungssystem die Reihenfolge weiter zum nächsten Arbeitstag. Eine Verschiebung des Datums kann zu einem Verkaufsauftrag, der für einen Minimalbestand gilt, aber keinen bestimmten Bedarf abdeckt. Bei solcher Nachfrage ohne Bedarf erstellt das Planungssystem ein zusätzlicher Vorrat.

### <a name="order"></a><a name="order"></a>Bestellung
...
#### <a name="order-to-order-links-and-past-due-dates"></a><a name="order-to-order-links-and-past-due-dates"></a>Auftrag-zu-Auftrag-Links und überfällige Datumsangaben
...
### <a name="lot-for-lot"></a><a name="lot-for-lot"></a>Los-für-Los
