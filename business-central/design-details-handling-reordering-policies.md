...
## <a name="stay-below-the-overflow-level"></a>Unter der Überlaufmenge bleiben
...
### <a name="calculating-the-overflow-level"></a>Berechnung der Überlaufmenge
...
Das Feld **Neuplanungsperiode** trägt gemeinsam mit dem Feld **Loskumulierungsperiode** dazu bei, den Bestellzyklus festzulegen. Ab dem Datum des ersten Bedarfspostens fasst das System alle Bedarfsposten in der nächsten Loskumulierungsperiode in einen Beschaffungsauftrag am Tag des ersten Bedarfs zusammen. Ein Bedarf, der ausserhalb der Loskumulierungsperiode liegt, fällt nicht unter den Beschaffungsauftrag.
