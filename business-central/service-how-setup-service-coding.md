...
# <a name="set-up-standard-service-codes" />Standardservicecodes einrichten
...
## <a name="to-set-up-a-standard-service-code" />So richten Sie einen Standardservicecode ein
...
## <a name="to-assign-a-standard-service-code-to-a-service-item-group" />So weisen Sie einer Serviceartikelgruppe einen Standardservicecode zu
