...
> [!Important]  
> Das Ändern einer globalen Dimension oder eines Dimensionscodes erfordert, dass alle Posten, die mit der Dimension gebucht werden, aktualisiert werden. Diese Aufgabe können Sie mit der Funktion **Globale Dimensionen ändern** ausführen, aber dies kann zeitaufwändig sein und sich negativ auf die Leistung auswirken. Ausserdem können Tabellen während des Updates gesperrt sein. Daher wählen Sie Ihre globalen und Shortcutdimensionen sorgfältig aus, um sie später nicht ändern zu müssen. <br /><br />
...
> [!Note]
> Wenn Sie eine globale Dimension oder einen Dimensionscode hinzufügen oder ändern, werden Sie automatisch abgemeldet und wieder angemeldet, damit der neuen Wert zur Verwendung in der vollständigen Anwendung vorbereitet wird.
