...
# <a name="allocate-resources" />Ressourcen zuordnen
...
## <a name="to-see-an-overview-of-service-orders-and-service-quotes" />So zeigen Sie eine Übersicht der Serviceaufträge und -angebote an
...
## <a name="to-allocate-a-resource-using-resource-or-resource-group-availability" />So weisen Sie eine Ressource anhand der Ressource oder der Ressourcengruppenverfügbarkeit zu
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Einsatzplanung** ein, und wählen Sie den zugehörigen Link.  
...
## <a name="to-allocate-a-resource-using-a-service-order" />So weisen Sie eine Ressource in einem Serviceauftrag zu
...
## <a name="to-reallocate-resources-on-a-service-order" />So ordnen Sie Ressourcen in einem Serviceauftrag neu zu
...
## <a name="to-reallocate-a-resource-using-the-dispatch-board" />So ordnen Sie eine Ressource mithilfe der Einsatzplanung neu zu
...
## <a name="to-register-resource-hours" />So erfassen Sie Ressourcenzeiten
...
## <a name="to-assign-a-resource-to-all-service-items-in-an-order" />So ordnen Sie allen Serviceartikeln in einem Serviceauftrag Ressourcen zu
...
## <a name="to-cancel-an-allocation" />So stornieren Sie eine Zuordnung
