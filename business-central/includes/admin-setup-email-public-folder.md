...
### <a name="create-an-admin-role-group" />Eine Administratorrollengruppe erstellen
...
### <a name="create-a-new-public-folder-mailbox" />Ein neues Postfach für öffentliche Ordner erstellen
...
### <a name="create-new-public-folders" />Neue öffentliche Ordner erstellen
...
### <a name="set-public-folder-ownership" />Besitz für öffentliche Ordner festlegen
...
### <a name="mail-enable-the-queue-public-folder" />Den öffentlichen Ordner *Warteschlange* für E-Mail aktivieren
...
### <a name="mail-enable-sending-emails-to-the-queue-public-folder" />Das Senden von E-Mails an den öffentlichen Ordner *Warteschlange* aktivieren
