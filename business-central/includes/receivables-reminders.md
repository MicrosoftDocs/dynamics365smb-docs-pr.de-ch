...
### <a name="to-create-a-reminder-automatically"></a><a name="to-create-a-reminder-automatically"></a>So erstellen Sie Mahnungen automatisch:
...
### <a name="to-create-a-reminder-manually"></a><a name="to-create-a-reminder-manually"></a>So werden Mahnungen manuell erstellt:
...
### <a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a>So ersetzen Sie Mahnungstexte:
...
### <a name="to-issue-a-reminder"></a><a name="to-issue-a-reminder"></a>Um eine Mahnung auszugeben
...
### <a name="to-cancel-an-issued-reminder"></a><a name="to-cancel-an-issued-reminder"></a>Zum Stornieren der registrierten Mahnung.
