...
### <a name="to-create-a-reminder-automatically" />So erstellen Sie Mahnungen automatisch:
...
### <a name="to-create-a-reminder-manually" />So werden Mahnungen manuell erstellt:
...
### <a name="to-replace-reminder-texts" />So ersetzen Sie Mahnungstexte:
...
### <a name="to-issue-a-reminder" />Um eine Mahnung auszugeben
...
### <a name="to-cancel-an-issued-reminder" />Zum Stornieren der registrierten Mahnung.
