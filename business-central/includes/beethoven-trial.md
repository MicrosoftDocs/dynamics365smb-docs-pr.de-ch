...
ms.author: edupont
---
## <a name="sign-up" />Anmeldung

### <a name="which-email-address-i-should-use-to-sign-up" />Mit welcher E-Mail-Adresse soll ich mich anmelden?
...
### <a name="what-are-the-system-requirements-for-the-trial" />Welche Systemvoraussetzungen bestehen für die Testversion?
...
## <a name="trial-app" />Test-App

### <a name="i-didnt-receive-the-trial-details-email-after-signing-up-what-should-i-do" />Ich habe nach der Anmeldung keine E-Mail mit den Testinformationen erhalten. Was soll ich tun?
...
### <a name="how-do-i-add-more-users-to-a-trial" />Wie füge ich einer Testversion weitere Benutzer hinzu?
...
### <a name="how-many-users-can-i-add-to-my-trial-environment" />Wie viele Benutzer kann ich zu meiner Testumgebung hinzufügen?

Sie können der Testumgebung eine unbegrenzte Anzahl von Benutzern hinzufügen.

### <a name="how-do-i-reset-the-trial-environment" />Wie setze ich die Testumgebung zurück?
...
## <a name="trial-expiration-and-extension" />Ablauf und Verlängerung der Testversion

### <a name="how-do-i-extend-the-trial" />Wie verlängere ich den Testzeitraum?
