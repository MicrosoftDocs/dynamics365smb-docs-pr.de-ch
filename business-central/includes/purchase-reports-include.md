...
|**Kreditor/Artikel Einkäufe**|313|Zeigt eine Liste der Artikelposten jedes Kreditors in der ausgewählten Periode an. Der Bericht enthält Angaben zur fakturierten Menge, zum Rechnungsbetrag und zu möglichen Skonti. Der Bericht kann z. B. zur Analyse der Artikeleinkäufe verwendet werden, so dass Sie erfahren, ob es eine Beziehung zwischen Skonti und Artikeleinkäufen gibt.|
...
|**Lager - Kreditoreneinkäufe**|714|Zeigt eine Liste der Kreditoren, von denen Ihr Unternehmen in der ausgewählten Periode Artikel gekauft hat. Er zeigt die fakturierte Menge, den Betrag und den Skonto. Der Bericht kann dazu verwendet werden, die Einkäufe eines Unternehmens zu analysieren.|
