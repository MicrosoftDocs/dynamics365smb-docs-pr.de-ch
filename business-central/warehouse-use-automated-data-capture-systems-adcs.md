...
---
# <a name="use-automated-data-capture-systems-adcs" />Automatisierte Datenerfassung (MDE) verwenden
...
## <a name="to-enable-web-services-for-adcs" />So aktivieren Sie Webdienste für ADCS

Um das automatisierte Datenerfassungssystem verwenden zu können, müssen Sie den ADCS-Webdienst aktivieren.  

## <a name="to-enable-and-publish-the-adcs-web-service" />So aktivieren und veröffentlichen Sie den ADCS-Webdienst
...
## <a name="to-set-up-a-warehouse-to-use-adcs" />So richten Sie ein Lager für die Verwendung von MDE ein:
...
## <a name="to-specify-an-item-to-use-adcs" />So geben Sie einen Artikel für die Verwendung von MDE an
...
## <a name="to-add-an-adcs-user" />Um einen MDE-Benutzer hinzufügen
...
### <a name="to-specify-that-a-warehouse-employee-is-an-adcs-user" />So geben Sie an, dass ein Lagermitarbeiter ein MDE-Benutzer ist
...
## <a name="to-create-and-customize-miniforms" />So erstellen und passen Sie Miniforms an
...
### <a name="to-create-a-miniform-for-adcs" />Um ein Miniform für MDE zu erstellen
...
### <a name="to-customize-miniform-functions" />Um Miniform-Funktionen anzupassen
