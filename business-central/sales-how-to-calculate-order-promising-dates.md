...
ms.author: edupont
---
# <a name="calculate-order-promising-dates"></a><a name="calculate-order-promising-dates"></a>Lieferterminzusagen-Daten berechnen
...
## <a name="about-order-promising"></a><a name="about-order-promising"></a>Über Lieferterminzusagen
...
### <a name="available-to-promise"></a><a name="available-to-promise"></a>Lieferzusage
...
### <a name="capable-to-promise"></a><a name="capable-to-promise"></a>Beschaffungszusage
...
### <a name="calculations"></a><a name="calculations"></a>Berechnungen
...
## <a name="to-set-up-order-promising"></a><a name="to-set-up-order-promising"></a>Lieferterminzusagen einrichten
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a><a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a>Eingehende und ausgehende Lagerumschlagszeiten in der Lieferterminzusage
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a><a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a>So geben Sie eingehende und ausgehende Lagerbearbeitungszeiten für Standorte ein
...
## <a name="to-make-an-item-critical"></a><a name="to-make-an-item-critical"></a>Einen Artikel als kritisch kennzeichnen
...
## <a name="to-calculate-an-order-promising-date"></a><a name="to-calculate-an-order-promising-date"></a>Lieferterminzusagen berechnen
