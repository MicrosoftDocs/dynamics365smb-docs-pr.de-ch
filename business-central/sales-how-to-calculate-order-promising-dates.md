...
ms.author: edupont
---
# <a name="calculate-order-promising-dates" />Lieferterminzusagen-Daten berechnen
...
## <a name="about-order-promising" />Über Lieferterminzusagen
...
### <a name="available-to-promise" />Lieferzusage
...
### <a name="capable-to-promise" />Beschaffungszusage
...
### <a name="calculations" />Berechnungen
...
## <a name="to-set-up-order-promising" />Lieferterminzusagen einrichten
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising" />Eingehende und ausgehende Lagerumschlagszeiten in der Lieferterminzusage
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents" />So geben Sie Standard-Handlingszeiten für eingehende und ausgehende Lager für Einkaufs- und Verkaufsbelege ein
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations" />So geben Sie eingehende und ausgehende Lagerbearbeitungszeiten für Standorte ein
...
## <a name="to-make-an-item-critical" />Einen Artikel als kritisch kennzeichnen
...
## <a name="to-calculate-an-order-promising-date" />Lieferterminzusagen berechnen
...
## <a name="see-related-microsoft-trainingtrainingmodulespromising-sales-order-delivery-dynamics--business-central" />Siehe verwandte [Microsoft Schulungen](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)
