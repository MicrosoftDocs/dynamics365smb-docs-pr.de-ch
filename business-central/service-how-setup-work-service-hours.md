...
ms.author: edupont
---
# <a name="set-up-work-hours-and-service-hours" />Einrichten von Arbeits- und Servicezeiten
...
## <a name="to-set-up-default-service-hours" />So richten Sie Servicestandardzeiten ein
...
## <a name="to-set-up-work-hour-templates" />Um Arbeitszeitvorlagen einzurichten
...
## <a name="to-set-up-contract-specific-service-hours" />So richten Sie vertragsspezifische Servicezeiten ein
