...
Ein weiteres wichtiges Feld ist das Feld **Maximale Losgrösse** auf der Karte **Artikel**. Es gibt eine maximal zulässige Menge für einen Artikelbestellvorschlag an und wird verwendet, wenn der Artikel in einer festen Transporteinheit, wie einem Container, geliefert wird, die Sie beispielsweise vollständig ausnutzen möchten. Sobald ein Auffüllbedarf festgestellt und die Losgrösse entsprechend dem festgelegten Wiederbeschaffungsverfahren angepasst wurde, wird die Menge – falls notwendig – verringert, um die maximale Losgrösse einzuhalten, die Sie für den Artikel festgelegt haben. Wenn darüber hinaus noch ein Bedarf besteht, werden neue Aufträge berechnet, um diesen zu erfüllen. Sie verwenden Sie dieses Feld im Allgemeinen mit der Produktionsart „Lagerfertigung“.  
