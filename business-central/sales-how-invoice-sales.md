...
ms.author: edupont
---
# <a name="invoice-sales"></a><a name="invoice-sales"></a>Fakturieren eines Verkaufs
...
## <a name="create-sales-invoices"></a><a name="create-sales-invoices"></a>Verkaufsrechnung erstellen
...
### <a name="to-create-a-sales-invoice"></a><a name="to-create-a-sales-invoice"></a>So erstellen Sie eine Verkaufsrechnung
...
### <a name="calculating-invoice-discounts-on-sales"></a><a name="calculating-invoice-discounts-on-sales"></a>Rechnungsrabatte bei Verkäufen berechnen
...
## <a name="registering-payments"></a><a name="registering-payments"></a>Zahlungen registrieren
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/invoicing-customers-dynamics-365-business-central/index)
