...
ms.author: edupont
---
# <a name="set-up-units-of-measure"></a><a name="set-up-units-of-measure"></a>Einheiten einrichten
...
## <a name="to-set-up-units-of-measure"></a><a name="to-set-up-units-of-measure"></a>So richten Sie Einheiten ein
...
## <a name="to-set-up-multiple-item-units-of-measure"></a><a name="to-set-up-multiple-item-units-of-measure"></a>So richten Sie mehrere Einheiten für Artikel ein
...
## <a name="to-set-up-unit-of-measure-translations"></a><a name="to-set-up-unit-of-measure-translations"></a>Einheiten der Massübersetzungen einrichten
...
## <a name="to-enter-a-default-unit-of-measure-code-for-sales-and-purchasing-transactions"></a><a name="to-enter-a-default-unit-of-measure-code-for-sales-and-purchasing-transactions"></a>Um einen Vorgabe-Einheitencode für Einkaufs- und Verkaufstransaktionen einzugeben
