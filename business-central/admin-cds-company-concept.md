...
# <a name="data-ownership-models" />Modelle für Datenbesitz
...
## <a name="team-ownership" />Team-Eigentum
...
## <a name="choosing-a-different-business-unit" />Auswahl einer anderen Geschäftseinheit
...
## <a name="person-ownership" />Eigentum der Person
