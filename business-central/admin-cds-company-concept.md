...
Sie können die Geschäftsbereichsauswahl ändern. Wenn Sie eine andere Einheit wählen, z.B. eine, die Sie zuvor im CDS angelegt haben, behält sie ihren ursprünglichen Namen. Das heisst, es wird nicht mit dem Suffix der Firmen-ID versehen. Wir werden ein Team zusammenstellen, das die Namenskonvention anwendet.
