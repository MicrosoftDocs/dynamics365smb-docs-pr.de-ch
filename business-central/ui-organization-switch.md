...
# <a name="switching-to-another-company-or-environment" />Wechseln zu einem anderen Unternehmen oder einer anderen Umgebung
...
## <a name="about-companies-and-environments" />Unternehmen und Umgebungen
...
## <a name="features-for-switching-company-or-environment" />Funktionen zum Wechseln zu einem anderen Unternehmen oder einer anderen Umgebung
...
## <a name="use-the-company-switcher" />Verwenden Sie den Firmenumschalter
...
## <a name="use-the-app-launcher" />App-Startfeld verwenden
...
-->
## <a name="use-my-settings" />Meine Einstellungen verwenden
...
## <a name="use-company-hub" />Unternehmens-Hub verwenden
