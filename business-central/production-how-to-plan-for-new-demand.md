...
ms.author: edupont
---
# <a name="plan-for-new-demand-order-by-order"></a><a name="plan-for-new-demand-order-by-order"></a>Planung der Bestellung eines neuen Bedarfs von Auftrag
...
## <a name="to-plan-for-new-production-order-demand"></a><a name="to-plan-for-new-production-order-demand"></a>So planen Sie neue Fertigungsaufträge
...
## <a name="to-plan-for-any-new-demand"></a><a name="to-plan-for-any-new-demand"></a>Für beliebigen neuen Bedarf planen
...
## <a name="to-make-supply-orders"></a><a name="to-make-supply-orders"></a>Beschaffungsaufträge erstellen
