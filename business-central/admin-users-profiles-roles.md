...
In [!INCLUDE[d365fin](includes/d365fin_md.md)] werden Benutzer von einem Administrator hinzugefügt, der Benutzern auch Zugriff auf die Bereichen von [!INCLUDE[d365fin](includes/d365fin_md.md)] gibt, die sie in ihrer Arbeit benötigen.  
...
Das Verfahren zum Ändern eines vorhandenen Profils ist dasselbe, ausser dass Sie ein vorhandenes Profil auf der Seite **Profile** auswählen, anstatt auf **Neu** zu klicken.  
