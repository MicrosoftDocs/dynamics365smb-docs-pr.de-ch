...
## So ordnen Sie ein Profil einem Benutzer zu
...
## So definieren Sie Benutzereinstellungen für ein Profil
...
## Löscht alle von einem Benutzer vorgenommenen Anpassungen.
...
## So löschen Sie Personalisierungen für bestimmte Seiten
...
## Siehe verwandte [Microsoft Schulungen](/training/modules/users-security-dynamics-365-business-central/)
