...
2. Füllen Sie auf der Seite **Intercompanyeinrichtung** die Felder aus. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
  ...
  > [!NOTE]
  > Der 1. Veröffentlichungszyklus 2022 führt eine neue **Intercompanyeinrichtung**-Seite ein, damit Sie auch angeben können, ob dieses Unternehmen automatisch Erfassungsjournalzeilen basierend auf den Buchungen eines Intercompany-Partners über die **IC-Fibu Erf.-Journal**-Seite erstellen muss. Wenn Ihre Organisation [!INCLUDE [prod_short](includes/prod_short.md)] vor diesem Veröffentlichungszyklus verwendet hat, müssen Sie die neue Erfahrung in der **Funktionsverwaltung**-Seite einschalten. Weitere Informationen finden Sie unter [Automatisch akzeptierte Transaktionen für konzerninterne Journale](/dynamics365-release-plan/2022wave1/smb/dynamics365-business-central/intercompany-postings-have-auto-accept-transaction-enabled-intercompany-general-journals).
...
## <a name="to-set-up-default-intercompany-partner-general-ledger-accounts"></a>Vorgegebene IC-Partner-Fibukonten einrichten  
