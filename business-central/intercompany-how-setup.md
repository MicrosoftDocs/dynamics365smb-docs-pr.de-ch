...
* Tauschen Sie Informationen über ihre unternehmensübergreifenden Einrichtungen aus. Jeder Partner kann diese Informationen unter **Intercompanyeinrichtung**, **Aktionen**, **Verbindungsdetails** abrufen.
...
Führen Sie die **Intercompanyeinrichtung**, **Aktionen**, **Verbindungsdetails** in allen Unternehmen aus, um die Informationen anzugeben. 
...
> [!TIP]
> Es empfiehlt sich, beim Erstellen Ihrer registrierten App einen Texteditor wie Notepad geöffnet zu haben. Sie benötigen einige Informationen, wenn Sie die **Intercompanyeinrichtung**, **Aktionen**, **Verbindungsdetails** ausführen. Daher ist es hilfreich, die Informationen zur Hand zu haben.
...
5. Wählen Sie im Feld **Berechtigungssatz** die Berechtigungssätze **D365 INTERCOMPANY CE & DATA ACCESS IC CE** aus.
...
## <a name="set-up-intercompany-general-journal-templates-and-batches"></a>So richten Sie allgemeine Intercomapny-FibuErf.-Journalzeilenvorlagen und -chargen ein
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts"></a>Vorgegebene IC-Partner-Fibukonten einrichten
