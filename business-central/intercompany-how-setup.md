...
---
# <a name="set-up-intercompany-transactions" />Intercompany-Transaktionen einrichten
...
## <a name="overview-of-the-steps-to-get-started" />Übersicht über die ersten Schritte
...
## <a name="set-up-a-synchronization-partner" />Einen Synchronisierungspartner einrichten
...
## <a name="set-up-the-intercompany-charts-of-accounts" />Richten Sie den Intercompanykontenplan ein
...
### <a name="import-or-export-an-intercompany-chart-of-accounts" />So exportieren oder importieren Sie einen Intercompanykontenplan
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts" />Den Intercompanykontenplan dem unternehmenseigenen Kontenplan zuordnen
...
## <a name="set-up-intercompany-dimensions" />So richten Sie Intercompanydimensionen ein
...
### <a name="import-or-export-intercompany-dimensions" />Importieren oder exportieren von Intercompanydimensionen
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions" />Intercompanydimensionen Ihren unternehmenseigenen Dimensionen zuordnen
...
## <a name="set-up-intercompany-general-journal-templates-and-batches" />So richten Sie allgemeine Intercomapny-FibuErf.-Journalzeilenvorlagen und -chargen ein
...
## <a name="set-up-a-company-for-intercompany-transactions" />Unternehmen für Intercompanytransaktionen einrichten
...
## <a name="set-up-intercompany-partners" />Intercompanypartner einrichten
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors" />Einrichten von Intercompanypartner als Kunden und Kreditoren
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts" />Vorgegebene IC-Partner-Fibukonten einrichten
...
### <a name="auto-accept-transactions-from-intercompany-partners" />Transaktionen von Intercompanypartnern automatisch akzeptieren
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners" />Geben Sie die Bankkonten an, die für Intercompanypartner verwendet werden sollen
...
## <a name="troubleshoot-your-intercompany-setup" />Fehlerbehandlung für Ihre Intercompany-Einrichtung
