...
ms.author: edupont
---
# <a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a>Fibu-Buchungszeile - Überblick
...
## <a name="old-architecture"></a><a name="old-architecture"></a>Alte Architektur
...
### <a name="new-architecture"></a><a name="new-architecture"></a>Neue Architektur
