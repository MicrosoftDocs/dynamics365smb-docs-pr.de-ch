...
# <a name="synchronizing-data-in-business-central-with-microsoft-dataverse" />Synchronisieren von Daten in Business Central mit Microsoft Dataverse
...
## <a name="standard-table-mapping-for-synchronization" />Standard-Tabellenzuordnung für die Synchronisierung
...
### <a name="tip-for-admins-viewing-table-mappings" />Tipp für Administratoren: Aufrufen von Tabellenzuordnungen
