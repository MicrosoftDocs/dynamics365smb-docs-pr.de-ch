...
1. Wählen Sie die ![Glühbirne, die das Symbol Wie möchten Sie weiter verfahren](media/ui-search/search_small.png "Tell me-Funktion") öffnet, geben Sie **Benutzereinrichtung** ein und wählen Sie dann den entsprechenden Link.
