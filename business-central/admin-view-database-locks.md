...
ms.author: jswymer
---
# <a name="viewing-database-locks"></a><a name="viewing-database-locks"></a>Anzeigen von Datenbank-Sperren
...
## <a name="to-view-database-locks"></a><a name="to-view-database-locks"></a>So zeigen Sie Datenbanksperren an
