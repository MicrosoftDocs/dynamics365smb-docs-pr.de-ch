...
---
# <a name="set-up-customer-discount-groups" />Debitorenrabattgruppen einrichten
...
## <a name="create-sales-line-discounts-for-a-customer-group" />Verkaufszeilenrabatte für eine Debitorgruppe erstellen
...
## <a name="assign-a-customer-to-a-discount-group" />Einen Debitor einer Rabattgruppe zuweisen
