...
**Kundenrabattgruppen** sind ähnlich zu [Kundenpreisgruppen](sales-how-to-set-up-customer-price-groups.md), können aber mit Artikelrabattgruppen kombiniert werden, um für ausgewählte Kunden schnell Zeilenrabatte auf viele Artikel festzulegen.
