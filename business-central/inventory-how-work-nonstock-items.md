...
ms.locfileid: "9532121"
---
# <a name="work-with-catalog-items"></a>Arbeiten mit Katalogartikeln

Katalogartikel sind Elemente, die Sie in [!INCLUDE[prod_short](includes/prod_short.md)] erst dann verwalten, wenn Sie sie verkaufen. Wenn Sie die Aktion **Katalogelement auswählen** verwenden, um ein Katalogelement zu einer Zeile in einem Verkaufsauftrag oder einer Offerte hinzuzufügen, wird das Katalogelement in einen regulären Artikel umgewandelt.
