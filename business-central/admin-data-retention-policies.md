...
ms.author: bholtorf
---
# <a name="define-retention-policies" />Aufbewahrungsrichtlinien definieren
...
## <a name="required-setups-and-permissions" />Erforderliche Einrichtungen und Berechtigungen
...
### <a name="to-create-retention-periods" />So erstellen Sie Aufbewahrungszeiträume
...
### <a name="set-up-a-retention-policy" />Aufbewahrungsrichtlinie einrichten
...
## <a name="applying-retention-policies" />Anwenden von Aufbewahrungsrichtlinien
...
## <a name="viewing-retention-policy-log-entries" />Anzeigen von Protokolleinträgen für Aufbewahrungsrichtlinien
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer" />Ihre Erweiterung in eine Aufbewahrungsrichtlinie einbeziehen (erfordert die Unterstützung eines Entwicklers)
