...
ms.author: edupont
---
# <a name="assign-default-bins-to-items" />Zuordnen der Vorgabelagerplätze zu Artikeln
...
## <a name="to-assign-a-default-bin-to-an-item" />So weisen Sie einen Standardlagerplatz einem Artikel zu
...
## <a name="to-change-the-default-bin-for-an-item" />So ändern Sie den Standardlagerplatz für einen Artikel
