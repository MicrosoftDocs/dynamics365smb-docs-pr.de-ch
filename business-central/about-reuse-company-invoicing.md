...
ms.author: bholtorf
---
# <a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a><a name="use-the-same-microsoft-365-account-in--and-microsoft-invoicing"></a>Dasselbe Microsoft 365-Konto in [!INCLUDE[prod_short](includes/prod_long.md)] und Microsoft Invoicing verwenden
...
## <a name="workaround"></a><a name="workaround"></a>Problemumgehung
...
### <a name="to-rename-your-company"></a><a name="to-rename-your-company"></a>Ihr Unternehmen umbenennen
...
### <a name="what-about-my-data"></a><a name="what-about-my-data"></a>Informationen zu Ihren Daten.
