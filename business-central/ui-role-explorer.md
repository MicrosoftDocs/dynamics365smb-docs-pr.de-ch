...
# <a name="finding-pages-with-the-role-explorer" />Suchen von Seiten mit dem Rollen-Explorer
...
## <a name="open-the-role-explorer" />Öffnen Sie den Rollen-Explorer
...
## <a name="navigate-features" />Funktionen navigieren
...
## <a name="search-for-features" />Nach Funktionen suchen
...
## <a name="explore-other-roles" />Andere Rollen erforschen
...
## <a name="expand-and-collapse-nodes-on-the-role-explorer" />Knoten im Rollen-Explorer erweitern und komprimieren
