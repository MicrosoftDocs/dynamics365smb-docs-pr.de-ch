...
- Im Verkauf, wo Sie Bestandsentnahmen verwenden, um Bestandslieferungen zu buchen, erstellt [!INCLUDE[prod_short](includes/prod_short.md)] eine Bestandskommissionierposition für jede Verkaufsauftragsposition. Wenn der Artikel in verschiedene Behälter gelegt wird, wird mehr als eine Zeile erstellt. Diese Kommissionierzeilen basieren auf der Menge im Feld **Zu liefernde Menge**.
- In Verkäufen, bei denen die gesamte Menge aus der Verkaufsauftragszeile montiert wird, wird eine Lagerkommissionierzeile für diese Menge erstellt. Der Wert im Feld „Menge für Montage“ entspricht dem Wert im Feld **Zu liefernde Menge**. Das Feld **Auftragsmontage** wird in der Zeile ausgewählt.
