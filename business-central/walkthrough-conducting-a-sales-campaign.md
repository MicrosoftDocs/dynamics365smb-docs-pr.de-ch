...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign" />Exemplarische Vorgehensweise: Durchführen einer Verkaufskampagne
...
## <a name="setting-up-a-campaign" />Einrichten einer Kampagne
...
### <a name="to-set-up-a-campaign" />So richten Sie eine Kampagne ein
...
## <a name="selecting-the-target-audience" />Auswählen der Zielgruppe
...
### <a name="to-create-a-segment-with-the-relevant-contacts" />So erstellen Sie ein Segment mit den relevanten Kontakten
...
### <a name="to-save-your-segmentation-criteria" />So speichern Sie Ihre Segmentierungskriterien
...
## <a name="mining-the-data" />Data Mining
...
### <a name="to-remove-contacts-from-the-segment" />So entfernen Sie Kontakte aus dem Segment
...
### <a name="to-bring-back-the-removed-contacts" />So stellen Sie die entfernten Kontakte wieder her
...
## <a name="linking-a-segment-to-a-campaign" />Verknüpfen eines Segments mit einer Kampagne
...
### <a name="to-link-a-segment-to-the-campaign" />So verknüpfen Sie ein Segment mit der Kampagne
...
## <a name="sending-letters-and-email-messages-to-contacts" />Senden von Briefen und E-Mail-Nachrichten an Kontakte
...
### <a name="to-use-a-segment-to-send-a-letter-to-a-contact" />So verwenden Sie ein Segment, um einen Brief an einen Kontakt zu senden
...
### <a name="to-send-an-email-message-to-a-contact" />So senden Sie eine E-Mail-Nachricht an einen Kontakt
...
## <a name="registering-campaign-responses" />Erfassen von Kampagnenreaktionen
...
### <a name="to-register-campaign-responses" />So erfassen Sie Kampagnenreaktionen
