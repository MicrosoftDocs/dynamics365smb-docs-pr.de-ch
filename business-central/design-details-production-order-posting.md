...
ms.author: edupont
---
# <a name="design-details-production-order-posting" />Designdetails: Fertigungsauftragsbuchung
...
## <a name="posting-structure" />Buchen der Struktur
...
## <a name="capacity-posting" />Kapazitätsbuchung
...
## <a name="production-order-costing" />Nachkalkulation für einen Produktionsauftrag
