...
ms.author: edupont
---
# <a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a>Designdetails: Fertigungsauftragsbuchung
...
## <a name="posting-structure"></a><a name="posting-structure"></a>Buchen der Struktur
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a>Kapazitätsbuchung
...
## <a name="production-order-costing"></a><a name="production-order-costing"></a>Nachkalkulation für einen Produktionsauftrag
