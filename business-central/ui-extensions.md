...
Da die folgenden Erweiterungen mit anderen Diensten kommunizieren, übertragen sie möglicherweise Daten ausserhalb der [!INCLUDE[prod_short](includes/prod_short.md)]-Umgebung:
