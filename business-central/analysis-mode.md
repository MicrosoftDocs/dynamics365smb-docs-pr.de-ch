...
---
# <a name="analyze-list-data-using-data-analysis-mode" />Analysieren Sie Daten auf Listenseiten im Datenanalysemodus
...
## <a name="prerequisite" />Voraussetzung
...
## <a name="work-with-data-analysis-mode" />Arbeiten Sie mit dem Datenanalysemodus
...
## <a name="limitations" />Einschränkungen
