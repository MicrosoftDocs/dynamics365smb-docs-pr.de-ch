...
---
# <a name="creating-power-bi-reports-for-displaying-list-data-in-"></a>Power BI-Berichte zum Anzeigen von Listendaten in [!INCLUDE[prod_short](includes/prod_short.md)] erstellen
