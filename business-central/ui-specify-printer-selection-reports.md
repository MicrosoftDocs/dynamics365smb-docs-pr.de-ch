...
description: Erfahren Sie, wie Sie Drucker einrichten, die Sie für Berichte und Belege verwenden können.
author: jswymer
...
1. Wählen Sie das Symbol ![Glühbirne, die die Tell Me Funktion öffnet](media/ui-search/search_small.png "Tell me-Funktion") aus, geben Sie **Druckerverwaltung** ein, und klicken Sie dann auf den entsprechenden Link.
