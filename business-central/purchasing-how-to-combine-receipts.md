...
ms.author: edupont
---
# <a name="combine-receipts-on-a-single-invoice" />Zusammenfassen von Lieferungen in einer einzelnen Rechnung
...
## <a name="to-combine-receipts" />So fassen Sie Wareneingänge zusammen
...
## <a name="to-remove-open-purchase-orders-after-combined-receipt-posting" />Offene Einkaufsreklamationen nach kombinierter Lieferungsbuchung entfernen
...
## <a name="see-related-microsoft-trainingtrainingmodulesprocessing-invoices-dynamics--business-central" />Siehe verwandte [Microsoft Schulungen](/training/modules/processing-invoices-dynamics-365-business-central/)
