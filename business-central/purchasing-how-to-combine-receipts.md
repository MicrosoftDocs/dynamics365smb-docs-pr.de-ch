...
1. Wählen Sie das Symbol ![Nach Seite oder Bericht suchen](media/ui-search/search_small.png "Nach Seite oder Bericht suchen") und geben **Erledigte Bestellungen löschen** ein. Wählen Sie dann den zugehörigen Link aus.  
