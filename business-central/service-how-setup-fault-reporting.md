...
# <a name="set-up-fault-reporting" />Fehlerberichte einrichten
...
## <a name="to-specify-the-overall-level-of-fault-reporting" />So legen Sie die Gesamtebene der Fehlerberichterstattung fest
...
## <a name="to-create-fault-and-resolution-code-relationships" />Einfügen von Problem/Lösungscode-Beziehungen
