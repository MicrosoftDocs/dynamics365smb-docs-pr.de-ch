...
---
# <a name="walkthrough-receiving-and-putting-away-in-basic-warehouse-configurations" />Exemplarische Vorgehensweise: Eingang und Einlagerung in Basis-Lagerkonfigurationen
...
## <a name="setting-up-the-location" />Einrichten des Lagerorts

Einstellungen auf der Seite **Lagerortkarte** definieren die Warenflüsse des Unternehmens.  

### <a name="to-set-up-the-location" />So richten Sie den Lagerort ein
...
## <a name="create-the-purchase-order" />Die Einkaufsbestellung erstellen

Bestellungen sind die häufigste Art des eingehenden Herkunftsbelegs.  

### <a name="to-create-the-purchase-order" />Bestellung erstellen
...
## <a name="receive-and-put-the-items-away" />Artikel erhalten und einlagern
...
### <a name="to-receive-and-put-the-items-away" />Artikel erhalten und einlagern
