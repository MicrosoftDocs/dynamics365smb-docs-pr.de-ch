...
# <a name="getting-business-central-on-your-mobile-device" />Abrufen von Business Central auf meinem mobilen Gerät
...
## <a name="get-the-app-on-my-mobile-device" />So wird die App auf mein mobiles Gerät heruntergeladen
