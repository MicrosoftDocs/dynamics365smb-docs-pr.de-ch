...
Sie können für jeden Ihrer Kunden eine bevorzugte Methode zum Senden von Verkaufsunterlagen einrichten, damit Sie nicht jedes Mal, wenn Sie einen Beleg senden, eine Versandoption auswählen müssen, z. B. ob Sie den Beleg per E-Mail oder als elektronischen Beleg senden möchten. Weitere Informationen finden Sie unter [Einrichten von Sendeprofilen](sales-how-setup-document-send-profiles.md).
