...
## <a name="to-add-prepayment-accounts-to-the-general-posting-setup" />So fügen Sie Vorauszahlungskonten zu "Buchungsmatrix Einrichtung" hinzu:
...
## <a name="to-set-up-number-series-for-prepayment-documents" />So richten Sie Nummernserien für Vorauszahlungsbelege ein:
...
## <a name="to-set-up-prepayment-percentages-for-items-customers-and-vendors" />Einrichtung von Vorauszahlungsprozentsätze für Artikel, Debitoren und Kreditoren
...
### <a name="to-determine-which-prepayment-percentage-has-first-priority" />So stellen Sie fest, welcher Vorauszahlungsprozentsatz die höchste Priorität hat:
...
## <a name="to-automatically-release-sales-orders-when-prepayments-are-applied" />So werden Verkaufsaufträge automatisch freigeben, wenn Vorauszahlungen angewendet werden
...
## <a name="see-related-microsoft-trainingtrainingmodulesprepayment-invoices-dynamics--business-central" />Siehe verwandte [Microsoft Schulungen](/training/modules/prepayment-invoices-dynamics-365-business-central/)
