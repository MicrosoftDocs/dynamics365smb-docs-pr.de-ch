...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically" />Exemplarische Vorgehensweise: Automatische Beschaffungsplanung
...
### <a name="to-create-stockkeeping-units" />So erstellen Sie Lagerhaltungsdaten
...
### <a name="to-change-selected-planning-parameters" />Ausgewählte Planungsparameter ändern
...
## <a name="creating-a-regenerative-supply-plan" />Erstellen einer Beschaffungsneuplanung
...
### <a name="to-create-the-sales-order" />So erstellen Sie den Verkaufsauftrag
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east" />So erstellen Sie eine Neuplanung, um den Bedarf am Standort OST zu erfüllen
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs" />Nettobedarf berechnen, um den Bedarf zugrunde liegender Komponenten einzuschliessen
...
## <a name="analyzing-the-planning-result" />Analysieren des Planungsergebnisses
...
### <a name="to-check-the-planning-parameter" />Den Planungsparameter prüfen
...
### <a name="to-view-more-order-tracking-entries" />Weitere Bedarfsverursacher anzeigen
...
## <a name="carrying-out-action-messages" />Durchführen von Ereignismeldungsaktionen
...
### <a name="to-automatically-create-the-suggested-supply-orders" />So erstellen Sie automatisch die vorgeschlagenen Beschaffungsaufträge
...
## <a name="creating-a-net-change-plan" />Erstellen eines Änderungsplans
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly" />So erstellen Sie den neuen Verkaufsbedarf und führen eine entsprechende Neuplanung durch
...
## <a name="analyzing-the-changed-planning-result" />Analysieren des geänderten Planungsergebnisses
...
### <a name="to-view-an-existing-order" />Bestehenden Auftrag anzeigen
