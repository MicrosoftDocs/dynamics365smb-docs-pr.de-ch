...
ms.author: jswymer
---
# <a name="process-sales-opportunities"></a><a name="process-sales-opportunities"></a><a name="process-sales-opportunities"></a>Verarbeiten von Verkaufschancen
...
## <a name="to-view-opportunities"></a><a name="to-view-opportunities"></a><a name="to-view-opportunities"></a>Anzeigen von Verkaufschancen
...
## <a name="to-close-opportunities"></a><a name="to-close-opportunities"></a><a name="to-close-opportunities"></a>Um Verkaufschancen abzuschliessen
...
## <a name="to-create-quotes-for-opportunities"></a><a name="to-create-quotes-for-opportunities"></a><a name="to-create-quotes-for-opportunities"></a>Um Angebote für Verkaufschancen zu erstellen
> [!NOTE]
...
## <a name="to-create-sales-orders-for-opportunities"></a><a name="to-create-sales-orders-for-opportunities"></a><a name="to-create-sales-orders-for-opportunities"></a>Verkaufsaufträge für Verkaufschancen erstellen
...
## <a name="to-delete-opportunities"></a><a name="to-delete-opportunities"></a><a name="to-delete-opportunities"></a>Um Verkaufchancen zu löschen
...
## <a name="to-move-an-opportunity-through-sales-cycle-stages"></a><a name="to-move-an-opportunity-through-sales-cycle-stages"></a><a name="to-move-an-opportunity-through-sales-cycle-stages"></a>Verschieben einer Verkaufschance über Verkaufsprozessstufen
