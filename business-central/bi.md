---
title: Finanzielle Analysen in Business Central
...
# <a name="financial-analytics-in-business-central"></a>Finanzielle Analysen in Business Central
...
Das Feature **Finanzberichte** gibt Ihnen Einblick in die in Ihrem Kontenplan (COA) enthaltenen Finanzdaten. Sie können Finanzberichte einrichten, um die Zahlen in den Finanzbuchhaltungskonten zu analysieren und Fibuposten mit Budgetposten zu vergleichen. Die Ergebnisse werden in Diagrammen und Berichten auf Ihrer Homepage angezeigt, darunter das Cashflowdiagramm sowie die Erfolgsrechnungs- und Bilanzberichte.

Dimensionen spielen eine wichtige Rolle bei Business Intelligence. Bei einer Dimension handelt es sich um Daten, die Sie einem Eintrag als Parameter hinzufügen können. Mit Dimensionen können Sie Einträge mit ähnlichen Merkmalen gruppieren, z. B. Kundschaft, Regionen, Produkte und Verkaufende, und diese Gruppen leicht für Analysen abrufen. Sie verwenden Dimensionen u. a. bei der Definition von Analyseansichten und beim Erstellen von Finanzberichten. Erfahren Sie mehr unter [Arbeiten mit Dimensionen](finance-dimensions.md).
...
Mit dem Datenanalysefeature können Sie fast jede Listenseite öffnen, z. B. die Seiten „Fibuposten“, „Anlagenposten“, „Scheckposten“ oder „Bankposten“, in den Analysemodus wechseln und dann Daten nach Belieben gruppieren, filtern und pivotieren.

:::image type="content" source="media/data-analysis-gl-entries.png" alt-text="Beispiel für die Durchführung einer Datenanalyse auf der Seite „Fibuposten“." lightbox="media/data-analysis-gl-entries.png":::
...
:::image type="content" source="media/open-in-excel-gl-entries.png" alt-text="Beispiel für die Durchführung einer Datenanalyse von Fibuposten mithilfe von Excel." lightbox="media/open-in-excel-gl-entries.png":::
...
[!INCLUDE [prod_short](includes/prod_short.md)] verfügt über eine Reihe von Seiten, die Ihnen einen finanziellen Überblick und die erledigende Aufgaben bieten.

### <a name="show-general-ledger-entries-and-balances-from-the-chart-of-accounts-page"></a>Fibuposten und Salden auf der Seite „Kontenplan“ anzeigen

Auf der Seite „Kontenplan“ werden alle Finanzbuchhaltungskonten mit aggregierten Zahlen zu den in der Finanzbuchhaltung gebuchten Beträgen angezeigt. Von dieser Seite aus können Sie beispielsweise Folgendes tun:  
...
Im Rahmen des Erfassens, Analysierens und Weitergebens der Firmendaten möchten Sie sich vielleicht aktuelle Beträge verglichen mit den budgetierten Beträgen für alle Konten sowie für mehrere Perioden anzeigen lassen. Sie können dies von der Seite **Kontenplan** aus über die Aktion **Saldo/Budget** tun.
...
In der Finanzanalyse sind Dimensionen Daten, die Sie einem Fibuposten als eine Art Markierung hinzufügen. Diese Daten dienen zum Gruppieren von Fibuposten mit ähnlichen Merkmalen – beispielsweise Debitoren, Regionen, Produkte oder Verkäufer – sowie zum einfachen Abrufen dieser Gruppen zur Analyse. Sie können Dimensionen für Posten in Erfassungsjournalen, Belegen und Budgets verwenden. Weitere Informationen finden Sie unter [Daten nach Dimensionen analysieren](bi-how-analyze-data-dimension.md)
