...
---
# <a name="put-items-away-with-inventory-put-aways" />Artikel mit Lagereinlagerungen einlagern
...
## <a name="to-create-an-inventory-put-away-from-the-source-document" />Eine Lagereinlagerung vom Herkunftsbeleg aus erstellen
...
## <a name="to-create-multiple-inventory-put-aways-with-a-batch-job" />So erstellen Sie mehrere Lagereinlagerungen mit einer Stapelverarbeitung
...
## <a name="to-create-the-put-away-in-two-steps" />So erstellen Sie die Einlagerung in zwei Schritten

### <a name="to-request-an-inventory-put-away-by-releasing-the-source-document" />So fordern Sie eine Lagereinlagerung durch Freigabe des Herkunftsbelegs an
...
### <a name="to-create-an-inventory-put-away-based-on-the-source-document" />Eine Lagereinlagerung vom Herkunftsbeleg aus erstellen
...
## <a name="to-record-the-inventory-put-away" />So erfassen Sie die Lagereinlagerung
