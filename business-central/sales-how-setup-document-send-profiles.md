...
## <a name="to-set-up-a-document-sending-profile" />Einrichten von Belegsendeprofilen
...
## <a name="to-specify-a-sending-profile-on-a-customer-card" />Sendeprofil für eine Debitorenkarte festlegen
