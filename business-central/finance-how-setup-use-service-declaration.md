...
Wenn Sie eine Einkaufs- oder Verkaufsrechnung erstellen, finden Sie in deren Zeilen zwei Felder, die sich auf Servicerechnungen beziehen. Beide Felder sind mit den Standardwerten aus Ihren Artikel-, Ressourcen- oder Artikelzu-/Abschlag-Einstellungen ausgefüllt.
...
Wenn Sie im Feld **Service Transaktionsart Code** einen Wert angeben, aber das Feld **Anwendbar für Service-Deklaration** nicht markieren, können Sie den Beleg zwar buchen, aber die Zeile wird dabei nicht berechnet.
