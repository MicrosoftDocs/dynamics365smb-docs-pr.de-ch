...
# <a name="couple-and-synchronize-records-between-dataverse-and-business-central" />Datensätze zwischen Dataverse und Business Central koppeln und synchronisieren
...
## <a name="video-example" />Video-Beispiel
...
## <a name="to-couple-a-record" />So koppeln Sie einen Datensatz
...
## <a name="to-synchronize-a-single-record" />So synchronisieren Sie einen einzelnen Datensatz
...
## <a name="to-synchronize-a-single-record-from-includecrmmdincludescrmmdmd" />So synchronisieren Sie einen einzelnen Datensatz von [!INCLUDE[crm_md](includes/crm_md.md)] aus
...
## <a name="to-couple-multiple-records-using-match-based-coupling" />So koppeln Sie mehrere Datensätze mithilfe der abgleichsbasierten Kopplung
...
## <a name="to-synchronize-multiple-records" />So synchronisieren Sie mehrere Datensätze
...
## <a name="bulk-insert-and-couple-records" />Masseneinfügung und Koppeln von Datensätzen
...
## <a name="uncoupling-records" />Kopplung von Datensätzen aufheben
