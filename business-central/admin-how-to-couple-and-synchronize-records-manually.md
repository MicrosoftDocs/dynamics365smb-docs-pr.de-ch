...
# <a name="couple-and-synchronize-records-between-dataverse-and-business-central"></a><a name="couple-and-synchronize-records-between-dataverse-and-business-central"></a>Datensätze zwischen Dataverse und Business Central koppeln und synchronisieren
...
## <a name="video-example"></a><a name="video-example"></a>Video-Beispiel
...
## <a name="to-couple-a-record"></a><a name="to-couple-a-record"></a>So koppeln Sie einen Datensatz
...
## <a name="to-synchronize-a-single-record"></a><a name="to-synchronize-a-single-record"></a>So synchronisieren Sie einen einzelnen Datensatz
...
## <a name="to-synchronize-a-single-record-from-"></a><a name="to-synchronize-a-single-record-from-"></a>So synchronisieren Sie einen einzelnen Datensatz von [!INCLUDE[crm_md](includes/crm_md.md)] aus
...
## <a name="to-couple-multiple-records-using-match-based-coupling"></a><a name="to-couple-multiple-records-using-match-based-coupling"></a>So koppeln Sie mehrere Datensätze mithilfe der abgleichsbasierten Kopplung
...
## <a name="to-synchronize-multiple-records"></a><a name="to-synchronize-multiple-records"></a>So synchronisieren Sie mehrere Datensätze
...
## <a name="bulk-insert-and-couple-records"></a><a name="bulk-insert-and-couple-records"></a>Masseneinfügung und Koppeln von Datensätzen
...
## <a name="uncoupling-records"></a><a name="uncoupling-records"></a>Kopplung von Datensätzen aufheben
