...
Zur Überprüfung einer Seite wählen Sie in der oberen rechten Ecke das ![Einstellungssymbol](media/ui-experience/settings_icon_small.png) und dann **Überprüfen** aus. Zudem besteht die Möglichkeit, die Tastenkombination **Ctrl+Alt+F1** zu verwenden.
