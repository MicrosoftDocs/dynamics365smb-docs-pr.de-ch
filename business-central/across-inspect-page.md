...
## <a name="work-with-page-inspection"></a>Mit der Seitenüberprüfung arbeiten

Starten Sie die Seitenüberprüfung über die Seite **Hilfe und Support**. Wählen Sie ein Fragezeichen in der oberen rechten Ecke aus, wählen Sie **Hilfe und Support** und dann **Seiten und Daten prüfen** aus. Zudem besteht die Möglichkeit, die Tastenkombination **Ctrl+Alt+F1** zu verwenden.
