...
ms.author: edupont
---
# <a name="managing-marketing-campaigns" />Verwaltung von Marketingkampagnen
...
## <a name="defining-individual-campaigns" />Einzelkampagne definieren
...
Sie können Kampagnenposten löschen, z. B. wenn der Posten eine Aktion speichert, die annulliert wurde. Es können nur stornierte Kampagnenposten gelöscht werden.
...
### <a name="registering-discount-percentages" />Erfassen von Rabattprozentsätzen
...
## <a name="conducting-campaigns" />Kampagnen durchführen
