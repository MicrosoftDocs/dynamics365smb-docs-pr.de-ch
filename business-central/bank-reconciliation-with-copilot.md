...
- Um alle vorgeschlagenen Zuordnungen zu verwerfen und das Copilot-Fenster zu schliessen, klicken Sie auf die Schaltfläche „Verwerfen“ (Papierkorb). ![Zeigt das Papierkorbsymbol zum Löschen aller Copilot-Vorschläge für die Bankkontoabstimmung](media/copilot-delete-trash-can.png) neben der **Behalten**-Schaltfläche unten am Fenster.
   ...
   > [!NOTE]
   > Wenn Sie Copilot über die Karte **Bankkontoabstimmung** für eine neue oder bestehende Abstimmung gestartet haben, werden nur die von Copilot vorgeschlagenen Zuordnungen gelöscht. Die durch die automatischen Zuordnungen vorgenommenen Zuordnungen sind bereits gespeichert.
   > 
   > Wenn Sie Copilot über die Liste **Bankkontoabstimmungen** gestartet haben, wird nichts gespeichert, auch nicht die importierten Kontoauszugspositionen, automatischen Zuordnungen und von Copilot vorgeschlagenen Zuordnungen.
...
## Nicht zugeordnete Banktransaktionen auf die vorgeschlagenen Fibukonten übertragen
...
6. Verwerfen oder speichern Sie Vorschläge.
