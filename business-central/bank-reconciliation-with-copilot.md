...
- Vorgeschlagene Fibukonten
  ...
  Für verbleibende Banktransaktionen, die keinem Sachbucheintrag zugeordnet werden können, vergleicht Copilot die Transaktionsbeschreibung mit Fibukontonamen und schlägt das wahrscheinlichste Fibukonto vor, auf das gebucht werden soll. Beispielsweise könnte Copilot vorschlagen, Transaktionen mit der Meldung „Tanken 24“ auf das Konto „Beförderung“ zu buchen.
   ...
   Gehen Sie zu [Nicht zugeordnete Banktransaktionen auf die vorgeschlagenen Fibukonten buchen](#post-unmatched-bank-transaction-amounts-to-suggested-general-ledger-accounts).
...
Überprüfen Sie im Abschnitt **Zugeordnete Vorschläge** Position für Position die vorgeschlagenen Zuordnungen und ergreifen Sie dann die entsprechenden Massnahmen:
...
## <a name="post-unmatched-bank-transaction-amounts-to-suggested-general-ledger-accounts"></a>Nicht zugeordnete Banktransaktionen auf die vorgeschlagenen Fibukonten buchen

In diesem Abschnitt erfahren Sie, wie Sie mit Copilot nicht abgestimmte (im Feld **Differenz** angegebene) Kontoauszugspositionen auf ein Fibukonto buchen. Diese Aufgabe kann nur aus einer bestehenden Abstimmung heraus durchgeführt werden.
...
1. Identifizieren Sie im Bereich **Kontoauszugspositionen** nicht abgeglichenen Kontoauszugspositionen und wählen Sie eine oder mehrere Positionen aus, die Sie abstimmen möchten.
   ...
   Diese Positionen sind die Kontoauszugspositionen, auf die sich Copilot bei der Buchung neuer Zahlungen auf das Fibukonto konzentriert.
...
1. Sobald Copilot die Generierung von Vorschlägen abgeschlossen hat, wird das Fenster **Copilot-Vorschläge für das Buchen von Differenzbeträgen auf Fibukonten** geöffnet.
