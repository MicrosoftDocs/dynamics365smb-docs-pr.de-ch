...
Das Fenster **Mit Copilot abgleichen** ist in zwei Abschnitte unterteilt. Der obere Abschnitt enthält einige allgemeine Details zum Ergebnis. Im unteren Abschnitt **Übereinstimmungsvorschläge** sind die von Copilot vorgeschlagenen Zuordnungen aufgeführt.
...
Gehen Sie im Abschnitt **Übereinstimmungsvorschläge** die vorgeschlagenen Übereinstimmungen Zeile für Zeile durch. Ergreifen Sie dann die entsprechenden Massnahmen:

- Um eine einzelne vorgeschlagene Zuordnung zu verwerfen, wählen Sie sie aus der Liste und dann die Aktion **Zeile löschen** aus.
- Um alle vorgeschlagenen Übereinstimmungen zu verwerfen und das Fenster **Mit Copilot abgleichen** zu schliessen, wählen Sie die Schaltfläche „Verwerfen“ (Papierkorb) ![Schaltfläche „Verwerfen“](media/copilot-delete-trash-can.png) neben der Schaltfläche **Behalten** unten im Fenster aus.
...
## <a name="post-unmatched-bank-transaction-amounts-to-suggested-gl-accounts"></a>Nicht zugeordnete Banktransaktionen auf die vorgeschlagenen Fibukonten buchen

In diesem Abschnitt wird erläutert, wie Sie mit Copilot nicht abgestimmte (wie im Feld **Differenz** angegebene) Kontoauszugspositionen auf ein Fibukonto buchen. Diese Aufgabe kann nur aus einer bestehenden Abstimmung heraus durchgeführt werden.
...
1. Gehen Sie zur Liste **Bankkontenabstimmungen** und öffnen Sie die vorhandene Abstimmung, die die nicht abgestimmten Positionen enthält.
    ...
    Dieser Schritt bietet Ihnen einen klaren Überblick über alle nicht abgestimmten Kontoauszugspositionen, die auf das Fibukonto übertragen werden müssen.
...
1. Identifizieren Sie im Bereich **Kontoauszugspositionen** die nicht abgeglichenen Kontoauszugspositionen, und wählen Sie eine oder mehrere Positionen aus, die Sie abstimmen möchten.
    ...
    Copilot konzentriert sich auf die ausgewählten Zeilen, um neue Zahlungen auf das Fibukonto zu buchen.

1. Wählen Sie **Differenz auf Fibukonto buchen**, um den Vorgang zu starten.

    ![Screenshot mit der Schaltfläche „Differenz auf Fibukonto buchen“ auf der Karte „Bankkontoabgleich“.](media/bank-reconciliation-transfer-gl-copilot-card.png)

    Copilot beginnt mit der Generierung von Vorschlägen für die Buchung neuer Zahlungen.

1. Nachdem Copilot die Generierung von Vorschlägen abgeschlossen hat, wird das Fenster **Copilot-Vorschläge für das Buchen von Differenzbeträgen auf Fibukonten** angezeigt.
    ...
    ![Screenshot mit dem Fenster „Copilot-Vorschläge für das Buchen von Differenzbeträgen auf Fibukonten“.](media/bank-reconciliation-gl-transfer-proposed-matches.png)
...
1. Überprüfen Sie die Vorschläge Position für Position, um sicherzustellen, dass die zur Buchung vorgeschlagenen Zahlungen richtig sind.
    ...
    - Wenn Sie einen Drilldown für den Vorschlag durchführen, indem Sie ihn in der Liste auswählen, gelangen Sie zu einer Liste mit Konten. Von hier aus können Sie ein anderes Konto auswählen. Sie können diese Art der manuellen Korrektur nur bei Verwendung des Flows **Differenz auf Fibukonto buchen** durchführen, nicht im Zuordnungs-Flow.
...
1. Verwerfen oder speichern Sie Vorschläge.
    ...
    - Um eine bestimmte Zuordnung zu verwerfen, wählen Sie sie aus der Liste und dann **Zeile löschen** aus. Um alle Vorschläge zu verwerfen und Copilot zu schliessen, wählen Sie die Schaltfläche „Verwerfen“ (Papierkorb) ![Schaltfläche „Verwerfen“.](media/copilot-delete-trash-can.png) neben der Schaltfläche **Behalten** unten im Fenster aus.
