...
> [!NOTE]  
>   Wenn Sie nicht das Bankkonto aus der Seite **Zahlungsabstimmungserfassungsjournal** abstimmen, müssen Sie das Fenster **Bankkonto-Abstimmung** verwenden. Weitere Informationen finden Sie unter [Vorgehensweise: Einrichten von Bankkonten](bank-how-reconcile-bank-accounts-separately.md).
