...
# <a name="set-up-pricing-and-additional-costs-for-services" />Einrichten von Preisen und zusätzlichen Kosten für Services
...
## <a name="to-set-up-a-service-price-group" />So richten Sie eine Servicepreisgruppe ein
...
## <a name="to-set-up-a-service-price-adjustment-group" />So richten Sie eine Servicepreiskorrekturgruppe ein
...
## <a name="to-set-up-additional-costs-for-services" />Einrichten zusätzlicher Kosten für Services
...
### <a name="to-set-up-service-costs" />Um Servicekosten einzurichten
...
### <a name="to-specify-a-default-cost-for-service-orders" />Um Standardkosten für Serviceaufträge anzugeben
