...
ms.author: bholtorf
---
# <a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes"></a><a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes"></a>Verwenden einen Power Automate Flow für Warnungen zu Dataverse Entitätsänderungen
...
## <a name="import-the-flow-template"></a><a name="import-the-flow-template"></a>Flow-Vorlage importieren
...
## <a name="define-the-flow-trigger"></a><a name="define-the-flow-trigger"></a>Flowtrigger definieren
...
## <a name="define-the-flow-condition"></a><a name="define-the-flow-condition"></a>Flowbedingung definieren
...
## <a name="notify-business-central-about-a-change"></a><a name="notify-business-central-about-a-change"></a>Benachrichtigen Sie Business Central über eine Änderung
