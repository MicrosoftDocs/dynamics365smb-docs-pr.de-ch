...
# <a name="set-up-service-contracts"></a><a name="set-up-service-contracts"></a>Serviceverträge einrichten
...
## <a name="to-set-up-a-service-contract-group"></a><a name="to-set-up-a-service-contract-group"></a>So richten Sie Servicevertragsgruppen ein
...
## <a name="to-set-up-a-service-contract-account-group"></a><a name="to-set-up-a-service-contract-account-group"></a>So richten Sie eine Servicevertragskontengruppe ein
...
## <a name="to-set-up-a-contract-template"></a><a name="to-set-up-a-contract-template"></a>So richten Sie Vertragsvorlagen ein
...
## <a name="to-set-up-a-customer-template"></a><a name="to-set-up-a-customer-template"></a>So richten Sie Debitorenvorlagen ein
