...
ms.author: edupont
---
# <a name="use-business-central-without-outlook"></a><a name="use-business-central-without-outlook"></a><a name="use-business-central-without-outlook"></a>Business Central ohne Outlook verwenden
...
## <a name="sending-email"></a><a name="sending-email"></a><a name="sending-email"></a>Versenden von E-Mails
