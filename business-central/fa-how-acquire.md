...
1. Wählen Sie das Symbol ![Glühlampe, mit der die Funktion „Wie möchten Sie weiter verfahren“ geöffnet wird](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren?") aus, geben Sie **FA-Einträge stronieren** ein, und wählen dann den zugehörigen Link aus.
2. Erstellen Sie eine Anschaffungs-Erf.-Journalzeile. Weitere Informationen finden Sie unter [Wie Anlagenanschaffungen mit dem Anlagen Fibu Erf.-Journal manuell gebucht werden](fa-how-acquire.md#to-post-a-fixed-asset-acquisition-manually-with-the-fixed-asset-gl-journal).
3. Geben Sie im Feld **Restwert** in der Erf.-Journalzeile den Restwertbetrag als Haben (mit einem Minuszeichen) ein.
4. Wählen Sie die Aktion **Buchen** aus.

> [!NOTE]  
>   Die Buchungsart R**estwert** steht nur auf der Seite **Anlagen Erf.-Journal** zur Verfügung. Sie ist auf der Seite **Anlagen Fibu Erf.-Journal** nicht verfügbar, weil der Restbetrag nie im Fibuposten gebucht wird.
