...
Wenn Ihr Kreditor zusätzliche Informationen wie eine Trackingnummer bereitstellt, können Sie diese Informationen als Kommentar in einer Bestellposition hinzufügen. Um einer Zeile einen Kommentar hinzuzufügen, wählen Sie im Feld **Typ** die Option **Kommentar** aus, und geben Sie die Informationen anschliessend in das Feld **Beschreibung** ein.  
...
Sie können auch das Anforderungsarbeitsblatt verwenden, um Bestellungen zu erstellen. Der Vorteil der Verwendung des Anforderungsarbeitsblatts besteht darin, dass Bestellungen für alle ausstehenden Direktlieferungen erstellt werden können. Das heisst, sie müssen nicht jede Bestellung einzeln erstellen.
