...
# <a name="troubleshooting-and-correcting-dimensions" />Fehlersuche und Korrektur von Dimensionen
...
## <a name="troubleshooting-dimensions-errors" />Beheben von Dimensionsfehlern
...
## <a name="changing-dimension-assignments-after-posting" />Ändern der Dimensionszuweisungen nach dem Buchen
...
### <a name="setting-up-dimension-corrections" />Einrichten von Dimensionskorrekturen
...
### <a name="correcting-a-dimension" />Korrigieren einer Dimension
...
### <a name="validating-dimension-corrections" />Validieren von Dimensionskorrekturen
...
### <a name="undoing-a-correction" />Rückgängig machen einer Korrektur
...
### <a name="dimension-corrections-on-large-data-sets" />Dimensionskorrekturen bei grossen Datenmengen
...
### <a name="use-analysis-views-with-dimension-corrections" />Analyseansichten mit Dimensionskorrekturen verwenden
...
### <a name="viewing-historical-dimension-corrections" />Anzeigen historischer Dimensionskorrekturen
...
### <a name="handling-incomplete-corrections" />Umgang mit unvollständigen Korrekturen
...
### <a name="use-cost-accounting-with-corrected-gl-entries" />Verwenden von Kostenrechnung mit korrigierten Fibukonteneinträgen
...
## <a name="see-related-microsoft-trainingtrainingmodulesdimensions-dynamics-365-business-central" />Siehe verwandte [Microsoft Schulungen](/training/modules/dimensions-dynamics-365-business-central/)
