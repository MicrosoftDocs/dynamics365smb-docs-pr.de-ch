...
Sie geben an, wie Sie die Synchronisierung der Kontakte mit Outlook einrichten möchten auf der Seite **Exchange Synchronisierung einrichten** in [!INCLUDE[d365fin](includes/d365fin_md.md)]. Als Voraussetzung muss Ihr Benutzerprofil in [!INCLUDE[d365fin](includes/d365fin_md.md)] Ihr E-Mail-Konto für Microsoft 365 angeben. Sie können dies im Abschnitt **Microsoft 365 Authentifizierung** Ihres Benutzerprofils in der Liste **Benutzer** überprüfen.  
...
* **Mit Office 365** synchronisieren
  ...
  Diese Aktion synchronisiert alle Änderungen in [!INCLUDE[d365fin](includes/d365fin_md.md)] zu Microsoft 365 seit der letzten Synchronisierung, basierend auf dem letzten Änderungsdatum. Alle neuen Kontakte von Microsoft 365 werden auch wieder in [!INCLUDE[d365fin](includes/d365fin_md.md)] synchronisiert. Dies ist typischerweise schneller als eine vollständige Synchronisierung.  
