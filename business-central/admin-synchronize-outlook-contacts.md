...
ms.author: bholtorf
---
# <a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook"></a><a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook"></a>Synchronisieren Sie Kontakte in Business Central mit Kontakten in Microsoft Outlook
...
## <a name="set-up-synchronization"></a><a name="set-up-synchronization"></a>Synchronisierung einrichten
...
### <a name="automate-synchronization"></a><a name="automate-synchronization"></a>Synchronisierung automatisieren
...
## <a name="synchronize-contacts"></a><a name="synchronize-contacts"></a>Kontakte synchronisieren
