...
ms.author: bholtorf
---
# <a name="about-planning-functionality" />Info zu Planungsfunktionen
...
## <a name="demand-and-supply" />Bedarf und Vorrat
...
## <a name="planning-calculation" />Planungsberechnung
...
## <a name="planning-with-manual-transfer-orders" />Planung mit manuellen Umlagerungsaufträgen
...
## <a name="other-important-planning-fields" />Andere wichtige Planungs-Felder

### <a name="planning-flexibility" />Planungsflexibilität
...
## <a name="planning-worksheets-and-requisition-worksheets" />Planungsarbeitsblätter und Anforderungsarbeitsblätter
...
### <a name="requisition-worksheet" />Anforderungsarbeitsblatt
...
## <a name="see-related-microsoft-trainingtrainingmodulesplan-items-dynamics-365-business-central" />Siehe verwandte [Microsoft Schulungen](/training/modules/plan-items-dynamics-365-business-central/)
