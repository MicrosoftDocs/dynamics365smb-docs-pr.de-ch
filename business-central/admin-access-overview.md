...
# <a name="manage-access-to-business-central" />Zugriff auf Business Central verwalten
...
## <a name="layered-access" />Mehrstufigen Zugriff
...
## <a name="business-central-administrator-tasks" />Administratorenaufgaben in Business Central
...
## <a name="business-central-developer-tasks" />Entwickleraufgaben in Business Central
