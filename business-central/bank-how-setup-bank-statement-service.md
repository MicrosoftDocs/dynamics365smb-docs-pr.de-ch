...
ms.author: edupont
---
# <a name="set-up-the-envestnet-yodlee-bank-feeds-service"></a><a name="set-up-the-envestnet-yodlee-bank-feeds-service"></a>Den Envestnet Yodlee Bank Feeds Service einrichten
...
## <a name="to-enable-the-bank-feed-service"></a><a name="to-enable-the-bank-feed-service"></a>So aktivieren Sie den Bankfeeddienst
...
## <a name="to-create-a-new-linked-bank-account"></a><a name="to-create-a-new-linked-bank-account"></a>So erstellen Sie ein neues verknüpftes Bankkonto
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell me-Funktion") Symbol. Geben Sie **Bankkonten** ein und wählen Sie dann den zugehörigen Link.
...
## <a name="to-link-a-bank-account-to-an-online-bank-account"></a><a name="to-link-a-bank-account-to-an-online-bank-account"></a>So verknüpfen Sie ein Bankkonto mit einem Onlinebankkonto
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell me-Funktion") Symbol. Geben Sie **Bankkonten** ein und wählen Sie dann den zugehörigen Link.
...
## <a name="to-edit-the-credentials-for-an-online-bank-account"></a><a name="to-edit-the-credentials-for-an-online-bank-account"></a>So bearbeiten Sie die Zugangsdaten für ein Online-Bankkonto
...
## <a name="to-unlink-a-bank-account"></a><a name="to-unlink-a-bank-account"></a>So heben Sie die Verknüpfung mit dem Bankkonto auf
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Bankkonten** ein und wählen Sie dann den zugehörigen Link.  
...
## <a name="to-update-bank-account-linking"></a><a name="to-update-bank-account-linking"></a>So aktualisieren Sie die Bankkontoverknüpfung
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Bankkonten** ein und wählen Sie dann den zugehörigen Link.
...
## <a name="to-enable-automatic-import-of-bank-statements"></a><a name="to-enable-automatic-import-of-bank-statements"></a>So aktivieren Sie das automatische Importieren von Bankauszügen
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Bankkonten** ein und wählen Sie dann den zugehörigen Link.
