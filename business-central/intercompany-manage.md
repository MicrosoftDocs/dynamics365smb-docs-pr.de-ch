...
ms.search.form: '605,'
---
# <a name="managing-intercompany-transactions" />Intercompanytransaktionen verwalten
...
## <a name="streamline-the-flow-of-business-activities" />Flow von Geschäftsaktivitäten optimieren
