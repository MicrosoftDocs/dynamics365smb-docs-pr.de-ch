...
# <a name="the-image-analyzer-extension" />Die Bildanalyse-Erweiterung
...
## <a name="switch-on-the-image-analyzer-extension" />Die Bildanalyse-Erweiterung einschalten
...
## <a name="analyze-an-item-image" />Bild eines Artikels analysieren
...
## <a name="analyze-a-contact-person-picture" />Bild einer Kontaktperson analysieren
...
## <a name="use-your-own-computer-vision-api-account" />Ihr eigenes Computer Vision API-Konto verwenden
...
## <a name="see-how-many-analyses-you-have-left-in-the-current-period" />Anzeigen, wie viele Analysen Sie in der laufenden Periode gelassen haben
...
## <a name="stop-using-the-image-analyzer-extension" />Verwendung der Bild-Analyzer-Erweiterung beenden
