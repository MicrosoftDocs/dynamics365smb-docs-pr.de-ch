...
Die Aktion **Auszuführende Aktion** stellt die folgende Optionen zur Verfügung:
  ...
  * *Zur Blockliste hinzufügen*
    ...
    > [!NOTE]  
    > **Artikelattribute** zeigen standardmässig Attribute an, deren **Genauigkeitsbewertung** über dem **Schwellenwert Genauigkeitsbewertung in %** liegt, der im **Bildanalysator-Setup** definiert ist. Um alle erkannten Attribute anzuzeigen, wählen Sie die Aktion **Alle Attribute anzeigen** aus.
