...
# <a name="use-word-templates-for-bulk-communication" />Word-Vorlagen für die Massenkommunikation verwenden
...
## <a name="set-up-the-source-of-data" />Einrichten der Datenquelle
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity" />Einträge hinzufügen, die mit der Quellentität zusammenhängen oder nicht zusammenhängen
...
### <a name="select-the-fields-to-include" />Wählen Sie die einzuschliessenden Felder aus
...
## <a name="to-create-a-word-template-in-business-central" />So erstellen Sie eine Word-Vorlage in Business Central
...
## <a name="set-up-the-template-in-word" />Einrichten der Vorlage in Word
...
## <a name="apply-a-template" />Eine Vorlage anwenden
...
## <a name="use-word-templates-with-email" />Word-Vorlagen mit E-Mail verwenden
...
## <a name="edit-a-word-template" />Eine Word-Vorlage bearbeiten
