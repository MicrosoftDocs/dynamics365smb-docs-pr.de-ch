...
# <a name="use-word-templates-for-bulk-communication"></a><a name="use-word-templates-for-bulk-communication"></a>Word-Vorlagen für die Massenkommunikation verwenden
...
## <a name="set-up-the-source-of-data"></a><a name="set-up-the-source-of-data"></a>Einrichten der Datenquelle
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity"></a><a name="add-entries-that-are-related-or-unrelated-to-the-source-entity"></a>Einträge hinzufügen, die mit der Quellentität zusammenhängen oder nicht zusammenhängen
...
### <a name="select-the-fields-to-include"></a><a name="select-the-fields-to-include"></a>Wählen Sie die einzuschliessenden Felder aus
...
## <a name="to-create-a-word-template-in-business-central"></a><a name="to-create-a-word-template-in-business-central"></a>So erstellen Sie eine Word-Vorlage in Business Central
...
## <a name="set-up-the-template-in-word"></a><a name="set-up-the-template-in-word"></a>Einrichten der Vorlage in Word
...
## <a name="apply-a-template"></a><a name="apply-a-template"></a>Eine Vorlage anwenden
...
## <a name="use-word-templates-with-email"></a><a name="use-word-templates-with-email"></a>Word-Vorlagen mit E-Mail verwenden
...
## <a name="edit-a-word-template"></a><a name="edit-a-word-template"></a>Eine Word-Vorlage bearbeiten
