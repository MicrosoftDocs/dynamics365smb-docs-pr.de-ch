...
ms.author: edupont
---
# <a name="about-the-data-exchange-framework" />Über das Datenaustauschframework
...
## <a name="electronic-documents" />Elektronische Belege
...
## <a name="currency-exchange-rates" />Währungswechselkurse
