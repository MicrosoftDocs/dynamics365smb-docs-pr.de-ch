...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure"></a><a name="design-details-item-tracking-posting-structure"></a>Designdetails: Artikeltracking-Buchungsstruktur
...
## <a name="one-to-many-relation"></a><a name="one-to-many-relation"></a>1:n-Beziehung
...
## <a name="codeunits-80-and-90"></a><a name="codeunits-80-and-90"></a>Codeunit 80 und 90
...
## <a name="posting-the-item-journal"></a><a name="posting-the-item-journal"></a>Buchen des Artikel Erf.-Journals.
...
## <a name="code-unit-22"></a><a name="code-unit-22"></a>Code Unit 22
