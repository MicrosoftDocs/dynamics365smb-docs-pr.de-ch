...
ms.author: edupont
---
# <a name="design-details-item-tracking-posting-structure" />Designdetails: Artikeltracking-Buchungsstruktur
...
## <a name="one-to-many-relation" />1:n-Beziehung
...
## <a name="posting-the-item-journal" />Buchen des Artikel Erf.-Journals.
