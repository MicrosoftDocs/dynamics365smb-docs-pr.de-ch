...
ms.author: edupont
---
# <a name="design-details-cost-adjustment" />Designdetails: Kostenregulierung
...
### <a name="item-application-entry" />Artikelausgleichsposten
...
### <a name="average-cost-adjustment-entry-point" />Eingabepunkt Regulierung Durchschnittskosten
...
### <a name="order-level" />Auftragesebene
...
## <a name="manual-versus-automatic-cost-adjustment" />Manuelle gegen Automatische Lagerregulierung
...
## <a name="adjust-cost---item-entries-batch-job" />Lagerreg. fakt. Einst. Preise (Stapelverarbeitung)
...
#### <a name="general-ledger-entries-1" />Fibuposten (1)
...
#### <a name="general-ledger-entries-2" />Fibuposten (2)
...
## <a name="automatic-cost-adjustment" />Automatische Kostenregulierung
