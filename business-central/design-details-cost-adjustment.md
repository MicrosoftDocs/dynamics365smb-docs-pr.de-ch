...
|Buchungsdatum|Lagerpostenart|Einstandsbetrag (tatsächl.)|Gebuchte Lagerregulierung an G/L|Fakturierte Menge|Laufnr.|  
|------------------|----------------------------|----------------------------|-------------------------|-----------------------|---------------|  
...
|Buchungsdatum|Lagerpostenart|Einstandsbetrag (tatsächl.)|Gebuchte Lagerregulierung an G/L|Fakturierte Menge|Ausgleich|Laufnr.|  
|------------------|----------------------------|----------------------------|-------------------------|-----------------------|----------------|---------------|  
