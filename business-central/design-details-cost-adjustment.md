...
ms.author: edupont
---
# <a name="design-details-cost-adjustment"></a><a name="design-details-cost-adjustment"></a>Designdetails: Kostenregulierung
...
## <a name="detecting-the-adjustment"></a><a name="detecting-the-adjustment"></a>Erkennen der Regulierung
...
### <a name="item-application-entry"></a><a name="item-application-entry"></a>Artikelausgleichsposten
...
### <a name="average-cost-adjustment-entry-point"></a><a name="average-cost-adjustment-entry-point"></a>Eingabepunkt Regulierung Durchschnittskosten
...
### <a name="order-level"></a><a name="order-level"></a>Auftragesebene
...
## <a name="manual-versus-automatic-cost-adjustment"></a><a name="manual-versus-automatic-cost-adjustment"></a>Manuelle gegen Automatische Lagerregulierung
...
## <a name="adjust-cost---item-entries-batch-job"></a><a name="adjust-cost---item-entries-batch-job"></a>Lagerreg. fakt. Einst. Preise (Stapelverarbeitung)
...
#### <a name="value-entries-1"></a><a name="value-entries-1"></a>Wertposten (1)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-1"></a>Relationsposten im Sachkonto – Tabelle Artikelpostenrelation (1)
...
#### <a name="general-ledger-entries-1"></a><a name="general-ledger-entries-1"></a>Fibuposten (1)
...
#### <a name="value-entries-2"></a><a name="value-entries-2"></a>Wertposten (2)
...
#### <a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-2"></a>Relationsposten im Sachkonto – Tabelle Artikelpostenrelation (2)
...
#### <a name="general-ledger-entries-2"></a><a name="general-ledger-entries-2"></a>Fibuposten (2)
...
## <a name="automatic-cost-adjustment"></a><a name="automatic-cost-adjustment"></a>Automatische Kostenregulierung
