...
Der Analysebericht besteht aus den Objekten, die Sie analysieren möchten (z. B. Debitoren, Debitorengruppen, Vertriebsmitarbeitende usw., dargestellt als Zeilen) und den Analyseparametern, d. h. der Art und Weise, wie Sie das Objekt analysieren möchten (z. B. Gewinnberechnungen, regelmässige Vergleiche von Verkaufsbeträgen und -volumen oder regelmässige Vergleiche von Ist- und Planzahlen, dargestellt als Spalten). 
