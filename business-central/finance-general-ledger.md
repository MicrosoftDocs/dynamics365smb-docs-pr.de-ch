...
ms.author: edupont
---
# <a name="understanding-the-general-ledger-and-chart-of-accounts"></a><a name="understanding-the-general-ledger-and-chart-of-accounts"></a>Den Fibuposten und den Kontenplan verstehen
...
## <a name="general-ledger-setup-and-general-posting-setup"></a><a name="general-ledger-setup-and-general-posting-setup"></a>Finanzbuchhaltungs-Einrichtung und Buchungsmatrix Einrichtung
...
## <a name="account-categories"></a><a name="account-categories"></a>Kontokategorien
...
## <a name="get-a-quick-overview"></a><a name="get-a-quick-overview"></a>Einen schnellen Überblick erhalten
...
## <a name="access-to-create-and-edit-accounts-and-account-categories"></a><a name="access-to-create-and-edit-accounts-and-account-categories"></a>Zugriff auf das Erstellen und Bearbeiten von Konten und Kontokategorien
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/business-central-configure-general-ledger-setup/)
