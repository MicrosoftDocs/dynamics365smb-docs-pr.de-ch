...
ms.author: edupont
---
# <a name="understanding-the-general-ledger-and-chart-of-accounts" />Den Fibuposten und den Kontenplan verstehen
...
## <a name="general-ledger-setup-and-general-posting-setup" />Finanzbuchhaltungs-Einrichtung und Buchungsmatrix Einrichtung
...
## <a name="the-chart-of-accounts" />Der Kontenplan
...
## <a name="account-categories" />Kontokategorien
...
## <a name="get-a-quick-overview" />Einen schnellen Überblick erhalten
...
## <a name="access-to-create-and-edit-accounts-and-account-categories" />Zugriff auf das Erstellen und Bearbeiten von Konten und Kontokategorien
...
## <a name="see-related-microsoft-trainingtrainingmodulesbusiness-central-configure-general-ledger-setup" />Siehe verwandte [Microsoft Schulungen](/training/modules/business-central-configure-general-ledger-setup/)
