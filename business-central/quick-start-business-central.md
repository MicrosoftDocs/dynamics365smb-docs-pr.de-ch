...
description: Machen Sie sich mit Business Central vertraut und nutzen Sie die Tipps aus den Schnellstart-Artikeln, die Ihnen beim Ausfüllen der ersten wichtigen Felder helfen.
...
ms.locfileid: "8147532"
---
# <a name="business-central-quick-starts"></a>Business Central Schnellstarts

Diese Schnellstart-Artikel helfen Ihnen, so schnell wie möglich loszulegen, damit Sie die grundlegenden Funktionen ausführen können, die Sie in [!INCLUDE[prod_short](includes/prod_short.md)] benötigen.
...
Der erste Schritt besteht darin, die grundlegenden Informationen über Ihre Firma anzugeben. Dazu gehören Informationen wie Adresse, Bankkonten, Umsatzsteuer-Identifikationsnummer und so weiter. Dies wird im Artikel [Unternehmensdaten-Schnellstart](quick-start-company-information.md) erklärt.
...
Wie Sie Produkte und Dienstleistungen einkaufen können, erfahren Sie im Artikel [Schnellstart für die Beschaffung](quick-start-procurement.md).  
