...
2. Alternativ können Sie auch auf die Grenze zwischen zwei Spalten doppelklicken, um die Breite der Spalte automatisch anzupassen. Dadurch wird die Breite auf die für die Lesbarkeit optimale Grösse eingestellt.
...
|**Nur Felder, Spalten und Teile**|Löscht die Personalisierungsänderungen, die Sie an dieser Seite gemacht haben, ausser denen auf der Aktionsleiste. Dies umfasst Änderungen an Feldern, Spalten, Teilen und Kacheln. |
