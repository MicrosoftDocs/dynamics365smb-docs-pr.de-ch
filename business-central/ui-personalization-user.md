...
ms.author: bholtorf
---
# <a name="personalize-your-workspace"></a><a name="personalize-your-workspace"></a>Ihren Arbeitsbereich personalisieren
...
## <a name="to-change-the-width-of-a-column"></a><a name="to-change-the-width-of-a-column"></a>Ändern der Breite einer Spalte
...
## <a name="to-start-personalizing-a-page-through-the-personalizing-banner"></a><a name="to-start-personalizing-a-page-through-the-personalizing-banner"></a>So beginnen Sie mit der Personalisierung einer Seite über das Banner **Personalisieren**
...
## <a name="what-you-can-personalize"></a><a name="what-you-can-personalize"></a><a name="What"></a>Was Sie personalisieren können
...
## <a name="personalizing-the-action-bar-and-menus"></a><a name="personalizing-the-action-bar-and-menus"></a><a name="Actions"></a>Personalisierung der Aktionsleiste und Menüs
...
### <a name="to-remove-hide-and-show-actions-and-action-groups"></a><a name="to-remove-hide-and-show-actions-and-action-groups"></a>So werden Aktionen und Aktionsgruppen entfernt, ausgeblendet und angezeigt
...
### <a name="to-move-actions-and-action-groups"></a><a name="to-move-actions-and-action-groups"></a>So werden Aktionen und Aktionsgruppen verschoben
...
## <a name="personalizing-parts"></a><a name="personalizing-parts"></a><a name="Parts"></a>Personalisierung von Teilen
...
## <a name="to-clear-personalization"></a><a name="to-clear-personalization"></a>So wird eine Personalisierung gelöscht
...
## <a name="other-points-of-interest"></a><a name="other-points-of-interest"></a>Andere Punkte von Interesse
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/personalize-ui-dynamics-365-business-central/index)
