...
ms.author: edupont
---
# <a name="adjust-item-costs" />Artikelpreise justieren
...
## <a name="to-adjust-item-costs-manually" />So regulieren Sie Artikelpreise manuell
...
## <a name="to-make-general-changes-in-the-direct-unit-cost" />Um allgemeine Änderungen in den direkten Einheitskosten durchzuführen:
...
## <a name="understanding-unit-cost-calculation" />Einstandspreisberechnung verstehen
