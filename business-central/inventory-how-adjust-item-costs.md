...
## <a name="to-adjust-item-costs-manually"></a><a name="to-adjust-item-costs-manually"></a><a name="to-adjust-item-costs-manually"></a>So regulieren Sie Artikelpreise manuell
...
## <a name="to-make-general-changes-in-the-direct-unit-cost"></a><a name="to-make-general-changes-in-the-direct-unit-cost"></a><a name="to-make-general-changes-in-the-direct-unit-cost"></a>Um allgemeine Änderungen in den direkten Einheitskosten durchzuführen:
...
## <a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a><a name="understanding-unit-cost-calculation"></a>Einstandspreisberechnung verstehen
...
## <a name="unit-cost-calculation-for-purchases"></a><a name="unit-cost-calculation-for-purchases"></a><a name="unit-cost-calculation-for-purchases"></a>Einstandspreisberechnung bei Einkäufen
...
### <a name="costing-method-fifo-lifo-specific-or-average"></a><a name="costing-method-fifo-lifo-specific-or-average"></a><a name="costing-method-fifo-lifo-specific-or-average"></a>Lagerabgangsmethode "FIFO", "LIFO", "Ausgewählt" oder "Durchschnitt"
...
### <a name="costing-method-standard"></a><a name="costing-method-standard"></a><a name="costing-method-standard"></a>Lagerabgangsmethode "Standard"
...
### <a name="all-costing-methods"></a><a name="all-costing-methods"></a><a name="all-costing-methods"></a>Alle Lagerabgangsmethoden
...
## <a name="unit-cost-calculation-for-sales"></a><a name="unit-cost-calculation-for-sales"></a><a name="unit-cost-calculation-for-sales"></a>Einstandspreisberechnung für Verkäufe
