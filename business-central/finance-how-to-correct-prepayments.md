...
ms.author: edupont
---
# <a name="correct-prepayments"></a><a name="correct-prepayments"></a>So korrigieren Sie Vorauszahlungen
...
## <a name="to-correct-a-prepayment"></a><a name="to-correct-a-prepayment"></a>So korrigieren Sie eine Vorauszahlung
