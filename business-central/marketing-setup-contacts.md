...
ms.author: edupont
---
# <a name="set-up-contacts" />Kontakte einrichten
...
## <a name="to-assign-industry-groups-to-a-contact" />Um einem Kontakt eine Branche zuzuordnen:
...
## <a name="to-assign-mailing-groups-to-a-contact" />Um einem Kontakt einen Verteiler zuzuordnen:
...
## <a name="to-define-a-contacts-alternate-address" />So definieren Sie die alternative Adresse eines Kontakts
...
## <a name="to-assign-job-responsibilities-to-a-contact" />So ordnen Sie einem Kontakt Verantwortlichkeiten zu
...
## <a name="to-assign-organizational-levels-to-a-contact" />So weisen Sie einem Kontakt Organisationsstufen zu
...
## <a name="to-assign-web-sources-to-a-contact" />So weisen Sie einem Kontakt Internetfavoriten zu
...
## <a name="to-assign-business-relations-to-a-contact" />Um Kontakten Geschäftsbeziehungen zuzuordnen:
...
## <a name="synchronizing-contacts-with-customers-vendors-and-bank-accounts" />Synchronisieren von Kontakten mit Debitoren, Kreditoren und Bankkonten
...
## <a name="searching-for-duplicate-contacts" />Suchen nach doppelten Kontakten
