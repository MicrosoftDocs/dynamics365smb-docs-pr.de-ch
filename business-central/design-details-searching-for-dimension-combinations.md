...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations"></a><a name="design-details-searching-for-dimension-combinations"></a>Designdetails: Suche nach Dimensionskombinationen
...
## <a name="building-search-tree"></a><a name="building-search-tree"></a>Erstellungs-Suchstruktur
...
### <a name="example-1"></a><a name="example-1"></a>Beispiel 1
...
### <a name="example-2"></a><a name="example-2"></a>Beispiel 2
...
### <a name="finding-dimension-set-id"></a><a name="finding-dimension-set-id"></a>Suchen der Dimensionssatz-ID
