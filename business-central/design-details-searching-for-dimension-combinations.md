...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations" />Designdetails: Suche nach Dimensionskombinationen
...
### <a name="finding-dimension-set-id" />Suchen der Dimensionssatz-ID
