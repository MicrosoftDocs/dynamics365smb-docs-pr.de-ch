...
---
# <a name="manage-master-data-synchronization"></a><a name="manage-master-data-synchronization"></a>Masterdatensynchronisierung verwalten
...
## <a name="investigate-the-status-of-synchronization"></a><a name="investigate-the-status-of-synchronization"></a>Den Status von Synchronisationsaufträgen anzeigen
...
## <a name="synchronize-modified-records"></a><a name="synchronize-modified-records"></a>Bearbeitete Datensätze synchronisieren
...
## <a name="update-table-schemas"></a><a name="update-table-schemas"></a>Tabellenschemata aktualisieren
...
## <a name="enable-or-disable-couplings-between-records"></a><a name="enable-or-disable-couplings-between-records"></a>Aktivieren oder deaktivieren Sie Kopplungen zwischen Datensätzen
...
## <a name="adding-extensions"></a><a name="adding-extensions"></a>Erweiterungen hinzufügen
...
## <a name="clean-up-old-entries"></a><a name="clean-up-old-entries"></a>Bereinigen Sie alte Einträge
