...
---
# <a name="mapping-the-tables-and-fields-to-synchronize" />Zu synchronisierende Tabellen und Felder zuordnen
...
## <a name="mapping-integration-tables" />Zuordnen von Integrationstabellen
...
### <a name="additional-mappings" />Zusätzliche Zuordnungen
...
### <a name="strategies-for-auto-resolving-conflicts" />Strategien zur automatischen Lösung von Konflikten
...
## <a name="mapping-integration-fields" />Zuordnen von Integrationsfeldern
...
### <a name="handle-differences-in-field-values" />Behandlung von Unterschieden in Feldwerten
...
### <a name="handle-missing-option-values" />Behandlung fehlender Optionswerte
...
## <a name="couple-records" />Gekoppelte Datensätze
...
## <a name="filter-records-and-rows" />Filtern von Datensätzen und Zeilen
...
## <a name="create-new-records" />Erstellen neuer Datensätze
...
### <a name="to-create-new-records-during-synchronization" />So erstellen Sie neue Datensätze während der Synchronisierung:

1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Integrationstabellenzuordnungen** ein und wählen Sie dann den zugehörigen Link.
2. Deaktivieren Sie im Tabellenzuordnungseintrag in der Liste das Feld **Nur gekoppelte Datensätze synchronisieren**.  

## <a name="use-configuration-templates-on-table-mappings" />Konfigurationsvorlagen für Tabellenzuordnungen verwenden
...
### <a name="to-specify-configuration-templates-on-a-table-mapping" />So bestimmen Sie Konfigurationsvorlagen für eine Tabellenzuordnung:
