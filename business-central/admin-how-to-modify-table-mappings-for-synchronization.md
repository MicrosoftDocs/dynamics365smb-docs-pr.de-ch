...
### <a name="handle-differences-in-field-values"></a>Behandlung von Unterschieden in Feldwerten
...
### <a name="handle-missing-option-values"></a>Behandlung fehlender Optionswerte
...
## <a name="couple-records"></a>Gekoppelte Datensätze
...
## <a name="filter-records-and-rows"></a>Filtern von Datensätzen und Zeilen
...
## <a name="create-new-records"></a>Erstellen neuer Datensätze
