...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging"></a><a name="design-details-reservation-order-tracking-and-action-messaging"></a>Designdetails: Reservierung, Auftragstracking und Aktionsmeldungen
...
## <a name="reservation"></a><a name="reservation"></a>Reservierung
...
### <a name="offsetting-in-reservations"></a><a name="offsetting-in-reservations"></a>Ausgleichung für Reservierungen
...
### <a name="manual-reservation"></a><a name="manual-reservation"></a>manuelle Reservierung
...
### <a name="automatic-reservations"></a><a name="automatic-reservations"></a>Automatische Reservierungen
...
## <a name="order-tracking"></a><a name="order-tracking"></a>Bedarfsverursacher
...
### <a name="the-order-network"></a><a name="the-order-network"></a>Das Auftragsnetzwerk
...
### <a name="offsetting-in-order-tracking"></a><a name="offsetting-in-order-tracking"></a>Ausgleichung im Bedarfsverursacher
...
### <a name="example-order-tracking-in-sales-production-and-transfers"></a><a name="example-order-tracking-in-sales-production-and-transfers"></a>Beispiel: Auftragstracking im Verkauf, in der Produktion und bei Umlagerungen
...
### <a name="entry-numbers-8-and-9"></a><a name="entry-numbers-8-and-9"></a>Postennummern 8 und 9
...
### <a name="entry-numbers-10"></a><a name="entry-numbers-10"></a>Postennummern 10
...
### <a name="entry-numbers-8-and-9-1"></a><a name="entry-numbers-8-and-9-1"></a>Postennummern 8 und 9
...
### <a name="entry-numbers-12-to-16"></a><a name="entry-numbers-12-to-16"></a>Postennummern 12 bis 16
...
### <a name="entry-numbers-21-and-22"></a><a name="entry-numbers-21-and-22"></a>Postennummern 21 und 22
...
## <a name="action-messaging"></a><a name="action-messaging"></a>Ereignismeldungen
...
## <a name="order-tracking-and-planning"></a><a name="order-tracking-and-planning"></a>Bedarfsverursacher und Planung
...
### <a name="planning-system-versus-order-tracking-and-action-messaging"></a><a name="planning-system-versus-order-tracking-and-action-messaging"></a>Planungssystem mit Bedarfsverursacher- und Aktions-Messaging
