...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging" />Designdetails: Reservierung, Auftragstracking und Aktionsmeldungen
...
### <a name="example-order-tracking-in-sales-production-and-transfers" />Beispiel: Auftragstracking im Verkauf, in der Produktion und bei Umlagerungen
...
### <a name="entry-numbers--and-" />Postennummern 8 und 9
...
### <a name="entry-numbers-" />Postennummern 10
...
### <a name="entry-numbers--to-" />Postennummern 12 bis 16
...
### <a name="entry-numbers--and-" />Postennummern 21 und 22
