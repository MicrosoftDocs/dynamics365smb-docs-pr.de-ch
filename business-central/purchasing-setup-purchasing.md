...
ms.author: edupont
---
# <a name="setting-up-purchasing" />Einkauf einrichten
...
## <a name="purchases-and-payables-setup" />Kreditoren und Einkauf Einr.
...
### <a name="general-settings" />Allgemeine Einstellungen
...
### <a name="number-series-settings" />Einstellungen für Nummernkreise
...
## <a name="exact-cost-reversing" />Exakte Einstandspreisstornierung
...
## <a name="more-purchasing-setups" />Weitere Einkaufskonfigurationen
...
## <a name="see-related-training-at-microsoft-learnlearnpathstrade-get-started-dynamics--business-central" />Siehe verwandte Schulungen unter [Microsoft Learn](/learn/paths/trade-get-started-dynamics-365-business-central/).
