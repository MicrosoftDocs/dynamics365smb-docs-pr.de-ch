...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts" />Preise und Rabatte einrichten
...
## <a name="setting-up-prices-and-discounts" />Preise und Rabatte einrichten
...
## <a name="about-price-lists" />Über Preislisten
...
## <a name="set-up-prices" />Preise einrichten
...
## <a name="work-with-invoice-discounts-and-service-charges" />Mit Rechnungsrabatten und Servicegebühren arbeiten
...
## <a name="calculating-the-best-price" />Den besten Preis berechnen
...
## <a name="see-related-microsoft-trainingtrainingmodulescustomer-discounts-dynamics-365-business-central" />Siehe verwandte [Microsoft Schulungen](/training/modules/customer-discounts-dynamics-365-business-central/)
