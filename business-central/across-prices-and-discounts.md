...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts"></a><a name="set-up-prices-and-discounts"></a>Preise und Rabatte einrichten
...
## <a name="setting-up-prices-and-discounts"></a><a name="setting-up-prices-and-discounts"></a>Preise und Rabatte einrichten
...
## <a name="about-price-lists"></a><a name="about-price-lists"></a>Über Preislisten
...
## <a name="set-up-prices"></a><a name="set-up-prices"></a>Preise einrichten
...
## <a name="to-set-up-a-sales-line-discount-for-a-customer"></a><a name="to-set-up-a-sales-line-discount-for-a-customer"></a>So erstellen Sie Verkaufszeilenrabatte für einen Debitor:
...
## <a name="work-with-invoice-discounts-and-service-charges"></a><a name="work-with-invoice-discounts-and-service-charges"></a>Mit Rechnungsrabatten und Servicegebühren arbeiten
...
### <a name="to-set-up-an-invoice-discount-for-a-customer"></a><a name="to-set-up-an-invoice-discount-for-a-customer"></a>Um Rechnungsrabattkonditionen für Einkäufe einzurichten:
...
## <a name="to-copy-sales-prices"></a><a name="to-copy-sales-prices"></a>Verkaufspreise kopieren
...
## <a name="to-bulk-update-item-prices"></a><a name="to-bulk-update-item-prices"></a>So aktualisieren Sie Debitorenartikelpreise auf einmal
...
## <a name="calculating-the-best-price"></a><a name="calculating-the-best-price"></a>Den besten Preis berechnen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/customer-discounts-dynamics-365-business-central/)
