...
4.  Wählen Sie im Feld **Basismasseinheit** die Option **Neu**, um die Seite **Ressourceneinheit** zu öffnen. Wählen Sie im Feld **Code** die Option **Stunde** aus. Wählen Sie die Schaltfläche **OK** aus.  
...
4.  Wählen Sie die Schaltfläche **OK**, um alle geöffneten Seiten zu schliessen.  
...
3.  Wählen Sie die Schaltfläche **OK**, um die Seite zu schliessen.  
...
6.  Wählen Sie die Schaltfläche **OK**, um die Seite zu schliessen.  
...
9. Wählen Sie die Schaltfläche **OK**, um die Seite zu schliessen.  
...
2.  Wählen Sie die Schaltfläche **OK**, um die Seite zu schliessen. Die Summen werden auf der Seite **Projektaufgabenzeilen** aktualisiert.  
...
4.  Wählen Sie die Schaltfläche **OK**, um die Seite zu schliessen. Die Summen werden auf der Seite **Projektaufgabenzeilen** aktualisiert.  
...
8.  Wählen Sie die Schaltfläche **OK** auf der Bestätigungsseite. Die generierten Zeilen werden dem Projekt-Erfassungsjournal hinzugefügt.  
...
10. Die Zeilen werden gebucht. Wählen Sie die Schaltfläche **OK**, um die Seiten zu schliessen.  
...
7.  Wählen Sie die Schaltfläche **OK**, um die Seite zu schliessen.  
...
9. Wählen Sie die Schaltfläche **OK**, um die Seiten zu schliessen.  
...
8.  Wählen Sie die Aktion **Buchen** aus. Wählen Sie die Schaltfläche **OK**, um die Seite zu schliessen.  
...
4.  Wählen Sie auf dem Inforegister **Buchung** im Feld **Produktbuchungsgruppe** die Option **SONST** aus. Wählen Sie die Schaltfläche **OK**, um die Seite zu schliessen.  
...
3.  Von der Projektkarte wählen Sie die **Ressource** Aktion aus. Geben Sie die folgenden Informationen ein:  
    ...
    -   **VK-Preis**: **10**  
     ...
     Wählen Sie die Schaltfläche **OK**, um die Seite zu schliessen.  
...
5.  Auf der Seite **Projekt Buch,-Blatt** wählen Sie die Aufgabe 1000 und wählen die Aktion **Buchen** aus.  
...
7.  Wählen Sie auf der Seite **Projektaufgabenzeilen** die option **Aufgabe 2000** aus, und öffnen Sie seine **Projektplanzeilen**.  
    ...
    |2|Plan|(heutiges Datum)|Option|70104|10|  
     ...
     Wählen Sie die Schaltfläche **OK**, um die Seite zu schliessen. Auf der Seite **Projektaufgabenzeilen** können Sie sehen, dass die Planbeträge aktualisiert wurden.  
