...
ms.author: edupont
---
# <a name="walkthrough-managing-projects-with-jobs"></a><a name="walkthrough-managing-projects-with-jobs"></a>Exemplarische Vorgehensweise: Verwalten von Projekten
...
### <a name="setting-up-a-job"></a><a name="setting-up-a-job"></a>Einrichten eines Projekts
...
### <a name="handling-fixed-prices"></a><a name="handling-fixed-prices"></a>Verwenden von Festpreisen
...
### <a name="copying-a-job"></a><a name="copying-a-job"></a>Kopieren eines Projekts
...
### <a name="making-payment-by-installment"></a><a name="making-payment-by-installment"></a>Anwenden von Teilzahlungen
...
### <a name="to-prepare-the-sample-data"></a><a name="to-prepare-the-sample-data"></a>So bereiten Sie die Beispieldaten vor
...
### <a name="to-create-a-job-journal-batch"></a><a name="to-create-a-job-journal-batch"></a>So erstellen Sie einen Projekt Erfassungsjournalnamen
...
## <a name="setting-up-a-job-1"></a><a name="setting-up-a-job-1"></a>Einrichten eines Projekts
...
### <a name="to-set-up-a-job"></a><a name="to-set-up-a-job"></a>So richten Sie ein Projekt ein
...
### <a name="to-customize-pricing"></a><a name="to-customize-pricing"></a>Preise anpassen
...
### <a name="to-add-job-tasks"></a><a name="to-add-job-tasks"></a>So fügen Sie Projektaufgaben hinzu
...
### <a name="to-create-planning-lines"></a><a name="to-create-planning-lines"></a>So erstellen Sie Planungszeilen
...
## <a name="calculating-remaining-usage"></a><a name="calculating-remaining-usage"></a>Berechnen des Restverbrauchs
...
### <a name="to-calculate-remaining-usage"></a><a name="to-calculate-remaining-usage"></a>So berechnen Sie den Restverbrauch
...
## <a name="creating-and-posting-a-job-sales-invoice"></a><a name="creating-and-posting-a-job-sales-invoice"></a>Erstellen und Buchen einer Projektverkaufsrechnung
...
### <a name="to-create-a-job-sales-invoice"></a><a name="to-create-a-job-sales-invoice"></a>So erstellen Sie eine Projektverkaufsrechnung
...
### <a name="to-post-a-new-sales-invoice"></a><a name="to-post-a-new-sales-invoice"></a>So buchen Sie eine neue Verkaufsrechnung
...
### <a name="to-view-the-posted-invoice"></a><a name="to-view-the-posted-invoice"></a>So zeigen Sie die gebuchte Rechnung an
...
### <a name="to-open-the-statistics-page"></a><a name="to-open-the-statistics-page"></a>So öffnen Sie die Seite "Statistik"
...
## <a name="handling-fixed-prices-1"></a><a name="handling-fixed-prices-1"></a>Verwenden von Festpreisen
...
### <a name="to-manage-fixed-pricing-in-jobs"></a><a name="to-manage-fixed-pricing-in-jobs"></a>So verwalten Sie Festpreise in Projekten
...
### <a name="to-enter-hours-in-the-job-journal"></a><a name="to-enter-hours-in-the-job-journal"></a>So erfassen Sie Stunden im Projekt Erf.-Journal
...
## <a name="copying-jobs"></a><a name="copying-jobs"></a>Kopieren von Projekten
...
### <a name="to-copy-a-job"></a><a name="to-copy-a-job"></a>So kopieren Sie ein Projekt
...
## <a name="making-payments-by-installments"></a><a name="making-payments-by-installments"></a>Anwenden von Teilzahlungen
...
### <a name="to-set-up-a-new-account"></a><a name="to-set-up-a-new-account"></a>So richten Sie ein neues Konto ein
...
### <a name="to-make-a-payment-by-installment"></a><a name="to-make-a-payment-by-installment"></a>So wenden Sie eine Teilzahlung an
...
### <a name="to-create-an-invoice"></a><a name="to-create-an-invoice"></a>So erstellen Sie eine Rechnung
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/paths/create-jobs/)
