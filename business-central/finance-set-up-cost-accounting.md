...
## Definieren der Beziehung zwischen Kostenarten und Fibukonten
...
### Beziehung zwischen Fibukonten und Kostenarten
...
### Kostenarten ohne Beziehung zum Fibukonto
...
1. Richten Sie eine Dimension als Kostenstellendimension auf der Seite **Kostenrechnungseinrichtung** ein. Nur die Werte aus dieser Dimension werden übertragen.
Sie können die Aktion **Aktionen** > **Funktionen** > **Kostenrechnungsdimensionen aktualisieren** zum Aktualisieren der Kostenrechnungsdimensionen auswählen.
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet 2.](media/ui-search/search_small.png "Tell me-Funktion") Symbol. Geben Sie **Kostenstellenplan** ein, und wählen Sie dann den entsprechenden Link.  
1. Klicken Sie auf der Registerkarte **Aktionen** in der Gruppe **Funktion** auf **Kostenstellen aus Dimension abrufen**, um Dimensionswerte zum Kostenstellenplan zu übertragen. Die Funktion überträgt die Dimensionswerte, die Sie in Schritt 1 definiert haben.  
...
### So transferieren Sie Dimensionswerte aus dem Fibukonto zum Kostenträgerplan
