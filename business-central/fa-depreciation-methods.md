...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets"></a><a name="depreciation-methods-for-fixed-assets"></a>Abschreibungsmethoden für Anlagen
...
## <a name="straight-line-depreciation"></a><a name="straight-line-depreciation"></a>Lineare Abschreibung
...
### <a name="depreciation-period"></a><a name="depreciation-period"></a>Abschreibungsperiode
...
### <a name="fixed-yearly-percentage"></a><a name="fixed-yearly-percentage"></a>Fester jährlicher Prozentsatz
...
### <a name="fixed-yearly-amount"></a><a name="fixed-yearly-amount"></a>Fester jährlicher Betrag
...
### <a name="example---straight-line-depreciation"></a><a name="example---straight-line-depreciation"></a>Beispiel – Lineare Abschreibung
...
## <a name="declining-balance-1-depreciation"></a><a name="declining-balance-1-depreciation"></a>Abschreibungsmethode "1 % degressiv"
...
### <a name="example---declining-balance-1-depreciation"></a><a name="example---declining-balance-1-depreciation"></a>Beispiel – Abschreibungsmethode "1 % degressiv"
...
## <a name="declining-balance-2-depreciation"></a><a name="declining-balance-2-depreciation"></a>Abschreibungsmethode "2 % degressiv"
...
### <a name="example---declining-balance-2-depreciation"></a><a name="example---declining-balance-2-depreciation"></a>Beispiel – Abschreibungsmethode "2 % degressiv"
...
## <a name="db1sl-depreciation"></a><a name="db1sl-depreciation"></a>Degressiv/Lineare Abschreibung 1
...
### <a name="example---db1-sl-depreciation"></a><a name="example---db1-sl-depreciation"></a>Beispiel – Degressiv-Lineare Abschreibung 1
...
## <a name="half-year-convention-depreciation"></a><a name="half-year-convention-depreciation"></a>Abschreibung 1 unter Verwendung der US-Halbjahresregel
...
### <a name="example---half-year-convention-depreciation"></a><a name="example---half-year-convention-depreciation"></a>Beispiel – Abschreibung 1 unter Verwendung der US-Halbjahresregel
...
## <a name="example---db1sl-depreciation-using-half-year-convention"></a><a name="example---db1sl-depreciation-using-half-year-convention"></a>Beispiel – Degressiv/Lineare Abschreibung 1 unter Verwendung der US-Halbjahresregel
...
## <a name="duplicating-entries-to-more-depreciation-books"></a><a name="duplicating-entries-to-more-depreciation-books"></a>Kopieren von Posten in weitere AfA-Bücher
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Siehe verwandte [Microsoft Schulungen](/training/modules/configure-depreciation-books/)
