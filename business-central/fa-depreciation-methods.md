...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets" />Abschreibungsmethoden für Anlagen
...
## <a name="straight-line-depreciation" />Lineare Abschreibung
...
### <a name="depreciation-period" />Abschreibungsperiode
...
### <a name="fixed-yearly-percentage" />Fester jährlicher Prozentsatz
...
### <a name="fixed-yearly-amount" />Fester jährlicher Betrag
...
### <a name="example---straight-line-depreciation" />Beispiel – Lineare Abschreibung
...
## <a name="half-year-convention-depreciation" />Abschreibung 1 unter Verwendung der US-Halbjahresregel
...
### <a name="example---half-year-convention-depreciation" />Beispiel – Abschreibung 1 unter Verwendung der US-Halbjahresregel
...
## <a name="duplicating-entries-to-more-depreciation-books" />Kopieren von Posten in weitere AfA-Bücher
