...
# <a name="install-and-uninstall-extensions-apps-in-business-central"></a><a name="install-and-uninstall-extensions-apps-in-business-central"></a><a name="install-and-uninstall-extensions-apps-in-business-central"></a>Erweiterungen (Apps) in Business Central installieren und deinstallieren
...
## <a name="install-an-extension"></a><a name="install-an-extension"></a><a name="install-an-extension"></a><a name="install"></a>Erweiterung installieren
...
## <a name="set-up-an-app"></a><a name="set-up-an-app"></a><a name="set-up-an-app"></a>Eine App einrichten
...
## <a name="upload-a-per-tenant-extension-pte"></a><a name="upload-a-per-tenant-extension-pte"></a><a name="upload-a-per-tenant-extension-pte"></a>Eine Pro-Tenant-Erweiterung (PTE) hochladen
...
## <a name="uninstall-an-app"></a><a name="uninstall-an-app"></a><a name="uninstall-an-app"></a>Eine App deinstallieren
