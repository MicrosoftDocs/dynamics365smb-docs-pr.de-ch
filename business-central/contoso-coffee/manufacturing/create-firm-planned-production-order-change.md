...
# <a name="walkthrough-create-a-firm-planned-production-order-and-change-it" />Exemplarische Vorgehensweise: Neuen fest geplanten Produktionsauftrag erstellen und ändern
