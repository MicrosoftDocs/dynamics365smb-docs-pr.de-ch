...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations"></a><a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations"></a><a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations"></a>Exemplarische Vorgehensweise für ein- und ausgehende Flows in gemischten Lagerkonfigurationen
...
## <a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations"></a><a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations"></a><a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations"></a>Ausgehender Flow: Komissionierung und Lieferung in erweiterten Lagerkonfigurationen
...
2. Zu versendende Artikel  
    ...
    Der Warenversand wird mit vier Zeilen gefüllt, die Verkaufszeilen für die angegebenen Kreditoren darstellen. Das Feld **Zu liefernde Menge** ist leer, da Artikel zuerst kommissioniert werden müssen.
