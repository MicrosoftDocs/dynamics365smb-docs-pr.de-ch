...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-mixed-warehouse-configurations" />Exemplarische Vorgehensweise für ein- und ausgehende Flows in gemischten Lagerkonfigurationen
...
## <a name="outbound-flow-picking-and-shipping-in-advanced-warehouse-configurations" />Ausgehender Flow: Komissionierung und Lieferung in erweiterten Lagerkonfigurationen
