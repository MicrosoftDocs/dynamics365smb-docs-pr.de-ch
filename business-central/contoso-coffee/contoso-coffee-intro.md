...
# <a name="introduction-to-contoso-coffee-demo-data"></a><a name="introduction-to-contoso-coffee-demo-data"></a>Einführung in Contoso Coffee-Demodaten
...
## <a name="set-up-contoso-coffee-data"></a><a name="set-up-contoso-coffee-data"></a>Demodaten für Contoso Coffee einrichten
...
## <a name="manufacturing-scenarios"></a><a name="manufacturing-scenarios"></a>Produktionsszenarien
...
## <a name="warehousing-scenarios"></a><a name="warehousing-scenarios"></a>Lagerszenarien
