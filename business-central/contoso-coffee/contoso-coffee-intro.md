...
- **SP-SCM1011 Airpot Duo**  
  ...
  Dieses Produkt erfordert Artikeltracking und verfügt über eine Komponente, die ebenfalls Artikeltracking voraussetzt. Die Kostenmethode ist *Spezial*.  
...
> [!IMPORTANT]
> Bevor Sie eines der Szenarien für Contoso Coffee ausführen, buchen Sie alle Erfassungsjournalzeilen mit Anfangssalden. Weitere Anforderungen finden Sie im Abschnitt [Contoso Coffee-Daten einrichten](#set-up-contoso-coffee-data).
