...
ms.author: bholtorf
---
# <a name="set-up-and-report-intrastat" />Einrichten und Berichten von Intrastat
...
## <a name="required-and-optional-setups" />Erforderliche und optionale Einrichtung
...
### <a name="to-set-up-intrastat-templates-and-batches" />So richten Sie Intrastat-Buch.-Blattvorlagen und -stapel ein
...
### <a name="to-set-up-transport-methods" />Einrichten von Transportmethoden
...
### <a name="to-set-up-which-intrastat-report-fields-are-mandatory" />Um einzurichten die Intrastat-Berichte erforderlich sein sollte Sie unter
...
#### <a name="to-set-up-transaction-nature-codes" />Einrichten von Transaktionsartencodes
...
## <a name="to-report-intrastat" />Intrastat-Berichte erstellen
...
### <a name="to-fill-in-intrastat-journals" />Intrastat-Erfassungsjournale ausfüllen:
...
### <a name="to-modify-intrastat-journals-lines" />So ändern Sie Intrastat-Erfassungsjournalzeilen
...
### <a name="report-intrastat-on-a-form-or-a-file" />Melden von Intrastat auf einem Formular oder einer Datei
...
### <a name="report-intrastat-in-a-file" />Intrastat Berichte in einer Datei
...
## <a name="reorganize-intrastat-journals" />Reorganisieren von Intrastat Erfassungsjournalen
...
## <a name="tariff-numbers" />Zollpositionen
