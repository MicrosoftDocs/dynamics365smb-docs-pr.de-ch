...
ms.author: edupont
---
# <a name="about-production-orders" />Info zu Fertigungsaufträgen
...
## <a name="production-order-creation" />Fertigungsauftrag erstellen
...
## <a name="limitations-on-production-order-creation" />Einschränkungen für das Erstellen von Fertigungsaufträgen
...
## <a name="production-order-status" />Fertigungsauftragsstatus (FA-Status)
...
### <a name="simulated-production-order" />Simulierter Fertigungsauftrag
...
### <a name="planned-production-order" />Geplanter Fertigungsauftrag
...
### <a name="firm-planned-production-order" />Fest geplanter Fertigungsauftrag
...
### <a name="released-production-order" />Freigegebener Fertigungsauftrag
...
### <a name="finished-production-order" />Beendeter Fertigungsauftrag
...
## <a name="production-order-execution" />Fertigungsauftrag ausführen
...
### <a name="material-consumption" />Materialverbrauch
...
### <a name="production-output" />Fertig produzierte Artikel (Istmeldungen)
...
### <a name="posting-consumption-and-output" />Verbrauch und Istmeldungen buchen
...
### <a name="production-journal" />Produktions Erfassungsjournal
