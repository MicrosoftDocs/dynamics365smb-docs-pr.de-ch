...
|Drücken Sie diese Tasten<br />(in Mac Os)|Um dies in einer Listenansicht tun |Um dies in einer Listenansicht tun |Bemerkungen|
|-----------------|-------|-------|-------|
|Ctrl+Home<br />(FN+CTRL+NACH-LINKS-TASTE)|Wählen Sie die erste Zeile in der Liste aus; Fokus springt zum ersten Feld in der Zeile.|Navigieren zum ersten Feld in einer Zeile. ||
|Ctrl+Ende<br />(FN+CTRL+NACH-RECHTS-TASTE)|Wählen Sie die letzte Zeile in der Liste aus; Fokus springt zum letzten Feld in der Zeile.|Navigieren zur letzten Kachel in einer Zeile.||
...
|Shift+Linksklick|Erweitern Sie die Auswahl von Zeilen, um die Zeile einzuschliessen, die Sie anklicken und alle Zeilen dazwischen.|Nicht anwendbar.|Sie können dieses verwenden, nachdem Sie CTRL+NACH-OBEN-TASTE oder CTRL+NACH-OBEN-TASTE unten verwenden, um Ihre Auswahl zu erweitern.|
|Ctrl+NACH-OBEN-TASTE<br />(CTRL+CMD+NACH-OBEN-TASTE)|Verschieben Sie den Fokus auf die Zeile darüber und halten Sie die aktuelle Zeile ausgewählt.|Nicht anwendbar.||
...
|CTRL+LEERTASTE<br />(Ctrl+Cmd+Leertaste)|Erweitern Sie die Auswahl von Zeilen, um die fokussierte Zeile einzuschliessen.|Nicht anwendbar.|Sie können dieses verwenden, nachdem Sie CTRL+NACH-OBEN-TASTE oder CTRL+NACH-OBEN-TASTE unten verwenden, um Ihre Auswahl zu erweitern.|
|Ctrl+A|Alle Zeilen auswählen.|Nicht anwendbar.||
|Shift+NACH-OBEN-TASTE|Erweitern Sie die Auswahl von Zeilen, um die Zeile darüber einzuschliessen.|Nicht anwendbar.||
...
|Shift+BILD-AB<br />(Shift+Fn+NACH-UNTEN-TASTE)|Erweitern Sie die Auswahl von Zeilen, um alle sichtbaren Zeilen unter der aktuellen Auswahl von Zeilen zu berücksichtigen.|Nicht anwendbar.||
|Ctrl+C<br />(Cmd+C)|Kopiert die ausgewählte Zeile in die Zwischenablage.|Nicht anwendbar.||
|Ctrl+V<br />(Cmd+V)|Fügen Sie die ausgewählten Zeilen der E-Mail die Zwischenablage in die aktuelle Seite oder den externen Dokument, Microsoft Excel z oder Outlook ein.|Nicht anwendbar.|Sie können dies nur in bearbeitbaren Listen tun.|
...
|Drücken Sie diese Tasten<br />(in Mac Os)|Vorgehensweise|
|-----------------|-------|
|F3|Schaltet das Suchenfeld um.<ul><li>Aktiviert das Suchenfeld, sodass Sie die Eingabe des Suchentexts starten.</li><li>Wenn das Suchenfeld bereits aktiviert ist, kehrt F3 zu der Liste zurück, ohne den Suchentext zu löschen.</li><ul>|  
|Shift+F3|Öffnet und beendet den Filterbereich.<ul><li> Falls der Filterbereich nicht geöffnet ist, öffnet Shift+F3 ihn und konzentriert sich auf die **+ Filter** Aktion unter **Liste filtern nach**, so dass Sie nur die EINGABETASTE klicken müssen, um das Hinzufügen eines Feldfilters zu starten.</li><li>Falls der Filterbereich bereits geöffnet ist, schliesst Shift+F3 ihn, aber löscht keine Filter, die Sie hinzugefügt haben.</li></ul>|
