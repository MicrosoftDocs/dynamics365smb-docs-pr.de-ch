...
|Ctrl+ALT+Q<br />(Ctrl+Option+Befehl+Q)|Öffnen Sie die Seite **Posten suchen**, um Belege und Posten zu finden, die auf der Grundlage gemeinsamer Informationen wie Belegnummer oder Buchungsdatum miteinander in Beziehung stehen. Weitere Informationen finden Sie unter [Suchen zugehöriger Entitäten für gebuchte Belege](ui-find-entries.md).|
...
|Ctrl+Alt+Shift+C|Informationen in der Unternehmenskennzeichnung anzeigen. Diese Verknüpfung wurde in Business Central 2022 Veröffentlichungszyklus 2 (Version 21) eingestellt und durch Ctrl+O ersetzt. |
...
|--------------------------------|----------|
|Ctrl++|Vergrössern Sie die aktuelle Seite.|  
|Ctrl+-|Verkleinern Sie die aktuelle Seite.|  
|Ctrl+0|Vergrössern Sie die aktuelle Seite auf 100 %.|  
