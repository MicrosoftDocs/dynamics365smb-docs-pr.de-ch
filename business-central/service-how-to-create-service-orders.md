...
ms.author: edupont
---
# <a name="create-service-orders"></a><a name="create-service-orders"></a>Erstellen von Serviceaufträgen
...
## <a name="to-create-a-service-order"></a><a name="to-create-a-service-order"></a>So erstellen Sie einen Serviceauftrag
...
## <a name="to-create-a-service-order-from-a-contract"></a><a name="to-create-a-service-order-from-a-contract"></a>So erstellen Sie Serviceaufträge aus Verträgen
...
## <a name="to-convert-a-service-quote-to-a-service-order"></a><a name="to-convert-a-service-quote-to-a-service-order"></a>So konvertieren Sie eine Serviceofferte in einen Serviceauftrag
...
## <a name="to-check-item-availability-for-one-or-more-orders"></a><a name="to-check-item-availability-for-one-or-more-orders"></a>So überprüfen Sie die Artikelverfügbarkeit für mindestens einen Auftrag
...
## <a name="to-reserve-an-item-for-a-service-order"></a><a name="to-reserve-an-item-for-a-service-order"></a>So reservieren Sie einen Artikel für einen Serviceauftrag:
...
## <a name="to-insert-lines-based-on-standard-service-codes"></a><a name="to-insert-lines-based-on-standard-service-codes"></a>So fügen Sie Zeilen basierend auf Standardservicecodes ein
...
## <a name="to-register-internal-or-public-comments"></a><a name="to-register-internal-or-public-comments"></a>So erfassen Sie interne oder öffentliche Bemerkungen
...
## <a name="to-delete-invoiced-service-orders"></a><a name="to-delete-invoiced-service-orders"></a>So löschen Sie fakturierte Serviceaufträge
