...
ms.author: edupont
---
# <a name="create-service-orders" />Erstellen von Serviceaufträgen
...
## <a name="to-create-a-service-order" />So erstellen Sie einen Serviceauftrag
...
## <a name="to-create-a-service-order-from-a-contract" />So erstellen Sie Serviceaufträge aus Verträgen
...
## <a name="to-convert-a-service-quote-to-a-service-order" />So konvertieren Sie eine Serviceofferte in einen Serviceauftrag
...
## <a name="to-check-item-availability-for-one-or-more-orders" />So überprüfen Sie die Artikelverfügbarkeit für mindestens einen Auftrag
...
## <a name="to-reserve-an-item-for-a-service-order" />So reservieren Sie einen Artikel für einen Serviceauftrag:
...
## <a name="to-insert-lines-based-on-standard-service-codes" />So fügen Sie Zeilen basierend auf Standardservicecodes ein
...
## <a name="to-register-internal-or-public-comments" />So erfassen Sie interne oder öffentliche Bemerkungen
...
## <a name="to-delete-invoiced-service-orders" />So löschen Sie fakturierte Serviceaufträge
