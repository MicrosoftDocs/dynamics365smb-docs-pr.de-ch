...
# <a name="sign-up-for-a-free-dynamics-365-business-central-trial"></a><a name="sign-up-for-a-free-dynamics-365-business-central-trial"></a>Für eine kostenlose Dynamics 365 Business Central-Testversion registrieren
...
## <a name="to-sign-up-for-the-trial"></a><a name="to-sign-up-for-the-trial"></a>So melden Sie sich für die Testversion an

[!INCLUDE [trial-get](includes/trial-get.md)]

## <a name="what-to-try"></a><a name="what-to-try"></a>Was Sie testen sollten
...
## <a name="get-started-with-a-subscription"></a><a name="get-started-with-a-subscription"></a>Erste Schritte mit einem Abonnement
...
## <a name="additional-resources"></a><a name="additional-resources"></a>Zusätzliche Ressourcen
