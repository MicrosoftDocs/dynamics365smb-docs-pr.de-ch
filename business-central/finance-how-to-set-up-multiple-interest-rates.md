...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment" />Mehrere Zinssätze für gestundete Zahlungen einrichten
...
## <a name="to-set-up-multiple-interest-rates" />Einrichten mehrerer Zinssätze.
