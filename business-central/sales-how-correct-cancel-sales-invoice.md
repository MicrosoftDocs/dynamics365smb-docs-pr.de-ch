...
ms.author: edupont
---
# <a name="correct-or-cancel-unpaid-sales-invoices"></a><a name="correct-or-cancel-unpaid-sales-invoices"></a>Ändern oder Löschen einer unbezahlten Verkaufsrechnung
...
## <a name="to-cancel-a-posted-sales-invoice"></a><a name="to-cancel-a-posted-sales-invoice"></a>Gebuchte Verkaufsrechnung stornieren
...
### <a name="partial-invoice-posting-also-supported"></a><a name="partial-invoice-posting-also-supported"></a>Buchung von Teilrechnungen wird ebenfalls unterstützt
...
## <a name="to-correct-a-posted-sales-invoice"></a><a name="to-correct-a-posted-sales-invoice"></a>Gebuchte Verkaufsrechnung korrigieren
