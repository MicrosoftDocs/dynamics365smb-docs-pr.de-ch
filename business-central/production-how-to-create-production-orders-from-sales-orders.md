...
---
# <a name="create-production-orders-from-sales-orders" />Fertigungsaufträge aus Verkaufsaufträgen zu erstellen:

In diesem Fenster können Sie direkt zum aktuellen Verkaufsauftrag einen Fertigungsauftrag erstellen.  

## <a name="to-create-a-production-order-from-a-sales-order" />Fertigungsaufträge aus Verkaufsaufträgen erstellen
