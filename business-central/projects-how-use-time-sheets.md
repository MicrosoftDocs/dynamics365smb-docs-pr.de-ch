...
2. Wählen Sie auf der Registerkarte **Home** die Option **Genehmigen** aus. Wählen Sie **Alle**, um alle Zeilen zu genehmigen. Wählen Sie **Ausgewählt**, um nur ausgewählte Zeilen zu genehmigen.
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Ressourcen Erf.-Journal** ein und wählen Sie dann den zugehörigen Link.  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Projekt Erf.-Journal** ein und wählen Sie dann den zugehörigen Link.  
2. Wählen Sie die Aktion **Zeilen von Arbeitszeittabellen vorschlagen** aus.  
3. Füllen Sie die Felder je nach Bedarf aus.  
...
1. Wählen Sie die ![Glühbirne, die die „Wie möchten Sie weiter verfahren“-Funktion öffnet.](media/ui-search/search_small.png "Tell Me-Funktion") Symbol. Geben Sie **Arbeitszeittabellen in Archiv verschieben** ein und wählen Sie dann den zugehörigen Link.  
