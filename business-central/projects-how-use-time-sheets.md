...
ms.author: edupont
---
# <a name="use-time-sheets" />Arbeitszeittabellen verwenden
...
## <a name="to-create-time-sheets" />So erstellen Sie Arbeitszeittabellen
...
## <a name="to-reuse-time-sheet-lines-in-other-time-sheets" />So können Sie Arbeitszeittabellenzeilen in anderen Arbeitszeittabellen wiederverwenden
...
## <a name="to-copy-job-planning-lines-to-a-time-sheet" />So kopieren Sie Projektplanzeilen in eine Arbeitszeittabelle:
...
## <a name="to-define-work-types-and-add-one-to-a-time-sheet" />Um Arbeitstypen festzulegen und einer Arbeitszeittabelle hinzufügen
...
## <a name="to-fill-in-time-sheet-lines-and-submit-for-approval" />So können Sie Arbeitszeittabellenzeilen ausfüllen und zur Genehmigung senden
...
## <a name="to-approve-or-reject-a-time-sheet" />So können Sie Arbeitszeittabellen genehmigen und ablehnen:
...
## <a name="to-reopen-a-time-sheet" />So öffnen Sie eine Arbeitszeittabelle erneut:
...
## <a name="to-view-and-approve-time-sheets-by-job" />So zeigen Sie Arbeitszeittabellen nach Projekt an und genehmigen diese
...
### <a name="to-approve-or-reject-a-time-sheet-by-job" />So können Sie Arbeitszeittabellen nach Projekt genehmigen oder ablehnen
...
## <a name="to-post-time-sheet-lines-in-a-resource-journal" />Buchen von Arbeitszeittabellenzeilen zu einem Ressourcen-Erf.-Journal
...
## <a name="to-post-time-sheet-lines-in-a-job-journal" />Buchen von Arbeitszeittabellenzeilen in einem Ressourcen-Erf.-Journal
...
## <a name="to-archive-time-sheets" />So archivieren Sie Arbeitszeittabellen
