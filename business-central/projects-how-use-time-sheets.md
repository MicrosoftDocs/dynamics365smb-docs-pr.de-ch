...
1. Wählen Sie das Symbol ![Glühlampe, mit der die Funktion „Wie möchten Sie weiter verfahren“ geöffnet wird](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren?") aus, geben Sie **Zeitblatt** ein, und wählen dann den zugehörigen Link aus.
...
1. Wählen Sie das Symbol ![Glühlampe, mit der die Funktion „Wie möchten Sie weiter verfahren“ geöffnet wird](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren?") aus, geben Sie **Zeitblatt-Manager** ein, und wählen dann den zugehörigen Link aus.
...
1. Wählen Sie das Symbol ![Glühlampe, mit der die Funktion „Wie möchten Sie weiter verfahren“ geöffnet wird](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren?") aus, geben Sie **Ressourcen Erf.-Journal** ein, und wählen dann den zugehörigen Link aus.  
...
1. Wählen Sie das Symbol ![Glühlampe, mit der die Funktion „Wie möchten Sie weiter verfahren“ geöffnet wird](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren?") aus, geben Sie **Job Erf.-Journal** ein, und wählen dann den zugehörigen Link aus.  
2. Wählen Sie die Aktion **Zeilen von Arbeitszeittabellen vorschlagen** aus.  
3. Füllen Sie die Felder je nach Bedarf aus.  
...
3. Wählen Sie das Symbol ![Glühlampe, mit der die Funktion standardmässig ](media/ui-search/search_small.png "Wie möchten Sie weiter verfahren") geöffnet wird, wählen Sie wie möchten Sie weiter verfahren aus, geben Sie **Zeitblatt-Manager** oder **Zeitblatt** aus und wählen dann den zugehörigen Link aus.
