...
|Konfigurationspaket mit PowerShell laden und importieren.|[Vorgehensweise: Konfigurieren neuer Unternehmen per Cmdlet](admin-how-to-configure-new-companies-using-a-cmdlet.md)|
