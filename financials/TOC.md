...
## [Von QuickBooks-App zu Microsoft Finance and Operations, Business edition wechseln](across-quickbooks-to-business-edition.md)
...
## [Finance and Operations, Business edition ohne Outlook verwenden](madeira-no-outlook.md)
## [Führen Ihrer Geschäftsdaten für Power BI](madeira-powerbi.md)
## [Power BI mit Finance and Operations, Business edition Inhaltspaketen verbinden](across-how-to-connect-powerbi-dynamics-365-content-packs-help.md)
## [Finance and Operations, Business edition in einem automatisierten Workflow verwenden](across-how-use-financials-data-source-flow.md)
## [Finance and Operations, Business edition als Power BI Datenquelle verwenden](across-how-use-financials-data-source-powerbi.md)
## [Finance and Operations, Business edition Daten verbinden, um eine Unternehmens App mithilfe von PowerApps verbinden](across-how-use-financials-data-source-powerapps.md)
...
## [ Finance and Operations, Business edition Werte vorschlagen lassen](ui-let-system-suggest-values.md)
...
## [Textbausteine anlegen](ui-how-define-ext-text.md)
...
### [Externen Buchhalter zu Ihrer Finance and Operations, Business edition einladen](finance-invite-external-accountant.md)  
...
## [Aufträge erstellen](sales-how-make-offers.md)
...
## [Änderungen in Finance and Operations, Business edition nachverfolgen](across-log-changes.md)
## [Benutzer und ihre Berechtigungen verwalten](ui-how-users-permissions.md)
