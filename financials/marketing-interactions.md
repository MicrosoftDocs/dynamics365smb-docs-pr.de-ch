---
title: Interaktionen| Microsoft Docs
description: "Beschreibt die Verwendung von Aktivitäten mit Kontakten in Financials"
...
Sie können Aktivitätenprotokollposten löschen, die annulliert wurden. Um Aktivitätenprotokollposten zu löschen, wählen Sie in der oberen rechten Ecke das Symbol **Nach Seite oder Bericht suchen **aus, ![Nach Seite oder Bericht suchen](media/ui-search/search_small.png "Symobl Nach Seite oder Bericht suchen") und geben Sie **Stornierte Aktivitätenprotokollposten löschen** ein, und wählen Sie den zugehörigen Link aus und geben dann die Informationen ein.
