...
Sie können mit dem Debitor verhandeln, indem Sie zuerst eine Verkaufsofferte erstellen, die Sie in eine Verkaufsrechnung umwandeln können, wenn Sie dem Verkauf zustimmen. Nachdem der Debitor die Vereinbarung bestätigt hat, beispielsweise nach dem Offertenprozess, können Sie eine Auftragsbestätigung senden, um Ihre Verpflichtung zu erfassen, die Produkte wie vereinbart zu liefern.
...
| --- | --- |
| Erstellen Sie eine Verkaufsofferte, in dem Sie Produkte auf verkäuflichen Bedingungen anbieten, bevor Sie die Offerte in eine Verkaufsrechnung umwandeln. |[Vorgehensweise: Machen Sie ein Angebot](sales-how-make-offers.md) |
