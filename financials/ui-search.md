---
title: Nach Seite oder Bericht suchen | Microsoft Docs
description: Erhalten Sie Informationen zu der Suche in Dynamics 365 for Financials.
...
**Hinweis:** Die verfügbaren Seiten und die Berichte hängen von der Benutzerumgebung ab, die Sie für Ihren Mandanten auswählen. Die **Standard** Umgebung gibt Zugang zu weniger, als die Umgebung **Suite**. Wenn Sie sich zum ersten Mal anmelden, nutzen Sie die Umgebung "Standard". Weitere Informationen finden Sie unter] [Benutzeroberfläche [!INCLUDE[d365fin](includes/d365fin_long_md.md)] (ui-experiences.md) anpassen.

**Hinweis**: Die Funktion **Suche nach Seite oder Bericht** sucht nicht nach Daten wie Debitorennamen, Adressen oder Transaktionen. Stattdessen können Sie nach Daten in den Listenseiten suchen, indem Sie das Lupensymbol in der rechten Ecke des Listenkopfes auswählen. Die Suche trifft nur auf die Liste zu, die Sie anzeigen. Informationen erhalten Sie unter [Eingeben von Kriterien in Filter](ui-enter-criteria-filters.md)
