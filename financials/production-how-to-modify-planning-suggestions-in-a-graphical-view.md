...
Wenn Sie das Dropdownmenü für das Inforegister **Zeitachse** zugreifen, sehen, die folgenden Funktionen, abhängig von dem, was Sie gewählt haben  
 ...
 |**Vergrössern (Ctrl+-)**|Verkleinert die Skala der x-Achse, sodass mehr Tage angezeigt werden. **Hinweis:** Sie erreichen dies auch, indem Sie STRG drücken + das Mausrad bewegen.|  
