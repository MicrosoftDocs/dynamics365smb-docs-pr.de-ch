...
|Manuelles Planen für Verkaufs- oder Fertigungsbedarf pro einzelner Operationsplanebene mithilfe des Fensters **Auftragsplanung**|[Vorgehensweise: Planung der Bestellung eines neuen Bedarfs von Auftrag](production-how-to-plan-for-new-demand.md)|
...
|Ausführen des Bestellvorschlags zum automatischen Erstellen eines ausführlichen Beschaffungsplans, um den Bedarf für Artikel zu decken, die ausschliesslich per Einkauf oder Umlagerung beschafft werden|**Bestellvorschlag** Seite|  
