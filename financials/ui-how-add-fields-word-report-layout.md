...
2.  Zeigen Sie die Registerkarte **Entwickler** im Menüband von Microsoft Word an.  
     ...
     Standardmässig wird die Registerkarte **Entwickler** nicht im Menüband angezeigt. Weitere Informationen finden Sie unter [Anzeigen der Entwickler-Registerkarte auf dem Menüband](http://go.microsoft.com/fwlink/?LinkID=389631).  
