---
title: 'Gewusst wie: Standorte einrichten | Microsoft Docs'
description: "Beschreibt, wie eine Lagerortkarte für jeden Ort oder jedes Lager, an dem Sie Lagerartikel speichern, einschließlich Regeln, wie man Artikel  von jedem Lagerort aus überträgt."
...
1. In der oberen rechter Ecke wählen Sie das Symbol **Nach Seite oder Bericht suchen aus **![Nach Seite oder Bericht suchen] (media/ui-search/search_small.png "")Symbol nach Seite oder Bericht suchen. Geben Sie **Standorte** ein und wählen Sie dann den entsprechenden Link aus.
...
1. In der oberen rechter Ecke wählen Sie das Symbol **Nach Seite oder Bericht suchen aus **![Nach Seite oder Bericht suchen] (media/ui-search/search_small.png "")Symbol nach Seite oder Bericht suchen. Geben Sie **Transferrouten** ein und wählen Sie dann den entsprechenden Link aus.
