...
Homepages verwenden ein Rollen orientiertes Design, damit Sie rasch auf Geschäftsvorgangs- und Intelligenztools zugreifen können, die Sie für Ihre Arbeit benötigen. Beispielsweise kann ein Buchhalter Zahlungen und Genehmigungen überwachen und Finanzdienstleistungsdiagramme anzeigen. Prüfen Sie sich die verschiedenen Homepages, indem Sie **Meine Einstellungen** in der oberen rechter Ecke und das Rollencenter auswählen, um dann zu untersuchen. Melden Sie sich erneut, um die Änderung zu übernehmen. Weitere Informationen finden Sie unter [Rollencenter ändern](change-role.md).  
