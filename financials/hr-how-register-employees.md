---
title: 'So gehts: Neue Mitarbeiter registrieren | Microsoft Docs'
...
1. In der oberen rechter Ecke wählen Sie das Symbol **Nach Seite oder Bericht suchen aus **![Nach Seite oder Bericht suchen] (media/ui-search/search_small.png "")Symbol nach Seite oder Bericht suchen. Geben Sie **Mitarbeiter** ein und wählen Sie dann den entsprechenden Link aus.
...
## <a name="to-register-an-alternate-address-for-an-employee"></a>So erfassen Sie eine alternative Adresse für einen Mitarbeiter
