...
description: "Beschreibt Position für Kontakte in Financials"
...
1. In der oberen rechter Ecke wählen Sie das **Symbol Nach Seite oder Bericht suchen **aus ![Nach Seite oder Bericht suchen ](media/ui-search/search_small.png "") Symbol nach Seite oder Bericht suchen. Geben Sie **Organisatiosstufe** ein und wählen Sie dann den entsprechenden Link aus.
