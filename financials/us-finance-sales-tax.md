---
title: Salestax sowie Salestaxgruppen in den USA und in Kanada| Microsoft Docs
description: "Mehr erfahren über das Einrichten von Salestax, Salestaxgruppen, Salestaxgebieten, Salestaxzuständigkeiten und Steuereinzelheiten."
...
Jedes Salestaxgebiet ist ein Gruppierung von Salestaxzuständigkeitsbereichen auf Grundlage einer bestimmten geografischen Lage. Beispielsweise hat das Salestaxgebiet in Miami, Florida, drei Salestaxzuständigkeitsbereiche: Stadt (Miami), Gemeinde (Dade) und Staat (Florida). [!INCLUDE[d365fin](includes/d365fin_md.md)] schließt eine begrenzte Zahl von Steuergebieten mit einer Standardkonfiguration ein, Sie können sie aber ändern und neue Steuergebiete hinzufügen.  
