...
|An|Informationen|  
|--------|---------|  
|Erstellen Sie den Kostenartenplan.|[Gewusst wie: Kostenarten einrichten](finance-how-to-set-up-cost-types.md)|  
...
|Erstellen Sie den Kostenstellenplan.|[Gewusst wie: Kostenstellen einrichten](finance-how-to-set-up-cost-centers.md)|  
