...
* Einrichten von MWST.-Produktbuchungsgruppen, um die Mehrwertsteuersätzen für die Produkte und Services zu definieren, die Sie kaufen und verkaufen.  
   ...
   > [!NOTE]  
>   Die Begriffe hinter den MWST-Geschäfts- und -Produktbuchungsgruppen entsprechen den allgemeinen Buchungsgruppen. Weitere Informationen finden Sie unter [Einrichten von Gruppenbuchungen ](finance-posting-groups.md)
