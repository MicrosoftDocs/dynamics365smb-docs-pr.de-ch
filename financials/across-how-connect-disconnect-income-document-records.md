...
---
# <a name="how-to-create-incoming-document-records-directly-from-documents-and-entries"></a>So wird's gemacht: Erstellen und Verknüpfen von Eingangsbelegen aus Belegen und Posten
